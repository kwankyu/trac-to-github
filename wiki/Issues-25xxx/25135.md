...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25135#issuecomment-386332",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25135#issuecomment-386333",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25135#event-225050"
}
```
