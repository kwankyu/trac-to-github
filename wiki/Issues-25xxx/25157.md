...
```json
{
    ...
    "label": "trivial",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-225433"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25157#issuecomment-387126",
    "user": "https://trac.sagemath.org/admin/accounts/users/sanketh"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25157#issuecomment-387127",
    "user": "https://trac.sagemath.org/admin/accounts/users/sanketh"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-225434"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-225435"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25157#issuecomment-387128",
    "user": "https://trac.sagemath.org/admin/accounts/users/sanketh"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25157#issuecomment-387129",
    "user": "https://trac.sagemath.org/admin/accounts/users/sanketh"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25157#event-225436"
}
```
