...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25012#issuecomment-383647",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25012#issuecomment-383648",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25012#issuecomment-383649",
    "user": "https://github.com/wbl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25012#issuecomment-383650",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-223713"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-223714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25012",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-223715"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-223716"
}
```
