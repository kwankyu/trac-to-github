...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-343159"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-343160"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-343161"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25012#issuecomment-381072",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25012#issuecomment-381073",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25012#issuecomment-381074",
    "user": "https://github.com/wbl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25012",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25012#issuecomment-381075",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-343162"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-343163"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-343164"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25012",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-343165"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25012#event-343166"
}
```
