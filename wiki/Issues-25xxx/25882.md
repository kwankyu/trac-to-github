...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25882#issuecomment-400528",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25882#event-231940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25882",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25882#event-231941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25882#issuecomment-400529",
    "user": "https://github.com/embray"
}
```
