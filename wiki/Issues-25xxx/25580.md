...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25580#event-229312"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25580#issuecomment-395172",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25580#event-229313"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25580#event-229314"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25580#event-229315"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25580#issuecomment-395173",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25580#event-229316"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25580",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25580#event-229317"
}
```
