...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25173#issuecomment-387457",
...
```json
{
    "body": "**Attachment:** [sl3webs.sage](https://github.com/sagemath/sage/files/ticket25173/sl3webs.sage)",
    "created_at": "2018-05-23T11:03:12Z",
    "issue": "https://github.com/sagemath/sage/issues/25173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25173#issuecomment-387458",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25173#issuecomment-387459",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25173#issuecomment-387460",
    "user": "https://github.com/BruceWestbury"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25173#issuecomment-387461",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25173#event-225564"
}
```
