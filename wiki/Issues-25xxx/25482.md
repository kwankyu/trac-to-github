...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349825"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349828"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25482#issuecomment-390758",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349829"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25482#issuecomment-390759",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25482#issuecomment-390760",
...
```json
{
    ...
    "milestone_title": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349830"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349831"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349832"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25482",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25482#event-349835"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25482",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25482#issuecomment-390761",
    "user": "https://github.com/embray"
}
```
