...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25804#issuecomment-399068",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25804",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25804#issuecomment-399069",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25804#event-231220"
}
```
