...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25004#event-343050"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25004#event-343051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25004#event-343052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25004#event-343053"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25004#event-343054"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25004",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25004#issuecomment-380853",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25004",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25004#issuecomment-380854",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25004",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25004#issuecomment-380855",
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25004#event-343055"
}
```
