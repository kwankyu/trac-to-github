...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25798#event-353833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25798#event-353834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25798#event-353835"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25798#issuecomment-396369",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25798#issuecomment-396370",
    "user": "https://github.com/AntGeorge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25798",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25798#issuecomment-396371",
    "user": "https://github.com/dcoudert"
}
```
