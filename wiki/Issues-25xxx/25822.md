...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354073"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354074"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354075"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354076"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25822#issuecomment-396651",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25822#issuecomment-396652",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25822#issuecomment-396653",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25822#issuecomment-396654",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25822#issuecomment-396655",
    "user": "https://github.com/sagetrac-parisse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25822#issuecomment-396656",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/25822#issuecomment-396657",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354077"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354078"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354079"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354080"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354081"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354082"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354083"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354084"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354085"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354086"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354087"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354088"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354089"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/25822",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/25822#event-354090"
}
```
