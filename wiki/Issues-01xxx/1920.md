...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9071"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9072"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1920/trac_1920-verify.patch",
    "created_at": "2012-07-07T03:55:00Z",
    "issue": "https://github.com/sagemath/sage/issues/1920",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1920/trac_1920-verify.patch",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9073"
}
```
...
```json
{
    ...
    "milestone": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9074"
}
```
...
```json
{
    ...
    "milestone": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9075"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9076"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9077"
}
```
...
```json
{
    ...
    "milestone": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9078"
}
```
...
```json
{
    ...
    "milestone": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9079"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9080"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1920",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1920#event-9081"
}
```
