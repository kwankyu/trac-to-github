...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1970#event-19697"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1970#event-19698"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1970",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1970#event-19699"
}
```
