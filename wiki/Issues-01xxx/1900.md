...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1900/graph_am-updated.patch",
    "created_at": "2008-01-24T05:44:07Z",
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1900/graph_am-updated.patch",
...
```json
{
    "body": "**Attachment:** [graph_am-updated.patch](https://github.com/sagemath/sage/files/ticket1900/graph_am-updated.patch)",
    "created_at": "2008-01-24T05:44:07Z",
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "issue_comment",
...
**Attachment:** [graph_am-updated.patch](https://github.com/sagemath/sage/files/ticket1900/graph_am-updated.patch)
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1900#event-8942"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1900/graph_am-over_integers.patch",
    "created_at": "2008-01-24T06:22:49Z",
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1900/graph_am-over_integers.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\n**Attachment:** [graph_am-over_integers.patch](https://github.com/sagemath/sage/files/ticket1900/graph_am-over_integers.patch)",
    "created_at": "2008-01-24T06:22:49Z",
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1900#event-8943"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1900#event-8944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1900",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1900#event-8945"
}
```
