...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1748#event-8053"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1748#event-8054"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1748#event-8055"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1748",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1748#issuecomment-8498",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1748#event-8056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1748",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1748#event-8057"
}
```
