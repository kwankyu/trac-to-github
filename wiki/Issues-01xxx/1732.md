...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1732#event-8010"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1732#issuecomment-8442",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1732#event-8011"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1732",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1732#event-8012"
}
```
