...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1512#issuecomment-7501",
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1512#event-7087"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1512#issuecomment-7502",
    "user": "https://trac.sagemath.org/admin/accounts/users/tkosan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1512",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1512#event-7088"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1512#event-7089"
}
```
