...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1992#issuecomment-10021",
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1992#event-9570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1992",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1992#event-9571"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1992#event-9572"
}
```
