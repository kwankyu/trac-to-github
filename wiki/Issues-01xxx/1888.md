...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1888#event-8856"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1888#event-8857"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1888#event-8858"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1888#event-8859"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1888",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1888#event-8860"
}
```
...
```json
{
    ...
    "milestone": "sage-4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1888#event-8861"
}
```
