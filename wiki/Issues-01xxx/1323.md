...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1323#event-6195"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1323#event-6196"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1323#event-6197"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1323#event-6198"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1323",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1323#event-6199"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1323#event-6200"
}
```
