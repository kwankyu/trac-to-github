...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1199#event-5568"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1199#event-5569"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1199#event-5570"
}
```
...
```json
{
    ...
    "label": "component: numerical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1199#event-5571"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1199#event-5572"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1199",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1199#event-5573"
}
```
