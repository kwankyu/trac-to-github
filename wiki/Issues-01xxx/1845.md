...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1845#event-8619"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket1845/trac-1845-fix-doctest.patch",
    "created_at": "2008-01-27T04:52:02Z",
    "issue": "https://github.com/sagemath/sage/issues/1845",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1845/trac-1845-fix-doctest.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/cwitty"
}
```
...
```json
{
    "body": "**Attachment:** [trac-1845-fix-doctest.patch](https://github.com/sagemath/sage/files/ticket1845/trac-1845-fix-doctest.patch)",
    "created_at": "2008-01-27T04:52:02Z",
    "issue": "https://github.com/sagemath/sage/issues/1845",
    "type": "issue_comment",
...
**Attachment:** [trac-1845-fix-doctest.patch](https://github.com/sagemath/sage/files/ticket1845/trac-1845-fix-doctest.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1845#event-8620"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1845#event-8621"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1845",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1845#event-8622"
}
```
