...
```json
{
    ...
    "asset_name": "Sage-2.8.15.alpha2-fix-dokchitser-doctest-FC7-32bit.patch",
    "asset_url": "tarball://root/attachments/ticket1372/Sage-2.8.15.alpha2-fix-dokchitser-doctest-FC7-32bit.patch",
    "created_at": "2007-12-02T16:38:46Z",
    "issue": "https://github.com/sagemath/sage/issues/1372",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket1372/Sage-2.8.15.alpha2-fix-dokchitser-doctest-FC7-32bit.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "**Attachment:** [Sage-2.8.15.alpha2-fix-dokchitser-doctest-FC7-32bit.patch](https://github.com/sagemath/sage/files/ticket1372/Sage-2.8.15.alpha2-fix-dokchitser-doctest-FC7-32bit.patch)",
    "created_at": "2007-12-02T16:38:46Z",
    "issue": "https://github.com/sagemath/sage/issues/1372",
    "type": "issue_comment",
...
**Attachment:** [Sage-2.8.15.alpha2-fix-dokchitser-doctest-FC7-32bit.patch](https://github.com/sagemath/sage/files/ticket1372/Sage-2.8.15.alpha2-fix-dokchitser-doctest-FC7-32bit.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1372",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/1372#issuecomment-6804",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1372",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1372#event-6429"
}
```
