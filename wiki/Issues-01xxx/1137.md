...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1137#event-5247"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1137#event-5248"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1137#event-5249"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1137",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1137#event-5250"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1137#event-5251"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1137#event-5252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/1137",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1137#event-5253"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/1137#event-5254"
}
```
