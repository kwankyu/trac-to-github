...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8397#event-104202"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8397#event-104203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8397#event-104204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8397#event-104205"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8397#event-104206"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8397",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8397#event-104207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8397#issuecomment-66310",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8397#issuecomment-66311",
    "user": "https://github.com/mwhansen"
}
```
