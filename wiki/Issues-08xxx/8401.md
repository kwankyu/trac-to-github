...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-104227"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-104228"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-104229"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-104230"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8401#issuecomment-66324",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8401",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8401#event-104231"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8401",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8401#issuecomment-66325",
    "user": "https://github.com/mwhansen"
}
```
