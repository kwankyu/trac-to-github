...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8538#event-106405"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8538#event-106406"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8538#event-106407"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8538#event-106408"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8538#event-106409"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8538#event-106410"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8538#issuecomment-68132",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8538#event-106411"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8538",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8538#event-106412"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8538#issuecomment-68133",
    "user": "https://github.com/mwhansen"
}
```
