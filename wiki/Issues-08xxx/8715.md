...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8715#event-109051"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8715#event-109052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8715#event-109053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8715#event-109054"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8715#event-109055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8715#event-109056"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8715#event-109057"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8715#event-109058"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8715#issuecomment-70492",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8715#issuecomment-70493",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8715#issuecomment-70494",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8715#issuecomment-70495",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8715#issuecomment-70496",
    "user": "https://github.com/sagetrac-mvngu"
}
```
