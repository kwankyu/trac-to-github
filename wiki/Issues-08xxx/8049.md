...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8049#event-99168"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8049#event-99169"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8049#event-99170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8049#event-99171"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8049#event-99172"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8049",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8049#event-99173"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8049#issuecomment-61738",
    "user": "https://github.com/sagetrac-tmonteil"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8049",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8049#issuecomment-61739",
    "user": "https://github.com/jdemeyer"
}
```
