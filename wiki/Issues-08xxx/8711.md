...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-108988"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-108989"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-108990"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-108991"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-108992"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-108993"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8711#issuecomment-70429",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-108994"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-108995"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8711#issuecomment-70430",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8711#issuecomment-70431",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-108996"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8711",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8711#event-108997"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8711#issuecomment-70432",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8711#issuecomment-70433",
    "user": "https://github.com/jhpalmieri"
}
```
