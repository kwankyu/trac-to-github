...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98642"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98643"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98644"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98645"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98647"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98648"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8005",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98649"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98650"
}
```
...
```json
{
    ...
    "subject": "https://github.com/orlitzky",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98651"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98652"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8005#issuecomment-61344",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8005",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8005#issuecomment-61345",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8005#event-98653"
}
```
