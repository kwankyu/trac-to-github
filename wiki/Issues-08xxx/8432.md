...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket8432/deps.diff",
    "created_at": "2010-03-04T04:02:41Z",
    "issue": "https://github.com/sagemath/sage/issues/8432",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8432/deps.diff",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "**Attachment:** [deps.diff](https://github.com/sagemath/sage/files/ticket8432/deps.diff)\n\nupdated deps",
    "created_at": "2010-03-04T04:02:41Z",
    "issue": "https://github.com/sagemath/sage/issues/8432",
    "type": "issue_comment",
...
**Attachment:** [deps.diff](https://github.com/sagemath/sage/files/ticket8432/deps.diff)
...
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "deps",
    "asset_url": "tarball://root/attachments/ticket8432/deps",
    "created_at": "2010-03-04T04:03:13Z",
    "issue": "https://github.com/sagemath/sage/issues/8432",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8432/deps",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [deps](https://github.com/sagemath/sage/files/ticket8432/deps)",
    "created_at": "2010-03-04T04:03:13Z",
    "issue": "https://github.com/sagemath/sage/issues/8432",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8432#event-59758"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\nYou should replace the current file `SAGE_ROOT/spkg/standard/deps` in Sage 4.3.4.alpha0 with the updated one on this ticket, i.e. [deps](https://github.com/sagemath/sage/files/ticket8432/deps).",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8432#event-59759"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8432#event-59760"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8432#event-59761"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8432",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8432#event-59762"
}
```
