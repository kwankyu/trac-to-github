...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8081#event-99590"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8081#event-99591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8081#event-99592"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8081#event-99593"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8081#event-99594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8081#event-99595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8081#event-99596"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8081#event-99597"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8081#issuecomment-62143",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8081#event-99598"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8081",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8081#event-99599"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8081#issuecomment-62144",
    "user": "https://github.com/sagetrac-mvngu"
}
```
