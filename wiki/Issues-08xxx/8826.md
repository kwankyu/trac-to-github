...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-110761"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-110762"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-110763"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-110764"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-110765"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8826",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-110766"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8826#issuecomment-72036",
    "user": "https://github.com/sagetrac-gostrc"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8826",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-110767"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8826",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-110768"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8826#issuecomment-72037",
    "user": "https://github.com/sagetrac-gostrc"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.4.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8826#event-110769"
}
```
