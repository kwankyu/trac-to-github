...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102323"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102325"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8278#issuecomment-64451",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8278#issuecomment-64452",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102326"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102327"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102328"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102329"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102330"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102331"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8278",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8278#event-102332"
}
```
