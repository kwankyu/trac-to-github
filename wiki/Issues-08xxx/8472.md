...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8472#event-105369"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8472#event-105370"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8472#event-105371"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8472#event-105372"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8472#event-105373"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8472",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8472#issuecomment-67353",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8472#event-105374"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8472#event-105375"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8472",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8472#event-105376"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8472#event-105377"
}
```
