...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103471"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103479"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8349#issuecomment-65641",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103480"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8349",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8349#event-103481"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8349#issuecomment-65642",
    "user": "https://github.com/sagetrac-mvngu"
}
```
