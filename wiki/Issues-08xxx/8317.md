...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8317#issuecomment-66623",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8317#event-58562"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8317#event-58563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8317#issuecomment-66624",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8317#issuecomment-66625",
...
```json
{
    ...
    "label": "component: symbolics",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8317#event-58564"
}
```
...
```json
{
    ...
    "label": "component: misc",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8317#event-58565"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8317#event-58566"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8317#event-58567"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8317#event-58568"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8317",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8317#issuecomment-66626",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8317#event-58569"
}
```
