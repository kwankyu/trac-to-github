...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8004#event-98627"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8004#event-98628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8004#event-98629"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8004#event-98630"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8004#event-98631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8004#event-98632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8004#event-98633"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8004#event-98634"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8004",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8004#issuecomment-61335",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8004#event-98635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8004",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8004#event-98636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8004",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8004#issuecomment-61336",
    "user": "https://github.com/qed777"
}
```
