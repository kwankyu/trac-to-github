...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8257#event-102060"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8257#event-102061"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8257#event-102062"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8257#event-102063"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8257#event-102064"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8257#event-102065"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8257#event-102066"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8257#event-102067"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8257",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8257#event-102068"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8257#issuecomment-64232",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8257",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8257#issuecomment-64233",
    "user": "https://github.com/sagetrac-mvngu"
}
```
