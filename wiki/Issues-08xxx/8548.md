...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106544"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106545"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106546"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106547"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8548",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106549"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106550"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8548",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106551"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106552"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106553"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8548",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8548#event-106555"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8548#issuecomment-68236",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8548#issuecomment-68237",
    "user": "https://github.com/sagetrac-mvngu"
}
```
