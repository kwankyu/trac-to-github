...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8733#event-62833"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8733#event-62834"
}
```
...
```json
{
    "body": "**Attachment:** [trac_8733-cgraph-cleanup.patch](https://github.com/sagemath/sage/files/ticket8733/trac_8733-cgraph-cleanup.patch)",
    "created_at": "2010-04-23T02:57:28Z",
    "issue": "https://github.com/sagemath/sage/issues/8733",
    "type": "issue_comment",
...
**Attachment:** [trac_8733-cgraph-cleanup.patch](https://github.com/sagemath/sage/files/ticket8733/trac_8733-cgraph-cleanup.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8733#event-62835"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8733#event-62836"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8733#issuecomment-72586",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8733#event-62837"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8733",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8733#event-62838"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8733#issuecomment-72587",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8733#issuecomment-72588",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
