...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100497"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100498"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100499"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100500"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100501"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100503"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8148#issuecomment-62892",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100504"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100505"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100506"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8148",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8148#event-100507"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8148#issuecomment-62893",
    "user": "https://github.com/jdemeyer"
}
```
