...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8937#issuecomment-75088",
    "user": "https://trac.sagemath.org/admin/accounts/users/amca01"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8937#issuecomment-75089",
    "user": "https://trac.sagemath.org/admin/accounts/users/amca01"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8937#issuecomment-75090",
    "user": "https://trac.sagemath.org/admin/accounts/users/amca01"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8937#event-64708"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8937#issuecomment-75091",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8937",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8937#issuecomment-75092",
    "user": "https://trac.sagemath.org/admin/accounts/users/amca01"
}
```
