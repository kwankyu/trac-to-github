...
```json
{
    "body": "**Attachment:** [trac_8321_numeric_int_mpmath.patch](https://github.com/sagemath/sage/files/ticket8321/trac_8321_numeric_int_mpmath.patch)\n\nNumerical evaluation of symbolic integration with arbitrary precision with help of mpmath",
    "created_at": "2010-08-25T15:43:31Z",
    "issue": "https://github.com/sagemath/sage/issues/8321",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58593"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58594"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58595"
}
```
...
```json
{
    "body": "**Attachment:** [trac_8321_rebase.patch](https://github.com/sagemath/sage/files/ticket8321/trac_8321_rebase.patch)\n\nrebase of previous patch to 4.7.1",
    "created_at": "2011-08-23T03:43:01Z",
    "issue": "https://github.com/sagemath/sage/issues/8321",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58596"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58597"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58598"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58599"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58600"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58601"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58602"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58603"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8321#event-58604"
}
```
