...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8963#issuecomment-75377",
    "user": "https://github.com/jdchristensen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8963#event-64961"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8963#issuecomment-75378",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8963#issuecomment-75379",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8963#event-64962"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8963#event-64963"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8963#issuecomment-75380",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8963#event-64964"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8963",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8963#event-64965"
}
```
