...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8304#event-102679"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8304#event-102680"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8304#event-102681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8304#event-102682"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8304#event-102683"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8304#event-102684"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8304#event-102685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8304#event-102686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8304#issuecomment-64693",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8304#event-102687"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8304",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8304#event-102688"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8304",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8304#issuecomment-64694",
    "user": "https://github.com/sagetrac-mvngu"
}
```
