...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8360#event-103626"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8360#event-103627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8360#event-103628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8360#event-103629"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8360#event-103630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8360#event-103631"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8360#issuecomment-65782",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8360#issuecomment-65783",
    "user": "https://github.com/nthiery"
}
```
