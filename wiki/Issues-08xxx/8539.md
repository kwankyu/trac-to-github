...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106420"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106421"
}
```
...
```json
{
    ...
    "subject": "https://github.com/rlmill",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106422"
}
```
...
```json
{
    ...
    "subject": "https://github.com/rlmill",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106423"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106426"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106427"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106428"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106429"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8539",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106430"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8539#issuecomment-68141",
...
```json
{
    ...
    "milestone_title": "sage-4.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106431"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8539#event-106432"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8539#issuecomment-68142",
    "user": "https://github.com/sagetrac-mvngu"
}
```
