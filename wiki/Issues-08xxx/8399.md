...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8399#event-104213"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8399#event-104214"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8399#event-104215"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8399#event-104216"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8399#event-104217"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-drkirkby",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8399#event-104218"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8399#event-104219"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8399#event-104220"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8399",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8399#issuecomment-66316",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8399",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8399#event-104221"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8399",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8399#issuecomment-66317",
    "user": "https://github.com/mwhansen"
}
```
