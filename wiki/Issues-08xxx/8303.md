...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8303#event-58442"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8303#event-58443"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8303#event-58444"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8303#event-58445"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8303",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8303#event-58446"
}
```
