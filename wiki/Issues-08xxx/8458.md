...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68942",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68943",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60088"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket8458/trac_8458_independent_graphs.patch",
    "created_at": "2012-01-03T23:10:53Z",
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8458/trac_8458_independent_graphs.patch",
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [trac_8458_independent_graphs.patch](https://github.com/sagemath/sage/files/ticket8458/trac_8458_independent_graphs.patch)\n\nI corrected the main generator. There are several specialized (e.g. tree generator) but I don't think the same problem arises in any of them. Do you agree?",
    "created_at": "2012-01-03T23:10:53Z",
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8458#issuecomment-68944",
    "user": "https://trac.sagemath.org/admin/accounts/users/brunellus"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60089"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60090"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket8458/trac_8458_independent_graphs.2.patch",
    "created_at": "2012-01-31T12:34:03Z",
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8458/trac_8458_independent_graphs.2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/brunellus"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60091"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60092"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60093"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60094"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60095"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60096"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket8458/trac_8458.patch",
    "created_at": "2012-01-31T17:44:47Z",
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8458/trac_8458.patch",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    "body": "**Attachment:** [trac_8458.patch](https://github.com/sagemath/sage/files/ticket8458/trac_8458.patch)",
    "created_at": "2012-01-31T17:44:47Z",
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60097"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60098"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60099"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8458",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8458#event-60100"
}
```
