...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63504"
}
```
...
```json
{
    "body": "**Attachment:** [trac_8801_projective_duals.patch](https://github.com/sagemath/sage/files/ticket8801/trac_8801_projective_duals.patch)\n\nThe patch implements duals of projective hypersurfaces. Patch rebased on top of Sage 5.2.",
    "created_at": "2012-08-24T17:20:59Z",
    "issue": "https://github.com/sagemath/sage/issues/8801",
    "type": "issue_comment",
...
**Attachment:** [trac_8801_projective_duals.patch](https://github.com/sagemath/sage/files/ticket8801/trac_8801_projective_duals.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63505"
}
```
...
```json
{
    ...
    "milestone": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63506"
}
```
...
```json
{
    ...
    "milestone": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63507"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63508"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63509"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63510"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63511"
}
```
...
```json
{
    ...
    "milestone": "sage-6.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63512"
}
```
...
```json
{
    ...
    "milestone": "sage-6.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63513"
}
```
...
```json
{
    ...
    "milestone": "sage-7.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63514"
}
```
...
```json
{
    ...
    "milestone": "sage-7.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63515"
}
```
...
```json
{
    ...
    "milestone": "sage-7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63516"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63517"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63518"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63519"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8801",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8801#event-63520"
}
```
