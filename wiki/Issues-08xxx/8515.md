...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106038"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106039"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106040"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106042"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8515#issuecomment-67903",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106046"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8515#issuecomment-67904",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106047"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8515",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8515#event-106048"
}
```
