...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8020#event-98829"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8020#event-98830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8020#event-98831"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8020#event-98832"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8020#event-98833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8020#event-98834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8020#event-98835"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8020#event-98836"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8020",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8020#event-98837"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8020#issuecomment-61449",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8020#issuecomment-61450",
    "user": "https://github.com/sagetrac-mvngu"
}
```
