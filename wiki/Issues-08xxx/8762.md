...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8762#event-63113"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8762#event-63114"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8762#issuecomment-72945",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8762#event-63115"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8762#issuecomment-72946",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8762#event-63116"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8762#event-63117"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8762#issuecomment-72947",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8762#issuecomment-72948",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8762#issuecomment-72949",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8762#issuecomment-72950",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8762#event-63118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8762",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8762#event-63119"
}
```
