...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101383"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101384"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101385"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101386"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101387"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101388"
}
```
...
```json
{
    ...
    "subject": "https://github.com/zimmermann6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101389"
}
```
...
```json
{
    ...
    "subject": "https://github.com/zimmermann6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101390"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101391"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101392"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101393"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8212",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8212#event-101394"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8212#issuecomment-63627",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8212#issuecomment-63628",
    "user": "https://github.com/qed777"
}
```
