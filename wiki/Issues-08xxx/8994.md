...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8994#event-65362"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8994#event-65363"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8994#event-65364"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8994#event-65365"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8994#issuecomment-75900",
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8994#event-65366"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8994#event-65367"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8994#event-65368"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8994#event-65369"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8994#issuecomment-75901",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8994#event-65370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8994#issuecomment-75902",
    "user": "https://github.com/mkoeppe"
}
```
