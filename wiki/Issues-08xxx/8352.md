...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8352#event-103509"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8352#event-103510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8352#event-103511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8352#event-103512"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8352#event-103513"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8352#event-103514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8352",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8352#issuecomment-65670",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8352#event-103515"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8352#event-103516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8352",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8352#issuecomment-65671",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8352#event-103517"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8352",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8352#event-103518"
}
```
