...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8217#event-101457"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8217#event-101458"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8217#event-101459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8217#event-101460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8217#event-101461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8217#event-101462"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8217#event-101463"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8217#issuecomment-63671",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8217#issuecomment-63672",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8217#event-101464"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8217",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8217#event-101465"
}
```
