...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8999#event-65407"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8999#issuecomment-75938",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8999",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8999#event-65408"
}
```
