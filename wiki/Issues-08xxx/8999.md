...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8999#event-113342"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8999#event-113343"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8999#event-113344"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8999#event-113345"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8999#event-113346"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8999#event-113347"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8999#event-113348"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8999#issuecomment-74110",
    "user": "https://github.com/sagetrac-mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8999",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8999#event-113349"
}
```
