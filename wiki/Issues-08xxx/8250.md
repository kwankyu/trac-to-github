...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101944"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101945"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101946"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101947"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101948"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101949"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101950"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101951"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101952"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101953"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8250#issuecomment-64149",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8250#issuecomment-64150",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101954"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8250",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8250#event-101955"
}
```
