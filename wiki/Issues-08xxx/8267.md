...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8267#event-102173"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8267#event-102174"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8267#event-102175"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8267#event-102176"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8267#event-102177"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8267#event-102178"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8267#event-102179"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8267#issuecomment-64335",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8267#event-102180"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8267",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8267#event-102181"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8267",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8267#issuecomment-64336",
    "user": "https://github.com/sagetrac-mvngu"
}
```
