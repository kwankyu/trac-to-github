...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8752#event-109616"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8752#event-109617"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8752#event-109618"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8752#event-109619"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8752#event-109620"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8752#event-109621"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8752#issuecomment-71063",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8752",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8752#event-109622"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8752#issuecomment-71064",
    "user": "https://github.com/sagetrac-lfousse"
}
```
