...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106350"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8534#issuecomment-68086",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106351"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106352"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106353"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106354"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106355"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106356"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106357"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106358"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106359"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8534#issuecomment-68087",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106360"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8534",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8534#event-106362"
}
```
