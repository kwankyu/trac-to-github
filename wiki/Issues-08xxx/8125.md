...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100245"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100246"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8125",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100247"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8125",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100248"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100249"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8125",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8125#issuecomment-62710",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8125",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8125#issuecomment-62711",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100253"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100254"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100255"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8125",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8125#event-100256"
}
```
