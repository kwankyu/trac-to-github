...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8560#event-106769"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8560#event-106770"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8560#event-106771"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8560#event-106772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8560#event-106773"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8560#event-106774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8560",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8560#issuecomment-68447",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8560#event-106775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8560#event-106776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8560#event-106777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8560",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8560#event-106778"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8560",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8560#issuecomment-68448",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8560",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8560#issuecomment-68449",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8560",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8560#issuecomment-68450",
    "user": "https://github.com/jhpalmieri"
}
```
