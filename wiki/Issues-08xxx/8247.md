...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8247#event-101910"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8247#event-101911"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8247#event-101912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8247#event-101913"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8247#event-101914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8247#issuecomment-64119",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8247",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8247#event-101915"
}
```
