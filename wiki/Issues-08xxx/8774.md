...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8774#event-109968"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8774#event-109969"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8774#event-109970"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8774#event-109971"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8774#event-109972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8774#event-109973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8774#event-109974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8774#event-109975"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8774#issuecomment-71294",
    "user": "https://github.com/wjp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8774#issuecomment-71295",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8774#event-109976"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8774",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8774#event-109977"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8774#issuecomment-71296",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8774#issuecomment-71297",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8774#issuecomment-71298",
    "user": "https://github.com/sagetrac-mvngu"
}
```
