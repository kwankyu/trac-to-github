...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111647"
}
```
...
```json
{
    ...
    "subject": "https://github.com/nathanncohen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111648"
}
```
...
```json
{
    ...
    "subject": "https://github.com/nathanncohen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111650"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111651"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111652"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111653"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111654"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8894#issuecomment-72785",
    "user": "https://github.com/sagetrac-lsampaio"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111655"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111656"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111657"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111658"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8894#issuecomment-72786",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111659"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8894#issuecomment-72787",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8894#issuecomment-72788",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111661"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111662"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111663"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8894",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8894#event-111664"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8894#issuecomment-72789",
    "user": "https://github.com/jdemeyer"
}
```
