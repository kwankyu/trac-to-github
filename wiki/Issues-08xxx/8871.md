...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-111341"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-111342"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-111343"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-111344"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8871#event-111345"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8871#issuecomment-72571",
    "user": "https://github.com/sagetrac-ecurry"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8871",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8871#issuecomment-72572",
    "user": "https://github.com/sagetrac-ecurry"
}
```
