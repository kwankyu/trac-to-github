...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8979#event-65141"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8979#event-65142"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8979#event-65143"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8979#event-65144"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8979#issuecomment-75607",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "label": "trivial",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8979#event-65145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8979#issuecomment-75608",
    "user": "https://trac.sagemath.org/admin/accounts/users/Moredread"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8979#issuecomment-75609",
    "user": "https://trac.sagemath.org/admin/accounts/users/Moredread"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8979#issuecomment-75610",
    "user": "https://trac.sagemath.org/admin/accounts/users/Moredread"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8979#issuecomment-75611",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8979#issuecomment-75612",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8979#event-65146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8979",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8979#event-65147"
}
```
