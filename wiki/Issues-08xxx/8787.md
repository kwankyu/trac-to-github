...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8787#event-63341"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8787#event-63342"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8787#event-63343"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8787#issuecomment-73260",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8787#issuecomment-73261",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8787#event-63344"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8787#event-63345"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8787#event-63346"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8787#event-63347"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8787#issuecomment-73262",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8787#issuecomment-73263",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8787#event-63348"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8787",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8787#event-63349"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8787#issuecomment-73264",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8787",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8787#issuecomment-73265",
    "user": "https://github.com/rlmill"
}
```
