...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8813#event-110580"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8813#event-110581"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8813#event-110582"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8813#event-110583"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8813#event-110584"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8813#issuecomment-71889",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8813",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8813#event-110585"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8813#event-110586"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8813#event-110587"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8813#event-110588"
}
```
