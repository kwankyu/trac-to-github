...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8264#event-102142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8264#event-102143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8264#event-102144"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8264#event-102145"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8264#event-102146"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8264#event-102147"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8264#event-102148"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8264#issuecomment-64314",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8264#event-102149"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8264",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8264#event-102150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8264#issuecomment-64315",
    "user": "https://github.com/mwhansen"
}
```
