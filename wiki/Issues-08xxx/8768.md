...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8768#event-63184"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8768#event-63185"
}
```
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8768#event-63186"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8768#event-63187"
}
```
...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8768#event-63188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8768",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8768#event-63189"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8768#issuecomment-73021",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8768#event-63190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8768#issuecomment-73022",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8768#issuecomment-73023",
    "user": "https://github.com/qed777"
}
```
