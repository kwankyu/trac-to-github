...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8663#event-108222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8663#event-108223"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8663#event-108224"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8663#event-108225"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8663#event-108226"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8663#issuecomment-69571",
    "user": "https://github.com/sagetrac-mehrunes-dagon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8663#issuecomment-69572",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8663#event-108227"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8663#event-108228"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8663#event-108229"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8663#issuecomment-69573",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8663",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8663#issuecomment-69574",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8663",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8663#event-108230"
}
```
