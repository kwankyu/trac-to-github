...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-110467"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-110468"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-110469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-110470"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-110471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-110472"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-110473"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-110474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8806#issuecomment-71807",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-110475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8806",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8806#event-110476"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8806#issuecomment-71808",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8806#issuecomment-71809",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8806#issuecomment-71810",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8806#issuecomment-71811",
    "user": "https://github.com/williamstein"
}
```
