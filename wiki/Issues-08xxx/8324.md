...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102966"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102969"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102970"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102971"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102972"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102973"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8324#issuecomment-64988",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102975"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8324#issuecomment-64989",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102976"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8324",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8324#event-102977"
}
```
