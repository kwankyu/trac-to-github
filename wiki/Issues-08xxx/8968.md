...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8968#event-112786"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8968#event-112787"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8968#event-112788"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8968#event-112789"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8968#event-112790"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8968#event-112791"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8968",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8968#event-112792"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8968#issuecomment-73587",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8968#event-112793"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8968#event-112794"
}
```
