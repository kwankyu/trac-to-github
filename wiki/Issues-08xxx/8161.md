...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100684"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100685"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100687"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100688"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100690"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100691"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8161#issuecomment-63042",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100692"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100693"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8161",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8161#issuecomment-63043",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100694"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8161",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8161#event-100695"
}
```
