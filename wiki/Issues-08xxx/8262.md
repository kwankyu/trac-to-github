...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102117"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102118"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102119"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102120"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102121"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102122"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-drkirkby",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102123"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102124"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102125"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8262",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102126"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8262#event-102127"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8262#issuecomment-64279",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8262#issuecomment-64280",
    "user": "https://github.com/qed777"
}
```
