...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8356#event-103572"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8356#event-103573"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8356#event-103574"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8356#event-103575"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8356#event-103576"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8356#event-103577"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8356#event-103578"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8356#event-103579"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8356",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8356#event-103580"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8356#issuecomment-65715",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8356#issuecomment-65716",
    "user": "https://github.com/mwhansen"
}
```
