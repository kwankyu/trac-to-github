...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket8090/genus2reduction-0.3.p6.patch",
    "created_at": "2010-01-27T20:32:36Z",
    "issue": "https://github.com/sagemath/sage/issues/8090",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket8090/genus2reduction-0.3.p6.patch",
...
```json
{
    "body": "**Attachment:** [genus2reduction-0.3.p6.patch](https://github.com/sagemath/sage/files/ticket8090/genus2reduction-0.3.p6.patch)",
    "created_at": "2010-01-27T20:32:36Z",
    "issue": "https://github.com/sagemath/sage/issues/8090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8090#issuecomment-63900",
    "user": "https://github.com/jaapspies"
}
```

**Attachment:** [genus2reduction-0.3.p6.patch](https://github.com/sagemath/sage/files/ticket8090/genus2reduction-0.3.p6.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8090#issuecomment-63901",
    "user": "https://github.com/jaapspies"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8090",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8090#issuecomment-63902",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8090",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8090#event-56574"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8090#event-56575"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8090#event-56576"
}
```
