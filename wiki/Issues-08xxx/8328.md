...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8328#event-58728"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8328#issuecomment-66994",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8328#issuecomment-66995",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8328#event-58729"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8328#event-58730"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8328#event-58731"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8328",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8328#event-58732"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8328#event-58733"
}
```
