...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8025#event-98877"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8025#event-98878"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8025#event-98879"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8025#event-98880"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8025#event-98881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8025#issuecomment-61471",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8025#event-98882"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8025#event-98883"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8025#event-98884"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8025#event-98885"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8025",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8025#event-98886"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8025#issuecomment-61472",
    "user": "https://github.com/williamstein"
}
```
