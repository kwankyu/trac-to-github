...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8307#event-102730"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8307#event-102731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8307#event-102732"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8307#event-102733"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8307#event-102734"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8307#event-102735"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8307#event-102736"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8307#event-102737"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8307",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8307#issuecomment-64812",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8307",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8307#issuecomment-64813",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8307#event-102738"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8307",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8307#event-102739"
}
```
