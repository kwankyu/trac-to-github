...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8179#event-100971"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8179#event-100972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8179#event-100973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8179#event-100974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8179#event-100975"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8179#event-100976"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8179#issuecomment-63305",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8179#event-100977"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8179",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8179#event-100978"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8179#issuecomment-63306",
    "user": "https://github.com/sagetrac-mvngu"
}
```
