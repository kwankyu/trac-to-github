...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-99892"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-99893"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-99894"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-99895"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-99896"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8104#issuecomment-62410",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8104",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8104#event-99897"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8104#issuecomment-62411",
    "user": "https://github.com/sagetrac-mvngu"
}
```
