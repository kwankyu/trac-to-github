...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8840#issuecomment-74100",
    "user": "https://trac.sagemath.org/admin/accounts/users/aliajouz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8840#issuecomment-74101",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8840#issuecomment-74102",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8840#issuecomment-74103",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8840#event-63882"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8840",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8840#issuecomment-74104",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8840#event-63883"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8840",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8840#event-63884"
}
```
