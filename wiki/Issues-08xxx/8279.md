...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8279#event-102333"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8279#event-102334"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8279#event-102335"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8279#event-102336"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8279#event-102337"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8279#event-102338"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8279#event-102339"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8279#issuecomment-64458",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8279#event-102340"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8279",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8279#event-102341"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8279#issuecomment-64459",
    "user": "https://github.com/mwhansen"
}
```
