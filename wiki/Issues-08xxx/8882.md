...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111472"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111473"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111481"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8882#issuecomment-72655",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8882#issuecomment-72656",
    "user": "https://github.com/saliola"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111483"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111484"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111485"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8882#issuecomment-72657",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111486"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8882",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8882#event-111487"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8882#issuecomment-72658",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8882#issuecomment-72659",
    "user": "https://github.com/sagetrac-mvngu"
}
```
