...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8259#event-102088"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8259#event-102089"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8259#event-102090"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8259#event-102091"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8259#event-102092"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8259#event-102093"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8259#event-102094"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8259#event-102095"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8259#event-102096"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8259",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8259#event-102097"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8259",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8259#issuecomment-64258",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8259",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8259#issuecomment-64259",
    "user": "https://github.com/sagetrac-mvngu"
}
```
