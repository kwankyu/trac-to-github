...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8107#event-99924"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8107#event-99925"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8107#event-99926"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8107#event-99927"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8107#event-99928"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8107#event-99929"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8107#event-99930"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8107#event-99931"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8107#issuecomment-62451",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8107#event-99932"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8107",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8107#event-99933"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8107",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8107#issuecomment-62452",
    "user": "https://github.com/sagetrac-mvngu"
}
```
