...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8563#event-106805"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8563#event-106806"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8563#event-106807"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8563#event-106808"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8563#event-106809"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8563",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/8563#issuecomment-68472",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8563#event-106810"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8563#event-106811"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/8563",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8563#event-106812"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/8563#event-106813"
}
```
