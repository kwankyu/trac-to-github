...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358551"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358552"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358553"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358554"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358555"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26194",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26194#issuecomment-403400",
    "user": "https://github.com/sagetrac-pbanks"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358557"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26194",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26194#issuecomment-403401",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358558"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358559"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26194",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26194#issuecomment-403402",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358560"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358561"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358562"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26194",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26194#event-358563"
}
```
