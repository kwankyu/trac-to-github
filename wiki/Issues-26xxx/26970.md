...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-367922"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-367923"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-367924"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-367925"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26970#issuecomment-415961",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26970#issuecomment-415962",
...
```json
{
    ...
    "milestone_title": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-367926"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-367927"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26970#issuecomment-415963",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-367928"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-367929"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-367930"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26970#issuecomment-415964",
    "user": "https://github.com/embray"
}
```
