...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26970#issuecomment-418625",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26970#issuecomment-418626",
...
```json
{
    ...
    "milestone": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-240364"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-240365"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26970#issuecomment-418627",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-240366"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-240367"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26970#event-240368"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26970#issuecomment-418628",
    "user": "https://github.com/embray"
}
```
