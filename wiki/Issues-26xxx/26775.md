...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26775#issuecomment-415029",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26775#event-238553"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26775",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26775#event-238554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26775",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26775#issuecomment-415030",
    "user": "https://github.com/jdemeyer"
}
```
