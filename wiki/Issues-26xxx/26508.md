...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26508#issuecomment-411397",
    "user": "https://trac.sagemath.org/admin/accounts/users/boussica"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26508#issuecomment-411398",
    "user": "https://trac.sagemath.org/admin/accounts/users/boussica"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26508#issuecomment-411399",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26508#issuecomment-411400",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26508#issuecomment-411401",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26508#issuecomment-411402",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26508#event-236778"
}
```
