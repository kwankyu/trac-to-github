...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26551#event-362795"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26551#event-362796"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26551#event-362797"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26551#event-362798"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26551#event-362799"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26551#issuecomment-409349",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26551#issuecomment-409350",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26551",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26551#issuecomment-409351",
    "user": "https://github.com/jiawei-wang-ucd"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26551#event-362800"
}
```
