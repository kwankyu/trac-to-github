...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26650#event-237746"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26650#event-237747"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26650#issuecomment-413459",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26650#event-237748"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26650#issuecomment-413460",
    "user": "https://github.com/embray"
}
```
