...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-367564"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-367565"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-367566"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-367567"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26948",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26948#issuecomment-415504",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26948",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-367568"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-367569"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-367570"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26948#event-367571"
}
```
