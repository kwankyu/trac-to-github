...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26408#issuecomment-409726",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26408",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26408#issuecomment-409727",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26408",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26408#issuecomment-409728",
    "user": "https://github.com/saraedum"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26408",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26408#issuecomment-409729",
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26408#event-235911"
}
```
