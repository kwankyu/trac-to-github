...
```json
{
    ...
    "milestone": "sage-8.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-237515"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-237516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26620#issuecomment-412938",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/26620#event-237517"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/26620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/26620#issuecomment-412939",
    "user": "https://github.com/embray"
}
```
