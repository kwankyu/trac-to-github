...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34790#issuecomment-563614",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34790#issuecomment-563615",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34790#issuecomment-563616",
    "user": "https://github.com/categorie"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34790#event-310241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34790#issuecomment-563617",
    "user": "https://github.com/categorie"
}
```
