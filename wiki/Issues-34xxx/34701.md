...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34701#event-470933"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34701#event-470934"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34701#event-470935"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34701#event-470936"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34701#issuecomment-560369",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34701#issuecomment-560370",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34701#issuecomment-560371",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34701#issuecomment-560372",
    "user": "https://github.com/sagetrac-git"
}
```
...
{
    "actor": "https://github.com/collares",
    "created_at": "2023-01-28T17:15:35Z",
    "event": "labeled",
    "issue": "https://github.com/sagemath/sage/issues/34701",
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34701#event-470937"
}
```
...
```json
{
    "body": "Author: **Mauricio Collares**",
    "created_at": "2023-01-28T18:04:30Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/34701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34701#issuecomment-560373",
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34701#event-470938"
}
```
