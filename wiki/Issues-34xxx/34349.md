...
archive/attachments_022375.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "output.txt",
    "asset_url": "tarball://root/attachments/ticket34349/output.txt",
    "created_at": "2022-08-12T09:06:34Z",
    "issue": "https://github.com/sagemath/sage/issues/34349",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket34349/output.txt",
    "user": "https://github.com/heindel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34349#issuecomment-557354",
    "user": "https://github.com/heindel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34349#issuecomment-557355",
    "user": "https://github.com/heindel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34349#event-307810"
}
```
...
archive/attachments_022376.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "installedPackages.txt",
    "asset_url": "tarball://root/attachments/ticket34349/installedPackages.txt",
    "created_at": "2022-08-12T19:32:41Z",
    "issue": "https://github.com/sagemath/sage/issues/34349",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket34349/installedPackages.txt",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34349#issuecomment-557356",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34349#event-307811"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34349#issuecomment-557357",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34349#issuecomment-557358",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34349",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34349#issuecomment-557359",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34349#event-307812"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34349#event-307813"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34349#event-307814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34349",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34349#event-307815"
}
```
