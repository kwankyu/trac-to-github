...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34411#issuecomment-558500",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34411#issuecomment-558501",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34411#issuecomment-558502",
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34411#event-308210"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34411#event-308211"
}
```
