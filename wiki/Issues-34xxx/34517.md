...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34517#issuecomment-560199",
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-308868"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34517#issuecomment-560200",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-308869"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-308870"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34517#event-308871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34517#issuecomment-560201",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34517#issuecomment-560202",
    "user": "https://github.com/mkoeppe"
}
```
