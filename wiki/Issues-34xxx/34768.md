...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34768#event-471614"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34768#event-471615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34768#event-471616"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34768#event-471617"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34768#issuecomment-561086",
    "user": "https://github.com/alexhutman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34768#event-471618"
}
```
