...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34457#event-468549"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34457#event-468550"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34457#event-468551"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34457#event-468552"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34457#issuecomment-556831",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34457#issuecomment-556832",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    "body": "<div id=\"comment:2\" align=\"right\">comment:2</div>\n\nJe peux pas faire grand chose sans avoir acces a **m....ca**\n\nVoici une branche avec une tentative \u00e0 l'aveugle.\n\nNot critical, as this concerns an optional interface.\n\n---\nNew commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/29b0cee93fe6000150ac818c21e5c7ca367da6db\"><code>29b0cee</code></a></td><td><code>mathematica interface</code></td></tr></table>\n",
    "created_at": "2022-08-30T15:46:25Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/34457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34457#issuecomment-556833",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34457#issuecomment-556834",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34457#issuecomment-556835",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34457#event-468553"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34457#event-468554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34457#issuecomment-556836",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34457",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34457#issuecomment-556837",
    "user": "https://github.com/EmmanuelCharpentier"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34457#event-468555"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34457#event-468556"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34457#event-468557"
}
```
