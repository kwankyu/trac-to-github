...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34524#issuecomment-560331",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34524#issuecomment-560332",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34524#issuecomment-560333",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34524#event-308921"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34524#issuecomment-560334",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34524#event-308922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34524",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34524#issuecomment-560335",
    "user": "https://github.com/mkoeppe"
}
```
