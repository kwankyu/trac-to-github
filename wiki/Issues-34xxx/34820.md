...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34820#event-472070"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34820#event-472071"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34820#event-472072"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34820#event-472073"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34820#event-472074"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34820#issuecomment-561643",
    "user": "https://github.com/mathlover2"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34820#issuecomment-561644",
    "user": "https://github.com/mathlover2"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34820#event-472075"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34820",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34820#event-472076"
}
```
