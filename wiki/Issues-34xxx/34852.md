...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-472360"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-472361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-472362"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34852#issuecomment-562067",
    "user": "https://github.com/loreno-heer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-472363"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-472364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34852#issuecomment-562068",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-472365"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-472366"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34852",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34852#issuecomment-562069",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-472367"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-472368"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34852",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34852#event-472369"
}
```
