...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-308179"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34403#issuecomment-558445",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34403#issuecomment-558446",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34403#issuecomment-558447",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-308180"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34403#event-308181"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34403#issuecomment-558448",
    "user": "https://github.com/mkoeppe"
}
```
