...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-466042"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-466043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-466044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-466045"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34233#issuecomment-553084",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34233#issuecomment-553085",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34233#issuecomment-553086",
    "user": "https://github.com/niranjankm"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-466046"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-466047"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/34233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/34233#issuecomment-553087",
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/34233#event-466048"
}
```
