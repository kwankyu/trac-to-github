...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32995#issuecomment-535567",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-298242"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32995#issuecomment-535568",
    "user": "https://github.com/orlitzky"
}
```
