...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-451821"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-451822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-451823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-451824"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32995#issuecomment-532943",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-451825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32995#event-451826"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32995#issuecomment-532944",
    "user": "https://github.com/orlitzky"
}
```
