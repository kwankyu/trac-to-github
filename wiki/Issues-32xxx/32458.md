...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32458#event-445317"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32458#event-445318"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32458#event-445319"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32458#event-445320"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32458#issuecomment-523728",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32458",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32458#issuecomment-523729",
    "user": "https://github.com/ekiral"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32458#event-445321"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32458",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32458#event-445322"
}
```
