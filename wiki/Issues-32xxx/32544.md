...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446296"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446297"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32544",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32544#issuecomment-524950",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/32544",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/32544#issuecomment-524951",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446299"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446300"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446301"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446302"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446303"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446304"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446305"
}
```
...
```json
{
    ...
    "created_at": "2023-01-16T16:53:44Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/32544",
    "type": "issue_comment",
...
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -24,5 +24,5 @@\n - #34520: remove randomly failing doctest in `src/sage/graphs/generators/random.py`\n - #34762: fix random chain complex doctest\n - #34901: random doctest failure in `src/doc/en/thematic_tutorials/group_theory.rst`\n-- #34914: random doctest failure in `src/sage/schemes/toric/sheaf/klyachko.py`\n+- #32773: random doctest failure in `src/sage/schemes/toric/sheaf/klyachko.py`\n \n``````\n",
    "created_at": "2023-01-17T18:54:56Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/32544",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/32544#event-446306"
}
```
