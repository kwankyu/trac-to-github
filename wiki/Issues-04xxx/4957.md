...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4957#event-57000"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4957#event-57001"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4957#event-57002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4957#event-57003"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4957",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4957#issuecomment-30047",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4957#event-57004"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4957",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4957#event-57005"
}
```
