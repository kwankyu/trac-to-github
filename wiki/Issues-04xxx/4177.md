...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4177/nb-version-number.patch",
    "created_at": "2008-10-17T19:03:18Z",
    "issue": "https://github.com/sagemath/sage/issues/4177",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4177/nb-version-number.patch",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "**Attachment:** [nb-version-number.patch](https://github.com/sagemath/sage/files/ticket4177/nb-version-number.patch)",
    "created_at": "2008-10-17T19:03:18Z",
    "issue": "https://github.com/sagemath/sage/issues/4177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4177#issuecomment-24726",
    "user": "https://github.com/kcrisman"
}
```

**Attachment:** [nb-version-number.patch](https://github.com/sagemath/sage/files/ticket4177/nb-version-number.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4177",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4177#issuecomment-24727",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4177#event-24106"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4177#event-24107"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4177#event-24108"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4177/trac_4177_reviewer.patch",
    "created_at": "2008-10-18T19:11:33Z",
    "issue": "https://github.com/sagemath/sage/issues/4177",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4177/trac_4177_reviewer.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [trac_4177_reviewer.patch](https://github.com/sagemath/sage/files/ticket4177/trac_4177_reviewer.patch)\n\nThe reviewer patch \"...\" the length since it will otherwise break from version to version.\n\nCheers,\n\nMichael",
    "created_at": "2008-10-18T19:11:33Z",
    "issue": "https://github.com/sagemath/sage/issues/4177",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4177#event-24109"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4177",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4177#event-24110"
}
```
