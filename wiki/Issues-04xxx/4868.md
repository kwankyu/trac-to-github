...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4868#event-55837"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4868#event-55838"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4868#event-55839"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4868#event-55840"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4868",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4868#event-55841"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4868",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4868#issuecomment-29343",
...
```json
{
    ...
    "milestone_title": "sage-3.2.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4868#event-55842"
}
```
