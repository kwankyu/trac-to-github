...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4071#event-45116"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4071#event-45117"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4071#event-45118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4071",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4071#event-45119"
}
```
