...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4750#issuecomment-29726",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4750#issuecomment-29727",
...
```json
{
    ...
    "milestone": "sage-5.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4750#event-28712"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4750#event-28713"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4750#event-28714"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4750#event-28715"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4750#event-28716"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4750",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4750#event-28717"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4750#event-28718"
}
```
