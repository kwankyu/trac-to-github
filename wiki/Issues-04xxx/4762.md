...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4762#event-54395"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4762#event-54396"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4762",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4762#issuecomment-28728",
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4762#event-54397"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4762#event-54398"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4762#event-54399"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4762",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4762#event-54400"
}
```
