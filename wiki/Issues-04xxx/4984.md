...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4984#event-57381"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4984#issuecomment-30329",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4984#event-57382"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4984#event-57383"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4984#event-57384"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4984#event-57385"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4984",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4984#event-57386"
}
```
