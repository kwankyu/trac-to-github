...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4084#issuecomment-23983",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4084#event-23503"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4084#event-23504"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4084#event-23505"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4084#issuecomment-23984",
    "user": "https://github.com/jicama"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4084#event-23506"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4084#event-23507"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4084#event-23508"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4084",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4084#event-23509"
}
```
