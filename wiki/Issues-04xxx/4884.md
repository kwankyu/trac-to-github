...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4884#event-56057"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4884",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4884#event-56058"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4884#event-56059"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4884#event-56060"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4884",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4884#event-56061"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4884",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4884#event-56062"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4884",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4884#issuecomment-29462",
    "user": "https://github.com/kcrisman"
}
```
