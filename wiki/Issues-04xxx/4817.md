...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4817#event-55130"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4817#event-55131"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4817#event-55132"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4817#event-55133"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4817#issuecomment-29075",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4817#event-55134"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4817",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4817#event-55135"
}
```
