...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4914#event-56422"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4914#event-56423"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4914#event-56424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4914#event-56425"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4914",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4914#issuecomment-29707",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4914#event-56426"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4914",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4914#event-56427"
}
```
