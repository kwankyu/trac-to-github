...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4998#event-30708"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4998#event-30709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4998#issuecomment-31587",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4998#event-30710"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4998#event-30711"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4998#event-30712"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4998",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4998#event-30713"
}
```
