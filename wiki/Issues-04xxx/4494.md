...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26521"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26522"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26523"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4494#issuecomment-27235",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "label": "component: linear algebra",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26524"
}
```
...
```json
{
    ...
    "label": "component: algebra",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26525"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26526"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26527"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26528"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26529"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26530"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26531"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4494",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4494#event-26532"
}
```
