...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4946#issuecomment-31079",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-30271"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-30272"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-30273"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-30274"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4946",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4946#event-30275"
}
```
