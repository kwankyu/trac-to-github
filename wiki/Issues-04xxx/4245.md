...
```json
{
    "body": "**Attachment:** [trac_4245.patch](https://github.com/sagemath/sage/files/ticket4245/trac_4245.patch)",
    "created_at": "2009-01-24T07:33:57Z",
    "issue": "https://github.com/sagemath/sage/issues/4245",
    "type": "issue_comment",
...
**Attachment:** [trac_4245.patch](https://github.com/sagemath/sage/files/ticket4245/trac_4245.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24556"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24557"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24558"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24559"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24560"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24561"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24562"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24563"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24564"
}
```
...
```json
{
    "body": "**Attachment:** [trac_4245-html-escape.patch](https://github.com/sagemath/sage/files/ticket4245/trac_4245-html-escape.patch)",
    "created_at": "2009-02-06T08:58:23Z",
    "issue": "https://github.com/sagemath/sage/issues/4245",
    "type": "issue_comment",
...
**Attachment:** [trac_4245-html-escape.patch](https://github.com/sagemath/sage/files/ticket4245/trac_4245-html-escape.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24565"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24566"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24567"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4245",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4245#event-24568"
}
```
