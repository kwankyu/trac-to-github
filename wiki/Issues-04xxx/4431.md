...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4431#issuecomment-26672",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4431#issuecomment-26673",
    "user": "https://trac.sagemath.org/admin/accounts/users/whuss"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4431#event-25967"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4431#event-25968"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4431",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4431#event-25969"
}
```
