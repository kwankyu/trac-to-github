...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4365#issuecomment-26259",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4365",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4365#event-25532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4365#issuecomment-26260",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4365#event-25533"
}
```
