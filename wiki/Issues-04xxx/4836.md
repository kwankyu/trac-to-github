...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29425"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4836",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4836#issuecomment-30304",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29426"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29427"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29428"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29429"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29430"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29431"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29432"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29433"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29434"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29435"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29436"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4836/4836_pari_getattr.patch",
    "created_at": "2010-09-28T10:56:15Z",
    "issue": "https://github.com/sagemath/sage/issues/4836",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4836/4836_pari_getattr.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "**Attachment:** [4836_pari_getattr.patch](https://github.com/sagemath/sage/files/ticket4836/4836_pari_getattr.patch)",
    "created_at": "2010-09-28T10:56:15Z",
    "issue": "https://github.com/sagemath/sage/issues/4836",
    "type": "issue_comment",
...
**Attachment:** [4836_pari_getattr.patch](https://github.com/sagemath/sage/files/ticket4836/4836_pari_getattr.patch)
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29437"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29438"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29439"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4836",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4836#event-29440"
}
```
