...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4173#issuecomment-24701",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4173#event-24086"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4173#issuecomment-24702",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4173#event-24087"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4173",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4173#event-24088"
}
```
