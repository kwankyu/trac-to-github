...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4720#event-53713"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4720#event-53714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4720",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4720#event-53715"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4720#issuecomment-28309",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4720#event-53716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4720#event-53717"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4720",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4720#event-53718"
}
```
