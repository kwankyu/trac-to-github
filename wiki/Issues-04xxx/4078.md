...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4078#issuecomment-23958",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4078#event-23468"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4078#issuecomment-23959",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4078#event-23469"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4078",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4078#event-23470"
}
```
