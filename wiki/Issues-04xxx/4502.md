...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4502#issuecomment-27331",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4502#issuecomment-27332",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4502/4502-crude_hack.patch",
    "created_at": "2008-11-16T09:54:01Z",
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4502/4502-crude_hack.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "<a id='comment:2'></a>\n**Attachment:** [4502-crude_hack.patch](https://github.com/sagemath/sage/files/ticket4502/4502-crude_hack.patch)\n\nWell, this makes the doctest failure go away on my Intel Mac. (I followed the proposal from Jason.)\n\nBut please someone have a look if it is worth the price paid.",
    "created_at": "2008-11-16T09:54:01Z",
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4502#issuecomment-27333",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26605"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4502#issuecomment-27334",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4502#issuecomment-27335",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26606"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26607"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26608"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26609"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26610"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26611"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4502/trac_4502.patch",
    "created_at": "2008-11-18T16:59:41Z",
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4502/trac_4502.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "<a id='comment:5'></a>\n**Attachment:** [trac_4502.patch](https://github.com/sagemath/sage/files/ticket4502/trac_4502.patch)\n\ndoctest changed in trac_4502.patch.  Apply instead of previous patch.",
    "created_at": "2008-11-18T16:59:41Z",
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4502#issuecomment-27336",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4502#issuecomment-27337",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26612"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26613"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26614"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26615"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4502/4502-next_try.patch",
    "created_at": "2008-11-18T21:23:33Z",
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4502/4502-next_try.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "**Attachment:** [4502-next_try.patch](https://github.com/sagemath/sage/files/ticket4502/4502-next_try.patch)\n\npatch against Sage 3.2.rc1; apply only this one",
    "created_at": "2008-11-18T21:23:33Z",
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "issue_comment",
...
**Attachment:** [4502-next_try.patch](https://github.com/sagemath/sage/files/ticket4502/4502-next_try.patch)
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26616"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26617"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26618"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26619"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4502/4502-next_try.2.patch",
    "created_at": "2008-11-18T22:17:47Z",
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4502/4502-next_try.2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "**Attachment:** [4502-next_try.2.patch](https://github.com/sagemath/sage/files/ticket4502/4502-next_try.2.patch)\n\napply only this one (doctest just nuked)",
    "created_at": "2008-11-18T22:17:47Z",
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "issue_comment",
...
**Attachment:** [4502-next_try.2.patch](https://github.com/sagemath/sage/files/ticket4502/4502-next_try.2.patch)
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26620"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26621"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4502/4502-next_try.3.patch",
    "created_at": "2008-11-19T18:07:04Z",
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4502/4502-next_try.3.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    "body": "**Attachment:** [4502-next_try.3.patch](https://github.com/sagemath/sage/files/ticket4502/4502-next_try.3.patch)\n\naddressing the reviewers wishes (hopefully)",
    "created_at": "2008-11-19T18:07:04Z",
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "issue_comment",
...
**Attachment:** [4502-next_try.3.patch](https://github.com/sagemath/sage/files/ticket4502/4502-next_try.3.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26622"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26623"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26624"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26625"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26626"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4502",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4502#event-26627"
}
```
