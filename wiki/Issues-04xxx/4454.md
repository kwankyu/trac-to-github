...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4454#event-50023"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4454#event-50024"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4454",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4454#event-50025"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4454#event-50026"
}
```
