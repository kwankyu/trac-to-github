...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4636#event-52593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4636#event-52594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4636#event-52595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4636#event-52596"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4636#issuecomment-27693",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4636#event-52597"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4636",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4636#event-52598"
}
```
