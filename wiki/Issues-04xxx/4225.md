...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4225#issuecomment-25053",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "asset_name": "4225-complex-sqrt.patch",
    "asset_url": "tarball://root/attachments/ticket4225/4225-complex-sqrt.patch",
    "created_at": "2008-10-03T07:45:44Z",
    "issue": "https://github.com/sagemath/sage/issues/4225",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4225/4225-complex-sqrt.patch",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    "body": "**Attachment:** [4225-complex-sqrt.patch](https://github.com/sagemath/sage/files/ticket4225/4225-complex-sqrt.patch)",
    "created_at": "2008-10-03T07:45:44Z",
    "issue": "https://github.com/sagemath/sage/issues/4225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4225#issuecomment-25054",
    "user": "https://github.com/robertwb"
}
```

**Attachment:** [4225-complex-sqrt.patch](https://github.com/sagemath/sage/files/ticket4225/4225-complex-sqrt.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4225#event-24438"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4225#event-24439"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4225#event-24440"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4225#event-24441"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "4225-complex-sqrt.2.patch",
    "asset_url": "tarball://root/attachments/ticket4225/4225-complex-sqrt.2.patch",
    "created_at": "2008-10-08T06:09:15Z",
    "issue": "https://github.com/sagemath/sage/issues/4225",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4225/4225-complex-sqrt.2.patch",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4225#event-24442"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4225#event-24443"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4225",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4225#event-24444"
}
```
