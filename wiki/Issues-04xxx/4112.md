...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4112#issuecomment-24263",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4112#event-23715"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4112",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4112#issuecomment-24264",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4112#event-23716"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4112",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4112#event-23717"
}
```
