...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4955#event-56971"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4955#event-56972"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4955",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4955#event-56973"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4955#issuecomment-30035",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4955#event-56974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4955#event-56975"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4955#event-56976"
}
```
