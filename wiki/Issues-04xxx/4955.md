...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4955#event-30371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4955#issuecomment-31203",
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4955#event-30372"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4955#event-30373"
}
```
