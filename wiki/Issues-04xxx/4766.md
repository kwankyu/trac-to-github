...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4766#event-54428"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4766#event-54429"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4766#event-54430"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4766#event-54431"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4766#event-54432"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4766",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4766#event-54433"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4766#issuecomment-28745",
    "user": "https://github.com/sagetrac-mvngu"
}
```
