...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4768#event-54448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4768#event-54449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4768#event-54450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4768#event-54451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4768#issuecomment-28753",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4768#event-54452"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4768",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4768#event-54453"
}
```
