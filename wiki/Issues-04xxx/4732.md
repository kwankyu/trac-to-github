...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-28515"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4732#event-28516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4732#issuecomment-29519",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4732#issuecomment-29520",
    "user": "https://github.com/jasongrout"
}
```
