...
```json
{
    ...
    "subject": "https://github.com/garyfurnish",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4811#event-55044"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4811#event-55045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4811#event-55046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4811#event-55047"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4811#issuecomment-29035",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4811#event-55048"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4811",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4811#event-55049"
}
```
