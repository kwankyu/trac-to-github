...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57024"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57025"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57026"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57027"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57028"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4960",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4960#event-57029"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4960",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4960#issuecomment-30064",
    "user": "https://github.com/williamstein"
}
```
