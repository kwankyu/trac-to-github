...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4752#event-54222"
}
```
...
```json
{
    ...
    "title_was": "list_plot3d crashes sage with some exact input",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4752#event-54223"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4752#event-54224"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4752#event-54225"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4752#event-54226"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4752",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4752#event-54227"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4752#issuecomment-28629",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
