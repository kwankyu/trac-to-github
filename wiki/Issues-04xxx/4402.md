...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4402#event-49315"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4402#event-49316"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4402#event-49317"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4402",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4402#event-49318"
}
```
