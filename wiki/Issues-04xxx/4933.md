...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4933#event-56639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4933#event-56640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4933#event-56641"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4933",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4933#event-56642"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4933#event-56643"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4933#event-56644"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4933",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4933#issuecomment-29831",
    "user": "https://github.com/JohnCremona"
}
```
