...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4520#event-26798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4520#issuecomment-27520",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4520#event-26799"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4520#event-26800"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4520#event-26801"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4520",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4520#event-26802"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4520#event-26803"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4520#event-26804"
}
```
