...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4086#event-45298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4086",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4086#event-45299"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.1.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4086#event-45300"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4086#event-45301"
}
```
