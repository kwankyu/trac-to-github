...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-55987"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-55988"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-55989"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-55990"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4880#issuecomment-29409",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-55991"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4880",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-55992"
}
```
