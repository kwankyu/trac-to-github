...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-29765"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4880",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4880#issuecomment-30555",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-29766"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-29767"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-29768"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-29769"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4880",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4880#event-29770"
}
```
