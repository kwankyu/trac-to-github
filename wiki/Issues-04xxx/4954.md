...
```json
{
    ...
    "subject": "https://github.com/seblabbe",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4954#event-56962"
}
```
...
```json
{
    ...
    "subject": "https://github.com/seblabbe",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4954#event-56963"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4954",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4954#issuecomment-30034",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4954#event-56964"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4954#event-56965"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4954#event-56966"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4954",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4954#event-56967"
}
```
