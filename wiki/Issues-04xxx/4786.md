...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4786#event-54694"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4786#event-54695"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4786#event-54696"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4786#event-54697"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4786#event-54698"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4786",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4786#event-54699"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4786",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4786#issuecomment-28887",
    "user": "https://github.com/sagetrac-mvngu"
}
```
