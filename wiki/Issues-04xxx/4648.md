...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4648#event-52757"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4648#event-52758"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4648#event-52759"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4648#event-52760"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4648",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4648#issuecomment-27795",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4648#event-52761"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4648",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4648#event-52762"
}
```
