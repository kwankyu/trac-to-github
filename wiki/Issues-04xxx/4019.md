...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4019#event-44499"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4019#event-44500"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4019#event-44501"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4019",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4019#event-44502"
}
```
