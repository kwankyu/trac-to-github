...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4922",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4922#issuecomment-30911",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4922#event-30079"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4922#event-30080"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4922#event-30081"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4922#event-30082"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4922",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4922#event-30083"
}
```
