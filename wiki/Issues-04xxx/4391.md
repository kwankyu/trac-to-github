...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4391#event-49201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4391#event-49202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4391#event-49203"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4391",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4391#event-49204"
}
```
