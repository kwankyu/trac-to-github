...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4399#event-49290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4399#event-49291"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4399#event-49292"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4399",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4399#event-49293"
}
```
