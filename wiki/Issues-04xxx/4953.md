...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4953#event-56951"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4953#event-56952"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4953#event-56953"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4953#event-56954"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4953#event-56955"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4953",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4953#issuecomment-30032",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4953",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4953#event-56956"
}
```
