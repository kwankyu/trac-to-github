...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4253#issuecomment-25244",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4253#event-24615"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4253#issuecomment-25245",
    "user": "https://trac.sagemath.org/admin/accounts/users/PolyBoRi"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4253#event-24616"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4253#event-24617"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4253#event-24618"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4253",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4253#event-24619"
}
```
