...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4700#event-53451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4700#event-53452"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4700#event-53453"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4700#event-53454"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4700",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4700#event-53455"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4700#event-53456"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4700",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4700#issuecomment-28141",
    "user": "https://github.com/jasongrout"
}
```
