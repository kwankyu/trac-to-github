...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4734#event-53911"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4734#event-53912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4734#event-53913"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4734#event-53914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4734#issuecomment-28418",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4734#event-53915"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4734",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4734#event-53916"
}
```
