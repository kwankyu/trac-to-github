...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4615#event-52284"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4615#event-52285"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4615",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4615#event-52286"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4615#event-52287"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4615#event-52288"
}
```
