...
```json
{
    ...
    "asset_name": "trac_4419.patch",
    "asset_url": "tarball://root/attachments/ticket4419/trac_4419.patch",
    "created_at": "2008-11-02T01:57:42Z",
    "issue": "https://github.com/sagemath/sage/issues/4419",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4419/trac_4419.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4419",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4419#issuecomment-26626",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4419#event-25902"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4419#event-25903"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4419",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4419#event-25904"
}
```
