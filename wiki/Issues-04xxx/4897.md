...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4897#event-56234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4897#event-56235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4897#event-56236"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4897#event-56237"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4897#event-56238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4897#event-56239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4897#issuecomment-29566",
    "user": "https://github.com/JohnCremona"
}
```
