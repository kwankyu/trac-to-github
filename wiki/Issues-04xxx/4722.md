...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4722#issuecomment-29460",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "asset_name": "trac_4722.patch",
    "asset_url": "tarball://root/attachments/ticket4722/trac_4722.patch",
    "created_at": "2008-12-11T04:56:32Z",
    "issue": "https://github.com/sagemath/sage/issues/4722",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4722/trac_4722.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "**Attachment:** [trac_4722.patch](https://github.com/sagemath/sage/files/ticket4722/trac_4722.patch)",
    "created_at": "2008-12-11T04:56:32Z",
    "issue": "https://github.com/sagemath/sage/issues/4722",
    "type": "issue_comment",
...
**Attachment:** [trac_4722.patch](https://github.com/sagemath/sage/files/ticket4722/trac_4722.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4722#event-28439"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4722#event-28440"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4722#event-28441"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4722#event-28442"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4722",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4722#event-28443"
}
```
