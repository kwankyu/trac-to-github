...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4823#event-55225"
}
```
...
```json
{
    ...
    "title_was": "No title",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4823#event-55226"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4823#event-55227"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4823#event-55228"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4823",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4823#issuecomment-29105",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4823#event-55229"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4823",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4823#event-55230"
}
```
