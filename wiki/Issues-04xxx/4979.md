...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4979#event-57301"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4979#event-57302"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4979#event-57303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4979#event-57304"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4979#event-57305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4979",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4979#event-57306"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4979#issuecomment-30285",
    "user": "https://github.com/fchapoton"
}
```
