...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4912#event-56403"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4912#event-56404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4912",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4912#event-56405"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4912#issuecomment-29690",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4912#event-56406"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4912#event-56407"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4912",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4912#event-56408"
}
```
