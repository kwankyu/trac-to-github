...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4658#event-52901"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4658#event-52902"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4658#event-52903"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4658#event-52904"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4658#issuecomment-27877",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4658#event-52905"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4658",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4658#event-52906"
}
```
