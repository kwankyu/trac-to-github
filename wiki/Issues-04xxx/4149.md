...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket4149/4149.patch",
    "created_at": "2008-09-19T01:20:54Z",
    "issue": "https://github.com/sagemath/sage/issues/4149",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket4149/4149.patch",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    "body": "**Attachment:** [4149.patch](https://github.com/sagemath/sage/files/ticket4149/4149.patch)",
    "created_at": "2008-09-19T01:20:54Z",
    "issue": "https://github.com/sagemath/sage/issues/4149",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4149#issuecomment-24563",
    "user": "https://github.com/jhpalmieri"
}
```

**Attachment:** [4149.patch](https://github.com/sagemath/sage/files/ticket4149/4149.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4149",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4149#issuecomment-24564",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4149",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4149#event-23956"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4149#event-23957"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4149#event-23958"
}
```
