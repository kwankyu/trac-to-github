...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4831#event-55333"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4831#event-55334"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4831#event-55335"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4831#event-55336"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4831#event-55337"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4831",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4831#event-55338"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4831",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4831#issuecomment-29144",
    "user": "https://github.com/loefflerd"
}
```
