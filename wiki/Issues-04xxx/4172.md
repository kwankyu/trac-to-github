...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4172#issuecomment-24700",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4172",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-24083"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-24084"
}
```
...
```json
{
    ...
    "milestone": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-24085"
}
```
