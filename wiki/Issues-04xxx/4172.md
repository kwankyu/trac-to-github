...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4172",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46334"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46335"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46336"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4172#event-46337"
}
```
