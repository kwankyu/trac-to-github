...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4797#event-54860"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4797#event-54861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4797#event-54862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4797#event-54863"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4797",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4797#event-54864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4797#issuecomment-28954",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4797#event-54865"
}
```
