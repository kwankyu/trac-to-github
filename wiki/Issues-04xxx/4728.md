...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4728#event-53841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4728#event-53842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4728#event-53843"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4728",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4728#event-53844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4728",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4728#issuecomment-28383",
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4728#event-53845"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4728#event-53846"
}
```
