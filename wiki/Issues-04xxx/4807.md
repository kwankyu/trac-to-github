...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-54985"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-54986"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-54987"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-54988"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-54989"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4807",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4807#event-54990"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4807",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4807#issuecomment-29011",
    "user": "https://github.com/mwhansen"
}
```
