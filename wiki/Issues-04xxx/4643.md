...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4643#event-52699"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4643",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4643#issuecomment-27760",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4643#event-52700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4643#event-52701"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4643#event-52702"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4643#event-52703"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4643",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4643#event-52704"
}
```
