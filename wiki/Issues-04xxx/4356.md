...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4356#issuecomment-26202",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4356#issuecomment-26203",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4356",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4356#event-25461"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4356#event-25462"
}
```
