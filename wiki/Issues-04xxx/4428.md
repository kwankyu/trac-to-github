...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4428#event-25959"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4428#issuecomment-26663",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4428#issuecomment-26664",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4428#event-25960"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4428",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4428#event-25961"
}
```
