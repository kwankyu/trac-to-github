...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4753#event-54248"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4753#event-54249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4753#event-54250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4753#event-54251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4753",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4753#issuecomment-28644",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4753#event-54252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4753",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4753#event-54253"
}
```
