...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4760#issuecomment-29828",
    "user": "https://github.com/garyfurnish"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4760#event-28826"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4760#event-28827"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4760",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4760#event-28828"
}
```
