...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4622#event-52415"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4622#event-52416"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4622#event-52417"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4622#event-52418"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4622#event-52419"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4622",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4622#issuecomment-27604",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4622",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4622#event-52420"
}
```
