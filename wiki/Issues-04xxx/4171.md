...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4171#issuecomment-24698",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-24080"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4171#issuecomment-24699",
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-24081"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4171",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4171#event-24082"
}
```
