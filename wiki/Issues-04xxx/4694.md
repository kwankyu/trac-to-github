...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4694#event-53386"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4694#event-53387"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4694#event-53388"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4694#event-53389"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4694",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4694#event-53390"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4694",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4694#issuecomment-28111",
...
```json
{
    ...
    "milestone_title": "sage-3.2.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4694#event-53391"
}
```
