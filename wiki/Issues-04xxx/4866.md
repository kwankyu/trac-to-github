...
```json
{
    ...
    "milestone_title": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4866#event-55813"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4866#event-55814"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4866#event-55815"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4866#event-55816"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4866",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4866#issuecomment-29336",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4866#event-55817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4866",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4866#event-55818"
}
```
