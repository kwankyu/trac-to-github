...
```json
{
    ...
    "milestone_title": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4950#event-56920"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4950#event-56921"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4950#event-56922"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4950#event-56923"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4950#event-56924"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4950",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4950#event-56925"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4950",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4950#issuecomment-30027",
    "user": "https://github.com/jdemeyer"
}
```
