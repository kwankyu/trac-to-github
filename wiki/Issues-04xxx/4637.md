...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-52606"
}
```
...
```json
{
    ...
    "title_was": "bug/stupid design of padic_printing.sep print mode stuff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-52607"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-52608"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4637",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-52609"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-52610"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4637#event-52611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4637",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4637#issuecomment-27705",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
