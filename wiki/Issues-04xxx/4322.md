...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4322#issuecomment-25898",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4322#issuecomment-25899",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25179"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25180"
}
```
...
```json
{
    ...
    "label": "component: coercion",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25181"
}
```
...
```json
{
    ...
    "label": "component: packages: optional",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25182"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25183"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25184"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25185"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25186"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25187"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4322",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4322#event-25189"
}
```
