...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4472#event-50270"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4472#event-50271"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4472#event-50272"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4472",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4472#event-50273"
}
```
