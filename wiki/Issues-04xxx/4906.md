...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-56349"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-56350"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-56351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-56352"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4906",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4906#issuecomment-29662",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-56353"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4906",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4906#event-56354"
}
```
