...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4657#event-27938"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4657#issuecomment-28965",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4657#event-27939"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4657#event-27940"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4657#event-27941"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4657#event-27942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4657",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4657#event-27943"
}
```
