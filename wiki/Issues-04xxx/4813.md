...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4813#event-55077"
}
```
...
```json
{
    ...
    "title_was": "contribution to the tests/ directory",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4813#event-55078"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4813#event-55079"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4813#event-55080"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4813#event-55081"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4813",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4813#event-55082"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4813#issuecomment-29047",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
