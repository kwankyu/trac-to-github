...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-55286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-55287"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4827",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4827#issuecomment-29122",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-55288"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4827",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-55289"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-55290"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-55291"
}
```
