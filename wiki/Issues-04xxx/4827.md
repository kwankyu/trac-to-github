...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4827",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4827#issuecomment-30262",
    "user": "https://github.com/haraldschilly"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-29362"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-29363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4827",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-29364"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-29365"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4827#event-29366"
}
```
