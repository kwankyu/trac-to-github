...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4838#event-55434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4838#event-55435"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4838#event-55436"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4838#event-55437"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4838#event-55438"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4838",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4838#event-55439"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4838#issuecomment-29199",
    "user": "https://github.com/qed777"
}
```
