...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4756#event-54300"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4756#event-54301"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4756#event-54302"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4756#event-54303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4756#event-54304"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4756",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4756#event-54305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4756#issuecomment-28678",
    "user": "https://github.com/jhpalmieri"
}
```
