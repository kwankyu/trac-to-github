...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4970#event-57174"
}
```
...
```json
{
    ...
    "subject": "https://github.com/NathanDunfield",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4970#event-57175"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4970#event-57176"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4970",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4970#issuecomment-30196",
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4970#event-57177"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4970#event-57178"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4970",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4970#event-57179"
}
```
