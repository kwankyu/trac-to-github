...
```json
{
    ...
    "milestone_title": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4956#event-56982"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4956#event-56983"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4956",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4956#issuecomment-30038",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4956#event-56984"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4956#event-56985"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4956",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4956#event-56986"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4956#event-56987"
}
```
