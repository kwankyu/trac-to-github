...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4107#event-45571"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4107",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4107#event-45572"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.1.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4107#event-45573"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4107#event-45574"
}
```
