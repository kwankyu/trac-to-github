...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4781#event-54638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4781#event-54639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4781#event-54640"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4781",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4781#event-54641"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4781#issuecomment-28843",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4781#event-54642"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4781#event-54643"
}
```
