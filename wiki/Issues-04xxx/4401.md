...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4401#event-49303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4401#event-49304"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4401#event-49305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4401",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4401#event-49306"
}
```
