...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4911#event-56391"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4911#event-56392"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4911#event-56393"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4911#event-56394"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4911",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4911#issuecomment-29684",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4911#event-56395"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4911",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4911#event-56396"
}
```
