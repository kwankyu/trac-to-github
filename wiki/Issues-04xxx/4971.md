...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4971#issuecomment-31369",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4971#event-30493"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4971#event-30494"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4971#event-30495"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4971#event-30496"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4971",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4971#event-30497"
}
```
