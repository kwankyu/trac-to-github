...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4782#event-54653"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4782#event-54654"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4782#event-54655"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4782",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4782#event-54656"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4782#event-54657"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4782#event-54658"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4782",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4782#issuecomment-28857",
    "user": "https://github.com/jdemeyer"
}
```
