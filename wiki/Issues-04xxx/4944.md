...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4944#event-56802"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4944#event-56803"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4944#event-56804"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4944#issuecomment-29905",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4944#event-56805"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4944#event-56806"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4944",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4944#event-56807"
}
```
