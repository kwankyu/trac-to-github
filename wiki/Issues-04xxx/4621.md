...
```json
{
    "body": "Attachment: **[4621-qqbar-embed.patch.gz](https://github.com/sagemath/sage/files/ticket4621/4621-qqbar-embed.patch.gz)**",
    "created_at": "2010-01-17T00:22:46Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/4621",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4621#issuecomment-27600",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4621#event-52408"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4621#event-52409"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4621#event-52410"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4621#event-52411"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4621#event-52412"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4621#event-52413"
}
```
