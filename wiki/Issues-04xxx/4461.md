...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4461#issuecomment-26992",
    "user": "https://trac.sagemath.org/admin/accounts/users/bpage"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4461",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4461#issuecomment-26993",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4461#event-26249"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4461#event-26250"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4461#event-26251"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4461#event-26252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4461",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4461#event-26253"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4461#event-26254"
}
```
