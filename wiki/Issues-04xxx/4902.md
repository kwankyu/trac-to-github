...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4902#event-56308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4902#event-56309"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4902#event-56310"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4902#event-56311"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4902#issuecomment-29614",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4902#event-56312"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4902",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4902#event-56313"
}
```
