...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4593#event-52031"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4593#event-52032"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4593#event-52033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4593#event-52034"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4593",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4593#event-52035"
}
```
