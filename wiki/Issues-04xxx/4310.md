...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4310",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4310#issuecomment-25808",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4310#event-25089"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4310",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4310#issuecomment-25809",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4310#event-25090"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4310",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4310#event-25091"
}
```
