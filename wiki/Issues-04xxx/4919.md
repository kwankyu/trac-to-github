...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4919#event-56473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4919#event-56474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4919",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4919#event-56475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4919",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4919#issuecomment-29732",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "title_was": "convert sage.misc.* docstrings to Sphinx",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4919#event-56476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4919#event-56477"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4919",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4919#event-56478"
}
```
