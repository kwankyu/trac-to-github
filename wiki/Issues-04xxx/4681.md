...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4681#event-53237"
}
```
...
```json
{
    ...
    "title_was": "General Smith normal form implementation",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4681#event-53238"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4681#event-53239"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4681#event-53240"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4681#event-53241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4681",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4681#event-53242"
}
```
