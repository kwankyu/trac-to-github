...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4849#event-55568"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4849",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4849#event-55569"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4849#event-55570"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4849#event-55571"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4849#event-55572"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4849#event-55573"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4849",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4849#issuecomment-29258",
    "user": "https://github.com/sagetrac-mvngu"
}
```
