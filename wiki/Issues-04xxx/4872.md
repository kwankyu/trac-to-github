...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4872#event-55875"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4872#event-55876"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4872#event-55877"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4872#event-55878"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4872",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4872#issuecomment-29351",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4872#event-55879"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4872",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4872#event-55880"
}
```
