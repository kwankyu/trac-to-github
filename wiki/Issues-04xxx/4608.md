...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52203"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52204"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52205"
}
```
...
```json
{
    ...
    "subject": "https://github.com/hivert",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52206"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4608",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4608#event-52207"
}
```
