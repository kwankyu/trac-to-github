...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4845#event-55524"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4845#event-55525"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4845#event-55526"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4845#event-55527"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4845#event-55528"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4845",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4845#event-55529"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4845#issuecomment-29239",
    "user": "https://github.com/craigcitro"
}
```
