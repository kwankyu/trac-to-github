...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4845#issuecomment-30383",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4845#event-29500"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4845#event-29501"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4845",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4845#event-29502"
}
```
