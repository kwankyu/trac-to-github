...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4485#event-50443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4485#event-50444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4485#event-50445"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4485",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4485#event-50446"
}
```
