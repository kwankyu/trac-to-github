...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4655#event-52851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4655#event-52852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4655#event-52853"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4655#event-52854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4655#event-52855"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4655",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4655#event-52856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4655#issuecomment-27852",
    "user": "https://github.com/fchapoton"
}
```
