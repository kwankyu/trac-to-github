...
```json
{
    ...
    "subject": "https://github.com/jicama",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4065#event-45048"
}
```
...
```json
{
    ...
    "subject": "https://github.com/jicama",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4065#event-45049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4065",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4065#event-45050"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4065#event-45051"
}
```
