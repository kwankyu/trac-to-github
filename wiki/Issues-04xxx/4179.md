...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4179#issuecomment-24733",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4179",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4179#issuecomment-24734",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4179#event-24114"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4179#event-24115"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4179",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4179#event-24116"
}
```
