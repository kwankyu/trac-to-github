...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-56194"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-56195"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-56196"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-56197"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4895#issuecomment-29540",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-56198"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4895",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4895#event-56199"
}
```
