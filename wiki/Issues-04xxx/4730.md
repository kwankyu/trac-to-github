...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4730#event-53861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4730#event-53862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4730#event-53863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4730#event-53864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4730",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4730#issuecomment-28392",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4730#event-53865"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4730",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4730#event-53866"
}
```
