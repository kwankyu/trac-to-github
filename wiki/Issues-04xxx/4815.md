...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4815#event-55103"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4815",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4815#event-55104"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4815#event-55105"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4815#event-55106"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4815#event-55107"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4815#issuecomment-29058",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4815",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4815#event-55108"
}
```
