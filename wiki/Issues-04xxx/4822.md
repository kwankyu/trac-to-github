...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4822#event-55208"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4822#event-55209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4822#event-55210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4822#event-55211"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4822#event-55212"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4822",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4822#event-55213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4822#issuecomment-29100",
    "user": "https://github.com/sagetrac-mvngu"
}
```
