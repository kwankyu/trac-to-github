...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4725#event-53796"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4725#event-53797"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4725#event-53798"
}
```
...
```json
{
    ...
    "subject": "https://github.com/loefflerd",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4725#event-53799"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4725#event-53800"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4725",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4725#event-53801"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4725",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4725#issuecomment-28366",
