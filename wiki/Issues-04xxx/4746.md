...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4746#event-54116"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4746#event-54117"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4746#event-54118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4746",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4746#event-54119"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/4746#issuecomment-28577",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4746#event-54120"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4746#event-54121"
}
```
