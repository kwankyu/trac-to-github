...
```json
{
    ...
    "milestone_title": "sage-3.1.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4303#event-48000"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4303#event-48001"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4303#event-48002"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/4303",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/4303#event-48003"
}
```
