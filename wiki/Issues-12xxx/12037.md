...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-161364"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-161365"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-161366"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-161367"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-161368"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-161369"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-161370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12037#issuecomment-128057",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12037#issuecomment-128058",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-161371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12037",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12037#event-161372"
}
```
