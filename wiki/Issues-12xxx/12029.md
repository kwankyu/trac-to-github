...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12029#event-161248"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12029#event-161249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12029#event-161250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12029#event-161251"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12029#event-161252"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12029#event-161253"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12029#event-161254"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12029#event-161255"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12029#issuecomment-127996",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12029#issuecomment-127997",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12029#event-161256"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12029",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12029#event-161257"
}
```
