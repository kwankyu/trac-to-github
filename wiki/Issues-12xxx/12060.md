...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161766"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161767"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161768"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161769"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161770"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161771"
}
```
...
```json
{
    ...
    "subject": "https://github.com/benjaminfjones",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161772"
}
```
...
```json
{
    ...
    "subject": "https://github.com/benjaminfjones",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12060#issuecomment-128401",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161774"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161775"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161776"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161777"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161778"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161779"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161780"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161781"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12060#issuecomment-128402",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12060",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161782"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161783"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161784"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12060#event-161785"
}
```
