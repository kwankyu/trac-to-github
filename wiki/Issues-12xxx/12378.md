...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12378#issuecomment-137526",
    "user": "https://trac.sagemath.org/admin/accounts/users/JoalHeagney"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12378#event-102029"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12378#issuecomment-137527",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12378#event-102030"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12378#issuecomment-137528",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12378#issuecomment-137529",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12378#event-102031"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12378#event-102032"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12378#issuecomment-137530",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12378#issuecomment-137531",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12378#event-102033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12378",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12378#event-102034"
}
```
