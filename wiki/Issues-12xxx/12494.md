...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12494#event-169370"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12494#event-169371"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12494#event-169372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12494#event-169373"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12494#event-169374"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-bober",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12494#event-169375"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-bober",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12494#event-169376"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12494#issuecomment-138051",
    "user": "https://github.com/sagetrac-bober"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12494#issuecomment-138052",
    "user": "https://github.com/sagetrac-bober"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12494",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12494#issuecomment-138053",
    "user": "https://github.com/sagetrac-bober"
}
```
