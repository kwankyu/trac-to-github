...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12522#event-169846"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12522#event-169847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12522#event-169848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12522#event-169849"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12522#event-169850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12522#event-169851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12522",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12522#issuecomment-138556",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12522",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12522#issuecomment-138557",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12522#event-169852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12522#event-169853"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12522",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12522#issuecomment-138558",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12522#event-169854"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12522",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12522#event-169855"
}
```
