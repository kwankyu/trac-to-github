...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12071#issuecomment-130800",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12071#event-98356"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12071#issuecomment-130801",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12071#issuecomment-130802",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12071",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12071#issuecomment-130803",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12071#event-98357"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12071#event-98358"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12071#event-98359"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12071#event-98360"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12071#event-98361"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12071#event-98362"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12071#event-98363"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12071#event-98364"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12071#event-98365"
}
```
