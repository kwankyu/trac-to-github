...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172825"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172828"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172829"
}
```
...
```json
{
    ...
    "subject": "https://github.com/hughrthomas",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172831"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12693#issuecomment-141544",
    "user": "https://github.com/sagetrac-dsm"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172832"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172834"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12693",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12693#event-172835"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12693#issuecomment-141545",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12693",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12693#issuecomment-141546",
    "user": "https://github.com/jdemeyer"
}
```
