...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12285#issuecomment-135171",
    "user": "https://trac.sagemath.org/admin/accounts/users/ncarter"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12285#issuecomment-135172",
    "user": "https://trac.sagemath.org/admin/accounts/users/ncarter"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12285#issuecomment-135173",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12285#event-100867"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12285#issuecomment-135174",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12285#issuecomment-135175",
    "user": "https://trac.sagemath.org/admin/accounts/users/ncarter"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12285#event-100868"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12285#event-100869"
}
```
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12285#event-100870"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12285#event-100871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12285#issuecomment-135176",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12285#event-100872"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12285",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12285#event-100873"
}
```
