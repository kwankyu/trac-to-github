...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12468#event-168973"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12468#event-168974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12468#event-168975"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12468#event-168976"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12468#event-168977"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12468",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12468#event-168978"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12468",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12468#issuecomment-137660",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12468#event-168979"
}
```
