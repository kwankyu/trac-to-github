...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178220"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178221"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178222"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178223"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178224"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178225"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178226"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178227"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178228"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178229"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178230"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178231"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178232"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12995",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12995#event-178233"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12995#issuecomment-147681",
    "user": "https://github.com/mminzlaff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12995#issuecomment-147682",
    "user": "https://github.com/mminzlaff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12995#issuecomment-147683",
    "user": "https://github.com/sagetrac-davideklund"
}
```
