...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166545"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166546"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166547"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166548"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166549"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166550"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12337#issuecomment-134170",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166551"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166552"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12337#issuecomment-134171",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166553"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12337",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12337#event-166555"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12337#issuecomment-134172",
    "user": "https://github.com/williamstein"
}
```
