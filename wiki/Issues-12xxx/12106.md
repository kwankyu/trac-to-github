...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12106#event-162546"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12106#event-162547"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12106#event-162548"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12106#event-162549"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12106#event-162550"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12106#event-162551"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12106#event-162552"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12106#event-162553"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12106#issuecomment-129346",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12106#event-162554"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12106",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12106#event-162555"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12106#issuecomment-129347",
    "user": "https://github.com/jdemeyer"
}
```
