...
```json
{
    ...
    "asset_name": "vector.patch",
    "asset_url": "tarball://root/attachments/ticket12412/vector.patch",
    "created_at": "2012-02-01T20:41:07Z",
    "issue": "https://github.com/sagemath/sage/issues/12412",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket12412/vector.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/JStarx"
}
```
...
```json
{
    "body": "**Attachment:** [vector.patch](https://github.com/sagemath/sage/files/ticket12412/vector.patch)",
    "created_at": "2012-02-01T20:41:07Z",
    "issue": "https://github.com/sagemath/sage/issues/12412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12412#issuecomment-138021",
    "user": "https://trac.sagemath.org/admin/accounts/users/JStarx"
}
```

**Attachment:** [vector.patch](https://github.com/sagemath/sage/files/ticket12412/vector.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-102340"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-102341"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-102342"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12412#issuecomment-138022",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12412#issuecomment-138023",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-102343"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12412",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12412#event-102344"
}
```
