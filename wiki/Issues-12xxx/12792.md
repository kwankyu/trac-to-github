...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174535"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174536"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174537"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174538"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174539"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174540"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174541"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174542"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174543"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174544"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174545"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12792#issuecomment-143456",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174546"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12792#issuecomment-143457",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174547"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12792",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12792#event-174548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12792#issuecomment-143458",
    "user": "https://github.com/jdemeyer"
}
```
