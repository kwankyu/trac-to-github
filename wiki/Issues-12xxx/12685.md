...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12685#event-172716"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12685#event-172717"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12685#event-172718"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12685#event-172719"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12685#event-172720"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12685",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12685#issuecomment-141432",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12685",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12685#issuecomment-141433",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12685#event-172721"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12685#event-172722"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12685",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12685#event-172723"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12685",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12685#issuecomment-141434",
    "user": "https://github.com/kini"
}
```
