...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12766#event-174166"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12766#event-174167"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12766#event-174168"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12766#event-174169"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12766#event-174170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12766#event-174171"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12766#event-174172"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12766#event-174173"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12766#issuecomment-143116",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12766#issuecomment-143117",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12766#event-174174"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12766",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12766#event-174175"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12766#issuecomment-143118",
    "user": "https://github.com/jdemeyer"
}
```
