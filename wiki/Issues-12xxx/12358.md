...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12358#issuecomment-136834",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12358#event-101752"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12358",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12358#event-101753"
}
```
...
```json
{
    ...
    "milestone": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12358#event-101754"
}
```
