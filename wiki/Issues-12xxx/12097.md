...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12097#event-162408"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12097#event-162409"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12097#event-162410"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12097#event-162411"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12097#event-162412"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12097#event-162413"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12097#event-162414"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12097#event-162415"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12097#issuecomment-129064",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12097#event-162416"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12097",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12097#event-162417"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12097#issuecomment-129065",
    "user": "https://github.com/jdemeyer"
}
```
