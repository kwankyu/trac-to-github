...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175452"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175453"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175454"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175455"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175456"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175457"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175458"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12839",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12839#issuecomment-144589",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175462"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12839",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12839#issuecomment-144590",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175463"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12839",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12839#event-175466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12839",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12839#issuecomment-144591",
    "user": "https://github.com/jdemeyer"
}
```
