...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12934#issuecomment-148771",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12934",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12934#issuecomment-148772",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12934",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12934#event-108923"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12934#event-108924"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12934",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12934#issuecomment-148773",
    "user": "https://github.com/williamstein"
}
```
