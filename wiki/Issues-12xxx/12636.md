...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12636#event-171935"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12636#event-171936"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12636#event-171937"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12636#event-171938"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12636#event-171939"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12636#event-171940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12636#issuecomment-140767",
    "user": "https://github.com/sagetrac-johanbosman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12636#event-171941"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12636#event-171942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12636#issuecomment-140768",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12636#event-171943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12636",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12636#event-171944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12636#issuecomment-140769",
    "user": "https://github.com/jdemeyer"
}
```
