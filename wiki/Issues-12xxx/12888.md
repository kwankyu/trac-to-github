...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176408"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176409"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176410"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176411"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176412"
}
```
...
```json
{
    ...
    "subject": "https://github.com/dcoudert",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176413"
}
```
...
```json
{
    ...
    "subject": "https://github.com/dcoudert",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176414"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176415"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176416"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176417"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176418"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176420"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176421"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12888#issuecomment-145774",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12888#issuecomment-145775",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176422"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12888",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12888#event-176423"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12888#issuecomment-145776",
    "user": "https://github.com/jdemeyer"
}
```
