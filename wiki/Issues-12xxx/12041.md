...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12041#event-161414"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12041#event-161415"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12041#event-161416"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12041#event-161417"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12041#event-161418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12041#event-161419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12041#event-161420"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12041#event-161421"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12041#issuecomment-128098",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12041",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12041#issuecomment-128099",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12041#event-161422"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12041",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12041#event-161423"
}
```
