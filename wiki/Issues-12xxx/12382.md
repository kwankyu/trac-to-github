...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167362"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167363"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167364"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167365"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167366"
}
```
...
```json
{
    ...
    "subject": "https://github.com/roed314",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167367"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167368"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12382#issuecomment-135303",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167369"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12382#issuecomment-135304",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12382",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12382#event-167372"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12382#issuecomment-135305",
