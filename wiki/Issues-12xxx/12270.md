...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165401"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165402"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165403"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165404"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165405"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165406"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165407"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12270#issuecomment-132759",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12270#issuecomment-132760",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165409"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165410"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165411"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12270",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12270#event-165412"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12270#issuecomment-132761",
    "user": "https://github.com/jdemeyer"
}
```
