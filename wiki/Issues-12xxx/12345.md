...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12345#event-166676"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12345#event-166677"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12345#event-166678"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12345#event-166679"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12345#event-166680"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12345#event-166681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12345#event-166682"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12345#event-166683"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12345#event-166684"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12345",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12345#event-166685"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12345#issuecomment-134359",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12345#issuecomment-134360",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12345#issuecomment-134361",
    "user": "https://github.com/kcrisman"
}
```
