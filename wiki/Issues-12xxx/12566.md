...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12566#event-170706"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12566#event-170707"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12566#event-170708"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12566#event-170709"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12566#event-170710"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12566",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12566#event-170711"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12566#issuecomment-139419",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12566#event-170712"
}
```
