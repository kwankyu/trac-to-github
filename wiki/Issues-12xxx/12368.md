...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-167104"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-167105"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-167106"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-167107"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-167108"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-167109"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-167110"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12368#issuecomment-134693",
    "user": "https://github.com/ohanar"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12368#issuecomment-134694",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-167111"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12368",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12368#event-167112"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12368#issuecomment-134695",
    "user": "https://github.com/jdemeyer"
}
```
