...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172902"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172903"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172904"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172905"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172906"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172907"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172908"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172909"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172910"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172911"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12698",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12698#issuecomment-141600",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12698",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12698#issuecomment-141601",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172913"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12698",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12698#issuecomment-141602",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12698",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12698#event-172915"
}
```
