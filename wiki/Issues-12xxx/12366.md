...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167081"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167082"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167083"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167084"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167085"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167086"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167087"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167088"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167089"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12366#issuecomment-134677",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167091"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12366#issuecomment-134678",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167092"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12366",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12366#event-167093"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12366",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12366#issuecomment-134679",
    "user": "https://github.com/jdemeyer"
}
```
