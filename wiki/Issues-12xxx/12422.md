...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12422#event-168015"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12422#event-168016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12422#event-168017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12422#event-168018"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12422#event-168019"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12422#event-168020"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12422",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12422#issuecomment-136227",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12422",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12422#issuecomment-136228",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12422",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12422#event-168021"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12422#event-168022"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12422#event-168023"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12422#event-168024"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12422",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12422#issuecomment-136229",
    "user": "https://github.com/jdemeyer"
}
```
