...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12687#event-172737"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12687#event-172738"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12687#event-172739"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12687#event-172740"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12687#event-172741"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12687#event-172742"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12687#event-172743"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12687#event-172744"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12687",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12687#issuecomment-141452",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12687",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12687#issuecomment-141453",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12687#event-172745"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12687",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12687#event-172746"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12687",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12687#issuecomment-141454",
    "user": "https://github.com/jdemeyer"
}
```
