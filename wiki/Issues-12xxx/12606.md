...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171432"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171435"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171436"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171437"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171438"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171439"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171440"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171441"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171442"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12606",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12606#event-171443"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12606#issuecomment-140051",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12606#issuecomment-140052",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12606",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12606#issuecomment-140053",
    "user": "https://github.com/jdemeyer"
}
```
