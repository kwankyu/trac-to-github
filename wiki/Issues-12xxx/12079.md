...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162110"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162111"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162112"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162113"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162114"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162115"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162116"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162117"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12079",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162119"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162120"
}
```
...
```json
{
    ...
    "subject": "https://github.com/dimpase",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12079#event-162121"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12079#issuecomment-128680",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12079",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12079#issuecomment-128681",
    "user": "https://github.com/dimpase"
}
```
