...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173969"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173970"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173971"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173975"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173976"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173977"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173978"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12752#issuecomment-142931",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173979"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173980"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173981"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12752",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173982"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173983"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12752#event-173984"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12752#issuecomment-142932",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12752",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12752#issuecomment-142933",
    "user": "https://github.com/jdemeyer"
}
```
