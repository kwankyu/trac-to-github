...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12283#event-165603"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12283#event-165604"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12283#event-165605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12283#event-165606"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12283#event-165607"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12283#event-165608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12283#event-165609"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12283#event-165610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12283#issuecomment-132893",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12283#issuecomment-132894",
    "user": "https://github.com/sagetrac-mhampton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12283#event-165611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12283",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/12283#event-165612"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/12283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/12283#issuecomment-132895",
    "user": "https://github.com/jdemeyer"
}
```
