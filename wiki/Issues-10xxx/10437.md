...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10437",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10437#issuecomment-99810",
    "user": "https://trac.sagemath.org/admin/accounts/users/Christyves"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10437",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10437#issuecomment-99811",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10437",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10437#issuecomment-99812",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10437",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10437#event-80024"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10437#event-80025"
}
```
...
```json
{
    ...
    "milestone": "sage-5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10437#event-80026"
}
```
