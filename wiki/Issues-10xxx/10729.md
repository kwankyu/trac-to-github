...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10729#issuecomment-105103",
    "user": "https://trac.sagemath.org/admin/accounts/users/jorges"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10729#issuecomment-105104",
    "user": "https://trac.sagemath.org/admin/accounts/users/jorges"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10729#issuecomment-105105",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10729#event-83276"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10729#event-83277"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10729#event-83278"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10729",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10729#issuecomment-105106",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10729#event-83279"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10729",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10729#event-83280"
}
```
