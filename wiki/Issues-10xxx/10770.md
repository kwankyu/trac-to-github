...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10770#event-140875"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10770#event-140876"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10770#event-140877"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10770#event-140878"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10770#issuecomment-103602",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10770#issuecomment-103603",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10770#issuecomment-103604",
    "user": "https://github.com/sagetrac-weigandt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10770",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10770#event-140879"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10770#event-140880"
}
```
