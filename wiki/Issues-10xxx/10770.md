...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10770#issuecomment-105663",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10770#issuecomment-105664",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10770#issuecomment-105665",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10770",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10770#issuecomment-105666",
    "user": "https://trac.sagemath.org/admin/accounts/users/weigandt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10770",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10770#event-83700"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10770#event-83701"
}
```
