...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10072#event-76532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10072#issuecomment-94425",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10072#issuecomment-94426",
    "user": "https://trac.sagemath.org/admin/accounts/users/fstan"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10072#event-76533"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10072#event-76534"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10072#event-76535"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10072#event-76536"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10072#event-76537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10072",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10072#event-76538"
}
```
