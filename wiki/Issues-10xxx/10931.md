...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10931#event-143481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10931#event-143482"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10931#event-143483"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10931",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10931#issuecomment-106246",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10931#event-143484"
}
```
...
```json
{
    ...
    "subject": "https://github.com/mantepse",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10931#event-143485"
}
```
...
```json
{
    ...
    "subject": "https://github.com/mantepse",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10931#event-143486"
}
```
