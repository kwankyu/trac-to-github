...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139768"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139769"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139770"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139771"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139772"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10689#issuecomment-102653",
    "user": "https://github.com/sagetrac-maldun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10689#issuecomment-102654",
    "user": "https://github.com/sagetrac-maldun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10689",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10689#issuecomment-102655",
    "user": "https://github.com/sagetrac-maldun"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-139778"
}
```
