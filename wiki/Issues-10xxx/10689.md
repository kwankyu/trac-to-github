...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10689#issuecomment-104709",
    "user": "https://trac.sagemath.org/admin/accounts/users/maldun"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-82957"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10689#issuecomment-104710",
    "user": "https://trac.sagemath.org/admin/accounts/users/maldun"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-82958"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10689",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-82959"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-82960"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10689",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10689#issuecomment-104711",
    "user": "https://trac.sagemath.org/admin/accounts/users/maldun"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10689#event-82961"
}
```
