...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10273#issuecomment-97802",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10273#issuecomment-97803",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10273#issuecomment-97804",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10273#event-78795"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10273",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10273#issuecomment-97805",
    "user": "https://trac.sagemath.org/admin/accounts/users/jpflori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10273",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10273#event-78796"
}
```
