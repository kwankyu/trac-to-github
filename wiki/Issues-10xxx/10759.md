...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140726"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140727"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140728"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140729"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140730"
}
```
...
```json
{
    ...
    "subject": "https://github.com/zimmermann6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140732"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10759",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10759#issuecomment-103460",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140733"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140734"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10759",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10759#issuecomment-103461",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140735"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140736"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140737"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10759",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10759#event-140738"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10759",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10759#issuecomment-103462",
