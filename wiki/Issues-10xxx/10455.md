...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10455#issuecomment-100022",
    "user": "https://trac.sagemath.org/admin/accounts/users/ebeyerstedt"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10455",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10455#event-80185"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10455#event-80186"
}
```
