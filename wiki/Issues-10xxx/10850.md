...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10850#event-142448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10850#event-142449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10850#event-142450"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10850#event-142451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10850#event-142452"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10850#issuecomment-105130",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10850#event-142453"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10850#event-142454"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10850#event-142455"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10850#issuecomment-105131",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10850#event-142456"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10850",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10850#event-142457"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10850#issuecomment-105132",
    "user": "https://github.com/nexttime"
}
```
