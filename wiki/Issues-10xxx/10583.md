...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10583#event-138003"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10583#event-138004"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10583#event-138005"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10583#event-138006"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10583#event-138007"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10583#issuecomment-100981",
    "user": "https://github.com/rkirov"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10583#issuecomment-100982",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10583",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10583#event-138008"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10583#issuecomment-100983",
    "user": "https://github.com/rkirov"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10583#event-138009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10583#event-138010"
}
```
