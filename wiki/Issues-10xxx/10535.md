...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137219"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137220"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137221"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137222"
}
```
...
```json
{
    ...
    "subject": "https://github.com/rbeezer",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137223"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137224"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137225"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137226"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10535#issuecomment-100254",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10535#issuecomment-100255",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137227"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137228"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10535",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10535#event-137229"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10535#issuecomment-100256",
