...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139256"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139257"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139258"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139259"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10660#issuecomment-102101",
    "user": "https://github.com/sagetrac-abmasse"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139262"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139263"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10660#issuecomment-102102",
    "user": "https://github.com/sagetrac-abmasse"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139264"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139265"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10660#issuecomment-102103",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139266"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10660",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10660#event-139267"
}
```
