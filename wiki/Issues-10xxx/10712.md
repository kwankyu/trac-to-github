...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104823",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83084"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104824",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83085"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83086"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104825",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104826",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104827",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83087"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83088"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104828",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104829",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104830",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83089"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83090"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10712/10712_long_time.patch",
    "created_at": "2011-02-22T10:03:35Z",
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10712/10712_long_time.patch",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    "body": "<a id='comment:9'></a>\n**Attachment:** [10712_long_time.patch](https://github.com/sagemath/sage/files/ticket10712/10712_long_time.patch)\n\nUpdated version.  I removed \"# long time\" from a few doctests in `devel/sage/sage/schemes/elliptic_curves/sha_tate.py`.",
    "created_at": "2011-02-22T10:03:35Z",
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104831",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83091"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83092"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104832",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83093"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10712#event-83094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10712",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10712#issuecomment-104833",
    "user": "https://github.com/jdemeyer"
}
```
