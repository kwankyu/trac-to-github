...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136439"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136440"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136441"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136442"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136443"
}
```
...
```json
{
    ...
    "subject": "https://github.com/nathanncohen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136444"
}
```
...
```json
{
    ...
    "subject": "https://github.com/nathanncohen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136448"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136449"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10497",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10497#event-136452"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10497#issuecomment-98777",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10497#issuecomment-98778",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10497#issuecomment-98779",
    "user": "https://github.com/kini"
}
```
