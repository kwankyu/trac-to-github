...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141197"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141198"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141199"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141200"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141201"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10789#issuecomment-103913",
    "user": "https://github.com/katestange"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141205"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141206"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10789#issuecomment-103914",
...
```json
{
    ...
    "milestone_title": "sage-4.6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10789#event-141207"
}
```
