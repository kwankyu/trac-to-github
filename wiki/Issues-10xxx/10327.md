...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket10327/trac_10327.patch",
    "created_at": "2010-11-25T19:58:42Z",
    "issue": "https://github.com/sagemath/sage/issues/10327",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket10327/trac_10327.patch",
...
```json
{
    "body": "**Attachment:** [trac_10327.patch](https://github.com/sagemath/sage/files/ticket10327/trac_10327.patch)",
    "created_at": "2010-11-25T19:58:42Z",
    "issue": "https://github.com/sagemath/sage/issues/10327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10327#issuecomment-98739",
    "user": "https://github.com/mwhansen"
}
```

**Attachment:** [trac_10327.patch](https://github.com/sagemath/sage/files/ticket10327/trac_10327.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10327#event-79303"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10327#issuecomment-98740",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10327#event-79304"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10327#issuecomment-98741",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10327#event-79305"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10327#event-79306"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10327#issuecomment-98742",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10327#event-79307"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10327#event-79308"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10327#event-79309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10327",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10327#event-79310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10327#issuecomment-98743",
