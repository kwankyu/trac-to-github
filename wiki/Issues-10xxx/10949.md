...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143739"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143740"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143741"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143742"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143743"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143744"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10949#issuecomment-106402",
    "user": "https://github.com/sagetrac-weaam"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10949#issuecomment-106403",
    "user": "https://github.com/sagetrac-weaam"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143745"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10949",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10949#issuecomment-106404",
    "user": "https://github.com/sagetrac-weaam"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143746"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143747"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143748"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143749"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143750"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143751"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143752"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143753"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10949#event-143754"
}
```
