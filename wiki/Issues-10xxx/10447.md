...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10447#issuecomment-99925",
    "user": "https://trac.sagemath.org/admin/accounts/users/jrp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10447#issuecomment-99926",
    "user": "https://trac.sagemath.org/admin/accounts/users/jrp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10447#issuecomment-99927",
    "user": "https://trac.sagemath.org/admin/accounts/users/jrp"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-80118"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-80119"
}
```
