...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-135621"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-135622"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-135623"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-135624"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10447#issuecomment-97908",
    "user": "https://github.com/sagetrac-jrp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10447#issuecomment-97909",
    "user": "https://github.com/sagetrac-jrp"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10447#issuecomment-97910",
    "user": "https://github.com/sagetrac-jrp"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-135625"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10447#event-135626"
}
```
