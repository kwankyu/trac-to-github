...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10994#event-144596"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10994#event-144597"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10994#event-144598"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10994#event-144599"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10994#issuecomment-108252",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10994#event-144600"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10994#event-144601"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10994#issuecomment-108253",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10994",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10994#event-144602"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10994",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10994#issuecomment-108254",
    "user": "https://github.com/jdemeyer"
}
```
