...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10181#issuecomment-96183",
...
```json
{
    "body": "**Attachment:** [subgroups.sage](https://github.com/sagemath/sage/files/ticket10181/subgroups.sage)",
    "created_at": "2010-10-28T15:40:56Z",
    "issue": "https://github.com/sagemath/sage/issues/10181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10181#issuecomment-96184",
    "user": "https://github.com/emmanuelthome"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10181#issuecomment-96185",
    "user": "https://github.com/emmanuelthome"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10181#event-77748"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10181#issuecomment-96186",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10181",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10181#issuecomment-96187",
    "user": "https://github.com/emmanuelthome"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10181#event-77749"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10181#event-77750"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10181#event-77751"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10181#event-77752"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10181#event-77753"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10181#event-77754"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10181#event-77755"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10181#event-77756"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10181#event-77757"
}
```
