...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10684#event-139711"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10684#event-139712"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10684#event-139713"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10684#event-139714"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10684#event-139715"
}
```
...
```json
{
    ...
    "subject": "https://github.com/aghitza",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10684#event-139716"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10684#issuecomment-102612",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10684#issuecomment-102613",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10684",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10684#event-139717"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10684#issuecomment-102614",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10684#event-139718"
}
```
