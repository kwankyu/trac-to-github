...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10278#event-133685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10278#event-133686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10278#event-133687"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10278#event-133688"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10278#event-133689"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10278#issuecomment-95870",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10278#issuecomment-95871",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10278#issuecomment-95872",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10278#event-133690"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10278",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10278#event-133691"
}
```
