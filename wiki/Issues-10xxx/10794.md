...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141319"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141320"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141322"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141323"
}
```
...
```json
{
    ...
    "subject": "https://github.com/rbeezer",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141326"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10794#issuecomment-104060",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141328"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10794",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10794#event-141329"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10794#issuecomment-104061",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10794",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10794#issuecomment-104062",
    "user": "https://github.com/rbeezer"
}
```
