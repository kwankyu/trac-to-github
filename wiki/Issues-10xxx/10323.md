...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10323#issuecomment-98706",
    "user": "https://trac.sagemath.org/admin/accounts/users/pcpa"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10323#issuecomment-98707",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10323#event-79275"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10323#issuecomment-98708",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10323#event-79276"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10323#event-79277"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10323#event-79278"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10323",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10323#event-79279"
}
```
