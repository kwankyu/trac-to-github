...
```json
{
    ...
    "label": "invalid",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10565#event-81563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10565",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10565#event-81564"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10565",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10565#issuecomment-102753",
    "user": "https://github.com/zimmermann6"
}
```
