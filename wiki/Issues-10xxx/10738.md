...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140412"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140413"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140414"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140415"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140416"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140417"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140418"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10738",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10738#issuecomment-103195",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10738",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10738#issuecomment-103196",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140420"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140421"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10738",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10738#event-140422"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10738",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10738#issuecomment-103197",
    "user": "https://github.com/jdemeyer"
}
```
