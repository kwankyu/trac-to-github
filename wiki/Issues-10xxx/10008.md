...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129237"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129238"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129239"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129240"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10008#issuecomment-91365",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10008#issuecomment-91366",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129242"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129243"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10008#issuecomment-91367",
    "user": "https://github.com/sagetrac-nborie"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129244"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10008",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129245"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129246"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129247"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-129248"
}
```
