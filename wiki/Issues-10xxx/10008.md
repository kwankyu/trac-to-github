...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-75816"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-75817"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10008#issuecomment-93335",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10008#issuecomment-93336",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-75818"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-75819"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10008#issuecomment-93337",
    "user": "https://trac.sagemath.org/admin/accounts/users/nborie"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-75820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10008",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-75821"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-75822"
}
```
...
```json
{
    ...
    "milestone": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10008#event-75823"
}
```
