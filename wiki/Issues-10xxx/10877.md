...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10877#event-142772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10877#event-142773"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10877#event-142774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10877#event-142775"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10877#event-142776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10877",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10877#event-142777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10877",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10877#issuecomment-105347",
    "user": "https://github.com/a-andre"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10877#event-142778"
}
```
