...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-131410"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-131411"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-131412"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-131413"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-93473",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-131414"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-131415"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-93474",
    "user": "https://github.com/sagetrac-mister-wardrop"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-93475",
    "user": "https://github.com/sagetrac-mister-wardrop"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-131416"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-93476",
    "user": "https://github.com/kcrisman"
}
```
