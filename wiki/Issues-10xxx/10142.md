...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-95458",
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-77270"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-95459",
    "user": "https://trac.sagemath.org/admin/accounts/users/mister.wardrop"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-95460",
    "user": "https://trac.sagemath.org/admin/accounts/users/mister.wardrop"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/10142#event-77271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/10142",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/10142#issuecomment-95461",
    "user": "https://github.com/kcrisman"
}
```
