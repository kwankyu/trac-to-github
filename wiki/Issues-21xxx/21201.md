...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295567"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295568"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295569"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309213",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309214",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309215",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295571"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309216",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309217",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309218",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309219",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309220",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309221",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309222",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309223",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309224",
...
```json
{
    "body": "<div id=\"comment:10\" align=\"right\">comment:10</div>\n\nReplying to [@mezzarobba](#comment%3A9):\n> Just to be sure: what do you mean by \"check if numeric zero\": check if something seems to be zero based on it numerical evaluation, or check if is syntactically zero? If the latter: yes, this is a very useful feature to have, for many, many types of objects. But in the case of `SR`, is there any strong reason to have `==` do more than check for syntactic equality?\n\nClearly not but unfortunately `bool()` with symbolic arguments does more by default. Please see https://github.com/sagemath/trac_to_gh/wiki/symbolics-nonzero for a summary. The goal is to design a better interface to the existing functionality.",
    "created_at": "2018-03-15T07:27:53Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309225",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309226",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309227",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309228",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295572"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295573"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295574"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21201#issuecomment-309229",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295575"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21201",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295576"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295577"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21201#event-295578"
}
```
