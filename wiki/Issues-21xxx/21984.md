...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21984#event-305407"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21984#event-305408"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21984#event-305409"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21984#event-305410"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21984#issuecomment-323836",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21984#issuecomment-323837",
    "user": "https://github.com/yuan-zhou"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21984#event-305411"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21984#event-305412"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21984#issuecomment-323838",
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21984#event-305413"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21984#event-305414"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21984#issuecomment-323839",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21984#event-305415"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21984#event-305416"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21984#issuecomment-323840",
    "user": "https://github.com/mathzeta"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21984#issuecomment-323841",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21984",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21984#issuecomment-323842",
    "user": "https://github.com/mathzeta"
}
```
