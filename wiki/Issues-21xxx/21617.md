...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21617#issuecomment-320248",
    "user": "https://trac.sagemath.org/admin/accounts/users/jferrara"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21617",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21617#issuecomment-320249",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/21617",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/21617#issuecomment-320250",
...
```json
{
    ...
    "milestone": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/21617#event-195436"
}
```
