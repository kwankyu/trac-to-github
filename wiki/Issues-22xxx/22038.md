...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22038#event-306056"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22038#event-306057"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22038#event-306058"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22038",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22038#issuecomment-324812",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22038#event-306059"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22038#event-306060"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22038#event-306061"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22038",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22038#event-306062"
}
```
