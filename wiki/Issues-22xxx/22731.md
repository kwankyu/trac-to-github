...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314673"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314674"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314675"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314676"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314677"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314678"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314679"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314680"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314682"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314683"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314684"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314687"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314688"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314690"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314692"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314693"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314694"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314695"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314696"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314697"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314698"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314699"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314700"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314701"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314702"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314703"
}
```
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n * Introduce `$SAGE_BIN` as the place where sage and the binaries of all the SPKGs get installed to. Configurable through `./configure --bindir`, default `$SAGE_LOCAL/bin/`.\n * Make `$SAGE_SCRIPTS_DIR` available like any other `$SAGE_\u2026` variable everywhere and use it as the directory where all the `sage-*` scripts are installed to. The default should be `$SAGE_LOCAL/bin/`, however, it's configurable as `./configure --with-scriptsdir`.\n \n-CI runs for the proposed changes are here: https://gitlab.com/sagemath/dev/sage/commits/sage-bin (note that the patchbot does not test these changes.)\n+CI runs for the proposed changes [Trac macro Image(https://gitlab.com/sagemath/dev/sage/badges/sage-bin/pipeline.svg,link=https://gitlab.com/sagemath/dev/sage/commits/sage-bin)](https://trac.sagemath.org/wiki/WikiMacros#Image-macro) (note that the patchbot does not test these changes.)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n * Introduce `$SAGE_BIN` as the place where sage and the binaries of all the SPKGs get installed to. Configurable through `./configure --bindir`, default `$SAGE_LOCAL/bin/`.\n * Make `$SAGE_SCRIPTS_DIR` available like any other `$SAGE_\u2026` variable everywhere and use it as the directory where all the `sage-*` scripts are installed to. The default should be `$SAGE_LOCAL/bin/`, however, it's configurable as `./configure --with-scriptsdir`.\n \n-CI runs for the proposed changes [Trac macro Image(https://gitlab.com/sagemath/dev/sage/badges/sage-bin/pipeline.svg,link=https://gitlab.com/sagemath/dev/sage/commits/sage-bin)](https://trac.sagemath.org/wiki/WikiMacros#Image-macro) (note that the patchbot does not test these changes.)\n+CI runs for the proposed changes [Trac macro Image(https://gitlab.com/sagemath/dev/sage/badges/22731/pipeline.svg,link=https://gitlab.com/sagemath/dev/sage/commits/22731)](https://trac.sagemath.org/wiki/WikiMacros#Image-macro) (note that the patchbot does not test these changes.)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n * Introduce `$SAGE_BIN` as the place where sage and the binaries of all the SPKGs get installed to. Configurable through `./configure --bindir`, default `$SAGE_LOCAL/bin/`.\n * Make `$SAGE_SCRIPTS_DIR` available like any other `$SAGE_\u2026` variable everywhere and use it as the directory where all the `sage-*` scripts are installed to. The default should be `$SAGE_LOCAL/bin/`, however, it's configurable as `./configure --with-scriptsdir`.\n \n-CI runs for the proposed changes [Trac macro Image(https://gitlab.com/sagemath/dev/sage/badges/22731/pipeline.svg,link=https://gitlab.com/sagemath/dev/sage/commits/22731)](https://trac.sagemath.org/wiki/WikiMacros#Image-macro) (note that the patchbot does not test these changes.)\n+CI runs for the proposed changes [Trac macro Image(https://gitlab.com/sagemath/dev/trac/badges/22731/pipeline.svg,link=https://gitlab.com/sagemath/dev/trac/commits/22731)](https://trac.sagemath.org/wiki/WikiMacros#Image-macro) (note that the patchbot does not test these changes.)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n * Introduce `$SAGE_BIN` as the place where sage and the binaries of all the SPKGs get installed to. Configurable through `./configure --bindir`, default `$SAGE_LOCAL/bin/`.\n * Make `$SAGE_SCRIPTS_DIR` available like any other `$SAGE_\u2026` variable everywhere and use it as the directory where all the `sage-*` scripts are installed to. The default should be `$SAGE_LOCAL/bin/`, however, it's configurable as `./configure --with-scriptsdir`.\n \n-CI runs for the proposed changes [Trac macro Image(https://gitlab.com/sagemath/dev/trac/badges/22731/pipeline.svg,link=https://gitlab.com/sagemath/dev/trac/commits/22731)](https://trac.sagemath.org/wiki/WikiMacros#Image-macro) (note that the patchbot does not test these changes.)\n+CI runs for the proposed changes [Trac macro Image(https://gitlab.com/sagemath/dev/trac/badges/u/saraedum/22731/pipeline.svg,link=https://gitlab.com/sagemath/dev/trac/commits/u/saraedum22731)](https://trac.sagemath.org/wiki/WikiMacros#Image-macro) (note that the patchbot does not test these changes.)\n``````\n",
...
```json
{
    "body": "Description changed:\n``````diff\n--- \n+++ \n@@ -1,4 +1,4 @@\n * Introduce `$SAGE_BIN` as the place where sage and the binaries of all the SPKGs get installed to. Configurable through `./configure --bindir`, default `$SAGE_LOCAL/bin/`.\n * Make `$SAGE_SCRIPTS_DIR` available like any other `$SAGE_\u2026` variable everywhere and use it as the directory where all the `sage-*` scripts are installed to. The default should be `$SAGE_LOCAL/bin/`, however, it's configurable as `./configure --with-scriptsdir`.\n \n-CI runs for the proposed changes [Trac macro Image(https://gitlab.com/sagemath/dev/trac/badges/u/saraedum/22731/pipeline.svg,link=https://gitlab.com/sagemath/dev/trac/commits/u/saraedum22731)](https://trac.sagemath.org/wiki/WikiMacros#Image-macro) (note that the patchbot does not test these changes.)\n+CI runs for the proposed changes [Trac macro Image(https://gitlab.com/sagemath/dev/trac/badges/u/saraedum/22731/pipeline.svg,link=https://gitlab.com/sagemath/dev/trac/commits/u/saraedum/22731)](https://trac.sagemath.org/wiki/WikiMacros#Image-macro) (note that the patchbot does not test these changes.)\n``````\n",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314704"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314705"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314706"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314707"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314708"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314709"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314710"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314711"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314712"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314713"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314714"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314717"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314718"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314719"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314720"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22731",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22731",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314722"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314723"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314724"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314725"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314726"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22731",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22731#event-314727"
}
```
