...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22542#event-312342"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22542#event-312343"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22542#issuecomment-333942",
    "user": "https://github.com/sagetrac-ssiddhant"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22542#event-312344"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22542#issuecomment-333943",
...
```json
{
    ...
    "milestone_title": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22542#event-312345"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22542#event-312346"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22542#event-312347"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22542#event-312348"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22542#event-312349"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22542",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22542#issuecomment-333944",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22542#event-312350"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22542",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22542#event-312351"
}
```
