...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22789#issuecomment-341921",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22789#issuecomment-341922",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22789#event-205087"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22789#issuecomment-341923",
    "user": "https://github.com/egourgoulhon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22789#issuecomment-341924",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22789#event-205088"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22789#event-205089"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22789#issuecomment-341925",
    "user": "https://github.com/man74cio"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22789#issuecomment-341926",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22789#event-205090"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22789#event-205091"
}
```
