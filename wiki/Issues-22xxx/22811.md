...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22811#issuecomment-342562",
    "user": "https://trac.sagemath.org/admin/accounts/users/rrogers"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22811#issuecomment-342563",
    "user": "https://trac.sagemath.org/admin/accounts/users/rrogers"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22811#issuecomment-342564",
    "user": "https://trac.sagemath.org/admin/accounts/users/rrogers"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22811#issuecomment-342565",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22811#event-205275"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22811#event-205276"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22811#event-205277"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22811#event-205278"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22811",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22811#event-205279"
}
```
