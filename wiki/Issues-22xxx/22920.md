...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22920#issuecomment-344402",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22920#event-206101"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22920#issuecomment-344403",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22920#event-206102"
}
```
