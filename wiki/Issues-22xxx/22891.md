...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22891#event-316679"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22891#event-316680"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22891#event-316681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22891#event-316682"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341424",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341425",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22891#event-316683"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341426",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341427",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    "body": "<div id=\"comment:4\" align=\"right\">comment:4</div>\n\nLove this.  Don't see any obvious problems with the commit (I haven't tested it, though, just reading through).\n\nOn a related note, can you test out the various tickets at https://github.com/sagemath/trac_to_gh/wiki/symbolics#Integration-tickets with this?  In particular the `abs_integrate` ones, see e.g. #12731.  If the integrator here is powerful enough, it might be time to replace the Maxima integrator with this one; the Maxima one has many errors (though in my opinion is still way better than not having one, as most of those are on relatively \"interesting\" functions like your example, abs and other stuff with branch issues).",
    "created_at": "2017-04-27T18:15:58Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341428",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341429",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341430",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22891#event-316684"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22891#event-316685"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341431",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341432",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341433",
    "user": "https://github.com/mforets"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341434",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22891#event-316686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22891#event-316687"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22891#issuecomment-341435",
