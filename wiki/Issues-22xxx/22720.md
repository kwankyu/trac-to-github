...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22720#issuecomment-340618",
    "user": "https://github.com/simonbrandhorst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22720#issuecomment-340619",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22720#issuecomment-340620",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22720#issuecomment-340621",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    "actor": "https://trac.sagemath.org/admin/accounts/users/amy",
    "created_at": "2017-09-30T19:44:17Z",
    "event": "labeled",
    "issue": "https://github.com/sagemath/sage/issues/22720",
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22720#event-204490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22720#issuecomment-340622",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22720#issuecomment-340623",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22720#issuecomment-340624",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22720#issuecomment-340625",
    "user": "https://trac.sagemath.org/admin/accounts/users/amy"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22720#event-204491"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22720#event-204492"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22720",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/22720#issuecomment-340626",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22720#event-204493"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/22720",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/22720#event-204494"
}
```
