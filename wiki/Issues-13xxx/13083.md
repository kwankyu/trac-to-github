...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13083#issuecomment-151530",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13083#issuecomment-151531",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13083#issuecomment-151532",
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-110699"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-110700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13083",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13083#issuecomment-151533",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-110701"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-110702"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13083#event-110703"
}
```
