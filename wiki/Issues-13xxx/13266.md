...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13266#issuecomment-155506",
    "user": "https://trac.sagemath.org/admin/accounts/users/Hester"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13266#issuecomment-155507",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13266#issuecomment-155508",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113090"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13266#issuecomment-155509",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "label": "trivial",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113091"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13266#issuecomment-155510",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13266#issuecomment-155511",
    "user": "https://github.com/kini"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13266#issuecomment-155512",
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113092"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13266#issuecomment-155513",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113093"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113094"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113095"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113096"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113097"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113098"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113099"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113100"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13266#event-113101"
}
```
