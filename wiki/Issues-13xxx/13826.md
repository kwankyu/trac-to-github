...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192187"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192190"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192191"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192192"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192193"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192194"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192195"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192196"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192198"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192199"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192200"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13826#issuecomment-162964",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13826#issuecomment-162965",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192202"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192203"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13826#issuecomment-162966",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13826#issuecomment-162967",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192208"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192211"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13826",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192212"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13826#issuecomment-162968",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192213"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13826#event-192214"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13826#issuecomment-162969",
    "user": "https://github.com/jdemeyer"
}
```
