...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13236#issuecomment-154776",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13236#issuecomment-154777",
    "user": "https://trac.sagemath.org/admin/accounts/users/numata"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13236#issuecomment-154778",
    "user": "https://trac.sagemath.org/admin/accounts/users/numata"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112669"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112670"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13236",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13236#issuecomment-154779",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112671"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112672"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112673"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112674"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112675"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112676"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112677"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112678"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112679"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112680"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13236#event-112681"
}
```
