...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13133#event-180673"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13133#event-180674"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13133#event-180675"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13133#event-180676"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13133#event-180677"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13133#event-180678"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13133#event-180679"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13133#event-180680"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13133#issuecomment-150238",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13133#issuecomment-150239",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/13133#issuecomment-150240",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13133#event-180681"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/13133",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/13133#event-180682"
}
```
