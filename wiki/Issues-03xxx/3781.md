...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3781#event-41452"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3781#event-41453"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3781#event-41454"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3781",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3781#event-41455"
}
```
