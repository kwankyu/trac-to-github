...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19327"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19328"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19329"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19330"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19331"
}
```
...
```json
{
    ...
    "asset_name": "3502.hg",
    "asset_url": "tarball://root/attachments/ticket3502/3502.hg",
    "created_at": "2008-09-11T09:21:23Z",
    "issue": "https://github.com/sagemath/sage/issues/3502",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3502/3502.hg",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "**Attachment:** [3502.hg](https://github.com/sagemath/sage/files/ticket3502/3502.hg)",
    "created_at": "2008-09-11T09:21:23Z",
    "issue": "https://github.com/sagemath/sage/issues/3502",
    "type": "issue_comment",
...
**Attachment:** [3502.hg](https://github.com/sagemath/sage/files/ticket3502/3502.hg)
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3502/trac-3502-addl.patch",
    "created_at": "2008-09-12T06:54:26Z",
    "issue": "https://github.com/sagemath/sage/issues/3502",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3502/trac-3502-addl.patch",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>\n**Attachment:** [trac-3502-addl.patch](https://github.com/sagemath/sage/files/ticket3502/trac-3502-addl.patch)\n\n(This doesn't need to go into 3.1.2, so I'm moving it to 3.1.3.)",
    "created_at": "2008-09-12T06:54:26Z",
    "issue": "https://github.com/sagemath/sage/issues/3502",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone": "sage-3.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19332"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19333"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19334"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19335"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19336"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3502",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3502#event-19337"
}
```
