...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3005#event-31745"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3005#event-31746"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3005#event-31747"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3005",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3005#event-31748"
}
```
