...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3000#event-31697"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3000#event-31698"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3000#event-31699"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3000",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3000#event-31700"
}
```
