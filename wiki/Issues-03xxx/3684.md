...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3684#event-40256"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3684",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3684#event-40257"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3684#event-40258"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3684#event-40259"
}
```
