...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3259/flint-soname.patch",
    "created_at": "2008-05-19T22:30:17Z",
    "issue": "https://github.com/sagemath/sage/issues/3259",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3259/flint-soname.patch",
    "user": "https://github.com/timabbott"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3259",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3259#issuecomment-18031",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3259#event-17477"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3259#event-17478"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3259",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3259#event-17479"
}
```
