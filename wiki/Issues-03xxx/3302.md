...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3302#event-35253"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3302#event-35254"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3302",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3302#event-35255"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3302#event-35256"
}
```
