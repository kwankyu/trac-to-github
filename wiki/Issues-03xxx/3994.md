...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3994#event-44208"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3994#event-44209"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3994#event-44210"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3994",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3994#event-44211"
}
```
