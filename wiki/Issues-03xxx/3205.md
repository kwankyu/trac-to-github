...
```json
{
    ...
    "milestone_title": "sage-3.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3205#event-34085"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3205#event-34086"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3205#event-34087"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3205",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3205#event-34088"
}
```
