...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3322#event-35506"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3322#event-35507"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3322#event-35508"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3322",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3322#event-35509"
}
```
