...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3860#event-42482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3860#event-42483"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3860#event-42484"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3860",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3860#event-42485"
}
```
