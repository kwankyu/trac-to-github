...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3004#event-31732"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3004",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3004#event-31733"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3004#event-31734"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3004#event-31735"
}
```
