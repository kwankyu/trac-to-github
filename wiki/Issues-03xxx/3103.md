...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3103#event-32890"
}
```
...
```json
{
    ...
    "title_was": "coercion errors of vectors from ZZ^2 and QQ^2 into CDF^2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3103#event-32891"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3103#event-32892"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3103",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3103#event-32893"
}
```
