...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3308#event-35320"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3308#event-35321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3308#event-35322"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3308",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3308#event-35323"
}
```
