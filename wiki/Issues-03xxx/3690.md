...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3690#event-40339"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3690#event-40340"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3690#event-40341"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3690",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3690#event-40342"
}
```
