...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3529#event-38291"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3529#event-38292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3529#event-38293"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3529",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3529#event-38294"
}
```
