...
```json
{
    ...
    "milestone_title": "sage-3.1.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3847#event-42301"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3847#event-42302"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3847#event-42303"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3847",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3847#event-42304"
}
```
