...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3792#event-41611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3792#event-41612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3792#event-41613"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3792",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3792#event-41614"
}
```
