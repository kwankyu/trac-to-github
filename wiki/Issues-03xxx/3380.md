...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3380#event-36300"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3380#event-36301"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3380#event-36302"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3380",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3380#event-36303"
}
```
