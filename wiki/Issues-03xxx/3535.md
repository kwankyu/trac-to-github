...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3535#event-19586"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3535",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3535#event-19587"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3535#issuecomment-20089",
...
```json
{
    ...
    "milestone": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3535#event-19588"
}
```
