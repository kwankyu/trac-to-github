...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3701#event-40479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3701#event-40480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3701#event-40481"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3701",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3701#event-40482"
}
```
