...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3368#event-36163"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3368#event-36164"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3368#event-36165"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3368",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3368#event-36166"
}
```
