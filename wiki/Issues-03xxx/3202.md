...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3202#event-34047"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3202#event-34048"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3202#event-34049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3202",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3202#event-34050"
}
```
