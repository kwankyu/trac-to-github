...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3428#event-18749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3428",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3428#event-18750"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3428#event-18751"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3428#event-18752"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3428#event-18753"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3428",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3428#event-18754"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3428#event-18755"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3428#event-18756"
}
```
