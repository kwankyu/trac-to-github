...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3752#event-41112"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3752",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3752#event-41113"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3752#event-41114"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3752#event-41115"
}
```
