...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3757#event-41161"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3757#event-41162"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3757#event-41163"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3757",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3757#event-41164"
}
```
