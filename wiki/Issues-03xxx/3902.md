...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3902",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3902#event-43047"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3902#event-43048"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3902#event-43049"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3902#event-43050"
}
```
