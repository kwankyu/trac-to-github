...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3404#event-18528"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3404#event-18529"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3404#event-18530"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3404#event-18531"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3404#event-18532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3404",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3404#event-18533"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3404#issuecomment-19198",
    "user": "https://github.com/mwhansen"
}
```
