...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3404#event-36595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3404#event-36596"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3404#event-36597"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3404",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3404#event-36598"
}
```
