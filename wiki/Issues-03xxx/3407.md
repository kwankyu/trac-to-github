...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3407#event-36640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3407#event-36641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3407#event-36642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3407",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3407#event-36643"
}
```
