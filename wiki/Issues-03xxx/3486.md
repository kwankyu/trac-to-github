...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3486#issuecomment-19768",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3486#event-19222"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3486",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3486#event-19223"
}
```
