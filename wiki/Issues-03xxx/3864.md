...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3864#event-42546"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3864#event-42547"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3864#event-42548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3864",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3864#event-42549"
}
```
