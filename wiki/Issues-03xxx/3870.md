...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3870#event-42624"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3870#event-42625"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3870",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3870#event-42626"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3870#event-42627"
}
```
