...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3312",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35371"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35372"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3312#event-35373"
}
```
