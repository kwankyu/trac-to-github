...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3839#event-42202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3839#event-42203"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3839#event-42204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3839",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3839#event-42205"
}
```
