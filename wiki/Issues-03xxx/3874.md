...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket3874/moebius.patch",
    "created_at": "2008-08-15T13:22:46Z",
    "issue": "https://github.com/sagemath/sage/issues/3874",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3874/moebius.patch",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [moebius.patch](https://github.com/sagemath/sage/files/ticket3874/moebius.patch)",
    "created_at": "2008-08-15T13:22:46Z",
    "issue": "https://github.com/sagemath/sage/issues/3874",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3874#event-22085"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3874#event-22086"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3874#event-22087"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3874#event-22088"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3874#event-22089"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3874#event-22090"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3874",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3874#event-22091"
}
```
