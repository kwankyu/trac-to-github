...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-34837"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-34838"
}
```
...
```json
{
    ...
    "title_was": "[with patch+spkg, needs review] Upgrade PolyBoRi to 0.5rc",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-34839"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3264",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3264#event-34840"
}
```
