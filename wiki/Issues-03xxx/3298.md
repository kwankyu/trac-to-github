...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3298#event-35214"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3298#event-35215"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3298#event-35216"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3298",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3298#event-35217"
}
```
