...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20200"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20201"
}
```
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20202"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20203"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20204"
}
```
...
```json
{
    ...
    "asset_name": "sage-3620.patch",
    "asset_url": "tarball://root/attachments/ticket3620/sage-3620.patch",
    "created_at": "2008-07-09T19:53:25Z",
    "issue": "https://github.com/sagemath/sage/issues/3620",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3620/sage-3620.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "**Attachment:** [sage-3620.patch](https://github.com/sagemath/sage/files/ticket3620/sage-3620.patch)",
    "created_at": "2008-07-09T19:53:25Z",
    "issue": "https://github.com/sagemath/sage/issues/3620",
    "type": "issue_comment",
...
**Attachment:** [sage-3620.patch](https://github.com/sagemath/sage/files/ticket3620/sage-3620.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20205"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20206"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20207"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3620",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20209"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3620",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3620#event-20210"
}
```
