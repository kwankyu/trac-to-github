...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-20853"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-20854"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-20855"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-20856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3706",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-20857"
}
```
