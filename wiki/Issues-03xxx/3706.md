...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40543"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40544"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40545"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3706",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3706#event-40546"
}
```
