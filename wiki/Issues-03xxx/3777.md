...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3777#event-21344"
}
```
...
```json
{
    ...
    "asset_name": "foo.html",
    "asset_url": "tarball://root/attachments/ticket3777/foo.html",
    "created_at": "2010-01-19T06:51:42Z",
    "issue": "https://github.com/sagemath/sage/issues/3777",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3777/foo.html",
...
```json
{
    "body": "**Attachment:** [foo.html](https://github.com/sagemath/sage/files/ticket3777/foo.html)\n\nSample failure of </script> tags.",
    "created_at": "2010-01-19T06:51:42Z",
    "issue": "https://github.com/sagemath/sage/issues/3777",
    "type": "issue_comment",
...
**Attachment:** [foo.html](https://github.com/sagemath/sage/files/ticket3777/foo.html)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3777#event-21345"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3777#event-21346"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3777",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3777#event-21347"
}
```
...
```json
{
    ...
    "label": "invalid",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3777#event-21348"
}
```
