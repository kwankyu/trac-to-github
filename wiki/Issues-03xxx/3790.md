...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3790#event-41582"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3790#event-41583"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3790#event-41584"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3790",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3790#event-41585"
}
```
