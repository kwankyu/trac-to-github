...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3763#event-41256"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3763#event-41257"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3763#event-41258"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3763",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3763#event-41259"
}
```
