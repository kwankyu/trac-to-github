...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3555#event-38654"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3555#event-38655"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3555#event-38656"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3555",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3555#event-38657"
}
```
