...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3840#event-42211"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3840#event-42212"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3840#event-42213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3840",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3840#event-42214"
}
```
