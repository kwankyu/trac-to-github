...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3946",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3946#issuecomment-23015",
    "user": "https://trac.sagemath.org/admin/accounts/users/choldsworth"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3946#event-22634"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3946#event-22635"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3946#event-22636"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3946#event-22637"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3946",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3946#event-22638"
}
```
