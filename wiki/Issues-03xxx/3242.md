...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3242#event-17374"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3242#event-17375"
}
```
...
```json
{
    ...
    "asset_name": "trac-3242-graph_relabel.patch",
    "asset_url": "tarball://root/attachments/ticket3242/trac-3242-graph_relabel.patch",
    "created_at": "2008-05-22T15:25:40Z",
    "issue": "https://github.com/sagemath/sage/issues/3242",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket3242/trac-3242-graph_relabel.patch",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac-3242-graph_relabel.patch](https://github.com/sagemath/sage/files/ticket3242/trac-3242-graph_relabel.patch)",
    "created_at": "2008-05-22T15:25:40Z",
    "issue": "https://github.com/sagemath/sage/issues/3242",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3242#event-17376"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3242#event-17377"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3242",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3242#event-17378"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3242#issuecomment-17953",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/3242#issuecomment-17954",
    "user": "https://github.com/fchapoton"
}
```
