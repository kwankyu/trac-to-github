...
```json
{
    ...
    "title_was": "wrap NTL's BKZ",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3232#event-34457"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3232#event-34458"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3232#event-34459"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3232",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3232#event-34460"
}
```
