...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3097#event-32798"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3097#event-32799"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3097#event-32800"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3097",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3097#event-32801"
}
```
