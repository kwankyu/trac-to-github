...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3762#event-41246"
}
```
...
```json
{
    ...
    "title_was": "remove quaddouble from sage -- not used, source of pain, mpfr is better",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3762#event-41247"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3762#event-41248"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3762",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3762#event-41249"
}
```
