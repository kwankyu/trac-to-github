...
```json
{
    ...
    "title_was": "[with spkg, patch - needs review] Upgrade Cython to 0.9.8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-42941"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-42942"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-42943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3896",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3896#event-42944"
}
```
