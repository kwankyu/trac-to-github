...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3858#event-42436"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3858#event-42437"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3858#event-42438"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3858",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3858#event-42439"
}
```
