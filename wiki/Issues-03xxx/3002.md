...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31717"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/3002",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/3002#event-31718"
}
```
