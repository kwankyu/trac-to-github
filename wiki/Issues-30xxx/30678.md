...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30678#issuecomment-492693",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-277150"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-277151"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-277152"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-277153"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30678#issuecomment-492694",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30678#issuecomment-492695",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30678#event-277154"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30678#issuecomment-492696",
    "user": "https://github.com/slel"
}
```
