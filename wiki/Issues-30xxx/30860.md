...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30860#issuecomment-496988",
    "user": "https://github.com/mignonph75"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30860",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/30860#issuecomment-496989",
    "user": "https://github.com/mignonph75"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/30860",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30860#event-279051"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/30860#event-279052"
}
```
