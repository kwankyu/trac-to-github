...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-383295"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-383296"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-383297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28144",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28144#issuecomment-437946",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28144",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28144#issuecomment-437947",
    "user": "https://github.com/thecaligarmo"
}
```
...
```json
{
    ...
    "title_was": "Sage + TikZ",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-383298"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-383299"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28144",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28144#issuecomment-437948",
    "user": "https://github.com/thecaligarmo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28144",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28144#event-383300"
}
```
