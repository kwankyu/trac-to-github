...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-384985"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-384986"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-384987"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-384988"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28250#issuecomment-440379",
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-384989"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28250#event-384990"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28250#issuecomment-440380",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28250#issuecomment-440381",
    "user": "https://github.com/edgarcosta"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28250#issuecomment-440382",
    "user": "https://github.com/embray"
}
```
