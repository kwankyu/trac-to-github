...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440747",
    "user": "https://trac.sagemath.org/admin/accounts/users/menosgeze"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440748",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440749",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440750",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440751",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440752",
    "user": "https://trac.sagemath.org/admin/accounts/users/menosgeze"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440753",
    "user": "https://trac.sagemath.org/admin/accounts/users/menosgeze"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440754",
    "user": "https://trac.sagemath.org/admin/accounts/users/menosgeze"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440755",
    "user": "https://trac.sagemath.org/admin/accounts/users/menosgeze"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440756",
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250853"
}
```
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250854"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440757",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440758",
...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250855"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250856"
}
```
...
```json
{
    ...
    "milestone": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250857"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250858"
}
```
...
```json
{
    ...
    "milestone": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250859"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28146#issuecomment-440759",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250861"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250862"
}
```
...
```json
{
    ...
    "milestone": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250863"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250864"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250865"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250866"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250867"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28146#event-250868"
}
```
