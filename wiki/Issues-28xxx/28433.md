...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-387592"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-387593"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28433#issuecomment-443011",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28433#issuecomment-443012",
    "user": "https://github.com/sagetrac-Dicolevrai"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-387594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-387595"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28433",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-387596"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28433#issuecomment-443013",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-387597"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-387598"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28433#event-387599"
}
```
