...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28103#issuecomment-440043",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28103#event-250439"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28103#event-250440"
}
```
...
```json
{
    ...
    "milestone": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28103#event-250441"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28103",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28103#issuecomment-440044",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28103#event-250442"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28103",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28103#event-250443"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28103#event-250444"
}
```
