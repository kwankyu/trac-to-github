...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391287"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391288"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391290"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447404",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391291"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447405",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447406",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391293"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447407",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391294"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447408",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391295"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391296"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447409",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447410",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447411",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28676#event-391298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447412",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447413",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28676#issuecomment-447414",
    "user": "https://github.com/mkoeppe"
}
```
