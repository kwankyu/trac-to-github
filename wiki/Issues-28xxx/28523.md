...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388931"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388932"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388933"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388934"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28523#issuecomment-444805",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28523#issuecomment-444806",
    "user": "https://github.com/remi-coulon"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28523#issuecomment-444807",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28523#issuecomment-444808",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388935"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388936"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28523#issuecomment-444809",
...
```json
{
    ...
    "milestone_title": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388937"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388938"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28523#issuecomment-444810",
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388939"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/28523",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/28523#issuecomment-444811",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388941"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388942"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388943"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388944"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388945"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388946"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388947"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388948"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388949"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388950"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/28523#event-388951"
}
```
