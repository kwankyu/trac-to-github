...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14653#issuecomment-180382",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14653#issuecomment-180383",
    "user": "https://trac.sagemath.org/admin/accounts/users/rowland"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14653#issuecomment-180384",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14653#issuecomment-180385",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14653#event-128632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14653#issuecomment-180386",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14653#issuecomment-180387",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "milestone": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14653#event-128633"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14653#event-128634"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14653#event-128635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14653#issuecomment-180388",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14653#event-128636"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14653#event-128637"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14653",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14653#event-128638"
}
```
