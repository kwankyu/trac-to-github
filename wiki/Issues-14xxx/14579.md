...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14579#issuecomment-179119",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14579",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14579#issuecomment-179120",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14579#event-127761"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14579#event-127762"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14579",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14579#issuecomment-179121",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14579#event-127763"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14579#event-127764"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14579#event-127765"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14579#event-127766"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14579",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14579#event-127767"
}
```
