...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14169#issuecomment-171396",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14169#issuecomment-171397",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14169#issuecomment-171398",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14169#issuecomment-171399",
    "user": "https://github.com/hughrthomas"
}
```
...
```json
{
    ...
    "milestone": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14169#event-123009"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14169#issuecomment-171400",
    "user": "https://github.com/hughrthomas"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14169#event-123010"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14169#issuecomment-171401",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14169",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14169#issuecomment-171402",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14169#event-123011"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14169#event-123012"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14169#event-123013"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14169",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14169#event-123014"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14169#event-123015"
}
```
