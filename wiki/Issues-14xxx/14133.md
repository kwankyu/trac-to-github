...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14133#issuecomment-170672",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14133#issuecomment-170673",
    "user": "https://trac.sagemath.org/admin/accounts/users/ManDay"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14133#issuecomment-170674",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14133#issuecomment-170675",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14133#issuecomment-170676",
    "user": "https://github.com/ppurka"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122605"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122606"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122607"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122608"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122609"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122610"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122611"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122612"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122613"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/14133#issuecomment-170677",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122614"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122615"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/14133",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/14133#event-122616"
}
```
