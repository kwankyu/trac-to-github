...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7730#event-94685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7730#event-94686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7730#event-94687"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7730#event-94688"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-spancratz",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7730#event-94689"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-spancratz",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7730#event-94690"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7730",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7730#issuecomment-58034",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7730",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7730#issuecomment-58035",
    "user": "https://github.com/kedlaya"
}
```
