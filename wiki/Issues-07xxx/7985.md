...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7985#event-98352"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7985#event-98353"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7985#event-98354"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7985#event-98355"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7985#event-98356"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7985#event-98357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7985#event-98358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7985#event-98359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7985#event-98360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7985",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7985#event-98361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7985#issuecomment-61138",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7985#issuecomment-61139",
    "user": "https://github.com/rlmill"
}
```
