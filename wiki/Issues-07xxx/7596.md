...
```json
{
    "body": "Attachment: **[trac_7596_places_for_QQ.patch.gz](https://github.com/sagemath/sage/files/ticket7596/trac_7596_places_for_QQ.patch.gz)**",
    "created_at": "2013-07-25T14:16:47Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/7596",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92713"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7596#issuecomment-56490",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7596",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7596#issuecomment-56491",
...
```json
{
    ...
    "milestone_title": "sage-9.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92715"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92717"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92718"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92719"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92720"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92721"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92722"
}
```
...
```json
{
    ...
    "milestone_title": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7596#event-92723"
}
```
