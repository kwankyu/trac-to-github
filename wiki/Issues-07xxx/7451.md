...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7451#event-90548"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7451#event-90549"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7451#event-90550"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7451#event-90551"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7451#event-90552"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7451#event-90553"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7451#issuecomment-54586",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7451",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7451#event-90554"
}
```
