...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7127#event-86187"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7127#event-86188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7127#event-86189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7127#event-86190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7127",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7127#issuecomment-51286",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7127#event-86191"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7127#event-86192"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7127",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7127#event-86193"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7127#event-86194"
}
```
