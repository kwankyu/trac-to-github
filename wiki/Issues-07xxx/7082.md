...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-85559"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-85560"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-85561"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-85562"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-85563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7082",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7082#issuecomment-50762",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-85564"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7082",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-85565"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-85566"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7082#event-85567"
}
```
