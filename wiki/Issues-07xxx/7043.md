...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7043#event-85047"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7043#event-85048"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7043#event-85049"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7043#event-85050"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7043#event-85051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7043#event-85052"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7043#event-85053"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7043",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7043#issuecomment-50533",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7043#event-85054"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7043",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7043#event-85055"
}
```
