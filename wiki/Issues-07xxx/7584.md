...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7584#issuecomment-57998",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7584",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7584#event-51963"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7584",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7584#issuecomment-57999",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7584",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7584#issuecomment-58000",
    "user": "https://github.com/mwhansen"
}
```
