...
```json
{
    ...
    "milestone": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52958"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52959"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52960"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52961"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52962"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52963"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52964"
}
```
...
```json
{
    "body": "**Attachment:** [trac-7682-realfield-printing-options.patch](https://github.com/sagemath/sage/files/ticket7682/trac-7682-realfield-printing-options.patch)",
    "created_at": "2010-01-26T09:37:43Z",
    "issue": "https://github.com/sagemath/sage/issues/7682",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52965"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52966"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52967"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52968"
}
```
...
```json
{
    "body": "**Attachment:** [trac-7682-realfield-printing-options.3.patch](https://github.com/sagemath/sage/files/ticket7682/trac-7682-realfield-printing-options.3.patch)\n\nrebase to 4.4.1, apply only this patch",
    "created_at": "2010-05-14T17:06:15Z",
    "issue": "https://github.com/sagemath/sage/issues/7682",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52969"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52970"
}
```
...
```json
{
    "body": "**Attachment:** [trac-7682-realfield-printing-options.5.patch](https://github.com/sagemath/sage/files/ticket7682/trac-7682-realfield-printing-options.5.patch)\n\nrebase to 4.4.1, fix startup bug,  fix one doctest to test for the startup bug; apply only this patch",
    "created_at": "2010-05-14T19:21:11Z",
    "issue": "https://github.com/sagemath/sage/issues/7682",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52971"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52972"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52973"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52974"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52975"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52976"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52977"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52978"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7682#event-52979"
}
```
