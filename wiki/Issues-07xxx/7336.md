...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7336#event-88936"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7336#event-88937"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7336#event-88938"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7336#event-88939"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7336#event-88940"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7336#event-88941"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7336#event-88942"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7336#event-88943"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7336",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7336#event-88944"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7336#issuecomment-53366",
    "user": "https://github.com/mwhansen"
}
```
