...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7882#issuecomment-61666",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-54855"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-54856"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-54857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7882",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-54858"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7882#issuecomment-61667",
    "user": "https://github.com/novoselt"
}
```
