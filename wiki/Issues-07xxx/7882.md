...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-96933"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-96934"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-96935"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-96936"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7882#issuecomment-59988",
    "user": "https://github.com/novoselt"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-96937"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-96938"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-96939"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-96940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7882",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7882#event-96941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7882#issuecomment-59989",
    "user": "https://github.com/novoselt"
}
```
