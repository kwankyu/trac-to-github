...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7438#event-90367"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7438#event-90368"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7438#event-90369"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7438#event-90370"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7438#event-90371"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7438#event-90372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7438#event-90373"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7438",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7438#issuecomment-54447",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7438#event-90374"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7438",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7438#event-90375"
}
```
