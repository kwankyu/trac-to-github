...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7433#event-90281"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7433#event-90282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7433#event-90283"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7433#event-90284"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7433#event-90285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7433#event-90286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7433#event-90287"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7433#event-90288"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7433",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7433#event-90289"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7433",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7433#issuecomment-54399",
    "user": "https://github.com/sagetrac-mvngu"
}
```
