...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7260#event-87843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7260#event-87844"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7260#event-87845"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7260#event-87846"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7260#event-87847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7260#event-87848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7260#event-87849"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7260#event-87850"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7260",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7260#event-87851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7260",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7260#issuecomment-52326",
    "user": "https://github.com/mwhansen"
}
```
