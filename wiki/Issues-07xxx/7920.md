...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7920#issuecomment-62027",
    "user": "https://trac.sagemath.org/admin/accounts/users/dagss"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7920#event-55187"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7920",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7920#issuecomment-62028",
    "user": "https://trac.sagemath.org/admin/accounts/users/dagss"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7920#event-55188"
}
```
