...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7726#event-94635"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7726#event-94636"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7726#event-94637"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7726#event-94638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7726#event-94639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7726#event-94640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7726#event-94641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7726#event-94642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7726",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7726#event-94643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7726#issuecomment-57988",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7726",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7726#issuecomment-57989",
    "user": "https://github.com/fchapoton"
}
```
