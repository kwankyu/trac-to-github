...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7130#event-47934"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7130#event-47935"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7130#event-47936"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7130#issuecomment-52910",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7130#issuecomment-52911",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7130/libpng.patch",
    "created_at": "2010-01-28T15:15:14Z",
    "issue": "https://github.com/sagemath/sage/issues/7130",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7130/libpng.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    "body": "**Attachment:** [libpng.patch](https://github.com/sagemath/sage/files/ticket7130/libpng.patch)",
    "created_at": "2010-01-28T15:15:14Z",
    "issue": "https://github.com/sagemath/sage/issues/7130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7130#issuecomment-52912",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```

**Attachment:** [libpng.patch](https://github.com/sagemath/sage/files/ticket7130/libpng.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7130#event-47937"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7130",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7130#event-47938"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7130",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7130#issuecomment-52913",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
