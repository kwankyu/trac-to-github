...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7182#event-86837"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7182#event-86838"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7182#event-86839"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7182#event-86840"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7182#event-86841"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7182#issuecomment-51590",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7182",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7182#event-86842"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7182#event-86843"
}
```
