...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7833#event-96207"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7833#event-96208"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7833#event-96209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7833#event-96210"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7833#event-96211"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7833#event-96212"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7833#event-96213"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7833#event-96214"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7833#issuecomment-59397",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7833#issuecomment-59398",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7833#event-96215"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7833",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7833#event-96216"
}
```
