...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7779#event-95411"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7779#event-95412"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7779#event-95413"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7779#event-95414"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7779#event-95415"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7779#event-95416"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7779#issuecomment-58643",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7779#event-95417"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7779#event-95418"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7779",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7779#issuecomment-58644",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7779#event-95419"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7779",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7779#event-95420"
}
```
