...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94326"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94327"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94328"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94329"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7706#issuecomment-57778",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94330"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7706",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7706#event-94331"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7706",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7706#issuecomment-57779",
    "user": "https://github.com/qed777"
}
```
