...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7164#event-86613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7164#event-86614"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7164#event-86615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7164#event-86616"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7164#event-86617"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7164#event-86618"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7164#event-86619"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7164#event-86620"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7164",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7164#event-86621"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7164#issuecomment-51527",
    "user": "https://github.com/mwhansen"
}
```
