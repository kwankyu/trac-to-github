...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-92491"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-92492"
}
```
...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-92493"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-92494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-92495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-92496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-92497"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-92498"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-92499"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7582#event-92500"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7582#issuecomment-56343",
    "user": "https://github.com/rlmill"
}
```
