...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93608"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93609"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7657#issuecomment-57129",
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7657",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7657#issuecomment-57130",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93616"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93617"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7657",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7657#event-93618"
}
```
