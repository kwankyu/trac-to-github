...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7006#event-84522"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7006#event-84523"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7006#event-84524"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7006#event-84525"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7006#event-84526"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7006#event-84527"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7006",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7006#event-84528"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7006#event-84529"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7006",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7006#event-84530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7006#issuecomment-50149",
    "user": "https://github.com/sagetrac-mvngu"
}
```
