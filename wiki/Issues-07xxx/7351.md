...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7351#event-89143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7351#event-89144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7351#event-89145"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7351#event-89146"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7351#event-89147"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7351#event-89148"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7351#event-89149"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7351#event-89150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7351",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7351#event-89151"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7351",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7351#issuecomment-53518",
    "user": "https://github.com/mwhansen"
}
```
