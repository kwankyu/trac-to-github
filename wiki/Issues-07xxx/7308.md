...
```json
{
    ...
    "type": "issue",
    "updated_at": "2023-01-16T07:53:02Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7308#event-88579"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7308#event-88580"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7308#event-88581"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7308#event-88582"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7308#event-88583"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7308#event-88584"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7308#event-88585"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7308#event-88586"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7308",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7308#event-88587"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7308#issuecomment-53046",
    "user": "https://github.com/sagetrac-mvngu"
}
```
