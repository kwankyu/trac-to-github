...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-52813"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-52814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7668",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-52815"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-52816"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-52817"
}
```
