...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93790"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93791"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93792"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93793"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93794"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93795"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93796"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7668",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93797"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7668",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93798"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7668#issuecomment-57378",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93799"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7668#event-93800"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7668",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7668#issuecomment-57379",
    "user": "https://github.com/kcrisman"
}
```
