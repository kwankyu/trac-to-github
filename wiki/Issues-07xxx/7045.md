...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7045#event-85079"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7045#event-85080"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7045#event-85081"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7045#event-85082"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7045#event-85083"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7045#event-85084"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7045#event-85085"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7045",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7045#event-85086"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7045#issuecomment-50551",
    "user": "https://github.com/mwhansen"
}
```
