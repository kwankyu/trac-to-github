...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7149#event-86420"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7149#event-86421"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7149#event-86422"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7149#event-86423"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7149",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7149#event-86424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7149#event-86425"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7149",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7149#event-86426"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7149#event-86427"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7149#event-86428"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7149",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7149#issuecomment-51388",
    "user": "https://github.com/mwhansen"
}
```
