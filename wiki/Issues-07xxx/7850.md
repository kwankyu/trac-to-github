...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96399"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96400"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96401"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96402"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96403"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-olazo",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96404"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-olazo",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96405"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96406"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96407"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7850",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7850#event-96409"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7850#issuecomment-59536",
    "user": "https://github.com/sagetrac-olazo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7850#issuecomment-59537",
    "user": "https://github.com/sagetrac-olazo"
}
```
