...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7450#event-90539"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7450#event-90540"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7450#event-90541"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7450#event-90542"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7450#event-90543"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7450#event-90544"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7450#event-90545"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7450#event-90546"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7450",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7450#event-90547"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7450",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7450#issuecomment-54585",
    "user": "https://github.com/mwhansen"
}
```
