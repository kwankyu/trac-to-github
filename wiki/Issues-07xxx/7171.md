...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7171#event-86706"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7171#event-86707"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7171#event-86708"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7171#event-86709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7171",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7171#event-86710"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7171#issuecomment-51560",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7171#event-86711"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7171#event-86712"
}
```
