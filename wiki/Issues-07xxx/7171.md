...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7171#issuecomment-53169",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7171",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7171#event-48222"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7171#issuecomment-53170",
...
```json
{
    ...
    "milestone": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7171#event-48223"
}
```
