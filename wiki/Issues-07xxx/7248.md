...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7248#event-87700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7248#event-87701"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7248#event-87702"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7248#event-87703"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7248",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7248#event-87704"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7248",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7248#event-87705"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7248#issuecomment-52217",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7248#event-87706"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7248#event-87707"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7248",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7248#event-87708"
}
```
