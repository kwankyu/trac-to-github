...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7337#event-88945"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7337#event-88946"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7337#event-88947"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7337",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7337#event-88948"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7337",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7337#event-88949"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7337#event-88950"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7337#event-88951"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7337",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7337#event-88952"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7337#event-88953"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7337",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7337#issuecomment-53375",
    "user": "https://github.com/sagetrac-mvngu"
}
```
