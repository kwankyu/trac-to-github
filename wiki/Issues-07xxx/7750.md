...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95011"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95014"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95016"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7750",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7750#event-95017"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7750#issuecomment-58336",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7750",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7750#issuecomment-58337",
    "user": "https://github.com/mwhansen"
}
```
