...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7583#event-92501"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7583#event-92502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7583#event-92503"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7583#event-92504"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7583#event-92505"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7583#event-92506"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7583#event-92507"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7583",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7583#event-92508"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7583#issuecomment-56349",
    "user": "https://github.com/mwhansen"
}
```
