...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97165"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97166"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97167"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97168"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97169"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97171"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97172"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97173"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97174"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-60148",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97175"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7898#event-97176"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7898#issuecomment-60149",
    "user": "https://github.com/rlmill"
}
```
