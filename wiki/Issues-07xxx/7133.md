...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7133#event-86249"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7133#event-86250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7133#event-86251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7133#event-86252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7133#issuecomment-51309",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7133",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7133#event-86253"
}
```
