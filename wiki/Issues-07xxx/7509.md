...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7509",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7509#event-91376"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7509#event-91377"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7509#event-91378"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7509#event-91379"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7509#event-91380"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7509#event-91381"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7509#event-91382"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7509#event-91383"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7509",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7509#event-91384"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7509",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7509#issuecomment-55338",
    "user": "https://github.com/williamstein"
}
```
