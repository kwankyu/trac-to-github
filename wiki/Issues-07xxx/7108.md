...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7108#event-85913"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7108#event-85914"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7108#event-85915"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7108#event-85916"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7108#event-85917"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7108",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7108#event-85918"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7108",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7108#issuecomment-51053",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7108#event-85919"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7108#event-85920"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7108#event-85921"
}
```
