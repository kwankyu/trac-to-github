...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7156#event-86494"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7156#event-86495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7156#event-86496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7156#event-86497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7156#issuecomment-51430",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7156",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7156#event-86498"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7156#event-86499"
}
```
