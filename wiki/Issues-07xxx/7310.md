...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7310#event-88599"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7310#event-88600"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7310#event-88601"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7310#event-88602"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7310#event-88603"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7310",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7310#issuecomment-53076",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7310#event-88604"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7310",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7310#event-88605"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7310#event-88606"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7310#event-88607"
}
```
