...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7015#event-84635"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7015#event-84636"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7015#event-84637"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7015#event-84638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7015#event-84639"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7015#event-84640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7015#event-84641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7015#event-84642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7015",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7015#event-84643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7015",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7015#issuecomment-50285",
    "user": "https://github.com/mwhansen"
}
```
