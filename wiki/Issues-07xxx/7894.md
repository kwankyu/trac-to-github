...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97115"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97116"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97117"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7894#issuecomment-60125",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7894",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7894#issuecomment-60126",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97119"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97120"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97121"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97122"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97123"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7894",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97124"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97125"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7894#event-97126"
}
```
