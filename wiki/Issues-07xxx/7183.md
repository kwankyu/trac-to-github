...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7183#event-86848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7183#event-86849"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7183#event-86850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7183#event-86851"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7183#event-86852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7183#event-86853"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7183#event-86854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7183#event-86855"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7183",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7183#event-86856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7183",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7183#issuecomment-51594",
    "user": "https://github.com/jdemeyer"
}
```
