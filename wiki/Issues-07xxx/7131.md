...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7131#event-86228"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7131#event-86229"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7131#event-86230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7131#event-86231"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7131",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7131#issuecomment-51307",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7131",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7131#event-86232"
}
```
