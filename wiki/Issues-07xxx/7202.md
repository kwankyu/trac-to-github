...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7202#event-87174"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7202#event-87175"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7202#event-87176"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7202#event-87177"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7202#event-87178"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7202#event-87179"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7202",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7202#issuecomment-51848",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7202",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7202#event-87180"
}
```
