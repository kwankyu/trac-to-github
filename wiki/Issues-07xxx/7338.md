...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7338#event-88958"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7338#event-88959"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7338#event-88960"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7338#event-88961"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7338#event-88962"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7338#event-88963"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7338#event-88964"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7338#event-88965"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7338",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7338#event-88966"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7338",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7338#issuecomment-53385",
    "user": "https://github.com/mwhansen"
}
```
