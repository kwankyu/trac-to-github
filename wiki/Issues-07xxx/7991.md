...
```json
{
    "body": "**Attachment:** [trac-7991-generic-kernel-testing.patch](https://github.com/sagemath/sage/files/ticket7991/trac-7991-generic-kernel-testing.patch)",
    "created_at": "2010-01-19T03:42:17Z",
    "issue": "https://github.com/sagemath/sage/issues/7991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7991#issuecomment-62878",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55824"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55825"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55826"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55827"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55828"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55829"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55830"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55831"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55832"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7991#issuecomment-62879",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7991#issuecomment-62880",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55833"
}
```
...
```json
{
    ...
    "milestone": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55834"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7991#issuecomment-62881",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7991#issuecomment-62882",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7991#event-55835"
}
```
