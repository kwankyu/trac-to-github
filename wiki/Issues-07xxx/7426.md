...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7426#event-90189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7426#event-90190"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7426#event-90191"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7426#event-90192"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7426#event-90193"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7426#event-90194"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7426#event-90195"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7426#event-90196"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7426",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7426#event-90197"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7426",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7426#issuecomment-54364",
    "user": "https://github.com/mwhansen"
}
```
