...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7467#event-90746"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7467#event-90747"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7467#event-90748"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7467#event-90749"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7467#event-90750"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7467#event-90751"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7467#event-90752"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7467",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7467#issuecomment-54711",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7467#event-90753"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7467",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7467#event-90754"
}
```
