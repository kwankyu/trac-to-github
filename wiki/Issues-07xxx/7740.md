...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94820"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94821"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94824"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94829"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7740",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7740#event-94830"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7740#issuecomment-58124",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7740#issuecomment-58125",
    "user": "https://github.com/nathanncohen"
}
```
