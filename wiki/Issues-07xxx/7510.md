...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7510#event-51215"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7510#event-51216"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7510#event-51217"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7510#event-51218"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7510",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7510#issuecomment-56983",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7510#event-51219"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7510",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7510#event-51220"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7510#event-51221"
}
```
