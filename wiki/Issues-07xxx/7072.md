...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7072#event-85441"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7072#event-85442"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7072#event-85443"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7072#event-85444"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7072#event-85445"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7072#event-85446"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7072#event-85447"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7072#event-85448"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7072#issuecomment-50718",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7072",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7072#event-85449"
}
```
