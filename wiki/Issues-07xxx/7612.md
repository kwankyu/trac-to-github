...
```json
{
    ...
    "milestone": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7612#event-52272"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7612",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7612#event-52273"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7612#issuecomment-58331",
    "user": "https://github.com/TimDumol"
}
```
