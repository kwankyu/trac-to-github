...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94034"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94035"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94038"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94039"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94040"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94041"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7683",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7683#issuecomment-57582",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94042"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7683",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7683#event-94043"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7683",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7683#issuecomment-57583",
    "user": "https://github.com/mwhansen"
}
```
