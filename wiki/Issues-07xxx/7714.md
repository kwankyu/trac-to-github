...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94466"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94467"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94468"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7714#issuecomment-57872",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7714",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7714#event-94476"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7714",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7714#issuecomment-57873",
    "user": "https://github.com/nexttime"
}
```
