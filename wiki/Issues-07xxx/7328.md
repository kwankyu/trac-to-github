...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7328#event-88831"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7328#event-88832"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7328#event-88833"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7328#event-88834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7328#event-88835"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7328#event-88836"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7328#event-88837"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7328#event-88838"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7328",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7328#event-88839"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7328#issuecomment-53277",
    "user": "https://github.com/mwhansen"
}
```
