...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7371#event-89391"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7371#event-89392"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7371#event-89393"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7371#event-89394"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7371#event-89395"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7371#event-89396"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7371#event-89397"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7371",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7371#event-89398"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7371#issuecomment-53684",
    "user": "https://github.com/mwhansen"
}
```
