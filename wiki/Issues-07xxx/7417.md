...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7417#event-90056"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7417#event-90057"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7417#event-90058"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7417#event-90059"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7417#event-90060"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7417#event-90061"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7417#event-90062"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7417",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7417#issuecomment-54289",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7417#event-90063"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7417",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7417#event-90064"
}
```
