...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7405#event-89908"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7405#event-89909"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7405#event-89910"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7405#event-89911"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7405#event-89912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7405#event-89913"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7405#event-89914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7405",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7405#event-89915"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7405",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7405#issuecomment-54200",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7405#event-89916"
}
```
