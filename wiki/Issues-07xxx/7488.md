...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-50986"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-50987"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7488#issuecomment-56672",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-50988"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-50989"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-50990"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7488",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-50991"
}
```
