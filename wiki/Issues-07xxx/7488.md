...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-91052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-91053"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-91054"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-91055"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-91056"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-91057"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-91058"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-91059"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7488",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7488#event-91060"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7488#issuecomment-55034",
    "user": "https://github.com/mwhansen"
}
```
