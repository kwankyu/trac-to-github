...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7932#event-97638"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7932#event-97639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7932#event-97640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7932#event-97641"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7932#event-97642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7932#issuecomment-60559",
    "user": "https://github.com/robertwb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7932",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7932#issuecomment-60560",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7932",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7932#event-97643"
}
```
