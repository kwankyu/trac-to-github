...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7502#event-91257"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7502#event-91258"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7502#event-91259"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7502#event-91260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7502#event-91261"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7502#event-91262"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7502#event-91263"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7502#event-91264"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7502",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7502#event-91265"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7502#issuecomment-55213",
    "user": "https://github.com/sagetrac-mvngu"
}
```
