...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7385#event-89614"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7385#event-89615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7385#event-89616"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7385#event-89617"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7385#event-89618"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7385#issuecomment-54023",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7385#event-89619"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7385",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7385#event-89620"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7385#event-89621"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7385#event-89622"
}
```
