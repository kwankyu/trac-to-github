...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7291#event-88252"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7291#event-88253"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7291#event-88254"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7291#event-88255"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7291#event-88256"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7291#event-88257"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7291",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7291#event-88258"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7291",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7291#issuecomment-52696",
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7291#event-88259"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7291#event-88260"
}
```
