...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7073#event-85459"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7073#event-85460"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7073#event-85461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7073#event-85462"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7073#event-85463"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7073#event-85464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7073#event-85465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7073#event-85466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7073",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7073#event-85467"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7073#issuecomment-50722",
    "user": "https://github.com/jdemeyer"
}
```
