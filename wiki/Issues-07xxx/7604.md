...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7604#event-52193"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7604/contfrac.py",
    "created_at": "2009-12-04T16:42:14Z",
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7604/contfrac.py",
    "user": "https://trac.sagemath.org/admin/accounts/users/solevillar"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [contfrac.py](https://github.com/sagemath/sage/files/ticket7604/contfrac.py)",
    "created_at": "2009-12-04T16:42:14Z",
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7604#event-52194"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket7604/trac_7604.patch",
    "created_at": "2009-12-07T08:12:11Z",
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket7604/trac_7604.patch",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7604#event-52195"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7604",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7604#event-52196"
}
```
...
```json
{
    ...
    "milestone": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7604#event-52197"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7604#event-52198"
}
```
