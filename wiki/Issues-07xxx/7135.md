...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7135#event-86273"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7135#event-86274"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7135#event-86275"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7135#event-86276"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7135#event-86277"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7135#event-86278"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7135#event-86279"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7135",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7135#issuecomment-51314",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7135#event-86280"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7135",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7135#event-86281"
}
```
