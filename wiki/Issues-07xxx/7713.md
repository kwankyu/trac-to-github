...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7713#event-53258"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7713#event-53259"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7713",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7713#issuecomment-59517",
    "user": "https://github.com/TimDumol"
}
```
