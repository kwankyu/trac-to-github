...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7479#event-90934"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7479#event-90935"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7479#event-90936"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7479#event-90937"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7479#event-90938"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7479#event-90939"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7479#event-90940"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7479#event-90941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7479",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7479#event-90942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7479",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7479#issuecomment-54936",
    "user": "https://github.com/mwhansen"
}
```
