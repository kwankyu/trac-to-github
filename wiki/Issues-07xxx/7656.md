...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93587"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93588"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93589"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7656#issuecomment-57126",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93590"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7656#issuecomment-57127",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93592"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93594"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7656",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93596"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7656#event-93597"
}
```
