...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7324#event-88763"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7324#event-88764"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7324#event-88765"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7324#event-88766"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7324#event-88767"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7324#event-88768"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7324#event-88769"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7324#event-88770"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7324",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7324#event-88771"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7324#issuecomment-53204",
    "user": "https://github.com/mwhansen"
}
```
