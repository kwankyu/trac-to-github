...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7653#event-93540"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7653#event-93541"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7653#event-93542"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7653#event-93543"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7653#event-93544"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7653#issuecomment-57086",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7653#event-93545"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7653#event-93546"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7653#issuecomment-57087",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7653#event-93547"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7653",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7653#event-93548"
}
```
