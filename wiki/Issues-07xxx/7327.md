...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7327#event-88822"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7327#event-88823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7327#event-88824"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7327#event-88825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7327#event-88826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7327#event-88827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7327#event-88828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7327#event-88829"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7327",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7327#event-88830"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7327",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7327#issuecomment-53272",
    "user": "https://github.com/kcrisman"
}
```
