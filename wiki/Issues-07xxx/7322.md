...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7322#event-88744"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7322#event-88745"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7322#event-88746"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7322#event-88747"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7322#event-88748"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7322#event-88749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7322",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7322#event-88750"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7322",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7322#issuecomment-53188",
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7322#event-88751"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7322#event-88752"
}
```
