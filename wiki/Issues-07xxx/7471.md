...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7471#event-90798"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7471#event-90799"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7471#event-90800"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7471#event-90801"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7471#event-90802"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7471#event-90803"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7471#event-90804"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7471#event-90805"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7471",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7471#event-90806"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7471#issuecomment-54742",
    "user": "https://github.com/mwhansen"
}
```
