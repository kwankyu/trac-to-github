...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7180#event-86822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7180#event-86823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7180#event-86824"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7180#event-86825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7180#event-86826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7180#event-86827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7180#event-86828"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7180#issuecomment-51587",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7180#event-86829"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7180",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7180#event-86830"
}
```
