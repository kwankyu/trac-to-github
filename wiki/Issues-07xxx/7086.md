...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7086#issuecomment-52393",
    "user": "https://github.com/hemmecke"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7086#event-47560"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7086#event-47561"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7086#event-47562"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7086",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7086#event-47563"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7086#event-47564"
}
```
