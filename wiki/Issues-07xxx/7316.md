...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7316#event-88680"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7316#event-88681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7316#event-88682"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7316#event-88683"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7316#event-88684"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7316#issuecomment-53142",
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7316#event-88685"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7316#event-88686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7316#event-88687"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7316",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7316#event-88688"
}
```
