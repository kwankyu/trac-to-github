...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7475#event-90853"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7475#event-90854"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7475#event-90855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7475#event-90856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7475#event-90857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7475#event-90858"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7475",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7475#issuecomment-54809",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7475#event-90859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7475#event-90860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7475",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7475#event-90861"
}
```
