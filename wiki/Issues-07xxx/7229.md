...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7229#event-87459"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7229#event-87460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7229#event-87461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7229#event-87462"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7229#event-87463"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7229#event-87464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7229#event-87465"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7229",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7229#event-87466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7229",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7229#issuecomment-52021",
    "user": "https://github.com/williamstein"
}
```
