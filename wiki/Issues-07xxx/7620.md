...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7620#event-52355"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7620#issuecomment-58430",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7620#event-52356"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7620#event-52357"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7620#issuecomment-58431",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7620#issuecomment-58432",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7620#event-52358"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7620",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7620#event-52359"
}
```
