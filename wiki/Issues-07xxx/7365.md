...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7365#event-89333"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7365#event-89334"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7365#event-89335"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7365#event-89336"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7365#event-89337"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7365#event-89338"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7365",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7365#event-89339"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7365#issuecomment-53647",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7365#event-89340"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7365#event-89341"
}
```
