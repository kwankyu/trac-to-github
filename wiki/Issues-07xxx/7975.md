...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7975",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7975#issuecomment-62653",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7975#event-55642"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7975#event-55643"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7975#event-55644"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7975#event-55645"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7975#event-55646"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7975#event-55647"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7975",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7975#event-55648"
}
```
