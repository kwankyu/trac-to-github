...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-87783"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7254",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7254#issuecomment-52300",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-87784"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7254",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-87785"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-87786"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-87787"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-87788"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-87789"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-87790"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7254#event-87791"
}
```
