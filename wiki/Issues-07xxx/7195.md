...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7195#event-87068"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7195#event-87069"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7195#event-87070"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7195#event-87071"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7195#event-87072"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7195#event-87073"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7195",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7195#event-87074"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7195#event-87075"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7195#event-87076"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7195",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7195#issuecomment-51778",
    "user": "https://github.com/fchapoton"
}
```
