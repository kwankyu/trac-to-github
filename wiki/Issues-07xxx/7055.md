...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7055#event-85214"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7055#event-85215"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7055#event-85216"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7055#event-85217"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7055#event-85218"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7055#event-85219"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7055#event-85220"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7055#event-85221"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7055",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7055#event-85222"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7055",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7055#issuecomment-50620",
    "user": "https://github.com/sagetrac-mvngu"
}
```
