...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62601",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62602",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7968#event-55592"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7968#event-55593"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7968#event-55594"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7968#event-55595"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7968#event-55596"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62603",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62604",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62605",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7968#event-55597"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7968#event-55598"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7968#issuecomment-62606",
    "user": "https://github.com/rlmill"
}
```
