...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7241#event-87629"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7241#event-87630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7241#event-87631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7241#event-87632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7241#event-87633"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7241#event-87634"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7241#event-87635"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7241#event-87636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7241",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7241#event-87637"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7241#issuecomment-52180",
    "user": "https://github.com/mwhansen"
}
```
