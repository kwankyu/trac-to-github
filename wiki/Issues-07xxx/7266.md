...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7266#event-87912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7266#event-87913"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7266#event-87914"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7266#event-87915"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7266#event-87916"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7266#event-87917"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7266#event-87918"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7266#event-87919"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7266",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7266#event-87920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7266#issuecomment-52398",
    "user": "https://github.com/williamstein"
}
```
