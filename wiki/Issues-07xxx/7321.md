...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7321#event-88732"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7321#event-88733"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7321#event-88734"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7321#event-88735"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7321#event-88736"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7321#event-88737"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7321#event-88738"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7321#event-88739"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7321",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7321#event-88740"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7321#issuecomment-53182",
    "user": "https://github.com/sagetrac-mvngu"
}
```
