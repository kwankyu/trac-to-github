...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7065#event-85330"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7065#event-85331"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7065#event-85332"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7065#event-85333"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7065#event-85334"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7065#event-85335"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7065#event-85336"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7065",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7065#issuecomment-50668",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7065#event-85337"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7065",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7065#event-85338"
}
```
