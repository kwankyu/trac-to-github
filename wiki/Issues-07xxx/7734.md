...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94739"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94740"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94741"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94742"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94743"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94744"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94745"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7734#issuecomment-58062",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94746"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7734",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94747"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7734",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7734#issuecomment-58063",
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94748"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7734#event-94749"
}
```
