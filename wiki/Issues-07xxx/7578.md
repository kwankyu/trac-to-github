...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7578#event-51906"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7578#event-51907"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7578#event-51908"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7578#issuecomment-57902",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7578#issuecomment-57903",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7578#event-51909"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7578",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7578#event-51910"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7578",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7578#issuecomment-57904",
    "user": "https://github.com/mwhansen"
}
```
