...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7376#event-89445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7376#event-89446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7376#event-89447"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7376#event-89448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7376#event-89449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7376#event-89450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7376#event-89451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7376#event-89452"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7376",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7376#event-89453"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7376",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7376#issuecomment-53734",
    "user": "https://github.com/sagetrac-mvngu"
}
```
