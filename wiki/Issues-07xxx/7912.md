...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-97351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-97352"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-97353"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-97354"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-97355"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-97356"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7912#issuecomment-60283",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-97357"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7912",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-97358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-97359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7912#event-97360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7912",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7912#issuecomment-60284",
    "user": "https://github.com/jhpalmieri"
}
```
