...
```json
{
    ...
    "type": "issue",
    "updated_at": "2023-01-16T07:52:34Z",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7393#event-89711"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7393#event-89712"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7393#event-89713"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7393#event-89714"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7393#event-89715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7393#event-89716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7393#event-89717"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7393#event-89718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7393",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7393#event-89719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7393",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7393#issuecomment-54080",
    "user": "https://github.com/mwhansen"
}
```
