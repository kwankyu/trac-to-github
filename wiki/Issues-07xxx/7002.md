...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7002#event-84470"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7002#event-84471"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7002#event-84472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7002#event-84473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7002#event-84474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7002#event-84475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7002",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7002#event-84476"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7002#event-84477"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7002#event-84478"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7002#issuecomment-50088",
    "user": "https://github.com/kcrisman"
}
```
