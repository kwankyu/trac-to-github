...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-94243"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-94244"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-94245"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-94246"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7701#issuecomment-57713",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-94247"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-94248"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7701#issuecomment-57714",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-94249"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7701",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-94250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-94251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-94252"
}
```
