...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7701#issuecomment-59366",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7701",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7701#issuecomment-59367",
    "user": "https://trac.sagemath.org/admin/accounts/users/thisch"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-53113"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-53114"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-53115"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7701",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-53116"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7701#event-53117"
}
```
