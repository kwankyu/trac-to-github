...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7419#event-90086"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7419#event-90087"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7419#event-90088"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7419#event-90089"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7419#event-90090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7419#event-90091"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7419",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7419#event-90092"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7419",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7419#issuecomment-54307",
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7419#event-90093"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7419#event-90094"
}
```
