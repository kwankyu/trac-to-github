...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7250#issuecomment-53880",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7250",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7250#event-48866"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7250#event-48867"
}
```
