...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7544#event-91898"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7544#event-91899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7544#event-91900"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7544#event-91901"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7544#event-91902"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7544",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7544#event-91903"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7544",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7544#issuecomment-55785",
    "user": "https://github.com/dandrake"
}
```
