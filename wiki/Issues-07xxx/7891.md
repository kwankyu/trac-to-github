...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7891#event-97083"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7891#event-97084"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7891#event-97085"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7891#event-97086"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7891#issuecomment-60104",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7891#event-97087"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7891",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7891#issuecomment-60105",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7891#event-97088"
}
```
