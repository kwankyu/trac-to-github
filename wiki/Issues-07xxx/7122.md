...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7122#event-86090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7122#event-86091"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7122#event-86092"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7122#event-86093"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7122#event-86094"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7122#event-86095"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7122#event-86096"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7122#event-86097"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7122",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7122#event-86098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7122#issuecomment-51224",
    "user": "https://github.com/mwhansen"
}
```
