...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7167#event-48196"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7167#event-48197"
}
```
...
```json
{
    ...
    "label": "component: porting",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7167#event-48198"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7167#event-48199"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7167#issuecomment-53152",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7167#issuecomment-53153",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7167#event-48200"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7167#event-48201"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7167",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7167#event-48202"
}
```
