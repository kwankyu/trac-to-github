...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7756#event-95087"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7756#event-95088"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7756#event-95089"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7756#event-95090"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7756#event-95091"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7756",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7756#event-95092"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7756#issuecomment-58389",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7756#issuecomment-58390",
    "user": "https://github.com/sagetrac-mvngu"
}
```
