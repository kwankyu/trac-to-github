...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7309#event-88588"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7309#event-88589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7309#event-88590"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7309#event-88591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7309#event-88592"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7309#event-88593"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7309",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7309#event-88594"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7309",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7309#issuecomment-53055",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7309#event-88595"
}
```
