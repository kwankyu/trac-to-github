...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-89352"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-89353"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-89354"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-89355"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-89356"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-89357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-89358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-89359"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7367",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7367#event-89360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7367#issuecomment-53664",
    "user": "https://github.com/mwhansen"
}
```
