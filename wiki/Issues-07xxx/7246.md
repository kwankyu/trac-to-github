...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7246#event-87684"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7246#event-87685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7246#event-87686"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7246#event-87687"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7246#event-87688"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7246#event-87689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7246#event-87690"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7246#event-87691"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7246",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7246#event-87692"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7246",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7246#issuecomment-52209",
    "user": "https://github.com/mwhansen"
}
```
