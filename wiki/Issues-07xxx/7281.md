...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7281#event-88126"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7281#event-88127"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7281#event-88128"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7281#event-88129"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7281#event-88130"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7281#event-88131"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7281#event-88132"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7281",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/7281#event-88133"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/7281",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/7281#issuecomment-52612",
    "user": "https://github.com/mwhansen"
}
```
