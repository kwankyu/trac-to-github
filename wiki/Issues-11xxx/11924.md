...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11924#event-159356"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11924#event-159357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11924#event-159358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11924#event-159359"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11924#issuecomment-125817",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11924#event-159360"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11924#event-159361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11924#event-159362"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11924#event-159363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11924#issuecomment-125818",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11924#event-159364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11924",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11924#event-159365"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11924#issuecomment-125819",
    "user": "https://github.com/jdemeyer"
}
```
