...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11665#event-154825"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11665#event-154826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11665#event-154827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11665#event-154828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11665#event-154829"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11665#event-154830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11665#event-154831"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11665#issuecomment-120204",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11665#issuecomment-120205",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11665#event-154832"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11665",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11665#event-154833"
}
```
