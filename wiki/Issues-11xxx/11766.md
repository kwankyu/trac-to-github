...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11766#event-156582"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11766#event-156583"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11766#event-156584"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11766#event-156585"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11766#event-156586"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11766#event-156587"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11766#event-156588"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11766#event-156589"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11766#issuecomment-122578",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11766#event-156590"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11766",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11766#event-156591"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11766#issuecomment-122579",
    "user": "https://github.com/jdemeyer"
}
```
