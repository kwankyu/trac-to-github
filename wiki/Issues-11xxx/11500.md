...
```json
{
    "body": "**Attachment:** [Plot3d bug.sws](https://github.com/sagemath/sage/files/ticket11500/9f8e0a4297b912b64328b0f9f7ff9a6d.sws)",
    "created_at": "2011-06-16T05:38:35Z",
    "issue": "https://github.com/sagemath/sage/issues/11500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11500#issuecomment-118924",
    "user": "https://trac.sagemath.org/admin/accounts/users/travis"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11500#issuecomment-118925",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11500#issuecomment-118926",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11500#issuecomment-118927",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11500#issuecomment-118928",
    "user": "https://trac.sagemath.org/admin/accounts/users/travis"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91302"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91303"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11500",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11500#issuecomment-118929",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91304"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91305"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91306"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91307"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91308"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91309"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91310"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91311"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11500#event-91312"
}
```
