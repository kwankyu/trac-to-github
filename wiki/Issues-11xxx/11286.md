...
```json
{
    "body": "**Attachment:** [solve2.sage](https://github.com/sagemath/sage/files/ticket11286/solve2.sage)",
    "created_at": "2011-05-04T01:33:15Z",
    "issue": "https://github.com/sagemath/sage/issues/11286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11286#issuecomment-115290",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11286#event-88866"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11286#issuecomment-115291",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11286#issuecomment-115292",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11286#issuecomment-115293",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11286",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11286#issuecomment-115294",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11286#event-88867"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11286#event-88868"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11286#event-88869"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11286#event-88870"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11286#event-88871"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11286#event-88872"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11286#event-88873"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11286#event-88874"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11286#event-88875"
}
```
