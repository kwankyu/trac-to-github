...
```json
{
    ...
    "asset_name": "trac_11585_depracted_function_alias.patch",
    "asset_url": "tarball://root/attachments/ticket11585/trac_11585_depracted_function_alias.patch",
    "created_at": "2011-07-11T17:05:38Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11585/trac_11585_depracted_function_alias.patch",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    "body": "**Attachment:** [trac_11585_depracted_function_alias.patch](https://github.com/sagemath/sage/files/ticket11585/trac_11585_depracted_function_alias.patch)",
    "created_at": "2011-07-11T17:05:38Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120912",
    "user": "https://github.com/defeo"
}
```

**Attachment:** [trac_11585_depracted_function_alias.patch](https://github.com/sagemath/sage/files/ticket11585/trac_11585_depracted_function_alias.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92553"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -8,6 +8,9 @@\n DeprecationWarning: (Since Version ?) a is deprecated. Please use sqrt instead.\n sqrt(5)\n ```\n+\n+**Apply:**\n+1.  [attachment:trac_11585_depracted_function_alias.patch](https://github.com/sagemath/sage/files/ticket11585/trac_11585_depracted_function_alias.patch)\n \n which is misleading because the user would expect to find `sqrt` in the same module as `a`.\n \n``````\n",
    "created_at": "2011-07-11T20:24:31Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120913",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120914",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120915",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92554"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92555"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -10,7 +10,7 @@\n ```\n \n **Apply:**\n-1.  [attachment:trac_11585_depracted_function_alias.patch](https://github.com/sagemath/sage/files/ticket11585/trac_11585_depracted_function_alias.patch)\n+1.  [attachment:trac_11585_deprecated_function_alias.patch](https://github.com/sagemath/sage/files/ticket11585/trac_11585_deprecated_function_alias.patch)\n \n which is misleading because the user would expect to find `sqrt` in the same module as `a`.\n \n``````\n",
    "created_at": "2011-07-11T20:59:58Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120916",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92556"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92557"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11585_deprecated_function_alias.patch",
    "asset_url": "tarball://root/attachments/ticket11585/trac_11585_deprecated_function_alias.patch",
    "created_at": "2011-07-11T20:59:58Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11585/trac_11585_deprecated_function_alias.patch",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [trac_11585_deprecated_function_alias.patch](https://github.com/sagemath/sage/files/ticket11585/trac_11585_deprecated_function_alias.patch)\n\nModified as requested by rbeezer. Apply second patch only (sorry for the mispelling in the first patch).",
    "created_at": "2011-07-11T20:59:58Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120917",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120918",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92558"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92559"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120919",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120920",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120921",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92560"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92561"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120922",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -26,5 +26,5 @@\n \n \n **Apply:**\n-1.  [attachment:trac_11585_deprecated_function_alias.patch](https://github.com/sagemath/sage/files/ticket11585/trac_11585_deprecated_function_alias.patch)\n+1.  [attachment:trac_11585_deprecated_function_alias+rc1.patch](https://github.com/sagemath/sage/files/ticket11585/e9f70c1fd18c72b528620ea4272eec70.patch)\n \n``````\n",
    "created_at": "2011-07-28T23:58:06Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11585#issuecomment-120923",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92562"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92563"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11585_deprecated_function_alias+rc1.patch",
    "asset_url": "tarball://root/attachments/ticket11585/e9f70c1fd18c72b528620ea4272eec70.patch",
    "created_at": "2011-07-28T23:58:06Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11585/e9f70c1fd18c72b528620ea4272eec70.patch",
    "user": "https://github.com/defeo"
}
```
...
```json
{
    "body": "<a id='comment:7'></a>\n**Attachment:** [trac_11585_deprecated_function_alias+rc1.patch](https://github.com/sagemath/sage/files/ticket11585/e9f70c1fd18c72b528620ea4272eec70.patch)",
    "created_at": "2011-07-28T23:58:06Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92564"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92565"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92566"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92567"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92568"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92569"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92570"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_11585_deprecated_function_alias-rc2.patch",
    "asset_url": "tarball://root/attachments/ticket11585/trac_11585_deprecated_function_alias-rc2.patch",
    "created_at": "2012-03-15T14:03:39Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket11585/trac_11585_deprecated_function_alias-rc2.patch",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    "body": "<a id='comment:18'></a>\n**Attachment:** [trac_11585_deprecated_function_alias-rc2.patch](https://github.com/sagemath/sage/files/ticket11585/trac_11585_deprecated_function_alias-rc2.patch)",
    "created_at": "2012-03-15T14:03:39Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92571"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92572"
}
```
...
```json
{
    "body": "**Changing work issues** from \"startuptime\" to \"\".",
    "created_at": "2012-03-16T07:53:28Z",
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_comment",
...
**Changing work issues** from "startuptime" to "".
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92573"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92574"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92575"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11585",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11585#event-92576"
}
```
