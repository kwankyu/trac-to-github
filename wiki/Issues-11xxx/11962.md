...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11962#event-97109"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11962#issuecomment-128993",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11962#event-97110"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11962#issuecomment-128994",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11962#issuecomment-128995",
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11962#event-97111"
}
```
...
```json
{
    ...
    "label": "component: interfaces",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11962#event-97112"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11962#event-97113"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11962#event-97114"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11962#issuecomment-128996",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11962#issuecomment-128997",
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11962#event-97115"
}
```
