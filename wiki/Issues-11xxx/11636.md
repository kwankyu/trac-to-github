...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11636#event-154415"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11636#event-154416"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11636#event-154417"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11636#event-154418"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11636#event-154419"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11636#event-154420"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11636#event-154421"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11636#event-154422"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11636",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11636#event-154423"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11636#issuecomment-119818",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11636#issuecomment-119819",
    "user": "https://github.com/jdemeyer"
}
```
