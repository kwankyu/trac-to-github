...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11660#event-154769"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11660#event-154770"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11660#event-154771"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11660#event-154772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11660#event-154773"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11660#event-154774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11660#event-154775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11660#event-154776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11660#issuecomment-120118",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11660#event-154777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11660",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11660#event-154778"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11660#issuecomment-120119",
    "user": "https://github.com/kini"
}
```
