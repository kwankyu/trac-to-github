...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11661#event-154779"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11661#event-154780"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11661#event-154781"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11661#event-154782"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11661#event-154783"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11661#event-154784"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11661#event-154785"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11661#issuecomment-120128",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11661#event-154786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11661",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11661#event-154787"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11661",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11661#issuecomment-120129",
    "user": "https://github.com/jdemeyer"
}
```
