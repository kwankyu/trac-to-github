...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11501#issuecomment-118938",
    "user": "https://trac.sagemath.org/admin/accounts/users/rmartinjak"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11501#issuecomment-118939",
    "user": "https://github.com/dimpase"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11501#event-91313"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11501#event-91314"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11501#event-91315"
}
```
...
```json
{
    ...
    "label": "pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11501#event-91316"
}
```
...
```json
{
    ...
    "label": "pending",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11501#event-91317"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11501#event-91318"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11501#event-91319"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11501",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11501#event-91320"
}
```
