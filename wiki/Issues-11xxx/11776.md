...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11776#issuecomment-125096",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11776#issuecomment-125097",
    "user": "https://trac.sagemath.org/admin/accounts/users/Pap"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11776#issuecomment-125098",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11776#issuecomment-125099",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11776#event-94758"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11776#issuecomment-125100",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11776#issuecomment-125101",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11776#issuecomment-125102",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11776#event-94759"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11776#event-94760"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11776#event-94761"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11776#event-94762"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11776#event-94763"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11776",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11776#event-94764"
}
```
