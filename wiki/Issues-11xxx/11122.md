...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146038"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146039"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146040"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146041"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146042"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146044"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146047"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11122#issuecomment-110494",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146048"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11122#issuecomment-110495",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146050"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11122",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11122#event-146051"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11122#issuecomment-110496",
    "user": "https://github.com/jdemeyer"
}
```
