...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11838#event-157775"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11838#event-157776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11838#event-157777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11838#event-157778"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11838#event-157779"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11838#event-157780"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11838#event-157781"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11838#issuecomment-123805",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11838#issuecomment-123806",
    "user": "https://github.com/sagetrac-bbanu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11838",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11838#issuecomment-123807",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11838#event-157782"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11838",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11838#event-157783"
}
```
