...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157849"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157852"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157853"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157855"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11842#issuecomment-123873",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157858"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11842",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157860"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11842#event-157861"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11842#issuecomment-123874",
    "user": "https://github.com/orlitzky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11842",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11842#issuecomment-123875",
    "user": "https://github.com/orlitzky"
}
```
