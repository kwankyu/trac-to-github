...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11582#event-153493"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11582#event-153494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11582#event-153495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11582#event-153496"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11582#event-153497"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11582#event-153498"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11582#event-153499"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11582#event-153500"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11582#event-153501"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11582",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11582#event-153502"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11582#issuecomment-118699",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11582#issuecomment-118700",
    "user": "https://github.com/williamstein"
}
```
