...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11484#issuecomment-118685",
    "user": "https://trac.sagemath.org/admin/accounts/users/ijstokes"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11484#event-91124"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11484#event-91125"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11484#event-91126"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11484#issuecomment-118686",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11484#event-91127"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11484#event-91128"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11484#event-91129"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11484",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11484#issuecomment-118687",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11484#event-91130"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11484",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11484#event-91131"
}
```
