...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11824#event-157588"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11824#event-157589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11824#event-157590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11824#event-157591"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11824#event-157592"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11824#event-157593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11824#event-157594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11824#event-157595"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11824#issuecomment-123648",
    "user": "https://github.com/sagetrac-fwclarke"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11824#issuecomment-123649",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11824#event-157596"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11824",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/11824#event-157597"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/11824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/11824#issuecomment-123650",
    "user": "https://github.com/nexttime"
}
```
