...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6146#event-73257"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6146#event-73258"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6146#event-73259"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6146",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6146#event-73260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6146#event-73261"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6146#event-73262"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6146#event-73263"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6146",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6146#issuecomment-40560",
    "user": "https://github.com/tornaria"
}
```
