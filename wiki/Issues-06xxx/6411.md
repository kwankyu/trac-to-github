...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6411#event-76689"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6411#event-76690"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6411#event-76691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6411#event-76692"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6411#event-76693"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6411#event-76694"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6411",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6411#event-76695"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6411#issuecomment-43186",
    "user": "https://github.com/rlmill"
}
```
