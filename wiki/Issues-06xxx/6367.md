...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6367#event-76073"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6367#event-76074"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6367#event-76075"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6367#event-76076"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6367#event-76077"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6367#issuecomment-42592",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6367#event-76078"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6367",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6367#event-76079"
}
```
