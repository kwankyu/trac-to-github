...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6340#event-75655"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6340#event-75656"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6340#event-75657"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6340#event-75658"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6340#event-75659"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6340#event-75660"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6340",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6340#event-75661"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6340",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6340#issuecomment-42250",
    "user": "https://github.com/sagetrac-mvngu"
}
```
