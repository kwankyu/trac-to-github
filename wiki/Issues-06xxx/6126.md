...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6126#event-73038"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6126#event-73039"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6126#event-73040"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6126#event-73041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6126#event-73042"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6126",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6126#event-73043"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6126#event-73044"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6126",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6126#issuecomment-40443",
    "user": "https://github.com/kcrisman"
}
```
