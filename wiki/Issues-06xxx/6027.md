...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6027#event-71725"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6027#event-71726"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6027#event-71727"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6027#event-71728"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6027#event-71729"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6027#event-71730"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6027",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6027#event-71731"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6027",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6027#issuecomment-39425",
    "user": "https://github.com/sagetrac-rdingman"
}
```
