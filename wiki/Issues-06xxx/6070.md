...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6070#event-72239"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6070#event-72240"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6070#event-72241"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6070#event-72242"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6070#event-72243"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6070#event-72244"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6070",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6070#event-72245"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6070",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6070#issuecomment-39763",
    "user": "https://github.com/loefflerd"
}
```
