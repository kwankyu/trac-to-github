...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6139#event-73185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6139#event-73186"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6139#event-73187"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6139#event-73188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6139#event-73189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6139#event-73190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6139",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6139#event-73191"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6139",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6139#issuecomment-40516",
    "user": "https://github.com/mwhansen"
}
```
