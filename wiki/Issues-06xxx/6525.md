...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6525/graph_latex_options.patch",
    "created_at": "2009-07-13T22:21:53Z",
    "issue": "https://github.com/sagemath/sage/issues/6525",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6525/graph_latex_options.patch",
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [graph_latex_options.patch](https://github.com/sagemath/sage/files/ticket6525/graph_latex_options.patch)",
    "created_at": "2009-07-13T22:21:53Z",
    "issue": "https://github.com/sagemath/sage/issues/6525",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6525#event-43156"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6525#event-43157"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6525#event-43158"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6525#event-43159"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6525/graph_latex_options-2.patch",
    "created_at": "2009-07-21T12:51:43Z",
    "issue": "https://github.com/sagemath/sage/issues/6525",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6525/graph_latex_options-2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/fidelbarrera"
}
```
