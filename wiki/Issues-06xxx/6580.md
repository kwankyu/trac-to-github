...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6580#issuecomment-45531",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6580#event-79043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6580#event-79044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6580#event-79045"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6580#event-79046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6580#event-79047"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6580#event-79048"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6580#event-79049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6580",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6580#event-79050"
}
```
