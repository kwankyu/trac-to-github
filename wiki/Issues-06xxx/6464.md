...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6464#event-77468"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6464#event-77469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6464#event-77470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6464#event-77471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6464#event-77472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6464#event-77473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6464#event-77474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6464",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6464#event-77475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6464",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6464#issuecomment-43946",
    "user": "https://github.com/sagetrac-mvngu"
}
```
