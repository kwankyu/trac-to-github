...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6850#event-82529"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6850#event-82530"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6850#event-82531"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6850#event-82532"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6850#issuecomment-48561",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6850#event-82533"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6850",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6850#event-82534"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6850#event-82535"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6850",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6850#event-82536"
}
```
