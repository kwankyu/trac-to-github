...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6016#event-71560"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6016#event-71561"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6016#event-71562"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6016#event-71563"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6016#event-71564"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6016#event-71565"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6016",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6016#event-71566"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6016",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6016#issuecomment-39297",
    "user": "https://github.com/sagetrac-mvngu"
}
```
