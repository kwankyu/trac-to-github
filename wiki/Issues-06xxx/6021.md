...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6021#event-71651"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6021#event-71652"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6021#event-71653"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6021#event-71654"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6021#event-71655"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6021#event-71656"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6021",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6021#event-71657"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6021#issuecomment-39394",
    "user": "https://github.com/JohnCremona"
}
```
