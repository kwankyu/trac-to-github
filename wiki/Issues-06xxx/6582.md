...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6582#event-79084"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6582#event-79085"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6582#event-79086"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6582#event-79087"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6582",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6582#issuecomment-45571",
    "user": "https://github.com/alexanderdreyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6582#event-79088"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6582",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6582#event-79089"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6582#event-79090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6582#event-79091"
}
```
