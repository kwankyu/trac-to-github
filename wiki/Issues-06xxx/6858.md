...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6858#event-82618"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6858#event-82619"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6858#event-82620"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6858#event-82621"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6858#event-82622"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6858#event-82623"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6858#event-82624"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6858",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6858#event-82625"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6858#issuecomment-48628",
    "user": "https://github.com/sagetrac-mvngu"
}
```
