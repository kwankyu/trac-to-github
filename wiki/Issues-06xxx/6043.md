...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6043#event-71923"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6043#event-71924"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6043#event-71925"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6043#event-71926"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6043",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6043#event-71927"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6043#event-71928"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6043",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6043#event-71929"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6043",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6043#issuecomment-39564",
    "user": "https://github.com/mwhansen"
}
```
