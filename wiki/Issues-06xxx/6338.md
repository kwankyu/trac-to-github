...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6338#event-75627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6338#event-75628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6338#event-75629"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6338#event-75630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6338#event-75631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6338#event-75632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6338",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6338#event-75633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6338",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6338#issuecomment-42221",
    "user": "https://github.com/jdemeyer"
}
```
