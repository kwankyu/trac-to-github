...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6213#event-74051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6213#event-74052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6213#event-74053"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6213#event-74054"
}
```
...
```json
{
    ...
    "subject": "https://github.com/loefflerd",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6213#event-74055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6213#event-74056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6213",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6213#event-74057"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6213",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6213#issuecomment-41185",
    "user": "https://github.com/loefflerd"
}
```
