...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6287#event-74865"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6287#event-74866"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6287#event-74867"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6287#event-74868"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6287#event-74869"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6287#event-74870"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6287",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6287#event-74871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6287#issuecomment-41789",
    "user": "https://github.com/sagetrac-mvngu"
}
```
