...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6279#event-74792"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6279#event-74793"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6279#event-74794"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6279#event-74795"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6279#event-74796"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6279#issuecomment-41730",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6279#event-74797"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6279",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6279#event-74798"
}
```
