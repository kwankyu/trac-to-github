...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6144#event-73234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6144#event-73235"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6144#event-73236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6144#event-73237"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6144#event-73238"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6144#event-73239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6144",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6144#event-73240"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6144",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6144#issuecomment-40552",
    "user": "https://github.com/mwhansen"
}
```
