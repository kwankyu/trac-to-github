...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6650#event-80029"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6650#event-80030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6650#event-80031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6650#event-80032"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6650#event-80033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6650#event-80034"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6650",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6650#event-80035"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6650#event-80036"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6650#issuecomment-46485",
    "user": "https://github.com/williamstein"
}
```
