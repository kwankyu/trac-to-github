...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6148#event-73278"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6148#event-73279"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6148#event-73280"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6148#event-73281"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6148#event-73282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6148#event-73283"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6148",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6148#event-73284"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6148#issuecomment-40567",
    "user": "https://github.com/mwhansen"
}
```
