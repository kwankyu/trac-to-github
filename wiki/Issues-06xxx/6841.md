...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6841#event-82442"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6841#event-82443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6841#event-82444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6841#event-82445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6841#event-82446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6841#event-82447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6841#event-82448"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6841",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6841#event-82449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6841",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6841#issuecomment-48496",
    "user": "https://github.com/sagetrac-mvngu"
}
```
