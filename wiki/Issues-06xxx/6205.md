...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6205#event-73954"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6205#event-73955"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6205#event-73956"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6205#event-73957"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6205#event-73958"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6205#event-73959"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6205",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6205#event-73960"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6205",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6205#issuecomment-41120",
    "user": "https://github.com/ncalexan"
}
```
