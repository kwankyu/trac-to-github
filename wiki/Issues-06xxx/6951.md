...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6951#event-83838"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6951#event-83839"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6951#event-83840"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6951#event-83841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6951#event-83842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6951#event-83843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6951#event-83844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6951#event-83845"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6951",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6951#event-83846"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6951",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6951#issuecomment-49632",
    "user": "https://github.com/sagetrac-mvngu"
}
```
