...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6617#event-79586"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6617#event-79587"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6617#event-79588"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6617#event-79589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6617#event-79590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6617#event-79591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6617#event-79592"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6617",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6617#event-79593"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6617",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6617#issuecomment-46054",
    "user": "https://github.com/sagetrac-mvngu"
}
```
