...
```json
{
    ...
    "milestone_title": "sage-4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6816#event-82129"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6816#event-82130"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6816#event-82131"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6816#event-82132"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6816",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6816#event-82133"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6816#event-82134"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6816#event-82135"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6816#event-82136"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6816",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6816#issuecomment-48223",
    "user": "https://github.com/kcrisman"
}
```
