...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6243#event-74371"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6243#event-74372"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6243#event-74373"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6243#event-74374"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6243#event-74375"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6243#event-74376"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6243",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6243#event-74377"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6243",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6243#issuecomment-41431",
    "user": "https://github.com/sagetrac-mvngu"
}
```
