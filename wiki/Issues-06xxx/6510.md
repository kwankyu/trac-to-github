...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6510#event-78129"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6510#event-78130"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6510#event-78131"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6510#event-78132"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6510#event-78133"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6510#event-78134"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6510#event-78135"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6510",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6510#event-78136"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6510",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6510#issuecomment-44816",
    "user": "https://github.com/sagetrac-mvngu"
}
```
