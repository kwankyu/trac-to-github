...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6684#event-80508"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6684#event-80509"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6684#event-80510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6684#event-80511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6684#event-80512"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6684#event-80513"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6684",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6684#issuecomment-46863",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6684#event-80514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6684",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6684#event-80515"
}
```
