...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6732#event-81012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6732#event-81013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6732#event-81014"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6732#event-81015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6732#event-81016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6732#event-81017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6732#event-81018"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6732",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6732#event-81019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6732#issuecomment-47160",
    "user": "https://github.com/sagetrac-mvngu"
}
```
