...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6766#event-81464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6766#event-81465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6766#event-81466"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6766#event-81467"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6766#event-81468"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6766#event-81469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6766#event-81470"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6766",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6766#event-81471"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6766#issuecomment-47784",
    "user": "https://github.com/sagetrac-mvngu"
}
```
