...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6285#event-74847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6285#event-74848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6285#event-74849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6285#issuecomment-41771",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6285#event-74850"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6285#event-74851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6285",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6285#event-74852"
}
```
