...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6088#event-72476"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6088#event-72477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6088#event-72478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6088#event-72479"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6088",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6088#event-72480"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6088#issuecomment-39947",
...
```json
{
    ...
    "milestone_title": "sage-4.0.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6088#event-72481"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6088#event-72482"
}
```
