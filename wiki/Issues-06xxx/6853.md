...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6853#event-82557"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6853#event-82558"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6853#event-82559"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6853#event-82560"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6853#event-82561"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6853#event-82562"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6853#event-82563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6853",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6853#event-82564"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6853",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6853#issuecomment-48574",
    "user": "https://github.com/sagetrac-mvngu"
}
```
