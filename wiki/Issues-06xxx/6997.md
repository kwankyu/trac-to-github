...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-84421"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-84422"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-84423"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-84424"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-84425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-84426"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6997",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6997#event-84427"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6997#issuecomment-50054",
    "user": "https://github.com/sagetrac-mvngu"
}
```
