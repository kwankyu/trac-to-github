...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6777#event-81600"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6777#event-81601"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6777#event-81602"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6777#event-81603"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6777#event-81604"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6777#event-81605"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6777#issuecomment-47880",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6777#event-81606"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6777",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6777#event-81607"
}
```
