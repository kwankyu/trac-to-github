...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6476#event-77623"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6476#event-77624"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6476#event-77625"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6476#event-77626"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6476#event-77627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6476#event-77628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6476#event-77629"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6476",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6476#event-77630"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6476",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6476#issuecomment-44066",
    "user": "https://github.com/sagetrac-mvngu"
}
```
