...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6919#event-83376"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6919#event-83377"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6919#event-83378"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6919#event-83379"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6919#event-83380"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6919#event-83381"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6919",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6919#event-83382"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6919#event-83383"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6919",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6919#event-83384"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6919",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6919#issuecomment-49244",
    "user": "https://github.com/sagetrac-mvngu"
}
```
