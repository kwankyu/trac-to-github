...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6620#event-79636"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6620#event-79637"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6620#event-79638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6620#event-79639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6620#event-79640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6620#event-79641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6620#event-79642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6620",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6620#event-79643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6620",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6620#issuecomment-46077",
    "user": "https://github.com/sagetrac-mvngu"
}
```
