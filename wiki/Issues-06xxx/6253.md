...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6253#event-74491"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6253#event-74492"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6253#event-74493"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6253#event-74494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6253#event-74495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6253#event-74496"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6253",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6253#event-74497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6253",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6253#issuecomment-41523",
    "user": "https://github.com/sagetrac-mvngu"
}
```
