...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6628#event-79715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6628#event-79716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6628#event-79717"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6628#event-79718"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6628#event-79719"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6628#event-79720"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6628#event-79721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6628",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6628#event-79722"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6628",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6628#issuecomment-46135",
    "user": "https://github.com/sagetrac-mvngu"
}
```
