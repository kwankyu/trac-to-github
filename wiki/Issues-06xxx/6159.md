...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6159#event-73385"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6159#event-73386"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6159#event-73387"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6159#event-73388"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6159#event-73389"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6159",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6159#issuecomment-40623",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6159#event-73390"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6159",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6159#event-73391"
}
```
