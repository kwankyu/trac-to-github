...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6921#event-83396"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6921#event-83397"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6921#event-83398"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6921#event-83399"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6921#event-83400"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6921#event-83401"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6921#event-83402"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6921",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6921#event-83403"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6921#event-83404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6921#issuecomment-49256",
    "user": "https://github.com/sagetrac-mvngu"
}
```
