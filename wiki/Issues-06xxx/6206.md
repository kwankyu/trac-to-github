...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6206#event-73964"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6206#event-73965"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6206#event-73966"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6206#event-73967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6206#event-73968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6206#event-73969"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6206",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6206#event-73970"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6206",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6206#issuecomment-41127",
    "user": "https://github.com/sagetrac-mvngu"
}
```
