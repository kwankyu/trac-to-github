...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6536#event-78445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6536#event-78446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6536#event-78447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6536#event-78448"
}
```
...
```json
{
    ...
    "subject": "https://github.com/loefflerd",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6536#event-78449"
}
```
...
```json
{
    ...
    "subject": "https://github.com/loefflerd",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6536#event-78450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6536#event-78451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6536",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6536#event-78452"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6536",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6536#issuecomment-45078",
    "user": "https://github.com/sagetrac-mvngu"
}
```
