...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6669#event-80274"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6669#event-80275"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6669#event-80276"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6669#event-80277"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6669#event-80278"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6669#event-80279"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6669#event-80280"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6669",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6669#event-80281"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6669",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6669#issuecomment-46665",
    "user": "https://github.com/mwhansen"
}
```
