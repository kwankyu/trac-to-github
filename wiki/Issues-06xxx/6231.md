...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74231"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74232"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74233"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74234"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74235"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6231#event-74236"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6231",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6231#issuecomment-41286",
    "user": "https://github.com/simon-king-jena"
}
```
