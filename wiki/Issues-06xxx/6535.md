...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-78432"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-78433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-78434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-78435"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-78436"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-78437"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6535",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6535#event-78438"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6535#issuecomment-45072",
    "user": "https://github.com/jdemeyer"
}
```
