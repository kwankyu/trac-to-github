...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6207#event-73977"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6207#event-73978"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6207#event-73979"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6207#event-73980"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6207#event-73981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6207#event-73982"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6207",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6207#event-73983"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6207#issuecomment-41141",
    "user": "https://github.com/sagetrac-mvngu"
}
```
