...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6982#event-84241"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6982#event-84242"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6982#event-84243"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6982#event-84244"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6982#event-84245"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6982#event-84246"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6982",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6982#event-84247"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6982#event-84248"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6982",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6982#event-84249"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6982",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6982#issuecomment-49928",
    "user": "https://github.com/sagetrac-mvngu"
}
```
