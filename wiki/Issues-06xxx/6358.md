...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6358#event-75951"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6358#issuecomment-42495",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6358#event-75952"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6358#event-75953"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6358#event-75954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6358#event-75955"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6358#event-75956"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6358",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6358#event-75957"
}
```
