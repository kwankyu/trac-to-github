...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6308#event-75136"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6308#event-75137"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6308#event-75138"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6308#event-75139"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6308#event-75140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6308#event-75141"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6308",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6308#event-75142"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6308",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6308#issuecomment-41960",
    "user": "https://github.com/craigcitro"
}
```
