...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6824#event-82233"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6824#event-82234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6824#event-82235"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6824#event-82236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6824#event-82237"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6824#event-82238"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6824#event-82239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6824",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6824#event-82240"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6824#issuecomment-48310",
    "user": "https://github.com/sagetrac-mvngu"
}
```
