...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6857#event-82605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6857#event-82606"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6857#event-82607"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6857#event-82608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6857#event-82609"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6857#event-82610"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6857#event-82611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6857",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6857#event-82612"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6857",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6857#issuecomment-48623",
    "user": "https://github.com/sagetrac-mvngu"
}
```
