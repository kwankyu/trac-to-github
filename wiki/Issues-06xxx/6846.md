...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6846#event-82484"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6846#event-82485"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6846#event-82486"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6846#event-82487"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6846#event-82488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6846#event-82489"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6846#event-82490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6846",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6846#event-82491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6846",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6846#issuecomment-48522",
    "user": "https://github.com/sagetrac-mvngu"
}
```
