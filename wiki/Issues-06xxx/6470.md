...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-77540"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-77541"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-77542"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-77543"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-77544"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6470",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-77545"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-77546"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6470",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6470#event-77547"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6470",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6470#issuecomment-44016",
    "user": "https://github.com/rlmill"
}
```
