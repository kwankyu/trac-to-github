...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6988#event-84309"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6988#event-84310"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6988#event-84311"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6988#event-84312"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6988#event-84313"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6988#event-84314"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6988#event-84315"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6988#event-84316"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6988",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6988#event-84317"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6988#issuecomment-49983",
    "user": "https://github.com/sagetrac-mvngu"
}
```
