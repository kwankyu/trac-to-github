...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6160#event-73392"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6160#event-73393"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6160#event-73394"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6160#event-73395"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6160#event-73396"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6160",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6160#event-73397"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6160#issuecomment-40627",
    "user": "https://github.com/burcin"
}
```
