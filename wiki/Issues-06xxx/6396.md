...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6396#event-76518"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6396#event-76519"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6396#event-76520"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6396#event-76521"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6396#event-76522"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6396#event-76523"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6396",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6396#event-76524"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6396",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6396#issuecomment-43089",
    "user": "https://github.com/sagetrac-mvngu"
}
```
