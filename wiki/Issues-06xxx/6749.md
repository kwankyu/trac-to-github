...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6749#event-81237"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6749#event-81238"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6749#event-81239"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6749#event-81240"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6749#event-81241"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6749#event-81242"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6749#event-81243"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6749",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6749#event-81244"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6749",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6749#issuecomment-47595",
    "user": "https://github.com/sagetrac-mvngu"
}
```
