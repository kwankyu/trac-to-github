...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6311#event-75187"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6311#event-75188"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6311#event-75189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6311#event-75190"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6311#event-75191"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6311#event-75192"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6311",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6311#event-75193"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6311#issuecomment-41996",
    "user": "https://github.com/fchapoton"
}
```
