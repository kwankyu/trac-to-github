...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6930#event-83561"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6930#event-83562"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6930#event-83563"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6930#event-83564"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6930#event-83565"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6930#event-83566"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6930#event-83567"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6930#event-83568"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6930",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6930#event-83569"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6930",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6930#issuecomment-49425",
    "user": "https://github.com/sagetrac-mvngu"
}
```
