...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6895#event-83128"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6895#event-83129"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6895#event-83130"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6895#event-83131"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6895#event-83132"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6895#issuecomment-49057",
    "user": "https://github.com/sagetrac-nbonifas"
}
```
