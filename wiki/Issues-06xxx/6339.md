...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-75637"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-75638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-75639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-75640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-75641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-75642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6339",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-75643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6339",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6339#issuecomment-42228",
    "user": "https://github.com/sagetrac-mvngu"
}
```
