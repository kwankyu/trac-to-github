...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-41437"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6339/content.patch",
    "created_at": "2009-09-09T20:25:01Z",
    "issue": "https://github.com/sagemath/sage/issues/6339",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6339/content.patch",
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [content.patch](https://github.com/sagemath/sage/files/ticket6339/content.patch)",
    "created_at": "2009-09-09T20:25:01Z",
    "issue": "https://github.com/sagemath/sage/issues/6339",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-41438"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-41439"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-41440"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6339",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6339#event-41441"
}
```
