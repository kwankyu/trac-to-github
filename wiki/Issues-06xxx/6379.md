...
```json
{
    ...
    "subject": "https://github.com/sagetrac-GeorgSWeber",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6379#event-76247"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-GeorgSWeber",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6379#event-76248"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6379#event-76249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6379#event-76250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6379#event-76251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6379#event-76252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6379",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6379#event-76253"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6379#issuecomment-42746",
    "user": "https://github.com/sagetrac-mvngu"
}
```
