...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6649#event-80021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6649#event-80022"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6649#event-80023"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6649#event-80024"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6649#event-80025"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6649#event-80026"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6649#event-80027"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6649",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6649#event-80028"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6649#issuecomment-46480",
    "user": "https://github.com/sagetrac-mvngu"
}
```
