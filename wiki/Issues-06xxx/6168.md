...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6168#event-73488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6168#event-73489"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6168#event-73490"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6168#event-73491"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6168#event-73492"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6168#event-73493"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6168",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6168#event-73494"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6168",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6168#issuecomment-40703",
    "user": "https://github.com/mwhansen"
}
```
