...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6659#event-80144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6659#event-80145"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6659#event-80146"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6659#event-80147"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6659#event-80148"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6659#event-80149"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6659#event-80150"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6659",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6659#event-80151"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6659",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6659#issuecomment-46559",
    "user": "https://github.com/sagetrac-mvngu"
}
```
