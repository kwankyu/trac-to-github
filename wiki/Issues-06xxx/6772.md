...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6772#event-81537"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6772#event-81538"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6772#event-81539"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6772#event-81540"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6772#event-81541"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6772#event-81542"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6772",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6772#issuecomment-47821",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6772#event-81543"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6772",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6772#event-81544"
}
```
