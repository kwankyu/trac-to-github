...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6029#event-71752"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6029#event-71753"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6029#event-71754"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6029#event-71755"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6029#event-71756"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6029#event-71757"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6029",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6029#event-71758"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6029",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6029#issuecomment-39440",
    "user": "https://github.com/loefflerd"
}
```
