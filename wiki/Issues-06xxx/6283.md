...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6283#event-74830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6283#event-74831"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6283#event-74832"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6283#event-74833"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6283#event-74834"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6283#event-74835"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6283",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6283#event-74836"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6283#issuecomment-41764",
    "user": "https://github.com/sagetrac-mvngu"
}
```
