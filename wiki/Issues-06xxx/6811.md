...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6811#event-82022"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6811#event-82023"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6811#event-82024"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6811#event-82025"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6811#event-82026"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6811#event-82027"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6811#event-82028"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6811",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6811#event-82029"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6811",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6811#issuecomment-48081",
    "user": "https://github.com/sagetrac-mvngu"
}
```
