...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6164#event-73443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6164#event-73444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6164#event-73445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6164#event-73446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6164#event-73447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6164#event-73448"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6164",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6164#event-73449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6164",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6164#issuecomment-40676",
    "user": "https://github.com/sagetrac-mvngu"
}
```
