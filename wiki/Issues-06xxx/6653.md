...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6653#event-80062"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6653#event-80063"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6653#event-80064"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6653#event-80065"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6653#event-80066"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6653",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6653#issuecomment-46502",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6653#event-80067"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6653",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6653#event-80068"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6653#event-80069"
}
```
