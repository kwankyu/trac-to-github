...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6284#event-74840"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6284#event-74841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6284#event-74842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6284#event-74843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6284#event-74844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6284#event-74845"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6284",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6284#event-74846"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6284",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6284#issuecomment-41767",
    "user": "https://github.com/williamstein"
}
```
