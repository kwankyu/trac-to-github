...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6290#event-74900"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6290#event-74901"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6290#event-74902"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6290#event-74903"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6290#event-74904"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6290",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6290#event-74905"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6290#event-74906"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6290#issuecomment-41818",
    "user": "https://github.com/golam-m-hossain"
}
```
