...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6430#event-76951"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6430#event-76952"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6430#event-76953"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6430#event-76954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6430#event-76955"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6430",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6430#issuecomment-43334",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6430#event-76956"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6430",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6430#event-76957"
}
```
