...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6851#event-82541"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6851#event-82542"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6851#event-82543"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6851#event-82544"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6851#event-82545"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6851#event-82546"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6851#event-82547"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6851",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6851#event-82548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6851",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6851#issuecomment-48569",
    "user": "https://github.com/sagetrac-mvngu"
}
```
