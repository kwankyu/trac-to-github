...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6073#event-72292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6073#event-72293"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6073#event-72294"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6073#event-72295"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6073#event-72296"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6073#event-72297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6073",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6073#event-72298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6073",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6073#issuecomment-39798",
    "user": "https://github.com/rlmill"
}
```
