...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6902#event-83204"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6902#event-83205"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6902#event-83206"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6902#event-83207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6902#event-83208"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6902#event-83209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6902#event-83210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6902#event-83211"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6902",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6902#event-83212"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6902",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6902#issuecomment-49135",
    "user": "https://github.com/sagetrac-mvngu"
}
```
