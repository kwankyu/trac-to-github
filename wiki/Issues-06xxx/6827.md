...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6827#event-82264"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6827#event-82265"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6827#event-82266"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6827#event-82267"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6827#event-82268"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6827#event-82269"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6827#event-82270"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6827",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6827#event-82271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6827",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6827#issuecomment-48340",
    "user": "https://github.com/sagetrac-mvngu"
}
```
