...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-71568"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-71569"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-71570"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-71571"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-71572"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-71573"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6017",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6017#event-71574"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6017#issuecomment-39302",
    "user": "https://github.com/ncalexan"
}
```
