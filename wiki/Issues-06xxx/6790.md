...
```json
{
    ...
    "type": "issue",
    "updated_at": "2010-08-20T12:31:26Z",
    "url": "https://github.com/sagemath/sage/issues/6790",
...
```json
{
    ...
    "created_at": "2009-08-20T22:28:19Z",
    "event": "milestoned",
    "issue": "https://github.com/sagemath/sage/issues/6790",
    "milestone_number": null,
    "milestone_title": "sage-4.5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6790#event-81775"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6790#event-81776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6790#event-81777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6790#event-81778"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6790#event-81779"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6790#issuecomment-47980",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6790#issuecomment-47981",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6790",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6790#issuecomment-47982",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6790",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6790#event-81780"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6790#event-81781"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6790#event-81782"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6790#event-81783"
}
```
