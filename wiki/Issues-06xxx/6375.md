...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6375#event-76191"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6375#event-76192"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6375#event-76193"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6375#event-76194"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6375",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6375#event-76195"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6375#issuecomment-42695",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6375#event-76196"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6375#event-76197"
}
```
