...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6832#event-82320"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6832#event-82321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6832#event-82322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6832#event-82323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6832#event-82324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6832#event-82325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6832#event-82326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6832",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6832#event-82327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6832",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6832#issuecomment-48388",
    "user": "https://github.com/sagetrac-mvngu"
}
```
