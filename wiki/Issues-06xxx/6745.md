...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6745#event-81171"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6745#event-81172"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6745#event-81173"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6745#event-81174"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6745#event-81175"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6745#event-81176"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6745",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6745#issuecomment-47546",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6745#event-81177"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6745",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6745#event-81178"
}
```
