...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6382#event-76293"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6382#event-76294"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6382#event-76295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6382",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6382#issuecomment-42769",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6382",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6382#event-76296"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6382#event-76297"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6382#event-76298"
}
```
...
```json
{
    ...
    "title_was": "[duplicate] implement additive_order for points on an elliptic curve",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6382#event-76299"
}
```
