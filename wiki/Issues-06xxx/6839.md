...
```json
{
    ...
    "subject": "https://github.com/anneschilling",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6839#event-82414"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6839#event-82415"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6839#event-82416"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6839",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6839#event-82417"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6839#event-82418"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6839",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6839#issuecomment-48456",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6839#event-82419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6839#event-82420"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6839",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6839#event-82421"
}
```
