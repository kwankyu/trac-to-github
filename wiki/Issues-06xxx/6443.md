...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6443#event-77101"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6443#event-77102"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6443#event-77103"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6443#event-77104"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6443#event-77105"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6443",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6443#issuecomment-43475",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6443#event-77106"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6443",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6443#event-77107"
}
```
