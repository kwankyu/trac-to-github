...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6190#event-73754"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6190#event-73755"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6190#event-73756"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6190#event-73757"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6190#event-73758"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6190#event-73759"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6190",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6190#event-73760"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6190",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6190#issuecomment-40977",
    "user": "https://github.com/sagetrac-mvngu"
}
```
