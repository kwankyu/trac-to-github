...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6759#event-81356"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6759#event-81357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6759#event-81358"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6759#event-81359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6759#event-81360"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6759#event-81361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6759#event-81362"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6759",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6759#event-81363"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6759",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6759#issuecomment-47709",
    "user": "https://github.com/mwhansen"
}
```
