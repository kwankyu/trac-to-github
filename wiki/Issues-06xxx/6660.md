...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6660#event-80152"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6660#event-80153"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6660#event-80154"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6660#event-80155"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6660#event-80156"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6660#issuecomment-46562",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6660#event-80157"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6660",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6660#event-80158"
}
```
