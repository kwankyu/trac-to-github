...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6238#issuecomment-42847",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-40618"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6238",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-40619"
}
```
