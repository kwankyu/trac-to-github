...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-74311"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-74312"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-74313"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-74314"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-74315"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6238",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6238#issuecomment-41402",
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-74316"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6238",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6238#event-74317"
}
```
