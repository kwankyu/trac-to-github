...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6887#event-83034"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6887#event-83035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6887#event-83036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6887#event-83037"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6887#event-83038"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6887#event-83039"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6887#event-83040"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6887#event-83041"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6887",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6887#event-83042"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6887#issuecomment-49028",
    "user": "https://github.com/kcrisman"
}
```
