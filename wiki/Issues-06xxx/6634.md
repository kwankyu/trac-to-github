...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6634#event-79793"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6634#event-79794"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6634#event-79795"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6634#event-79796"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6634#event-79797"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6634#event-79798"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6634#event-79799"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6634",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6634#event-79800"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6634#issuecomment-46216",
    "user": "https://github.com/sagetrac-mvngu"
}
```
