...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6280#issuecomment-43188",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6280#issuecomment-43189",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6280#event-40890"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6280",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6280#event-40891"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6280#event-40892"
}
```
