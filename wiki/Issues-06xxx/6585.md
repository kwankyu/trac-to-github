...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-79123"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-79124"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-79125"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-79126"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-79127"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-79128"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-79129"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6585#event-79130"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6585",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6585#issuecomment-45602",
    "user": "https://github.com/sagetrac-mvngu"
}
```
