...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6211#event-74021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6211#event-74022"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6211#event-74023"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6211#event-74024"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6211",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6211#issuecomment-41174",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6211#event-74025"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6211#event-74026"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6211",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6211#event-74027"
}
```
