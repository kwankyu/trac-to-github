...
```json
{
    "body": "**Attachment:** [trac_6388-log-behavior.patch](https://github.com/sagemath/sage/files/ticket6388/trac_6388-log-behavior.patch)\n\nBased on 4.1.1",
    "created_at": "2009-09-02T12:21:55Z",
    "issue": "https://github.com/sagemath/sage/issues/6388",
    "type": "issue_comment",
...
**Attachment:** [trac_6388-log-behavior.patch](https://github.com/sagemath/sage/files/ticket6388/trac_6388-log-behavior.patch)
...
```json
{
    "body": "**Attachment:** [trac_6388-log-behavior.2.patch](https://github.com/sagemath/sage/files/ticket6388/trac_6388-log-behavior.2.patch)\n\nBased on 4.1.1",
    "created_at": "2009-09-02T12:55:39Z",
    "issue": "https://github.com/sagemath/sage/issues/6388",
    "type": "issue_comment",
...
**Attachment:** [trac_6388-log-behavior.2.patch](https://github.com/sagemath/sage/files/ticket6388/trac_6388-log-behavior.2.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6388#event-41903"
}
```
...
```json
{
    "body": "**Attachment:** [trac_6388-log-behavior-supplement.patch](https://github.com/sagemath/sage/files/ticket6388/trac_6388-log-behavior-supplement.patch)\n\nRequires regular patch, based on 4.1.1",
    "created_at": "2009-09-03T01:59:04Z",
    "issue": "https://github.com/sagemath/sage/issues/6388",
    "type": "issue_comment",
...
**Attachment:** [trac_6388-log-behavior-supplement.patch](https://github.com/sagemath/sage/files/ticket6388/trac_6388-log-behavior-supplement.patch)
...
```json
{
    "body": "**Attachment:** [trac_6388-log-behavior-supp2.patch](https://github.com/sagemath/sage/files/ticket6388/trac_6388-log-behavior-supp2.patch)\n\nApply after others",
    "created_at": "2009-09-05T17:36:32Z",
    "issue": "https://github.com/sagemath/sage/issues/6388",
    "type": "issue_comment",
...
**Attachment:** [trac_6388-log-behavior-supp2.patch](https://github.com/sagemath/sage/files/ticket6388/trac_6388-log-behavior-supp2.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6388#event-41904"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6388#event-41905"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6388#event-41906"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6388#issuecomment-44311",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6388",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6388#issuecomment-44312",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6388#event-41907"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6388",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6388#event-41908"
}
```
