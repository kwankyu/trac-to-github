...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6645#event-79949"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6645#event-79950"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6645#event-79951"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6645#event-79952"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6645#event-79953"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6645#event-79954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6645#event-79955"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6645",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6645#event-79956"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6645#issuecomment-46387",
    "user": "https://github.com/qed777"
}
```
