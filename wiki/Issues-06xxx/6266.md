...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6266#event-74646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6266#event-74647"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6266#event-74648"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6266",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6266#event-74649"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6266#issuecomment-41639",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6266#event-74650"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6266#event-74651"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6266",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6266#event-74652"
}
```
