...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6716#event-44695"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6716#event-44696"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6716#event-44697"
}
```
...
```json
{
    ...
    "label": "component: porting: solaris",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6716#event-44698"
}
```
...
```json
{
    ...
    "label": "component: algebra",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6716#event-44699"
}
```
...
```json
{
    ...
    "milestone": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6716#event-44700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6716",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6716#event-44701"
}
```
