...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6569#event-78916"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6569#event-78917"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6569#event-78918"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6569#event-78919"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6569#event-78920"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6569#event-78921"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6569#event-78922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6569",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6569#event-78923"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6569",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6569#issuecomment-45446",
    "user": "https://github.com/jdemeyer"
}
```
