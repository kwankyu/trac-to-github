...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6865#event-82736"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6865#event-82737"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6865#event-82738"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6865#event-82739"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6865#event-82740"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6865#event-82741"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6865#event-82742"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6865#event-82743"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6865",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6865#event-82744"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6865",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6865#issuecomment-48748",
    "user": "https://github.com/sagetrac-mvngu"
}
```
