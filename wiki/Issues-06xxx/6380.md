...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6380#event-76263"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6380#event-76264"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6380#event-76265"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6380#event-76266"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6380#event-76267"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6380#event-76268"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6380",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6380#event-76269"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6380",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6380#issuecomment-42757",
    "user": "https://github.com/sagetrac-mvngu"
}
```
