...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6583#event-79105"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6583#event-79106"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6583#event-79107"
}
```
...
```json
{
    ...
    "title_was": "Implement two descent over QQ natively in Sage using ratpoints",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6583#event-79108"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6583#event-79109"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6583#event-79110"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6583#event-79111"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6583",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6583#event-79112"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6583",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6583#issuecomment-45593",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
