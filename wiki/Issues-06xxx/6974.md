...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6974#event-84124"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6974#event-84125"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6974#event-84126"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6974#event-84127"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6974#event-84128"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6974#event-84129"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6974#event-84130"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6974#event-84131"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6974",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6974#event-84132"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6974#issuecomment-49866",
    "user": "https://github.com/sagetrac-mvngu"
}
```
