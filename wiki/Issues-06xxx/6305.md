...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6305#event-75090"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6305#event-75091"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6305#event-75092"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6305#event-75093"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6305",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6305#issuecomment-41933",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6305#event-75094"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6305#event-75095"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6305",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6305#event-75096"
}
```
