...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6822#event-82206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6822#event-82207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6822#event-82208"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6822#event-82209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6822#event-82210"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6822#issuecomment-48288",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6822#event-82211"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6822",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6822#event-82212"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6822#event-82213"
}
```
