...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6171#event-73523"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6171#event-73524"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6171#event-73525"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6171#event-73526"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6171#event-73527"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6171#event-73528"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6171",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6171#event-73529"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6171#issuecomment-40725",
    "user": "https://github.com/sagetrac-mvngu"
}
```
