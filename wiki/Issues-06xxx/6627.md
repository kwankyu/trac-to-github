...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6627#event-79706"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6627#event-79707"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6627#event-79708"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6627#event-79709"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6627#event-79710"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6627",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6627#issuecomment-46116",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6627#event-79711"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6627",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6627#event-79712"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6627#event-79713"
}
```
