...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6935#event-83625"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6935#event-83626"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6935#event-83627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6935#event-83628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6935#event-83629"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6935#event-83630"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6935#event-83631"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6935",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6935#issuecomment-49456",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6935#event-83632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6935",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6935#event-83633"
}
```
