...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6051#event-72029"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6051#event-72030"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6051#event-72031"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6051#event-72032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6051#event-72033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6051#event-72034"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6051",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6051#event-72035"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6051",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6051#issuecomment-39656",
    "user": "https://github.com/sagetrac-mvngu"
}
```
