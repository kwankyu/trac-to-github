...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6806#event-81964"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6806#event-81965"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6806#event-81966"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6806#event-81967"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6806#event-81968"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6806#event-81969"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6806#issuecomment-48048",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6806#event-81970"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6806",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6806#event-81971"
}
```
