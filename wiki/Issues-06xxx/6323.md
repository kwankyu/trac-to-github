...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43553",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41258"
}
```
...
```json
{
    ...
    "label": "trivial",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41259"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41260"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41261"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6323/trac_6323.patch",
    "created_at": "2013-06-21T15:29:41Z",
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6323/trac_6323.patch",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "**Attachment:** [trac_6323.patch](https://github.com/sagemath/sage/files/ticket6323/trac_6323.patch)",
    "created_at": "2013-06-21T15:29:41Z",
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43554",
    "user": "https://github.com/mwhansen"
}
```

**Attachment:** [trac_6323.patch](https://github.com/sagemath/sage/files/ticket6323/trac_6323.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6323#issuecomment-43555",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41262"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41263"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41264"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6323/trac_6323-rev.patch",
    "created_at": "2013-06-27T17:08:20Z",
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6323/trac_6323-rev.patch",
    "user": "https://github.com/nathanncohen"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41265"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41266"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6323",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6323#event-41267"
}
```
