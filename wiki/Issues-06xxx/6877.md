...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6877#event-82873"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6877#event-82874"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6877#event-82875"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6877#event-82876"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6877#event-82877"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6877#event-82878"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6877#event-82879"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6877#event-82880"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6877",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6877#event-82881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6877",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6877#issuecomment-48866",
    "user": "https://github.com/sagetrac-mvngu"
}
```
