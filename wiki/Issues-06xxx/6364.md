...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6364#event-76031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6364#event-76032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6364#event-76033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6364#event-76034"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6364#event-76035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6364#event-76036"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6364",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6364#event-76037"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6364",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6364#issuecomment-42577",
    "user": "https://github.com/sagetrac-mvngu"
}
```
