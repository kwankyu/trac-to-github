# Issue 6441: Charpoly (plus adjoint and det)
...
```json
{
    ...
    "title": "Charpoly (plus adjoint and det)",
    "type": "issue",
    "url": "https://github.com/sagemath/sage/issues/6441",
...
```json
{
    ...
    "asset_name": "dfmatrix.patch",
    "asset_url": "tarball://root/attachments/ticket6441/dfmatrix.patch",
    "created_at": "2009-06-28T17:51:57Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/dfmatrix.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    "body": "**Attachment:** [dfmatrix.patch](https://github.com/sagemath/sage/files/ticket6441/dfmatrix.patch)\n\nCode for division-free matrix computations",
    "created_at": "2009-06-28T17:51:57Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44882",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```

**Attachment:** [dfmatrix.patch](https://github.com/sagemath/sage/files/ticket6441/dfmatrix.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44883",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44884",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44885",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44886",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44887",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42315"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42316"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44888",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44889",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44890",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44891",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "dfmatrix20090707.patch",
    "asset_url": "tarball://root/attachments/ticket6441/dfmatrix20090707.patch",
    "created_at": "2009-08-05T06:47:55Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/dfmatrix20090707.patch",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42317"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44893",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44894",
    "user": "https://trac.sagemath.org/admin/accounts/users/ylchapuy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44895",
    "user": "https://github.com/rbeezer"
}
```
...
{
    "body": "**Description changed:**\n``````diff\n--- \n+++ \n@@ -70,7 +70,7 @@\n \n To quickly mention the latter: in the file matrix2.pyx I simply implemented _adjoint(self), since inheriting classes overwrite this.\n \n-The calls to charpoly can choose an algorithm (as before, although it wasn't really used since there wasn't any choice).  This problem thus translates to choosing the most sensible defaults (possibly depending on whether something is a number field, or an exact field, etc) in the implementation of charpoly, and to go through all the calls of charpoly in the current code, to check what the desired behaviour is.  This question only arises as the Hessenberg algorithm runs in time O(n^3) whereas the division-free algorithm implemented here runs in time O(n^4).  Thus the division-free algorithm wouldn't necessarily be the right choice between these two in all cases.\n+The calls to charpoly can choose an algorithm (as before, although it wasn't really used since there wasn't any choice).  This problem thus translates to choosing the most sensible defaults (possibly depending on whether something is a number field, or an exact field, etc) in the implementation of charpoly, and to go through all the calls of charpoly in the current code, to check what the desired behaviour is.  This question only arises as the Hessenberg algorithm runs in time `O(n^3)` whereas the division-free algorithm implemented here runs in time `O(n^4)`.  Thus the division-free algorithm wouldn't necessarily be the right choice between these two in all cases.\n \n In the case of number fields (PARI) or exact fields (Hessenberg form) or Z/nZ (lift to Z), the choice is pretty clear.  The same holds in cases where this wasn't implemented before.  I think the only remaining cases for which there may or may not be an obvious (at least to me!) choice are non-exact fields like R or Qp (and their extensions).  Then it's basically a choice between speed (and managing precision as the caller by ensuring one has good bounds on the input) or guaranteed precision.\n \n``````\n",
    "created_at": "2009-08-19T16:21:29Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44896",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44897",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44899",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44900",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "20090821_Charpoly.patch",
    "asset_url": "tarball://root/attachments/ticket6441/20090821_Charpoly.patch",
    "created_at": "2009-08-22T05:11:51Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/20090821_Charpoly.patch",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44902",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42318"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44904",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44905",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44906",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44907",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_a_rings.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_a_rings.patch",
    "created_at": "2009-08-25T10:18:13Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    "body": "**Attachment:** [trac_6441_a_rings.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings.patch)\n\n20090825 - Including divison-free adjoint, charpoly and det",
    "created_at": "2009-08-25T10:18:13Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44908",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```

**Attachment:** [trac_6441_a_rings.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings.patch)
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_b_df_charpoly.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_b_df_charpoly.patch",
    "created_at": "2009-08-26T05:55:19Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_b_df_charpoly.patch",
    "user": "https://github.com/rbeezer"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_a_reviewer.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_a_reviewer.patch",
    "created_at": "2009-08-27T04:59:43Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_reviewer.patch",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44911",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44913",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44914",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_a_rings.2.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_a_rings.2.patch",
    "created_at": "2009-08-27T23:36:38Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings.2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_b_df_charpoly.2.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_b_df_charpoly.2.patch",
    "created_at": "2009-08-27T23:36:38Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_b_df_charpoly.2.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    "body": "**Attachment:** [trac_6441_a_rings.2.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings.2.patch)\n\n**Attachment:** [trac_6441_b_df_charpoly.2.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_b_df_charpoly.2.patch)\n\n20090827 - Including divison-free adjoint, charpoly and det",
    "created_at": "2009-08-27T23:36:38Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44915",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```

**Attachment:** [trac_6441_a_rings.2.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings.2.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44916",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44917",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44918",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_a_rings.3.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_a_rings.3.patch",
    "created_at": "2009-08-28T14:13:05Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings.3.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    "body": "**Attachment:** [trac_6441_a_rings.3.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings.3.patch)\n\n20090828 - Including divison-free adjoint, charpoly and det",
    "created_at": "2009-08-28T14:13:05Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44919",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```

**Attachment:** [trac_6441_a_rings.3.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings.3.patch)
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_b_df_charpoly.3.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_b_df_charpoly.3.patch",
    "created_at": "2009-08-30T05:26:44Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_b_df_charpoly.3.patch",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "**Reviewer:** Rob Beezer, Yann Laigle-Chapuy",
    "created_at": "2009-08-30T05:26:44Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44921",
    "user": "https://github.com/rbeezer"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_reviewer_doctests.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_reviewer_doctests.patch",
    "created_at": "2009-08-30T05:27:30Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_reviewer_doctests.patch",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "**Attachment:** [trac_6441_reviewer_doctests.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_reviewer_doctests.patch)",
    "created_at": "2009-08-30T05:27:30Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44922",
    "user": "https://github.com/rbeezer"
}
```

**Attachment:** [trac_6441_reviewer_doctests.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_reviewer_doctests.patch)
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42319"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42320"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44923",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44925",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44927",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_a_rings_rebase.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_a_rings_rebase.patch",
    "created_at": "2009-09-02T17:22:37Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings_rebase.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    "body": "**Attachment:** [trac_6441_a_rings_rebase.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings_rebase.patch)\n\n20090902 - Including \"is_field\" etc for rings, to facilitate the division-free matrix operations",
    "created_at": "2009-09-02T17:22:37Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44928",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```

**Attachment:** [trac_6441_a_rings_rebase.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings_rebase.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44929",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42321"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42322"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_b_df_charpoly_rebase.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_b_df_charpoly_rebase.patch",
    "created_at": "2009-09-03T22:27:50Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_b_df_charpoly_rebase.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44931",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44932",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44934",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44935",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_a_rings_412rebase.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_a_rings_412rebase.patch",
    "created_at": "2009-09-06T21:37:19Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings_412rebase.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_6441_b_df_charpoly_412rebase.patch",
    "asset_url": "tarball://root/attachments/ticket6441/trac_6441_b_df_charpoly_412rebase.patch",
    "created_at": "2009-09-06T21:37:19Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6441/trac_6441_b_df_charpoly_412rebase.patch",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```
...
```json
{
    "body": "**Attachment:** [trac_6441_a_rings_412rebase.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings_412rebase.patch)\n\n**Attachment:** [trac_6441_b_df_charpoly_412rebase.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_b_df_charpoly_412rebase.patch)\n\n20090906 - Including divison-free adjoint, charpoly and det",
    "created_at": "2009-09-06T21:37:19Z",
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44936",
    "user": "https://trac.sagemath.org/admin/accounts/users/spancratz"
}
```

**Attachment:** [trac_6441_a_rings_412rebase.patch](https://github.com/sagemath/sage/files/ticket6441/trac_6441_a_rings_412rebase.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44937",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42323"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42324"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44938",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6441#issuecomment-44939",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42325"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6441",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6441#event-42326"
}
```
