...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6676#event-80381"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6676#event-80382"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6676#event-80383"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6676#event-80384"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6676#event-80385"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6676#event-80386"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6676#event-80387"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6676",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6676#event-80388"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6676",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6676#issuecomment-46772",
    "user": "https://github.com/mwhansen"
}
```
