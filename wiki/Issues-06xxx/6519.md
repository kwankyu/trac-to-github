...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6519#event-78251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6519#event-78252"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6519#event-78253"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6519#event-78254"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6519#event-78255"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6519#event-78256"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6519#event-78257"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6519",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6519#event-78258"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6519",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6519#issuecomment-44934",
    "user": "https://github.com/sagetrac-mvngu"
}
```
