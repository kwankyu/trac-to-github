...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6989#event-84319"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6989#event-84320"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6989#event-84321"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6989#event-84322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6989#event-84323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6989#event-84324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6989#event-84325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6989#event-84326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6989",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6989#event-84327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6989",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6989#issuecomment-49991",
    "user": "https://github.com/sagetrac-mvngu"
}
```
