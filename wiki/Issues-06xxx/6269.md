...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6269#event-74691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6269#event-74692"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6269#event-74693"
}
```
...
```json
{
    ...
    "title_was": "Coloring odds and ends",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6269#event-74694"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6269#event-74695"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6269",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6269#issuecomment-41675",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6269#event-74696"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6269",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6269#event-74697"
}
```
