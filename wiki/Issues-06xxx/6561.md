...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6561#event-78773"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6561#event-78774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6561#event-78775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6561#event-78776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6561#event-78777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6561#event-78778"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6561#event-78779"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6561",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6561#event-78780"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6561#issuecomment-45326",
    "user": "https://github.com/sagetrac-mvngu"
}
```
