...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6329#event-75492"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6329#event-75493"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6329#event-75494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6329#event-75495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6329#event-75496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6329#event-75497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6329",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6329#event-75498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6329",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6329#issuecomment-42164",
    "user": "https://github.com/williamstein"
}
```
