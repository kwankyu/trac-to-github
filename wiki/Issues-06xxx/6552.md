...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6552#event-78666"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6552#event-78667"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6552#event-78668"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6552#event-78669"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6552#event-78670"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6552",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6552#event-78671"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6552",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6552#event-78672"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6552",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6552#event-78673"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6552",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6552#issuecomment-45236",
    "user": "https://github.com/sagetrac-mvngu"
}
```
