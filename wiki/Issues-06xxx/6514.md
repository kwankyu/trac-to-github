...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6514#event-78175"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6514#event-78176"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6514#event-78177"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6514#event-78178"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6514#event-78179"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6514#event-78180"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6514#event-78181"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6514",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6514#event-78182"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6514",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6514#issuecomment-44846",
    "user": "https://github.com/sagetrac-mvngu"
}
```
