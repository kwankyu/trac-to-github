...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6813#event-82100"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6813#event-82101"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6813#event-82102"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6813#event-82103"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6813#event-82104"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6813#event-82105"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6813#event-82106"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6813",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6813#event-82107"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6813",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6813#issuecomment-48205",
    "user": "https://github.com/mwhansen"
}
```
