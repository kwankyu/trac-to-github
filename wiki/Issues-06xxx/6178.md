...
```json
{
    ...
    "subject": "https://github.com/loefflerd",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6178#event-73608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6178#event-73609"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6178#event-73610"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6178#event-73611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6178#event-73612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6178#event-73613"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6178",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6178#event-73614"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6178",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6178#issuecomment-40846",
    "user": "https://github.com/williamstein"
}
```
