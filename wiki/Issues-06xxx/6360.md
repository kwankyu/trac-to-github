...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6360#event-75983"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6360#event-75984"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6360#event-75985"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6360#event-75986"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6360#event-75987"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6360#event-75988"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6360",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6360#event-75989"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6360#issuecomment-42518",
    "user": "https://github.com/ncalexan"
}
```
