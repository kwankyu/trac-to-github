...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6890#event-46005"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6890",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6890#issuecomment-50613",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6890#event-46006"
}
```
