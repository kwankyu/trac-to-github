...
```json
{
    ...
    "subject": "https://github.com/hemmecke",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6652#event-80052"
}
```
...
```json
{
    ...
    "subject": "https://github.com/hemmecke",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6652#event-80053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6652#event-80054"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6652#event-80055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6652#event-80056"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6652#event-80057"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6652#issuecomment-46496",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6652#event-80058"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6652",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6652#event-80059"
}
```
