...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6674#event-80366"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6674#event-80367"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6674#event-80368"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6674#event-80369"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6674#event-80370"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6674#event-80371"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6674#event-80372"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6674",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6674#event-80373"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6674#issuecomment-46763",
    "user": "https://github.com/sagetrac-mvngu"
}
```
