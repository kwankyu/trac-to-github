...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6296#event-74971"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6296#event-74972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6296#event-74973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6296#event-74974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6296#event-74975"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6296#event-74976"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6296",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6296#event-74977"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6296",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6296#issuecomment-41843",
    "user": "https://github.com/qed777"
}
```
