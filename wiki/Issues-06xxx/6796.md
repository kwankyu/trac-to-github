...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6796#event-81840"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6796#event-81841"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6796#event-81842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6796#event-81843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6796#event-81844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6796",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6796#issuecomment-47996",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6796",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6796#event-81845"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6796#event-81846"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6796#event-81847"
}
```
