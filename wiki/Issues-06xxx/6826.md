...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-82255"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-82256"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-82257"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-82258"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-82259"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-82260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-82261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6826",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6826#event-82262"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6826",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6826#issuecomment-48334",
    "user": "https://github.com/sagetrac-mvngu"
}
```
