...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6710#event-80804"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6710#event-80805"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6710#event-80806"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6710#event-80807"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6710#event-80808"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6710#event-80809"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6710",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6710#issuecomment-47033",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6710#event-80810"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6710",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6710#event-80811"
}
```
