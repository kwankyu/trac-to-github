...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80374"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80375"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80376"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80377"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80378"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6675",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6675#event-80379"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6675#issuecomment-46766",
    "user": "https://github.com/sagetrac-mvngu"
}
```
