...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6129#event-39953"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6129#event-39954"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6129",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6129#event-39955"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6129",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6129#issuecomment-41876",
    "user": "https://github.com/mwhansen"
}
```
