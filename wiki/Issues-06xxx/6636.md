...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6636#event-79818"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6636#event-79819"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6636#event-79820"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6636#event-79821"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6636#event-79822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6636#event-79823"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6636",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6636#issuecomment-46228",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6636#event-79824"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6636",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6636#event-79825"
}
```
