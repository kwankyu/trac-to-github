...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6820#event-82182"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6820#event-82183"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6820#event-82184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6820#event-82185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6820#event-82186"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6820#event-82187"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6820#event-82188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6820",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6820#event-82189"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6820",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6820#issuecomment-48273",
    "user": "https://github.com/mwhansen"
}
```
