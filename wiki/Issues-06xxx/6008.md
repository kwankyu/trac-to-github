...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6008",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6008#event-71461"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6008",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6008#event-71462"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6008#event-71463"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6008#event-71464"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6008#event-71465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6008#event-71466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6008",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6008#event-71467"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6008",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6008#issuecomment-39240",
    "user": "https://github.com/loefflerd"
}
```
