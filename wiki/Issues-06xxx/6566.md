...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6566#event-78857"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6566#event-78858"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6566#event-78859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6566#event-78860"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6566#event-78861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6566#event-78862"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6566",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6566#issuecomment-45368",
    "user": "https://github.com/tscholl2"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6566#event-78863"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6566",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6566#event-78864"
}
```
