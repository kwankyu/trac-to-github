...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6385#event-76337"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6385#event-76338"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6385#event-76339"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6385#issuecomment-42798",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6385#event-76340"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6385#event-76341"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6385#event-76342"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6385",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6385#event-76343"
}
```
