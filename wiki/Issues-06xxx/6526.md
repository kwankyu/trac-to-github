...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6526#event-78344"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6526#event-78345"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6526#event-78346"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6526#event-78347"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6526#event-78348"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6526#event-78349"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6526#event-78350"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6526",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6526#event-78351"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6526#issuecomment-45008",
    "user": "https://github.com/sagetrac-mvngu"
}
```
