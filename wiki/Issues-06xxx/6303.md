...
```json
{
    ...
    "title_was": "sage-4.0.2.rc0 test failure",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6303#event-75069"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6303#event-75070"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6303#event-75071"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6303#event-75072"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6303#event-75073"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6303#event-75074"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6303",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6303#event-75075"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6303",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6303#issuecomment-41910",
