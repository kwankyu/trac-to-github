...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6612#event-79514"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6612#event-79515"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6612#event-79516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6612#event-79517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6612#event-79518"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6612#event-79519"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6612#issuecomment-45959",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6612#event-79520"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6612",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6612#event-79521"
}
```
