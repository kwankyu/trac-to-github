...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-43870"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac_6613-test-case.patch](https://github.com/sagemath/sage/files/ticket6613/trac_6613-test-case.patch)",
    "created_at": "2009-07-24T14:39:45Z",
    "issue": "https://github.com/sagemath/sage/issues/6613",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-43871"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-43872"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-43873"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6613",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-43874"
}
```
