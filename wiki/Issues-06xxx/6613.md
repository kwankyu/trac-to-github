...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-79524"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-79525"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-79526"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-79527"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-79528"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-79529"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-79530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6613",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6613#event-79531"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6613",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6613#issuecomment-45965",
    "user": "https://github.com/sagetrac-mvngu"
}
```
