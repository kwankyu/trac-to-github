...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6717#event-80871"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6717#event-80872"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6717#event-80873"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6717#event-80874"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6717#event-80875"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6717#event-80876"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6717#event-80877"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6717",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6717#event-80878"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6717",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6717#issuecomment-47068",
    "user": "https://github.com/sagetrac-mvngu"
}
```
