...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6118#event-72944"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6118#event-72945"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6118#event-72946"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6118#event-72947"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6118#event-72948"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6118#event-72949"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6118",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6118#event-72950"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6118",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6118#issuecomment-40380",
    "user": "https://github.com/mwhansen"
}
```
