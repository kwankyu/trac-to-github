...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6506#event-78079"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6506#event-78080"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6506#event-78081"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6506#event-78082"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6506#event-78083"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6506",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6506#event-78084"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6506#event-78085"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6506",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6506#event-78086"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6506",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6506#issuecomment-44782",
    "user": "https://github.com/jdemeyer"
}
```
