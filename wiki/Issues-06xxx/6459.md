...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6459#event-77417"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6459#event-77418"
}
```
...
```json
{
    ...
    "title_was": "make it so control-shift-enter sends a blank line to tinymce",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6459#event-77419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6459#event-77420"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6459",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6459#event-77421"
}
```
...
```json
{
    ...
    "title_was": "[partial positive review] make it so control-shift-enter sends a blank line to tinymce",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6459#event-77422"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6459#event-77423"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6459",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6459#event-77424"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6459#issuecomment-43899",
    "user": "https://github.com/kcrisman"
}
```
