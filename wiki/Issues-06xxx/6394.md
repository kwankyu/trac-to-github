...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6394#event-76492"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6394#event-76493"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6394#event-76494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6394#event-76495"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6394#event-76496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6394#event-76497"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6394",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6394#event-76498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6394",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6394#issuecomment-43068",
    "user": "https://github.com/rlmill"
}
```
