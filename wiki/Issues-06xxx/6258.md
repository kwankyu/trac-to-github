...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6258#event-74547"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6258#event-74548"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6258#event-74549"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6258#event-74550"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6258#event-74551"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6258#issuecomment-41553",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6258#event-74552"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6258",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6258#event-74553"
}
```
