...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6605#event-79433"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6605",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6605#event-79434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6605#event-79435"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6605",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6605#event-79436"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6605#event-79437"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6605#event-79438"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6605",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6605#issuecomment-45904",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6605#event-79439"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6605",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6605#event-79440"
}
```
