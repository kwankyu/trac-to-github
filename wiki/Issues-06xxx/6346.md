...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6346#event-75775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6346#event-75776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6346#event-75777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6346#event-75778"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6346#event-75779"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6346",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6346#issuecomment-42386",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6346#event-75780"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6346",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6346#event-75781"
}
```
