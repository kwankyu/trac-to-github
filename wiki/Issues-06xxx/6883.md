...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6883#event-82992"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6883#event-82993"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6883#event-82994"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6883#event-82995"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6883#event-82996"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6883#event-82997"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6883#event-82998"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6883#event-82999"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6883",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6883#event-83000"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6883#issuecomment-48987",
    "user": "https://github.com/sagetrac-mvngu"
}
```
