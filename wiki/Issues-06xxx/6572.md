...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6572#event-78954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6572#event-78955"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6572#event-78956"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6572#event-78957"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6572#event-78958"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6572#event-78959"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6572#event-78960"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6572",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6572#event-78961"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6572",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6572#issuecomment-45482",
    "user": "https://github.com/mwhansen"
}
```
