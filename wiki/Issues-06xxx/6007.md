...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6007#event-71447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6007#event-71448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6007#event-71449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6007#event-71450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6007#event-71451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6007",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6007#issuecomment-39230",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6007#event-71452"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6007",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6007#event-71453"
}
```
