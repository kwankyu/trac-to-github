...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6203#event-73921"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6203#event-73922"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6203#event-73923"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6203#event-73924"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6203#event-73925"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6203#event-73926"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6203",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6203#event-73927"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6203",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6203#issuecomment-41109",
    "user": "https://github.com/mwhansen"
}
```
