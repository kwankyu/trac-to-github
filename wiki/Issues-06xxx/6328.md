...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6328#event-75472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6328#event-75473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6328#event-75474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6328#event-75475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6328#event-75476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6328#event-75477"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6328",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6328#event-75478"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6328#issuecomment-42146",
    "user": "https://github.com/sagetrac-mvngu"
}
```
