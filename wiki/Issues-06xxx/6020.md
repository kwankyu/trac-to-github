...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket6020/trac-6020.patch",
    "created_at": "2009-05-11T17:00:36Z",
    "issue": "https://github.com/sagemath/sage/issues/6020",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6020/trac-6020.patch",
...
```json
{
    "body": "**Attachment:** [trac-6020.patch](https://github.com/sagemath/sage/files/ticket6020/trac-6020.patch)",
    "created_at": "2009-05-11T17:00:36Z",
    "issue": "https://github.com/sagemath/sage/issues/6020",
    "type": "issue_comment",
...
**Attachment:** [trac-6020.patch](https://github.com/sagemath/sage/files/ticket6020/trac-6020.patch)
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39083"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39084"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39085"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39086"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39087"
}
```
...
```json
{
    ...
    "milestone": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39088"
}
```
...
```json
{
    ...
    "milestone": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39089"
}
```
...
```json
{
    ...
    "milestone": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39090"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39091"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39092"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39093"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39094"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39095"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39096"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39097"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6020",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-39099"
}
```
