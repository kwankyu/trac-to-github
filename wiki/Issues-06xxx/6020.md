...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-71629"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-71630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-71631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-71632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-71633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6020",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6020#issuecomment-39369",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-71634"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6020",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6020#event-71635"
}
```
