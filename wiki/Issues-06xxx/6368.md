...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-76083"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-76084"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-76085"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-76086"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-76087"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-76088"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6368",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6368#event-76089"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6368#issuecomment-42597",
    "user": "https://github.com/qed777"
}
```
