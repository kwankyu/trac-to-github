...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6241#event-74348"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6241#event-74349"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6241#event-74350"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6241#event-74351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6241#event-74352"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6241#event-74353"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6241",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6241#event-74354"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6241#issuecomment-41419",
    "user": "https://github.com/craigcitro"
}
```
