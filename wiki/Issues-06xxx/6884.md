...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6884#event-83001"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6884#event-83002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6884#event-83003"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6884#event-83004"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6884#event-83005"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6884#event-83006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6884#event-83007"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6884",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6884#event-83008"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6884",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6884#issuecomment-48994",
    "user": "https://github.com/sagetrac-mvngu"
}
```
