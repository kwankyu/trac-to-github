...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6140#event-73198"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6140#event-73199"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6140#event-73200"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6140#event-73201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6140#event-73202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6140#event-73203"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6140",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6140#event-73204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6140",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6140#issuecomment-40526",
    "user": "https://github.com/craigcitro"
}
```
