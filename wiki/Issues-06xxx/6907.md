...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6907#event-83269"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6907#event-83270"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6907#event-83271"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6907#event-83272"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6907#event-83273"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6907#event-83274"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6907",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6907#event-83275"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6907",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6907#issuecomment-49178",
    "user": "https://github.com/jasongrout"
}
```
