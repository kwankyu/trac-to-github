...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6966#event-84035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6966#event-84036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6966#event-84037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6966#event-84038"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6966#event-84039"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6966#event-84040"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6966",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6966#event-84041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6966#event-84042"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6966",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6966#event-84043"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6966",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6966#issuecomment-49796",
    "user": "https://github.com/sagetrac-mvngu"
}
```
