...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-81768"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-81769"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-81770"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-81771"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-81772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-81773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6789#issuecomment-47979",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-81774"
}
```
