...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-45236"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6789#issuecomment-49538",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-45237"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-45238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6789#issuecomment-49539",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6789#event-45239"
}
```
