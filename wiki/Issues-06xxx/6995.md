...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6995#event-84402"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6995#event-84403"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6995#event-84404"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6995#event-84405"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6995#event-84406"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6995#event-84407"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6995",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6995#event-84408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6995#issuecomment-50041",
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6995#event-84409"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6995#event-84410"
}
```
