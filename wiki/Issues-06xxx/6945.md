...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6945#event-83769"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6945#event-83770"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6945#event-83771"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6945#event-83772"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6945#event-83773"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6945#event-83774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6945#event-83775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6945#event-83776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6945",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6945#event-83777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6945",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6945#issuecomment-49565",
    "user": "https://github.com/sagetrac-mvngu"
}
```
