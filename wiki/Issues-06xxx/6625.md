...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6625#event-79687"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6625#event-79688"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6625#event-79689"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6625#event-79690"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6625#event-79691"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6625#event-79692"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6625#event-79693"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6625#event-79694"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6625",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6625#issuecomment-46107",
    "user": "https://github.com/sagetrac-mvngu"
}
```
