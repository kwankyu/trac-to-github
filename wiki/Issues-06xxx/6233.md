...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6233#event-40574"
}
```
...
```json
{
    ...
    "milestone": "sage-4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6233#event-40575"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6233#event-40576"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6233#event-40577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6233",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6233#event-40578"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6233#event-40579"
}
```
