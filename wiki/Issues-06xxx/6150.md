...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6150#event-73298"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6150#event-73299"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6150#event-73300"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6150#event-73301"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6150#event-73302"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6150#event-73303"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6150",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6150#event-73304"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6150",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6150#issuecomment-40583",
    "user": "https://github.com/loefflerd"
}
```
