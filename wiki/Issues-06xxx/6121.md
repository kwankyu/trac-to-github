...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6121#event-39904"
}
```
...
```json
{
    "body": "**Attachment:** [6121-nested-pickle-meta.patch](https://github.com/sagemath/sage/files/ticket6121/6121-nested-pickle-meta.patch)",
    "created_at": "2009-06-10T09:04:06Z",
    "issue": "https://github.com/sagemath/sage/issues/6121",
    "type": "issue_comment",
...
**Attachment:** [6121-nested-pickle-meta.patch](https://github.com/sagemath/sage/files/ticket6121/6121-nested-pickle-meta.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6121#event-39905"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6121#event-39906"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6121#event-39907"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6121#event-39908"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6121#event-39909"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6121#event-39910"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6121",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6121#event-39911"
}
```
