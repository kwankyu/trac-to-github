...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6170#event-73510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6170#event-73511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6170#event-73512"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6170#event-73513"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6170#event-73514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6170",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6170#issuecomment-40718",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6170#event-73515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6170",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6170#event-73516"
}
```
