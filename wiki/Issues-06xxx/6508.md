...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6508#event-78099"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6508#event-78100"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6508#event-78101"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6508#event-78102"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6508#event-78103"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6508",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6508#event-78104"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6508",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6508#issuecomment-44797",
    "user": "https://github.com/sagetrac-mvngu"
}
```
