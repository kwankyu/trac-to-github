...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-77120"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-77121"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-77122"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-77123"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-77124"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-77125"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6445",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-77126"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6445",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6445#issuecomment-43486",
    "user": "https://github.com/sagetrac-mvngu"
}
```
