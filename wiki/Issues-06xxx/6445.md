...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-42348"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-42349"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-42350"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-42351"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6445",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6445#event-42352"
}
```
