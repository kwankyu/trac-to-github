...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6962#event-83992"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6962#event-83993"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6962#event-83994"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6962#event-83995"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6962#event-83996"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6962#event-83997"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6962",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6962#event-83998"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6962#issuecomment-49759",
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6962#event-83999"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6962#event-84000"
}
```
