...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6901#event-83192"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6901#event-83193"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6901#event-83194"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6901#event-83195"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6901#event-83196"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6901#event-83197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6901#event-83198"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6901#event-83199"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6901",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6901#event-83200"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6901",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6901#issuecomment-49127",
    "user": "https://github.com/sagetrac-mvngu"
}
```
