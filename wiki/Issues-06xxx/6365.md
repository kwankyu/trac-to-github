...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6365#event-76043"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6365#event-76044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6365#event-76045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6365#event-76046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6365#event-76047"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6365#event-76048"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6365",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6365#event-76049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6365#issuecomment-42583",
    "user": "https://github.com/jdemeyer"
}
```
