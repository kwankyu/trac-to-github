...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6538#event-78476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6538#event-78477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6538#event-78478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6538#event-78479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6538#event-78480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6538#event-78481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6538#event-78482"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6538",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6538#event-78483"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6538",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6538#issuecomment-45105",
    "user": "https://github.com/nthiery"
}
```
