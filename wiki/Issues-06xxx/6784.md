...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6784#event-45204"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6784#event-45205"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6784#event-45206"
}
```
...
```json
{
    "body": "**Attachment:** [trac_6784.patch](https://github.com/sagemath/sage/files/ticket6784/trac_6784.patch)\n\napply after spkg's at #6564 and #6699",
    "created_at": "2009-08-20T23:35:21Z",
    "issue": "https://github.com/sagemath/sage/issues/6784",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6784#issuecomment-49512",
    "user": "https://github.com/aghitza"
}
```

**Attachment:** [trac_6784.patch](https://github.com/sagemath/sage/files/ticket6784/trac_6784.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6784#event-45207"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6784",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6784#issuecomment-49513",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6784#event-45208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6784",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6784#event-45209"
}
```
