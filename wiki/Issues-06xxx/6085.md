...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6085#event-72444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6085#event-72445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6085#event-72446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6085#event-72447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6085#event-72448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6085#event-72449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6085",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6085#event-72450"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6085",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6085#issuecomment-39935",
    "user": "https://github.com/rlmill"
}
```
