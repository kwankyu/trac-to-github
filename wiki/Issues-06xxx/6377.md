...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6377#event-76216"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6377#event-76217"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6377#event-76218"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6377",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6377#event-76219"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6377#event-76220"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6377#event-76221"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6377",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6377#event-76222"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6377#issuecomment-42709",
    "user": "https://github.com/sagetrac-mvngu"
}
```
