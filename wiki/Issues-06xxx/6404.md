...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6404#event-76595"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6404#event-76596"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6404#event-76597"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6404#event-76598"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6404#event-76599"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6404#event-76600"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6404",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6404#event-76601"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6404",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6404#issuecomment-43137",
    "user": "https://github.com/sagetrac-mvngu"
}
```
