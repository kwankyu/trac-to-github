...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6270#event-74704"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6270#event-74705"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6270#event-74706"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6270#event-74707"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6270#event-74708"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6270",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6270#issuecomment-41682",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6270#event-74709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6270",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6270#event-74710"
}
```
