...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6574#event-78976"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6574#event-78977"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6574#event-78978"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6574#event-78979"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6574",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6574#issuecomment-45497",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6574#event-78980"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6574",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6574#event-78981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6574#event-78982"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6574",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6574#event-78983"
}
```
