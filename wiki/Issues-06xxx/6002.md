...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6002#event-71367"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6002#event-71368"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6002#event-71369"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6002#event-71370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6002",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6002#event-71371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6002",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6002#issuecomment-39194",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6002#event-71372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6002#event-71373"
}
```
