...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6825#event-82246"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6825#event-82247"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6825#event-82248"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6825#event-82249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6825#event-82250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6825#event-82251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6825#event-82252"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6825",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6825#event-82253"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6825",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6825#issuecomment-48325",
    "user": "https://github.com/mwhansen"
}
```
