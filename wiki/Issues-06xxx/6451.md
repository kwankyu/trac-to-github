...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6451#event-77205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6451#event-77206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6451#event-77207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6451#event-77208"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6451#event-77209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6451#event-77210"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6451",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6451#event-77211"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6451#issuecomment-43586",
    "user": "https://github.com/sagetrac-mvngu"
}
```
