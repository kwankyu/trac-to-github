...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6835#event-82348"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6835#event-82349"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6835#event-82350"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6835#event-82351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6835#event-82352"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6835#event-82353"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6835#issuecomment-48399",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6835#event-82354"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6835",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6835#event-82355"
}
```
