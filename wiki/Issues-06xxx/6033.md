...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6033#event-71801"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6033#event-71802"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6033#event-71803"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6033#event-71804"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6033#event-71805"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6033#event-71806"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6033",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6033#event-71807"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6033",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6033#issuecomment-39468",
    "user": "https://github.com/mwhansen"
}
```
