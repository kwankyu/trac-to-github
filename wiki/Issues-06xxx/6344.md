...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41510"
}
```
...
```json
{
    ...
    "milestone": "sage-4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41511"
}
```
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [trac_6344-mma_style_attempt.patch](https://github.com/sagemath/sage/files/ticket6344/trac_6344-mma_style_attempt.patch)\n\n[attachment:trac_6344-mma_style_attempt.patch](https://github.com/sagemath/sage/files/ticket6344/trac_6344-mma_style_attempt.patch) implements an approximation to MMA style. It is just for testing, needs much more work for inclusion.\n\nIt doesn't look good in text only mode:\n\n```\nsage: f = function('f')\nsage: f(x).derivative(x,3)\nf^{(3)}(x)\n```",
    "created_at": "2009-06-24T21:49:13Z",
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41512"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41513"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41514"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43826",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "**Attachment:** [trac_6344-symbolic_derivative_print.patch](https://github.com/sagemath/sage/files/ticket6344/trac_6344-symbolic_derivative_print.patch)\n\nchange printing of symbolic derivatives",
    "created_at": "2009-07-14T21:39:39Z",
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43827",
    "user": "https://github.com/burcin"
}
```

**Attachment:** [trac_6344-symbolic_derivative_print.patch](https://github.com/sagemath/sage/files/ticket6344/trac_6344-symbolic_derivative_print.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43828",
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41516"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41517"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41518"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41519"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41520"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43829",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41521"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41522"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41523"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41524"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43830",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43831",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43832",
    "user": "https://trac.sagemath.org/admin/accounts/users/schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43833",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43834",
    "user": "https://trac.sagemath.org/admin/accounts/users/schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43835",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43836",
    "user": "https://trac.sagemath.org/admin/accounts/users/schymans"
}
```
...
```json
{
    "body": "<a id='comment:21'></a>\nWow, after reading the threads in question I see that at this point Sage has existed about as long with this new format as it did with the previous one.  I'm reluctant to make this wontfix, at least the *option* as indicated there\n\n```\npsi(x) = function('psi',x)\ng = diff(psi(x),x)\nlatex(g)\n\\frac{d \\psi\\left(x\\right)}{d x}\n\n# Switch to D format\nsage.symbolic.pynac.typeset_d_as_diff=False\n\nlatex(g)\nD[0]\\psi\\left(x\\right)\n```\nshould exist, except of course the other way around for the default nowadays, I guess.  Maybe that piece of [attachment:enhanced-symbolic-typesetting-rebased_to_4.0.1.patch:ticket:5711](https://github.com/sagemath/sage/files/ticket6344/df33a427cb69b97cdd997841d5cc30e3.patch:ticket:5711) should be implemented here instead?",
    "created_at": "2014-12-05T04:11:42Z",
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43837",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43838",
    "user": "https://trac.sagemath.org/admin/accounts/users/schymans"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43839",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43840",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43841",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43842",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43843",
    "user": "https://github.com/nbruin"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41525"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41526"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41527"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41528"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41529"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41530"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6344#issuecomment-43844",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41531"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6344",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6344#event-41532"
}
```
