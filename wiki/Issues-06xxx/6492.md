...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6492#event-77820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6492",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6492#event-77821"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6492",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6492#event-77822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6492#event-77823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6492#event-77824"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6492#event-77825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6492#event-77826"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6492",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6492#event-77827"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6492#issuecomment-44260",
    "user": "https://github.com/rlmill"
}
```
