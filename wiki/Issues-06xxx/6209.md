...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6209#event-74000"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6209#event-74001"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6209#event-74002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6209#event-74003"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6209#event-74004"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6209#event-74005"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6209",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6209#event-74006"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6209",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6209#issuecomment-41158",
    "user": "https://github.com/mwhansen"
}
```
