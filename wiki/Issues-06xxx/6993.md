...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6993#event-84373"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6993#event-84374"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6993#event-84375"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6993#event-84376"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6993#event-84377"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6993",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6993#event-84378"
}
```
...
```json
{
    ...
    "title_was": "[with package] update pynac to 0.1.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6993#event-84379"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6993#event-84380"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6993",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6993#event-84381"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6993",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6993#issuecomment-50026",
    "user": "https://github.com/sagetrac-mvngu"
}
```
