...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6983#event-84250"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6983#event-84251"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6983#event-84252"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6983#event-84253"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6983#event-84254"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6983#event-84255"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6983#event-84256"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6983",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6983#event-84257"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6983",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6983#issuecomment-49933",
    "user": "https://github.com/williamstein"
}
```
