...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6746#event-81180"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6746#event-81181"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6746#event-81182"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6746#event-81183"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6746",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6746#issuecomment-47549",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6746",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6746#event-81184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6746#event-81185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6746#event-81186"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6746#event-81187"
}
```
