...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6122#event-39912"
}
```
...
```json
{
    ...
    "asset_name": "no-nodetex.patch",
    "asset_url": "tarball://root/attachments/ticket6122/no-nodetex.patch",
    "created_at": "2009-05-31T00:49:15Z",
    "issue": "https://github.com/sagemath/sage/issues/6122",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket6122/no-nodetex.patch",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6122#event-39913"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6122",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6122#event-39914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6122#issuecomment-41837",
    "user": "https://trac.sagemath.org/admin/accounts/users/mvngu"
}
```
