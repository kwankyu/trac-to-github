...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6122#event-72990"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6122#event-72991"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6122#event-72992"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6122#event-72993"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6122#event-72994"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6122#event-72995"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6122",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6122#event-72996"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6122",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6122#issuecomment-40420",
    "user": "https://github.com/sagetrac-mvngu"
}
```
