...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6036#event-71845"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6036#event-71846"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6036#event-71847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6036#event-71848"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6036",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6036#event-71849"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6036#event-71850"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6036#event-71851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6036",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6036#issuecomment-39504",
    "user": "https://github.com/loefflerd"
}
```
