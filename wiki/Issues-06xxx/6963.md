...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6963#event-84001"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6963#event-84002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6963#event-84003"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6963#event-84004"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6963#event-84005"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6963#event-84006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6963#event-84007"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6963#event-84008"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6963",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6963#event-84009"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6963",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6963#issuecomment-49770",
    "user": "https://github.com/sagetrac-mvngu"
}
```
