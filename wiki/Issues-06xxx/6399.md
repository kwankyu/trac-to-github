...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6399#event-76543"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6399#event-76544"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6399#event-76545"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6399#event-76546"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6399#event-76547"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6399#event-76548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6399",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6399#event-76549"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6399",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6399#issuecomment-43102",
    "user": "https://github.com/rlmill"
}
```
