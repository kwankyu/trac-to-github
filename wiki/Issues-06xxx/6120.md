...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6120#event-72970"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6120#event-72971"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6120#event-72972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6120#event-72973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6120#event-72974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6120#event-72975"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6120",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6120#event-72976"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6120",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6120#issuecomment-40402",
    "user": "https://github.com/mwhansen"
}
```
