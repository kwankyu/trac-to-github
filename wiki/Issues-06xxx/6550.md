...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6550#event-78629"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6550#event-78630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6550#event-78631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6550#event-78632"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6550#issuecomment-45212",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6550#event-78633"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6550#event-78634"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6550#event-78635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6550",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6550#event-78636"
}
```
