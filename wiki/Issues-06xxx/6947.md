...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6947#event-83787"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6947#event-83788"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6947#event-83789"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6947#event-83790"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6947#event-83791"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6947#event-83792"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6947#event-83793"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6947#event-83794"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6947",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6947#event-83795"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6947",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6947#issuecomment-49583",
    "user": "https://github.com/sagetrac-mvngu"
}
```
