...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6829#event-82294"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6829#event-82295"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6829#event-82296"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6829#event-82297"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6829#event-82298"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6829#event-82299"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6829#event-82300"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6829",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6829#event-82301"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6829",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6829#issuecomment-48359",
    "user": "https://github.com/sagetrac-mvngu"
}
```
