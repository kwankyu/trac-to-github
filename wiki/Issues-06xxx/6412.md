...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6412#event-76698"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6412#event-76699"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6412#event-76700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6412#event-76701"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6412#event-76702"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6412#event-76703"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6412",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6412#event-76704"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6412",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6412#issuecomment-43191",
    "user": "https://github.com/sagetrac-mvngu"
}
```
