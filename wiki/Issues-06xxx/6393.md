...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6393#event-76480"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6393#event-76481"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6393#event-76482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6393#event-76483"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6393#event-76484"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6393#event-76485"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6393",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6393#event-76486"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6393",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6393#issuecomment-43063",
    "user": "https://github.com/sagetrac-mvngu"
}
```
