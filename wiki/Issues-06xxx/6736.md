...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6736#event-81048"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6736#event-81049"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6736#event-81050"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6736#event-81051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6736#event-81052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6736#event-81053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6736#event-81054"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6736",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6736#event-81055"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6736",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6736#issuecomment-47180",
    "user": "https://github.com/sagetrac-mvngu"
}
```
