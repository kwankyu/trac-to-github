...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6964#event-84012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6964#event-84013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6964#event-84014"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6964#event-84015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6964#event-84016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6964#event-84017"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6964",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6964#event-84018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6964#event-84019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6964",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6964#event-84020"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6964",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6964#issuecomment-49781",
    "user": "https://github.com/sagetrac-mvngu"
}
```
