...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6972#event-84099"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6972#event-84100"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6972#event-84101"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6972#event-84102"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6972#event-84103"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6972#event-84104"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6972#event-84105"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6972#event-84106"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6972",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6972#event-84107"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6972#issuecomment-49839",
    "user": "https://github.com/sagetrac-mvngu"
}
```
