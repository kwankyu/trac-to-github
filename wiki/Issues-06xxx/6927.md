...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-83529"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-83530"
}
```
...
```json
{
    ...
    "title_was": "extend CachedFunction to handle disk-cache",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-83531"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-83532"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-83533"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-83534"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-83535"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-83536"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6927",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6927#event-83537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6927",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6927#issuecomment-49388",
    "user": "https://github.com/boothby"
}
```
