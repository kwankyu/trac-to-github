...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6039#event-71873"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6039#event-71874"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6039#event-71875"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6039#event-71876"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6039#event-71877"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6039",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6039#issuecomment-39516",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6039#event-71878"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6039",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6039#event-71879"
}
```
