...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6352#event-75851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6352#event-75852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6352#event-75853"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6352#event-75854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6352#event-75855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6352#event-75856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6352",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6352#event-75857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6352",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6352#issuecomment-42439",
    "user": "https://github.com/maxthemouse"
}
```
