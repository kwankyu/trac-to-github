...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6013#event-71520"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6013#event-71521"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6013#event-71522"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6013#event-71523"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6013",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6013#event-71524"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6013#event-71525"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6013#event-71526"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6013",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6013#issuecomment-39271",
    "user": "https://github.com/loefflerd"
}
```
