...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6776#event-81588"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6776#event-81589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6776#event-81590"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6776#event-81591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6776#event-81592"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6776#event-81593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6776#event-81594"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6776",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6776#event-81595"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6776",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6776#issuecomment-47872",
    "user": "https://github.com/sagetrac-mvngu"
}
```
