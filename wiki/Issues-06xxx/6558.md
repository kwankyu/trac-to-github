...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6558#event-78731"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6558#event-78732"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6558#event-78733"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6558#event-78734"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6558#event-78735"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6558",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6558#event-78736"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6558#event-78737"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6558",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6558#event-78738"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6558",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6558#issuecomment-45280",
    "user": "https://github.com/sagetrac-mvngu"
}
```
