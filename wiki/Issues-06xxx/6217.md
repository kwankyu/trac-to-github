...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6217#event-74098"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6217#event-74099"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6217#event-74100"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6217#event-74101"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6217#event-74102"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6217#event-74103"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6217",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6217#event-74104"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6217#issuecomment-41212",
    "user": "https://github.com/mwhansen"
}
```
