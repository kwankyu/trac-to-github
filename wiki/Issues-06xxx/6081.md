...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6081#event-72381"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6081#event-72382"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6081#event-72383"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6081#event-72384"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6081#event-72385"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6081#event-72386"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6081",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6081#event-72387"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6081#issuecomment-39848",
    "user": "https://github.com/nthiery"
}
```
