...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6373#event-76175"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6373#event-76176"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6373#event-76177"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6373#event-76178"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6373#event-76179"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6373#event-76180"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6373",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6373#event-76181"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6373#issuecomment-42689",
    "user": "https://github.com/sagetrac-mvngu"
}
```
