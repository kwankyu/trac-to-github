...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6162#event-73417"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6162#event-73418"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6162#event-73419"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6162#event-73420"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6162#event-73421"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6162#event-73422"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6162",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6162#event-73423"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6162",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6162#issuecomment-40647",
    "user": "https://github.com/sagetrac-mvngu"
}
```
