...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6892#event-83089"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6892#event-83090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6892#event-83091"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6892#event-83092"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6892#event-83093"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6892#event-83094"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6892#event-83095"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6892#event-83096"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6892",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6892#event-83097"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6892",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6892#issuecomment-49050",
    "user": "https://github.com/mwhansen"
}
```
