...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6908#event-83276"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6908#event-83277"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6908#event-83278"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6908#event-83279"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6908#event-83280"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6908#event-83281"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6908#event-83282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6908#event-83283"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6908",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6908#event-83284"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6908",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6908#issuecomment-49189",
    "user": "https://github.com/sagetrac-mvngu"
}
```
