...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6091#event-72528"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6091#event-72529"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6091#event-72530"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6091#event-72531"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6091#event-72532"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6091#event-72533"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6091#event-72534"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6091#issuecomment-39986",
    "user": "https://github.com/mwhansen"
}
```
