...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6909#event-83289"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6909#event-83290"
}
```
...
```json
{
    ...
    "title_was": "No title",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6909#event-83291"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6909#event-83292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6909#event-83293"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6909#event-83294"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6909#event-83295"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6909#event-83296"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6909",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6909#event-83297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6909#issuecomment-49195",
