...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6740#event-81093"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6740#event-81094"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6740#event-81095"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6740#event-81096"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6740#event-81097"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6740#event-81098"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6740#event-81099"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6740",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6740#event-81100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6740",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6740#issuecomment-47203",
    "user": "https://github.com/fredrik-johansson"
}
```
