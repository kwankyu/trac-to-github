...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6579#event-79030"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6579#event-79031"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6579#event-79032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6579#event-79033"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6579#event-79034"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6579#event-79035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6579#event-79036"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6579",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6579#event-79037"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6579",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6579#issuecomment-45525",
    "user": "https://github.com/mwhansen"
}
```
