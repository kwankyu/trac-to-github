...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6141#event-73207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6141#event-73208"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6141#event-73209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6141#event-73210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6141#event-73211"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6141#event-73212"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6141",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6141#event-73213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6141",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6141#issuecomment-40532",
    "user": "https://github.com/sagetrac-mvngu"
}
```
