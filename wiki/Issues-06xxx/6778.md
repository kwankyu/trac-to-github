...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6778#event-81609"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6778#event-81610"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6778#event-81611"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6778#event-81612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6778#event-81613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6778#event-81614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6778#event-81615"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6778",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6778#event-81616"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6778",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6778#issuecomment-47886",
    "user": "https://github.com/sagetrac-mvngu"
}
```
