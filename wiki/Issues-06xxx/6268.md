...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6268#event-74666"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6268#event-74667"
}
```
...
```json
{
    ...
    "subject": "https://github.com/burcin",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6268#event-74668"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6268#event-74669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6268",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6268#event-74670"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6268#event-74671"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6268",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6268#event-74672"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6268#issuecomment-41655",
    "user": "https://github.com/burcin"
}
```
