...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-77732"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-77733"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-77734"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-77735"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-77736"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-77737"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-77738"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6485",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6485#event-77739"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6485#issuecomment-44174",
    "user": "https://github.com/qed777"
}
```
