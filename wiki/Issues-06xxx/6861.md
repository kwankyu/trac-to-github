...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6861#event-82663"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6861#event-82664"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6861#event-82665"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6861#event-82666"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6861#event-82667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6861",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6861#event-82668"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6861#event-82669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6861",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6861#event-82670"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6861",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6861#issuecomment-48679",
    "user": "https://github.com/sagetrac-mvngu"
}
```
