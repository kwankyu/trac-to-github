...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6463#event-77456"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6463#event-77457"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6463#event-77458"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6463#event-77459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6463#event-77460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6463#event-77461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6463#event-77462"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6463",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6463#event-77463"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6463#issuecomment-43928",
    "user": "https://github.com/sagetrac-mvngu"
}
```
