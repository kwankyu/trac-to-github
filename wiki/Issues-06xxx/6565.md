...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6565#event-78839"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6565#event-78840"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6565",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6565#issuecomment-45365",
    "user": "https://github.com/tscholl2"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6565#event-78841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6565#event-78842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6565#event-78843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6565#event-78844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6565#event-78845"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6565",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6565#event-78846"
}
```
