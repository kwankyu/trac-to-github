...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6968#event-84058"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6968#event-84059"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6968#event-84060"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6968#event-84061"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6968#event-84062"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6968#event-84063"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6968#event-84064"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6968#event-84065"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6968",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6968#event-84066"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6968#issuecomment-49815",
    "user": "https://github.com/sagetrac-mvngu"
}
```
