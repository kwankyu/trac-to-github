...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6671#event-80324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6671#event-80325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6671#event-80326"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6671#event-80327"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6671#event-80328"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6671#event-80329"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6671#event-80330"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6671",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6671#event-80331"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6671",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6671#issuecomment-46717",
    "user": "https://github.com/jhpalmieri"
}
```
