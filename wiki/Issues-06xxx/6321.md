...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6321#event-75349"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6321",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6321#issuecomment-42071",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6321#event-75350"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6321#event-75351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6321#event-75352"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6321#event-75353"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6321#event-75354"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6321",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6321#event-75355"
}
```
