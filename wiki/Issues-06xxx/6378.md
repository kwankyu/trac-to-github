...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-76235"
}
```
...
```json
{
    ...
    "title_was": "make sage -merge more user-friendly",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-76236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-76237"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-76238"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-76239"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-76240"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6378#event-76241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6378#issuecomment-42738",
    "user": "https://github.com/jdemeyer"
}
```
