...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6192#event-73774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6192#event-73775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6192#event-73776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6192#event-73777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6192",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6192#event-73778"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6192#event-73779"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6192",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6192#event-73780"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6192",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6192#issuecomment-40988",
    "user": "https://github.com/mwhansen"
}
```
