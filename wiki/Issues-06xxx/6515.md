...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6515#event-78185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6515#event-78186"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6515#event-78187"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6515#event-78188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6515#event-78189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6515#event-78190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6515#issuecomment-44858",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6515#event-78191"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6515",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6515#event-78192"
}
```
