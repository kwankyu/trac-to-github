...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6197#event-73841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6197#event-73842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6197#event-73843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6197#event-73844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6197#event-73845"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6197#event-73846"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6197",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6197#event-73847"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6197#issuecomment-41042",
    "user": "https://github.com/sagetrac-mvngu"
}
```
