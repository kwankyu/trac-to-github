...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6045#event-71972"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6045#event-71973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6045#event-71974"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6045#event-71975"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6045#event-71976"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6045#event-71977"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6045",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6045#event-71978"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6045",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6045#issuecomment-39606",
    "user": "https://github.com/sagetrac-mvngu"
}
```
