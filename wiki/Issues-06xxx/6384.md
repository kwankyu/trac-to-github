...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6384#event-76321"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6384#event-76322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6384#event-76323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6384#event-76324"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6384#event-76325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6384#event-76326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6384",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6384#event-76327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6384#issuecomment-42795",
    "user": "https://github.com/JohnCremona"
}
```
