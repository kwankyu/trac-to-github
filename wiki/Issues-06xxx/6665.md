...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6665#event-80213"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6665#event-80214"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6665#event-80215"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6665#event-80216"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6665#event-80217"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6665#event-80218"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6665#event-80219"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6665",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6665#event-80220"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6665",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6665#issuecomment-46600",
    "user": "https://github.com/mwhansen"
}
```
