...
```json
{
    ...
    "milestone_title": "sage-4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6240#event-74336"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6240#event-74337"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6240#event-74338"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6240#event-74339"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6240",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6240#event-74340"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6240#event-74341"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6240#event-74342"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6240",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6240#issuecomment-41413",
    "user": "https://github.com/jdemeyer"
}
```
