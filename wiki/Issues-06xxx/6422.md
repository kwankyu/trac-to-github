...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6422#event-76843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6422#event-76844"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6422#event-76845"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6422#event-76846"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6422#event-76847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6422#event-76848"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6422",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6422#event-76849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6422",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6422#issuecomment-43258",
    "user": "https://github.com/sagetrac-mvngu"
}
```
