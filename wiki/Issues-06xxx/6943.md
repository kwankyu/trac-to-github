...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6943#event-83747"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6943#event-83748"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6943#event-83749"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6943#event-83750"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6943#event-83751"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6943#event-83752"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6943#event-83753"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6943#event-83754"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6943",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6943#event-83755"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6943",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6943#issuecomment-49551",
    "user": "https://github.com/sagetrac-mvngu"
}
```
