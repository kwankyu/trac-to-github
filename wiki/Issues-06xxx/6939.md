...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6939#event-83695"
}
```
...
```json
{
    ...
    "subject": "https://github.com/jasongrout",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6939#event-83696"
}
```
...
```json
{
    ...
    "subject": "https://github.com/jasongrout",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6939#event-83697"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6939#event-83698"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6939#event-83699"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6939#event-83700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6939#event-83701"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6939#event-83702"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6939",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6939#event-83703"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6939#issuecomment-49519",
    "user": "https://github.com/sagetrac-mvngu"
}
```
