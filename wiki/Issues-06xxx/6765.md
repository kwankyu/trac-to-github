...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6765#event-81455"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6765#event-81456"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6765#event-81457"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6765#event-81458"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6765",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6765#event-81459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6765#event-81460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6765#event-81461"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6765#event-81462"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6765",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6765#issuecomment-47776",
    "user": "https://github.com/sagetrac-mvngu"
}
```
