...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6632#event-79769"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6632#event-79770"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6632#event-79771"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6632#event-79772"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6632#event-79773"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6632#event-79774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6632#event-79775"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6632",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6632#event-79776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6632",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6632#issuecomment-46205",
    "user": "https://github.com/sagetrac-hartke"
}
```
