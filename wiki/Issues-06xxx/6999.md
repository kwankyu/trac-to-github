...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6999#event-84440"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6999#event-84441"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6999#event-84442"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6999#event-84443"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6999#event-84444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6999#event-84445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6999#event-84446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6999#event-84447"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6999",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6999#event-84448"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6999",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6999#issuecomment-50064",
    "user": "https://github.com/sagetrac-mvngu"
}
```
