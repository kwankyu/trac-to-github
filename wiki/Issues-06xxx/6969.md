...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6969#event-84069"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6969#event-84070"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6969#event-84071"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6969#event-84072"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6969#event-84073"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6969#event-84074"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6969",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6969#event-84075"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6969#event-84076"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6969",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6969#event-84077"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6969",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6969#issuecomment-49823",
    "user": "https://github.com/sagetrac-mvngu"
}
```
