...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6151#event-73307"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6151#event-73308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6151#event-73309"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6151#event-73310"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6151#event-73311"
}
```
...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6151#event-73312"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6151",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6151#event-73313"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6151",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6151#issuecomment-40589",
    "user": "https://github.com/williamstein"
}
```
