...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6408#event-76637"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6408#event-76638"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6408#event-76639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6408#event-76640"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6408",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6408#event-76641"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6408#event-76642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6408",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6408#event-76643"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6408",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6408#issuecomment-43159",
    "user": "https://github.com/rlmill"
}
```
