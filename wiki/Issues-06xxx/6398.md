...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6398#event-76531"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6398#event-76532"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6398#event-76533"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6398#event-76534"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6398",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6398#issuecomment-43093",
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6398#event-76535"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6398#event-76536"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6398",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6398#event-76537"
}
```
