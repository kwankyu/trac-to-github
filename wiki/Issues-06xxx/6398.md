...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6398#issuecomment-44574",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6398#event-42001"
}
```
...
```json
{
    ...
    "milestone": "sage-4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6398#event-42002"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6398",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6398#event-42003"
}
```
