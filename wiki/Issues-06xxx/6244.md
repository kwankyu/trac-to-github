...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6244#event-74381"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6244#event-74382"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6244#event-74383"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6244#event-74384"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6244",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6244#event-74385"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6244#event-74386"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6244",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6244#event-74387"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6244",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6244#issuecomment-41438",
    "user": "https://github.com/ncalexan"
}
```
