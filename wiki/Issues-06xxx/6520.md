...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6520#event-78266"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6520#event-78267"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6520#event-78268"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6520#event-78269"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6520",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6520#issuecomment-44942",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6520#event-78270"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6520#event-78271"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6520#event-78272"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6520",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6520#event-78273"
}
```
