...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6392#event-76467"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6392#event-76468"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6392#event-76469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6392#event-76470"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6392#event-76471"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6392#event-76472"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6392",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6392#event-76473"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6392",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6392#issuecomment-43054",
    "user": "https://github.com/vbraun"
}
```
