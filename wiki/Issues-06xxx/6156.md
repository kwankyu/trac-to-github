...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6156#event-73355"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6156#event-73356"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6156#event-73357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6156#event-73358"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6156",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6156#event-73359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6156#event-73360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6156",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6156#event-73361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6156",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6156#issuecomment-40602",
    "user": "https://github.com/sagetrac-mvngu"
}
```
