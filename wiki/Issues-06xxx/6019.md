...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6019#event-71605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6019#event-71606"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6019#event-71607"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6019#event-71608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6019#event-71609"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6019#event-71610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6019",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6019#event-71611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6019#issuecomment-39360",
    "user": "https://github.com/loefflerd"
}
```
