...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6234#event-74260"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6234#event-74261"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6234#event-74262"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6234#event-74263"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6234#event-74264"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6234#event-74265"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6234",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6234#event-74266"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6234",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6234#issuecomment-41315",
    "user": "https://github.com/craigcitro"
}
```
