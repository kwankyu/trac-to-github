...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6715#event-80850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6715#event-80851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6715#event-80852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6715#event-80853"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6715#event-80854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6715#event-80855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6715#event-80856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6715",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6715#event-80857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6715",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6715#issuecomment-47058",
    "user": "https://github.com/sagetrac-mvngu"
}
```
