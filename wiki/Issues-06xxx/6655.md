...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6655#event-80099"
}
```
...
```json
{
    ...
    "subject": "https://github.com/hivert",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6655#event-80100"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6655#event-80101"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6655#event-80102"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6655#event-80103"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6655#event-80104"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6655#event-80105"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6655",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/6655#event-80106"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/6655",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/6655#issuecomment-46530",
    "user": "https://github.com/sagetrac-mvngu"
}
```
