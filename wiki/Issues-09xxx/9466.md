...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9466",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9466#issuecomment-83511",
    "user": "https://github.com/mstreng"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9466#event-70054"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9466#event-70055"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9466#event-70056"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9466#event-70057"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9466#event-70058"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9466#event-70059"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9466",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9466#event-70060"
}
```
