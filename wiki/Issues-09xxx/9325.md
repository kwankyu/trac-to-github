...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-118218"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-118219"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-118220"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-118221"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-118222"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-dpoetzsch",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-118223"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-dpoetzsch",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-118224"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9325#event-118225"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9325#issuecomment-78764",
    "user": "https://github.com/sagetrac-dpoetzsch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9325#issuecomment-78765",
    "user": "https://github.com/sagetrac-dpoetzsch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9325#issuecomment-78766",
    "user": "https://github.com/sagetrac-dpoetzsch"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9325#issuecomment-78767",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9325#issuecomment-78768",
    "user": "https://github.com/nthiery"
}
```
