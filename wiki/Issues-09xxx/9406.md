...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9406#issuecomment-82291",
    "user": "https://trac.sagemath.org/admin/accounts/users/olazo"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-69367"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9406",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-69368"
}
```
