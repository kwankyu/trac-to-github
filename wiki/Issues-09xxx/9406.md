...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-119518"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-119519"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-119520"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-119521"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-119522"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9406",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9406#issuecomment-80404",
    "user": "https://github.com/sagetrac-olazo"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-119523"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-119524"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9406",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9406#event-119525"
}
```
