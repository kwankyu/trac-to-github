...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69017"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69018"
}
```
...
```json
{
    ...
    "milestone": "sage-4.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69019"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69020"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9377#issuecomment-81806",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9377#issuecomment-81807",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9377#issuecomment-81808",
    "user": "https://github.com/kwankyu"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69022"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69023"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9377#issuecomment-81809",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9377#issuecomment-81810",
    "user": "https://trac.sagemath.org/admin/accounts/users/mariah"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69024"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69025"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9377#issuecomment-81811",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9377",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9377#issuecomment-81812",
    "user": "https://github.com/dandrake"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69026"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9377",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9377#event-69027"
}
```
