...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9397#event-69255"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9397#event-69256"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9397#event-69257"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9397#issuecomment-82167",
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9397#event-69258"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9397#event-69259"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9397#issuecomment-82168",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9397",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9397#issuecomment-82169",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "milestone": "sage-4.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9397#event-69260"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9397#event-69261"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9397#event-69262"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9397",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9397#event-69263"
}
```
