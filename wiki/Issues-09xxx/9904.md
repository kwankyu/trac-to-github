...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9904#issuecomment-91250",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9904",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9904#issuecomment-91251",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9904",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-74600"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-74601"
}
```
...
```json
{
    ...
    "milestone": "sage-5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9904#event-74602"
}
```
