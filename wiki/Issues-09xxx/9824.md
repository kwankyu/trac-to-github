...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73839"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73840"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73841"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9824#issuecomment-89600",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9824#issuecomment-89601",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73842"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73843"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73844"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73845"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73846"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73847"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73848"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73849"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73850"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9824#issuecomment-89602",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9824#issuecomment-89603",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73852"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73853"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9824#issuecomment-89604",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9824#issuecomment-89605",
    "user": "https://trac.sagemath.org/admin/accounts/users/captaintrunky"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9824#issuecomment-89606",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9824#issuecomment-89607",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73854"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73855"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73856"
}
```
...
```json
{
    ...
    "milestone": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9824",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9824#issuecomment-89608",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73858"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9824",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9824#event-73859"
}
```
