...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9298#issuecomment-80269",
...
```json
{
    ...
    "milestone": "sage-5.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9298#event-68278"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9298#issuecomment-80270",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9298#issuecomment-80271",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9298#event-68279"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9298#issuecomment-80272",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9298#event-68280"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9298#event-68281"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9298",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9298#issuecomment-80273",
    "user": "https://trac.sagemath.org/admin/accounts/users/Bouillaguet"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9298#event-68282"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9298",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9298#event-68283"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9298#event-68284"
}
```
