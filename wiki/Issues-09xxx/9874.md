...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127010"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127013"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127014"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127015"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127016"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127017"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127018"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127019"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127020"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127021"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9874#issuecomment-88481",
    "user": "https://github.com/sagetrac-ktkohl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9874#issuecomment-88482",
    "user": "https://github.com/sagetrac-ktkohl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9874#issuecomment-88483",
    "user": "https://github.com/sagetrac-ktkohl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9874#issuecomment-88484",
    "user": "https://github.com/sagetrac-ktkohl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9874#issuecomment-88485",
    "user": "https://github.com/sagetrac-ktkohl"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9874",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9874#issuecomment-88486",
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127023"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127024"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9874#event-127025"
}
```
