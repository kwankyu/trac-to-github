...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9630#issuecomment-86075",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9630#issuecomment-86076",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9630#issuecomment-86077",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9630#issuecomment-86078",
...
```json
{
    ...
    "milestone": "sage-4.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9630#event-71709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9630#issuecomment-86079",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9630#event-71710"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9630#event-71711"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9630#event-71712"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9630#event-71713"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9630#event-71714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9630",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9630#event-71715"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9630",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9630#issuecomment-86080",
