...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9233#event-116992"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9233#event-116993"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9233#event-116994"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9233#event-116995"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9233#event-116996"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9233#issuecomment-77456",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9233#issuecomment-77457",
...
```json
{
    ...
    "milestone_title": "sage-4.4.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9233#event-116997"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9233#event-116998"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9233#event-116999"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9233",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9233#event-117000"
}
```
