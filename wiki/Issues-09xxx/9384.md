...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119132"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119133"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119134"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119135"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119136"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119137"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119138"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119139"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9384",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119146"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9384#issuecomment-80035",
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119147"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9384#event-119148"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9384#issuecomment-80036",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9384#issuecomment-80037",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9384#issuecomment-80038",
    "user": "https://github.com/adeines"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9384",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9384#issuecomment-80039",
    "user": "https://github.com/JohnCremona"
}
```
