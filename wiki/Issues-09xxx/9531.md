...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9531#event-121572"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9531#event-121573"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9531#event-121574"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9531#event-121575"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9531#event-121576"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9531",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9531#issuecomment-82514",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.5.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9531#event-121577"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9531",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9531#event-121578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9531",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9531#issuecomment-82515",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9531#event-121579"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9531#event-121580"
}
```
