...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9602#event-71440"
}
```
...
```json
{
    ...
    "milestone": "sage-5.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9602#event-71441"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9602#issuecomment-85613",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9602#issuecomment-85614",
    "user": "https://trac.sagemath.org/admin/accounts/users/stephen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9602#event-71442"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9602#event-71443"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9602",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9602#issuecomment-85615",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9602#event-71444"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9602",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9602#event-71445"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9602#event-71446"
}
```
