...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118777"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118778"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118779"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118780"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118781"
}
```
...
```json
{
    ...
    "subject": "https://github.com/williamstein",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118782"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118783"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9360#issuecomment-79720",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118784"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118785"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9360#issuecomment-79721",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9360#issuecomment-79722",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9360#issuecomment-79723",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118786"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9360",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9360#event-118787"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9360#issuecomment-79724",
    "user": "https://github.com/rlmill"
}
```
