...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73760"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73761"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9817#issuecomment-89529",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "label": "component: porting: aix or hp-ux",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73762"
}
```
...
```json
{
    ...
    "label": "component: porting",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73763"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73764"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73765"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73766"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73767"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73768"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73769"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73770"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73771"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9817#issuecomment-89530",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9817",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9817#issuecomment-89531",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73772"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73773"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73774"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73775"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9817",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9817#event-73777"
}
```
