...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69289"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69290"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69291"
}
```
...
```json
{
    ...
    "asset_name": "trac_9401.patch",
    "asset_url": "tarball://root/attachments/ticket9401/trac_9401.patch",
    "created_at": "2013-08-25T12:45:08Z",
    "issue": "https://github.com/sagemath/sage/issues/9401",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9401/trac_9401.patch",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69292"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69293"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69294"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69295"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69296"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69297"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69298"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69299"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69300"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69301"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9401",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9401#event-69302"
}
```
