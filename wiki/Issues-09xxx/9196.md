...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9196#issuecomment-78724",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9196#event-67382"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9196#event-67383"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9196",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9196#issuecomment-78725",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9196",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9196#issuecomment-78726",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9196",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9196#issuecomment-78727",
    "user": "https://trac.sagemath.org/admin/accounts/users/drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9196",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9196#issuecomment-78728",
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9196#event-67384"
}
```
...
```json
{
    ...
    "milestone": "sage-5.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9196#event-67385"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9196",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9196#event-67386"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9196",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9196#issuecomment-78729",
    "user": "https://github.com/jdemeyer"
}
```
