...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9576#issuecomment-85132",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9576#issuecomment-85133",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9576#issuecomment-85134",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9576#event-71192"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9576#issuecomment-85135",
    "user": "https://trac.sagemath.org/admin/accounts/users/pmenegat"
}
```
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9576#event-71193"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9576#issuecomment-85136",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9576#event-71194"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9576#event-71195"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9576",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9576#issuecomment-85137",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9576#event-71196"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9576",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9576#event-71197"
}
```
