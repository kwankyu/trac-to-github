...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72197"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9677#issuecomment-86818",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72198"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72199"
}
```
...
```json
{
    "body": "**Attachment:** [trac_9677.patch](https://github.com/sagemath/sage/files/ticket9677/trac_9677.patch)",
    "created_at": "2011-12-18T16:09:09Z",
    "issue": "https://github.com/sagemath/sage/issues/9677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9677#issuecomment-86819",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72200"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72201"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9677#issuecomment-86820",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9677#issuecomment-86821",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72202"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72203"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9677#issuecomment-86822",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9677",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9677#issuecomment-86823",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72204"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72205"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72206"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72207"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72208"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72209"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72210"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72211"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9677#event-72212"
}
```
