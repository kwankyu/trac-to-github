...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9415#event-69448"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9415",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9415#event-69449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9415",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9415#issuecomment-82405",
    "user": "https://trac.sagemath.org/admin/accounts/users/rkirov"
}
```
