...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-128698"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-128699"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-128700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-128701"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-128702"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9974#issuecomment-90915",
    "user": "https://github.com/sagetrac-drkirkby"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9974#issuecomment-90916",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9974",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9974#issuecomment-90917",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-128703"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9974",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9974#event-128704"
}
```
