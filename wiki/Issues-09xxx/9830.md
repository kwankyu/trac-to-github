...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9830#event-126392"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9830#event-126393"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9830#event-126394"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9830#event-126395"
}
```
...
```json
{
    ...
    "subject": "https://github.com/qed777",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9830#event-126396"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9830#issuecomment-87785",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9830#issuecomment-87786",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9830",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9830#issuecomment-87787",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9830#event-126397"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9830#event-126398"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9830#event-126399"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9830#event-126400"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9830",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9830#event-126401"
}
```
