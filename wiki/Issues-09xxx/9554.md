...
```json
{
    ...
    "asset_name": "trac_9554-fix_order_of_var_names-SageNB-repo.patch",
    "asset_url": "tarball://root/attachments/ticket9554/trac_9554-fix_order_of_var_names-SageNB-repo.patch",
    "created_at": "2010-07-22T15:40:42Z",
    "issue": "https://github.com/sagemath/sage/issues/9554",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket9554/trac_9554-fix_order_of_var_names-SageNB-repo.patch",
...
```json
{
    "body": "**Attachment:** [trac_9554-fix_order_of_var_names-SageNB-repo.patch](https://github.com/sagemath/sage/files/ticket9554/trac_9554-fix_order_of_var_names-SageNB-repo.patch)\n\nSageNB repo patch - logically same as https://github.com/sagemath/sage/files/ticket8988/trac_8988-sageinspect_doctest_fix.patch",
    "created_at": "2010-07-22T15:40:42Z",
    "issue": "https://github.com/sagemath/sage/issues/9554",
    "type": "issue_comment",
...
**Attachment:** [trac_9554-fix_order_of_var_names-SageNB-repo.patch](https://github.com/sagemath/sage/files/ticket9554/trac_9554-fix_order_of_var_names-SageNB-repo.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9554#event-70958"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9554#event-70959"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9554#event-70960"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9554",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9554#issuecomment-84763",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9554",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9554#issuecomment-84764",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9554",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9554#issuecomment-84765",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9554",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9554#issuecomment-84766",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9554",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9554#issuecomment-84767",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9554#event-70961"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9554",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9554#event-70962"
}
```
