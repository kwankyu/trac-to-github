...
```json
{
    "body": "**Attachment:** [trac_9773-abelian-groups-draft-1.patch](https://github.com/sagemath/sage/files/ticket9773/trac_9773-abelian-groups-draft-1.patch)",
    "created_at": "2010-08-20T23:10:06Z",
    "issue": "https://github.com/sagemath/sage/issues/9773",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73254"
}
```
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73255"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73256"
}
```
...
```json
{
    "body": "**Attachment:** [trac_9773-abelian-groups-draft-5.patch](https://github.com/sagemath/sage/files/ticket9773/trac_9773-abelian-groups-draft-5.patch)",
    "created_at": "2012-07-31T02:54:58Z",
    "issue": "https://github.com/sagemath/sage/issues/9773",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73257"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73258"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73259"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73260"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73261"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73262"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73263"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73264"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9773#event-73265"
}
```
