...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119198"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119199"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119200"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119201"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119203"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119205"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119206"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119207"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119208"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9387#issuecomment-80142",
    "user": "https://github.com/RalphieBoy"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9387#issuecomment-80143",
    "user": "https://github.com/RalphieBoy"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119211"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119212"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9387#issuecomment-80144",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9387#issuecomment-80145",
    "user": "https://github.com/loefflerd"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9387",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9387#issuecomment-80146",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9387",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9387#event-119214"
}
```
