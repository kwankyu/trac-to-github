...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9884#issuecomment-90727",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9884",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9884#issuecomment-90728",
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/9884#event-74380"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9884",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9884#issuecomment-90729",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/9884",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/9884#issuecomment-90730",
    "user": "https://github.com/edgarcosta"
}
```
