...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18368#issuecomment-255203",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18368",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18368#issuecomment-255204",
    "user": "https://github.com/paulmasson"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18368#event-166306"
}
```
...
```json
{
    ...
    "milestone": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18368#event-166307"
}
```
