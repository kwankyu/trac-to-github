...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264074",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264075",
    "user": "https://trac.sagemath.org/admin/accounts/users/jonathan.judge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264076",
    "user": "https://trac.sagemath.org/admin/accounts/users/jonathan.judge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264077",
    "user": "https://trac.sagemath.org/admin/accounts/users/jonathan.judge"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18744#issuecomment-264078",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18744#event-169958"
}
```
