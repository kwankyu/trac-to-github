...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18258#event-165258"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18258",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18258#issuecomment-252910",
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18258#event-165259"
}
```
...
```json
{
    ...
    "milestone": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18258#event-165260"
}
```
