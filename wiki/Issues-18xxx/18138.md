...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18138#issuecomment-250306",
    "user": "https://github.com/rljacobson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18138#issuecomment-250307",
    "user": "https://github.com/rljacobson"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18138#event-164065"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18138#issuecomment-250308",
    "user": "https://github.com/rljacobson"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18138#issuecomment-250309",
...
```json
{
    ...
    "milestone": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18138#event-164066"
}
```
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18138#event-164067"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18138#issuecomment-250310",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18138#event-164068"
}
```
...
```json
{
    ...
    "milestone": "sage-7.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18138#event-164069"
}
```
