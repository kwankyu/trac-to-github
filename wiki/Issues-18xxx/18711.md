...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18711#issuecomment-263416",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18711#issuecomment-263417",
    "user": "https://trac.sagemath.org/admin/accounts/users/rolandog"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18711",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18711#issuecomment-263418",
    "user": "https://trac.sagemath.org/admin/accounts/users/rolandog"
}
```
...
```json
{
    ...
    "milestone": "sage-6.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18711#event-169632"
}
```
