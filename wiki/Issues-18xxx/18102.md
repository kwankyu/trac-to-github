...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18102#event-255184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18102#event-255185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18102#event-255186"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18102#issuecomment-246892",
    "user": "https://github.com/jjermann"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18102#issuecomment-246893",
    "user": "https://github.com/jjermann"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18102#event-255187"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18102#issuecomment-246894",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18102",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18102#issuecomment-246895",
    "user": "https://github.com/jjermann"
}
```
