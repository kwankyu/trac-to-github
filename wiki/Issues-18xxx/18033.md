...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18033#issuecomment-248012",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18033",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18033#issuecomment-248013",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18033",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18033#issuecomment-248014",
...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18033#event-163059"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18033#event-163060"
}
```
...
```json
{
    ...
    "milestone": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/18033#event-163061"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/18033",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/18033#issuecomment-248015",
    "user": "https://github.com/slel"
}
```
