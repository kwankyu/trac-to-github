...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/265#event-966"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/265#event-967"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/265",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/265#event-968"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/265#event-969"
}
```
