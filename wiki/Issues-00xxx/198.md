...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/198#event-665"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/198",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/198#event-666"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/198#event-667"
}
```
