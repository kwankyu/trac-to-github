...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/954#event-4473"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/954#event-4474"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket954/test_gcc_version.pl",
    "created_at": "2007-11-04T01:21:07Z",
    "issue": "https://github.com/sagemath/sage/issues/954",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket954/test_gcc_version.pl",
    "user": "https://trac.sagemath.org/admin/accounts/users/jkantor"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/954#event-4475"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/954#event-4476"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/954#event-4477"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/954",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/954#event-4478"
}
```
