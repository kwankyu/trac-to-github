...
```json
{
    ...
    "milestone": "sage-2.8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/201#event-679"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/201#event-680"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/201",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/201#event-681"
}
```
