...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/667#event-2897"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/667#event-2898"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/667#event-2899"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/667#event-2900"
}
```
...
```json
{
    ...
    "milestone": "sage-3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/667#event-2901"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/667",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/667#event-2902"
}
```
