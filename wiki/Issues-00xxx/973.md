...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/973#event-4556"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/973#event-4557"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/973#event-4558"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/973#event-4559"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/973",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/973#event-4560"
}
```
