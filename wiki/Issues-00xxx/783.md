...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3526",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3607"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3608"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket783/783-dilog_lame.patch",
    "created_at": "2008-04-19T14:41:38Z",
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket783/783-dilog_lame.patch",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3528",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3609"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3529",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3530",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3611"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3612"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3531",
...
```json
{
    ...
    "milestone": "sage-3.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3613"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3614"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3532",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3615"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3616"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3617"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3533",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3534",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label": "needs info",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3618"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3619"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3620"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3621"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3535",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3536",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:12'></a>\nThe function `syntactically_equal()` in [attachment:trac_783.patch](https://github.com/sagemath/sage/files/ticket783/trac_783.patch) doesn't contain doctests. I don't see how the changes to `sage/symbolic/expression.pyx` in that patch are relevant to this ticket. Perhaps these should be on a different ticket.",
    "created_at": "2010-09-12T12:05:39Z",
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3537",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3622"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3623"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3538",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket783/trac_783.patch",
    "created_at": "2010-09-12T17:00:00Z",
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket783/trac_783.patch",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "**Attachment:** [trac_783.patch](https://github.com/sagemath/sage/files/ticket783/trac_783.patch)",
    "created_at": "2010-09-12T17:00:00Z",
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3539",
    "user": "https://github.com/mwhansen"
}
```

**Attachment:** [trac_783.patch](https://github.com/sagemath/sage/files/ticket783/trac_783.patch)
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3624"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3625"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3540",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3541",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/783#issuecomment-3542",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3626"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/783",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/783#event-3627"
}
```
