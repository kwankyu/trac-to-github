...
```json
{
    ...
    "type": "issue",
    "url": "https://github.com/sagemath/sage/issues/98",
...
```json
{
    ...
    "created_at": "2006-09-30T02:19:05Z",
    "event": "renamed",
    "issue": "https://github.com/sagemath/sage/issues/98",
    "rename": {
        "from": "p-adic print_prec does work as advertised",
        "to": "p-adic print_prec does not work as advertised"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/98#event-341"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/98",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/98#issuecomment-340",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/98",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/98#issuecomment-341",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/98",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/98#event-342"
}
```
