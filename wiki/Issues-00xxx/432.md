...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/432#event-1776"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/432#event-1777"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/432#event-1778"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/432#event-1779"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/432",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/432#event-1780"
}
```
