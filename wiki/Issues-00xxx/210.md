...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/210#event-699"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/210#event-700"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/210",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/210#event-701"
}
```
