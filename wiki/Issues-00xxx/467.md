...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/467#event-1922"
}
```
...
```json
{
    ...
    "label": "feature",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/467#event-1923"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/467#event-1924"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/467#event-1925"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/467",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/467#event-1926"
}
```
