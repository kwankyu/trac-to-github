...
```json
{
    "body": "Attachment: **[trac715_weak_coercion_cache.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac715_weak_coercion_cache.patch.gz)**\n\nUse weak references in the coercion cache",
...
```json
{
    "body": "Attachment: **[test_orphan_functor.gz](https://github.com/sagemath/sage/files/ticket715/test_orphan_functor.gz)**\n\nExperimental patch using weak references on domain and codomain of functors",
...
```json
{
    "body": "Attachment: **[trac_715-rebase_11599.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac_715-rebase_11599.patch.gz)**\n\nRebase on top of #11599, now circularly depends on #11521",
...
```json
{
    ...
    "created_at": "2012-04-12T13:48:16Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/715",
    "type": "issue_comment",
...
```json
{
    "body": "Attachment: **[trac_715-size_t-take2.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac_715-size_t-take2.patch.gz)**\n\nUse size_t instead of Py_ssize_t for indices used by PyList_GET_ITEM",
...
```json
{
    "body": "Attachment: **[trac_715_local_refcache.patch.gz](https://github.com/sagemath/sage/files/ticket715/trac_715_local_refcache.patch.gz)**\n\nKeep track of references in a local dictionary",
