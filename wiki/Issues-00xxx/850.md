...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket850/function-init.patch",
    "created_at": "2007-10-11T15:34:01Z",
    "issue": "https://github.com/sagemath/sage/issues/850",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket850/function-init.patch",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    "body": "**Attachment:** [function-init.patch](https://github.com/sagemath/sage/files/ticket850/function-init.patch)",
    "created_at": "2007-10-11T15:34:01Z",
    "issue": "https://github.com/sagemath/sage/issues/850",
    "type": "issue_comment",
...
**Attachment:** [function-init.patch](https://github.com/sagemath/sage/files/ticket850/function-init.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/850#event-4055"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/850",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/850#event-4056"
}
```
