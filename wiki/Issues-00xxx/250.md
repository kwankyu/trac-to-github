...
```json
{
    ...
    "milestone": "sage-2.9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/250#event-840"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/250#event-841"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/250",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/250#event-842"
}
```
