...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/593#event-2576"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/593#event-2577"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/593#event-2578"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/593#event-2579"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/593",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/593#event-2580"
}
```
