...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/192#event-651"
}
```
...
```json
{
    ...
    "milestone": "sage-1.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/192#event-652"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/192",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/192#event-653"
}
```
