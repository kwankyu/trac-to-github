...
```json
{
    ...
    "asset_name": "gmp_leak.patch",
    "asset_url": "tarball://root/attachments/ticket566/gmp_leak.patch",
    "created_at": "2007-09-06T22:01:52Z",
    "issue": "https://github.com/sagemath/sage/issues/566",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket566/gmp_leak.patch",
...
```json
{
    "body": "**Attachment:** [gmp_leak.patch](https://github.com/sagemath/sage/files/ticket566/gmp_leak.patch)",
    "created_at": "2007-09-06T22:01:52Z",
    "issue": "https://github.com/sagemath/sage/issues/566",
    "type": "issue_comment",
...
**Attachment:** [gmp_leak.patch](https://github.com/sagemath/sage/files/ticket566/gmp_leak.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/566",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/566#event-2484"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/566#event-2485"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/566#event-2486"
}
```
...
archive/attachments_000224.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "segfault-fix.patch",
    "asset_url": "tarball://root/attachments/ticket566/segfault-fix.patch",
    "created_at": "2007-09-07T10:52:13Z",
    "issue": "https://github.com/sagemath/sage/issues/566",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket566/segfault-fix.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "**Attachment:** [segfault-fix.patch](https://github.com/sagemath/sage/files/ticket566/segfault-fix.patch)",
    "created_at": "2007-09-07T10:52:13Z",
    "issue": "https://github.com/sagemath/sage/issues/566",
    "type": "issue_comment",
...
**Attachment:** [segfault-fix.patch](https://github.com/sagemath/sage/files/ticket566/segfault-fix.patch)
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/566#event-2487"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/566#event-2488"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/566",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/566#event-2489"
}
```
