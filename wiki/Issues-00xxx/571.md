...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/571#event-2503"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/571#event-2504"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/571",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/571#event-2505"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/571#event-2506"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/571#event-2507"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/571",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/571#event-2508"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/571#event-2509"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/571#event-2510"
}
```
