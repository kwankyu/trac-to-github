...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/396#event-1581"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/396#event-1582"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/396#event-1583"
}
```
...
archive/attachments_000114.json:
```json
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "396.patch",
    "asset_url": "tarball://root/attachments/ticket396/396.patch",
    "created_at": "2007-09-06T23:02:48Z",
    "issue": "https://github.com/sagemath/sage/issues/396",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket396/396.patch",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    "body": "**Attachment:** [396.patch](https://github.com/sagemath/sage/files/ticket396/396.patch)",
    "created_at": "2007-09-06T23:02:48Z",
    "issue": "https://github.com/sagemath/sage/issues/396",
    "type": "issue_comment",
...
**Attachment:** [396.patch](https://github.com/sagemath/sage/files/ticket396/396.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/396",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/396#event-1584"
}
```
