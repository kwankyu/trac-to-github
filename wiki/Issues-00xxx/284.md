...
```json
{
    ...
    "milestone": "sage-2.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/284#event-1073"
}
```
...
```json
{
    ...
    "milestone": "sage-2.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/284#event-1074"
}
```
...
```json
{
    ...
    "milestone": "sage-2.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/284#event-1075"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/284",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/284#event-1076"
}
```
