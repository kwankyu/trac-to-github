...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/351#event-1377"
}
```
...
```json
{
    ...
    "milestone": "sage-2.8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/351#event-1378"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/351#event-1379"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/351",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/351#event-1380"
}
```
