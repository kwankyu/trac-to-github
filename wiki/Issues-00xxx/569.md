...
```json
{
    ...
    "asset_name": "piecewise-trac569fix-20070905.hg",
    "asset_url": "tarball://root/attachments/ticket569/piecewise-trac569fix-20070905.hg",
    "created_at": "2007-09-06T00:36:36Z",
    "issue": "https://github.com/sagemath/sage/issues/569",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket569/piecewise-trac569fix-20070905.hg",
    "user": "https://github.com/wdjoyner"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/569",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/569#event-2494"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/569#event-2495"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/569#event-2496"
}
```
