...
```json
{
    ...
    "label": "invalid",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/775#event-3570"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/775",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/775#event-3571"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/775#event-3572"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/775#event-3573"
}
```
