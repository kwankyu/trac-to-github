...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/228",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/228#event-774"
}
```
