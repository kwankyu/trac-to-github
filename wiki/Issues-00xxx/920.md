...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/920#event-4312"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/920#event-4313"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket920/920.patch",
    "created_at": "2007-10-24T19:24:49Z",
    "issue": "https://github.com/sagemath/sage/issues/920",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket920/920.patch",
...
```json
{
    "body": "<a id='comment:6'></a>\n**Attachment:** [920.patch](https://github.com/sagemath/sage/files/ticket920/920.patch)\n\napplied to 2.8.9.alpha1",
    "created_at": "2007-10-24T19:24:49Z",
    "issue": "https://github.com/sagemath/sage/issues/920",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/920",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/920#event-4314"
}
```
