...
```json
{
    ...
    "asset_name": "patch-738.hg",
    "asset_url": "tarball://root/attachments/ticket738/patch-738.hg",
    "created_at": "2007-09-23T21:36:49Z",
    "issue": "https://github.com/sagemath/sage/issues/738",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket738/patch-738.hg",
    "user": "https://trac.sagemath.org/admin/accounts/users/dmharvey"
}
```
...
```json
{
    "body": "**Attachment:** [patch-738.hg](https://github.com/sagemath/sage/files/ticket738/patch-738.hg)\n\nfixes this bug",
    "created_at": "2007-09-23T21:36:49Z",
    "issue": "https://github.com/sagemath/sage/issues/738",
    "type": "issue_comment",
...
**Attachment:** [patch-738.hg](https://github.com/sagemath/sage/files/ticket738/patch-738.hg)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/738",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/738#event-3363"
}
```
