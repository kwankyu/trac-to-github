...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/971#event-4547"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/971#event-4548"
}
```
...
```json
{
    ...
    "milestone": "sage-2.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/971#event-4549"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/971#event-4550"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/971",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/971#event-4551"
}
```
