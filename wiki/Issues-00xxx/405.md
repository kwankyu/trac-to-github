...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/405#event-1615"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/405#event-1616"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/405#event-1617"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/405",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/405#event-1618"
}
```
