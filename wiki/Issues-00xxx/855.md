...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/855",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/855#event-4068"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/855#event-4069"
}
```
...
```json
{
    ...
    "milestone": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/855#event-4070"
}
```
