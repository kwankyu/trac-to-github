...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/453",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/453#event-1874"
}
```
...
```json
{
    ...
    "milestone": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/453#event-1875"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/453#event-1876"
}
```
