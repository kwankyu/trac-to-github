...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134499"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134500"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134501"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134502"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15208#issuecomment-189766",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15208#issuecomment-189767",
    "user": "https://trac.sagemath.org/admin/accounts/users/elixyre"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15208#issuecomment-189768",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134503"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134504"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15208#issuecomment-189769",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134505"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134506"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134507"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134508"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15208",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15208#event-134509"
}
```
