...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15834#event-224096"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15834#event-224097"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15834#event-224098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15834#issuecomment-200416",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15834#issuecomment-200417",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15834#event-224099"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15834#issuecomment-200418",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15834#event-224100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15834",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15834#event-224101"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15834",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15834#issuecomment-200419",
    "user": "https://github.com/williamstein"
}
```
