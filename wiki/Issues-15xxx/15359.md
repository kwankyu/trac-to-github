...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15359#issuecomment-192894",
    "user": "https://trac.sagemath.org/admin/accounts/users/fschulze"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15359#issuecomment-192895",
    "user": "https://trac.sagemath.org/admin/accounts/users/fschulze"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15359#issuecomment-192896",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15359#event-136213"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15359#event-136214"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15359#issuecomment-192897",
    "user": "https://trac.sagemath.org/admin/accounts/users/fschulze"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15359#event-136215"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15359",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15359#issuecomment-192898",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-5.13",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15359#event-136216"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15359",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15359#event-136217"
}
```
