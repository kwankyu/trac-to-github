...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15502#issuecomment-195824",
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15502#event-138011"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15502#event-138012"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15502#issuecomment-195825",
    "user": "https://trac.sagemath.org/admin/accounts/users/vbraun_spam"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15502#event-138013"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15502#event-138014"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15502#event-138015"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15502#event-138016"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15502#issuecomment-195826",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15502",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15502#issuecomment-195827",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15502#event-138017"
}
```
