...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15979#event-225968"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15979#event-225969"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15979#event-225970"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15979#event-225971"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15979#issuecomment-202685",
    "user": "https://github.com/sagetrac-jkeitel"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15979#event-225972"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15979#issuecomment-202686",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15979#issuecomment-202687",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15979#event-225973"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15979#event-225974"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15979#issuecomment-202688",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15979",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15979#issuecomment-202689",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15979#event-225975"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15979",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15979#event-225976"
}
```
