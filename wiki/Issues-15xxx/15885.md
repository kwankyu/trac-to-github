...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15885#event-224759"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15885#event-224760"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15885#event-224761"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15885#issuecomment-201234",
    "user": "https://github.com/mezzarobba"
}
```
