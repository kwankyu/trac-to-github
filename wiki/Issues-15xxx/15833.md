...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224083"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224084"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224085"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224086"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224087"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15833#issuecomment-200414",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224088"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224089"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224091"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15833#issuecomment-200415",
    "user": "https://github.com/miguelmarco"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224092"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224093"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15833",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15833#event-224095"
}
```
