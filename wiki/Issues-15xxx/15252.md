...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15252#event-135052"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15252",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15252#issuecomment-190654",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15252#event-135053"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15252#event-135054"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15252#event-135055"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15252",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15252#issuecomment-190655",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15252",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15252#issuecomment-190656",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15252",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15252#issuecomment-190657",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15252#event-135056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15252",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15252#event-135057"
}
```
