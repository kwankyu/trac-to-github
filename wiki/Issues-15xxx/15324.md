...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192349",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192350",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192351",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192352",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15324#event-135837"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192353",
    "user": "https://trac.sagemath.org/admin/accounts/users/Stefan"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15324#event-135838"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15324#event-135839"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192354",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192355",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15324#issuecomment-192356",
    "user": "https://github.com/jdemeyer"
}
```
