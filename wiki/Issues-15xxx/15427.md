...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217713"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217714"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217716"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15427#issuecomment-191913",
    "user": "https://github.com/sagetrac-afiori"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/15427",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/15427#issuecomment-191914",
    "user": "https://github.com/sagetrac-afiori"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217717"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217718"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217719"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217720"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217721"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217722"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/15427#event-217723"
}
```
