...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33441#issuecomment-542910",
    "user": "https://github.com/SwannChelly"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33441",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33441#issuecomment-542911",
    "user": "https://github.com/SwannChelly"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33441#event-301755"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33441#event-301756"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33441#event-301757"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33441#event-301758"
}
```
