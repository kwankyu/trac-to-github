...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33207#issuecomment-539347",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33207#issuecomment-539348",
    "user": "https://github.com/tornaria"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33207#issuecomment-539349",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33207#event-300122"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33207#event-300123"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33207#event-300124"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33207#event-300125"
}
```
