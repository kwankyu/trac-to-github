...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33212#issuecomment-539391",
    "user": "https://github.com/GMS103"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33212#event-300152"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33212#issuecomment-539392",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33212#issuecomment-539393",
    "user": "https://github.com/GMS103"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33212#issuecomment-539394",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33212#issuecomment-539395",
    "user": "https://github.com/GMS103"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33212#issuecomment-539396",
    "user": "https://github.com/malb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33212#issuecomment-539397",
    "user": "https://github.com/GMS103"
}
```
...
```json
{
    ...
    "milestone": "sage-9.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33212#event-300153"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33212#event-300154"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33212#event-300155"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33212#event-300156"
}
```
