...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33848#event-304741"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33848#event-304742"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33848#issuecomment-550110",
    "user": "https://github.com/mkoeppe"
}
```
