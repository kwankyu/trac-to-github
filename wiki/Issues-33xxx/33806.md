...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-304449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33806#issuecomment-549133",
    "user": "https://github.com/collares"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33806",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33806#issuecomment-549134",
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-304450"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33806#event-304451"
}
```
