...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33882#issuecomment-550793",
    "user": "https://github.com/maxale"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33882#issuecomment-550794",
    "user": "https://github.com/maxale"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/33882",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/33882#issuecomment-550795",
    "user": "https://github.com/maxale"
}
```
...
```json
{
    ...
    "milestone": "sage-9.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33882#event-304991"
}
```
...
```json
{
    ...
    "milestone": "sage-9.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/33882#event-304992"
}
```
