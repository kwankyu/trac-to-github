...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17722#event-250266"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17722#event-250267"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17722#event-250268"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17722#event-250269"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17722#issuecomment-239424",
...
```json
{
    ...
    "milestone_title": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17722#event-250270"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17722#event-250271"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17722#issuecomment-239425",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17722",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17722#issuecomment-239426",
    "user": "https://github.com/sagetrac-buck"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17722#event-250272"
}
```
