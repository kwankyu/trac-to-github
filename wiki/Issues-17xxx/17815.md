...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251368"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251369"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251370"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17815#issuecomment-240667",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251373"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251374"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251375"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251376"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251377"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251378"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251379"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17815#issuecomment-240668",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17815#issuecomment-240669",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17815#issuecomment-240670",
...
```json
{
    ...
    "milestone_title": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251380"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251381"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17815#issuecomment-240671",
...
```json
{
    ...
    "milestone_title": "sage-9.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251382"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17815#event-251383"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17815#issuecomment-240672",
    "user": "https://github.com/mkoeppe"
}
```
