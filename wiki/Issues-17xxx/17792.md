...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251080"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251081"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251082"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251083"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251084"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251085"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251086"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251087"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251088"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251089"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251091"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251092"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251093"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251094"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251095"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251096"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17792#issuecomment-240270",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17792#issuecomment-240271",
    "user": "https://github.com/mmasdeu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251097"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251098"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17792#issuecomment-240272",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17792#issuecomment-240273",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17792#issuecomment-240274",
    "user": "https://github.com/JohnCremona"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251099"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17792#issuecomment-240275",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251101"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17792",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17792#event-251102"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17792#issuecomment-240276",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17792#issuecomment-240277",
    "user": "https://github.com/kcrisman"
}
```
