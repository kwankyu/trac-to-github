...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17414#event-246089"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17414#event-246090"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17414#event-246091"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17414#event-246092"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17414#issuecomment-232864",
...
```json
{
    ...
    "milestone_title": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17414#event-246093"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17414",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17414#event-246094"
}
```
