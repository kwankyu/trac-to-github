...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17593#event-248477"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17593#event-248478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17593#event-248479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17593#event-248480"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17593#event-248481"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17593",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17593#issuecomment-236307",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17593#event-248482"
}
```
