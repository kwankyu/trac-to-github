...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17544#issuecomment-237852",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17544",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17544#issuecomment-237853",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17544",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17544#issuecomment-237854",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17544",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17544#issuecomment-237855",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "milestone": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17544#event-158629"
}
```
