...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17123#event-242370"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17123#event-242371"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17123#event-242372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17123#event-242373"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17123#event-242374"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17123#issuecomment-227043",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17123#issuecomment-227044",
    "user": "https://github.com/PeterLuschny"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17123#issuecomment-227045",
    "user": "https://github.com/mantepse"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17123",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17123#issuecomment-227046",
    "user": "https://github.com/PeterLuschny"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17123#event-242375"
}
```
