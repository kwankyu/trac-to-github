...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241048"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241049"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241050"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241051"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241054"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241056"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241057"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241058"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241059"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241060"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241061"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241062"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241063"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241064"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241065"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241066"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241067"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241068"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241069"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17019#issuecomment-225084",
    "user": "https://github.com/sagetrac-git"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241070"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241071"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17019#issuecomment-225085",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17019#issuecomment-225086",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17019#issuecomment-225087",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241072"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241073"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17019#issuecomment-225088",
    "user": "https://github.com/johanrosenkilde"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17019#issuecomment-225089",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241074"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17019",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17019#event-241075"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17019#issuecomment-225090",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17019#issuecomment-225091",
    "user": "https://github.com/fchapoton"
}
```
