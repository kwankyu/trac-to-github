...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17774#issuecomment-242531",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17774#issuecomment-242532",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.5",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17774#event-160721"
}
```
...
```json
{
    ...
    "milestone": "sage-6.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17774#event-160722"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17774#event-160723"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17774#issuecomment-242533",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17774#issuecomment-242534",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17774#issuecomment-242535",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17774#event-160724"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17774#event-160725"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17774#event-160726"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17774",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/17774#event-160727"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17774#issuecomment-242536",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17774#issuecomment-242537",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/17774",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/17774#issuecomment-242538",
    "user": "https://github.com/nexttime"
}
```
