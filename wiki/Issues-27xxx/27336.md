...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-425432",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-425433",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-425434",
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-243782"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-243783"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-243784"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-425435",
    "user": "https://github.com/embray"
}
```
