...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-372907"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-372908"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-372909"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-372910"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-422750",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-422751",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-422752",
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-372911"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-372912"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27336#event-372913"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27336",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27336#issuecomment-422753",
    "user": "https://github.com/embray"
}
```
