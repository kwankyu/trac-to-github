...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27019#issuecomment-419288",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27019#issuecomment-419289",
...
```json
{
    ...
    "milestone": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27019#event-240799"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27019#event-240800"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27019#issuecomment-419290",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27019#event-240801"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27019#event-240802"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27019#event-240803"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27019",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27019#issuecomment-419291",
    "user": "https://github.com/embray"
}
```
