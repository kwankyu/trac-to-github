...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27276#event-372139"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27276#event-372140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27276#event-372141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27276#event-372142"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27276#event-372143"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27276#event-372144"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27276#issuecomment-421724",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27276#issuecomment-421725",
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27276#event-372145"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27276",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27276#issuecomment-421726",
    "user": "https://github.com/embray"
}
```
