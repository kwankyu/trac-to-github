...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27733#issuecomment-432662",
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27733#event-247025"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27733#issuecomment-432663",
    "user": "https://github.com/embray"
}
```
