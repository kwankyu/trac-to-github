...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-368846"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-368847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-368848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-368849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27035#issuecomment-416921",
...
```json
{
    ...
    "milestone_title": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-368850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-368851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27035#issuecomment-416922",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-368852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-368853"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-368854"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27035",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-368855"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27035#issuecomment-416923",
    "user": "https://github.com/dimpase"
}
```
