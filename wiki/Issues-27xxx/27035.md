...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27035#issuecomment-419589",
...
```json
{
    ...
    "milestone": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-241004"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-241005"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27035#issuecomment-419590",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-241006"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-241007"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27035",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27035#event-241008"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27035#issuecomment-419591",
    "user": "https://github.com/dimpase"
}
```
