...
```json
{
    ...
    "milestone": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27006#event-240680"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27006#issuecomment-419151",
    "user": "https://github.com/fchapoton"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27006#event-240681"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27006#event-240682"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27006",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27006#event-240683"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27006#event-240684"
}
```
