...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-422232",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-422233",
    "user": "https://github.com/ph4r05"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-422234",
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-242333"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-242334"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-422235",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-242335"
}
```
