...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-370821"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-370822"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-370823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-370824"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-370825"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-419562",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-419563",
    "user": "https://github.com/ph4r05"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-419564",
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-370826"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-370827"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27185",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27185#issuecomment-419565",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27185#event-370828"
}
```
