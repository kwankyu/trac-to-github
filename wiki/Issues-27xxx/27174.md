...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27174#issuecomment-422152",
    "user": "https://github.com/ManfP"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27174#issuecomment-422153",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27174#event-242283"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27174#event-242284"
}
```
