...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27174#event-370714"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27174#event-370715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27174#event-370716"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27174#issuecomment-419483",
    "user": "https://github.com/ManfP"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27174",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27174#issuecomment-419484",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27174#event-370717"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27174#event-370718"
}
```
