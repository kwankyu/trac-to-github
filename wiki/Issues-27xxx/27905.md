...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27905#event-380020"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27905#event-380021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27905#event-380022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27905#issuecomment-433623",
    "user": "https://github.com/Miguel-OYeah"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27905#issuecomment-433624",
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27905#event-380023"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27905#issuecomment-433625",
    "user": "https://github.com/embray"
}
```
