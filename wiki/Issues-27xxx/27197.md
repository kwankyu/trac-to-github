...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27197#issuecomment-422566",
    "user": "https://github.com/johnmwu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27197#issuecomment-422567",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27197#issuecomment-422568",
    "user": "https://github.com/johnmwu"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27197",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27197#event-242470"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27197#event-242471"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27197#event-242472"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27197#issuecomment-422569",
    "user": "https://github.com/jdemeyer"
}
```
