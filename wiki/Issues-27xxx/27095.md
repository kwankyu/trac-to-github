...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27095#issuecomment-420709",
    "user": "https://github.com/simon-king-jena"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27095#issuecomment-420710",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27095#issuecomment-420711",
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27095#event-241620"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27095#event-241621"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27095",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27095#issuecomment-420712",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27095#event-241622"
}
```
