...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424525",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424526",
    "user": "https://trac.sagemath.org/admin/accounts/users/git"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424527",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424528",
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-243337"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-243338"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27285#event-243339"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27285#issuecomment-424529",
    "user": "https://github.com/embray"
}
```
