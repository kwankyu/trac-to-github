...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27660#issuecomment-431446",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27660#issuecomment-431447",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27660#event-246453"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27660#issuecomment-431448",
    "user": "https://github.com/embray"
}
```
