...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27599#event-376229"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27599#event-376230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27599#event-376231"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27599#event-376232"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27599#event-376233"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27599#issuecomment-427718",
    "user": "https://github.com/DeRhamSource"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27599#issuecomment-427719",
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27599#event-376234"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27599#issuecomment-427720",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27599#issuecomment-427721",
    "user": "https://github.com/DeRhamSource"
}
```
