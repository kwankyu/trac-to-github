...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27833#event-379142"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27833#event-379143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27833#event-379144"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27833#issuecomment-432136",
    "user": "https://github.com/slel"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27833",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27833#issuecomment-432137",
    "user": "https://github.com/slel"
}
```
