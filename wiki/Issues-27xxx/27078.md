...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27078#event-369481"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27078#event-369482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27078#event-369483"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27078#issuecomment-417747",
    "user": "https://github.com/JCGoran"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27078#issuecomment-417748",
...
```json
{
    ...
    "milestone_title": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27078#event-369484"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27078#event-369485"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/27078#event-369486"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/27078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/27078#issuecomment-417749",
    "user": "https://github.com/embray"
}
```
