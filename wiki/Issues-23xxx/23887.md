...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23887#event-214214"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23887#issuecomment-363088",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23887#issuecomment-363089",
    "user": "https://trac.sagemath.org/admin/accounts/users/victoriasanders"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23887#issuecomment-363090",
    "user": "https://github.com/roed314"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23887#issuecomment-363091",
    "user": "https://trac.sagemath.org/admin/accounts/users/victoriasanders"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23887#issuecomment-363092",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23887",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23887#issuecomment-363093",
    "user": "https://github.com/bryangingechen"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23887#event-214215"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23887#event-214216"
}
```
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23887#event-214217"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23887#event-214218"
}
```
...
```json
{
    ...
    "milestone": "sage-8.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23887#event-214219"
}
```
