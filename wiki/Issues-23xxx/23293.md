...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23293#issuecomment-352086",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23293",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23293#issuecomment-352087",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23293",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23293#issuecomment-352088",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23293#event-209241"
}
```
