...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23358#event-322565"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23358#event-322566"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23358#event-322567"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23358#event-322568"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23358#event-322569"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23358#issuecomment-350806",
    "user": "https://github.com/infinity0"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23358#event-322570"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23358#event-322571"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23358",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23358#issuecomment-350807",
    "user": "https://github.com/infinity0"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23358#event-322572"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23358#event-322573"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23358",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23358#event-322574"
}
```
