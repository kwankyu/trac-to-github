...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23869#event-328838"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23869#event-328839"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23869#event-328840"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23869#event-328841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23869#event-328842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23869#event-328843"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23869",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23869#event-328844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23869",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23869#issuecomment-360083",
    "user": "https://github.com/koffie"
}
```
