...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23888#issuecomment-363094",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23888#issuecomment-363095",
    "user": "https://github.com/edgarcosta"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23888#issuecomment-363096",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23888",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23888#issuecomment-363097",
    "user": "https://github.com/edgarcosta"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23888",
    "rename": {
        "from": "charpoly over ZZ",
        "to": "charpoly over ZZ : flint or linbox ?"
    },
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23888#event-214220"
}
```
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23888#event-214221"
}
```
