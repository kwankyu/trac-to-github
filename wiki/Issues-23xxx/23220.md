...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-208769"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23220#issuecomment-351159",
    "user": "https://trac.sagemath.org/admin/accounts/users/dbisogno"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23220#issuecomment-351160",
    "user": "https://trac.sagemath.org/admin/accounts/users/dbisogno"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23220#issuecomment-351161",
    "user": "https://trac.sagemath.org/admin/accounts/users/dbisogno"
}
```
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23220#event-208770"
}
```
