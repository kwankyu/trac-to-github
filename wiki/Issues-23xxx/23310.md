...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23310#issuecomment-352261",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23310",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23310#issuecomment-352262",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/23310",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/23310#issuecomment-352263",
    "user": "https://trac.sagemath.org/admin/accounts/users/msaaltink"
}
```
...
```json
{
    ...
    "milestone": "sage-8.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/23310#event-209362"
}
```
