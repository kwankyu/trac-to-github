...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20378#issuecomment-296457",
    "user": "https://trac.sagemath.org/admin/accounts/users/RikSchepens"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20378#issuecomment-296458",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20378",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20378#issuecomment-296459",
    "user": "https://trac.sagemath.org/admin/accounts/users/zgershkoff"
}
```
...
```json
{
    ...
    "milestone": "sage-7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20378#event-184473"
}
```
