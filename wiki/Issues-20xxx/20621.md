...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20621#event-288002"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20621#event-288003"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20621#event-288004"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20621#event-288005"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20621#issuecomment-298195",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20621#event-288006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20621#event-288007"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20621#event-288008"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20621",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20621#event-288009"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20621",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20621#issuecomment-298196",
    "user": "https://github.com/vbraun"
}
```
