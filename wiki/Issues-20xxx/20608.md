...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20608#issuecomment-300521",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20608#issuecomment-300522",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20608#issuecomment-300523",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20608#issuecomment-300524",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20608#event-186293"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20608#event-186294"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20608#issuecomment-300525",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20608#issuecomment-300526",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20608#event-186295"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20608#event-186296"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20608#event-186297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20608",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20608#event-186298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20608",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20608#issuecomment-300527",
    "user": "https://github.com/vbraun"
}
```
