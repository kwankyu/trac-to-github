...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20436#issuecomment-297573",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20436#issuecomment-297574",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20436",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20436#issuecomment-297575",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "milestone": "sage-7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20436#event-184889"
}
```
