...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-286400"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-286401"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-286402"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-286403"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-286404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20492#issuecomment-295860",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20492#issuecomment-295861",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-286405"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-286406"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-286407"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20492#event-286408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20492#issuecomment-295862",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20492#issuecomment-295863",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20492",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20492#issuecomment-295864",
    "user": "https://github.com/embray"
}
```
