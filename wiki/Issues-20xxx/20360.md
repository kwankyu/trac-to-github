...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20360#event-284884"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20360#event-284885"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20360#event-284886"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20360#event-284887"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20360#event-284888"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20360#issuecomment-293737",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20360#issuecomment-293738",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20360",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20360#issuecomment-293739",
...
```json
{
    ...
    "milestone_title": "sage-7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20360#event-284889"
}
```
