...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285425"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285426"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285427"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285428"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285429"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285430"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285431"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285432"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20408",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20408#issuecomment-294733",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20408",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20408#issuecomment-294734",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285435"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20408",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20408#event-285436"
}
```
