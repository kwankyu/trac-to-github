...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20097#issuecomment-290773",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20097#issuecomment-290774",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20097#issuecomment-290775",
    "user": "https://github.com/DaveWitteMorris"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20097",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20097#issuecomment-290776",
    "user": "https://github.com/ninja18"
}
```
...
```json
{
    ...
    "milestone": "sage-7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20097#event-181980"
}
```
