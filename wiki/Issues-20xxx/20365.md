...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296290",
    "user": "https://trac.sagemath.org/admin/accounts/users/jcristau"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296291",
    "user": "https://github.com/kiwifb"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296292",
...
```json
{
    ...
    "milestone": "sage-7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-184391"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296293",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-184392"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/20365#event-184393"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/20365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/20365#issuecomment-296294",
    "user": "https://github.com/jdemeyer"
}
```
