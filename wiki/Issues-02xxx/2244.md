...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2244/wiggle-interior.patch",
    "created_at": "2008-02-21T21:20:51Z",
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2244/wiggle-interior.patch",
...
```json
{
    "body": "**Attachment:** [wiggle-interior.patch](https://github.com/sagemath/sage/files/ticket2244/wiggle-interior.patch)\n\napply after William's patch",
    "created_at": "2008-02-21T21:20:51Z",
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_comment",
...
**Attachment:** [wiggle-interior.patch](https://github.com/sagemath/sage/files/ticket2244/wiggle-interior.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-11110"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-11111"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-11112"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2244/sage-2244-nowiggle.patch",
    "created_at": "2008-02-24T04:58:06Z",
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2244/sage-2244-nowiggle.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-11113"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-11114"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-11115"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2244/2244_nowiggle_new.patch",
    "created_at": "2008-03-15T18:11:16Z",
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2244/2244_nowiggle_new.patch",
...
```json
{
    "body": "**Attachment:** [2244_nowiggle_new.patch](https://github.com/sagemath/sage/files/ticket2244/2244_nowiggle_new.patch)\n\napply instead of the two above",
    "created_at": "2008-03-15T18:11:16Z",
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_comment",
...
**Attachment:** [2244_nowiggle_new.patch](https://github.com/sagemath/sage/files/ticket2244/2244_nowiggle_new.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-11116"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-11117"
}
```
