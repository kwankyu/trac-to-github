...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-22835"
}
```
...
```json
{
    ...
    "title_was": "[very positive review, needs rebase] add a randomize=False option to the plot command, to avoid \"wiggle\" in animations",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-22836"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2244",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2244#event-22837"
}
```
