...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2358",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24238"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24239"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2358#event-24240"
}
```
