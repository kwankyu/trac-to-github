...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2976#issuecomment-16348",
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2976#event-15737"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2976",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2976#event-15738"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2976",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2976#issuecomment-16349",
    "user": "https://github.com/williamstein"
}
```
