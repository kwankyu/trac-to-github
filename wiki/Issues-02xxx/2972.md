...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2972#event-15716"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2972#event-15717"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2972#event-15718"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2972#event-15719"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2972",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2972#event-15720"
}
```
