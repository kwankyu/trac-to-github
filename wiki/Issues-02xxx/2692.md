...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2692#event-28249"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2692#event-28250"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2692#event-28251"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2692",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2692#event-28252"
}
```
