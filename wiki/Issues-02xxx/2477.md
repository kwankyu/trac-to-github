...
```json
{
    "body": "**Attachment:** [2477.patch](https://github.com/sagemath/sage/files/ticket2477/2477.patch)",
    "created_at": "2008-03-14T14:53:02Z",
    "issue": "https://github.com/sagemath/sage/issues/2477",
    "type": "issue_comment",
...
**Attachment:** [2477.patch](https://github.com/sagemath/sage/files/ticket2477/2477.patch)
...
```json
{
    ...
    "milestone": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2477#event-12660"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2477#event-12661"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2477#event-12662"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2477#event-12663"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2477#event-12664"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2477#event-12665"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2477#event-12666"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2477#event-12667"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2477#event-12668"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2477",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2477#event-12669"
}
```
