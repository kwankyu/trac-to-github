...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2315#event-23604"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2315#event-23605"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2315",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2315#event-23606"
}
```
