...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2110#event-21214"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2110",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2110#event-21215"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2110#event-21216"
}
```
