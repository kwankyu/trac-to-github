...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2939#event-31020"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2939#event-31021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2939#event-31022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2939",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2939#event-31023"
}
```
