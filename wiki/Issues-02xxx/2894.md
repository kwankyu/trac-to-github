...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2894#event-30498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2894",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2894#event-30499"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2894#event-30500"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2894#event-30501"
}
```
