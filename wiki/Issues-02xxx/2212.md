...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2212#event-22458"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2212#event-22459"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2212",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2212#event-22460"
}
```
