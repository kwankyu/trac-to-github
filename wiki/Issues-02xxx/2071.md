...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2071#event-20748"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2071#event-20749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2071",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2071#event-20750"
}
```
