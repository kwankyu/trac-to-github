...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2468",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2468#event-25558"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2468#event-25559"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2468#event-25560"
}
```
