...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2044#event-20474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2044#event-20475"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2044",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2044#event-20476"
}
```
