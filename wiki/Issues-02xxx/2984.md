...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2984#event-31549"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2984#event-31550"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2984#event-31551"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2984",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2984#event-31552"
}
```
