...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2998#issuecomment-16427",
    "user": "https://github.com/dfdeshom"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-15820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2998",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-15821"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2998#event-15822"
}
```
