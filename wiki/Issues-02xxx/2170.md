...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2170#event-10628"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2170/8312.patch",
    "created_at": "2008-02-15T13:56:15Z",
    "issue": "https://github.com/sagemath/sage/issues/2170",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2170/8312.patch",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "**Attachment:** [8312.patch](https://github.com/sagemath/sage/files/ticket2170/8312.patch)",
    "created_at": "2008-02-15T13:56:15Z",
    "issue": "https://github.com/sagemath/sage/issues/2170",
    "type": "issue_comment",
...
**Attachment:** [8312.patch](https://github.com/sagemath/sage/files/ticket2170/8312.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2170#event-10629"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2170/8312.2.patch",
    "created_at": "2008-02-25T14:18:47Z",
    "issue": "https://github.com/sagemath/sage/issues/2170",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2170/8312.2.patch",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2170#event-10630"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2170/8683.patch",
    "created_at": "2008-02-25T16:32:56Z",
    "issue": "https://github.com/sagemath/sage/issues/2170",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2170/8683.patch",
    "user": "https://github.com/zimmermann6"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\n**Attachment:** [8683.patch](https://github.com/sagemath/sage/files/ticket2170/8683.patch)\n\n> This patch seems to be identical to the original patch.\n\nSorry for that. The new one (8683.patch) should be the correct one.",
    "created_at": "2008-02-25T16:32:56Z",
    "issue": "https://github.com/sagemath/sage/issues/2170",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2170#event-10631"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2170#event-10632"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2170#event-10633"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2170",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2170#event-10634"
}
```
