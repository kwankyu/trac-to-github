...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2645#event-27735"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2645#event-27736"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2645#event-27737"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2645",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2645#event-27738"
}
```
