...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-25517"
}
```
...
```json
{
    ...
    "title_was": "Linbox static commentator make sage crash on PPC",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-25518"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2463",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2463#event-25519"
}
```
