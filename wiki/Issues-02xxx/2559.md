...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2559#event-26634"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2559#event-26635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2559",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2559#event-26636"
}
```
