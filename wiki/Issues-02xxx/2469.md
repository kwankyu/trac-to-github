...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2469#event-25565"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2469#event-25566"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2469",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2469#event-25567"
}
```
