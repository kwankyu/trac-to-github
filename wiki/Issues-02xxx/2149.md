...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2149/2149.patch",
    "created_at": "2008-02-29T02:15:05Z",
    "issue": "https://github.com/sagemath/sage/issues/2149",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2149/2149.patch",
...
```json
{
    "body": "**Attachment:** [2149.patch](https://github.com/sagemath/sage/files/ticket2149/2149.patch)",
    "created_at": "2008-02-29T02:15:05Z",
    "issue": "https://github.com/sagemath/sage/issues/2149",
    "type": "issue_comment",
...
**Attachment:** [2149.patch](https://github.com/sagemath/sage/files/ticket2149/2149.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2149#event-10511"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2149#event-10512"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2149#event-10513"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2149#event-10514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2149",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2149#event-10515"
}
```
...
```json
{
    ...
    "label": "wontfix",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2149#event-10516"
}
```
