...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2034#event-20352"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2034#event-20353"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2034",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2034#event-20354"
}
```
