...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2707#event-28462"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2707#event-28463"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2707#event-28464"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2707",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2707#event-28465"
}
```
