...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2974#event-31449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2974#event-31450"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2974#event-31451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2974",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2974#event-31452"
}
```
