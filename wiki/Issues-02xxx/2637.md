...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2637#event-27646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2637#event-27647"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2637#event-27648"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2637",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2637#event-27649"
}
```
