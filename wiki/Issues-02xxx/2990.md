...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2990#event-31602"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2990#event-31603"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2990#event-31604"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2990",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2990#event-31605"
}
```
