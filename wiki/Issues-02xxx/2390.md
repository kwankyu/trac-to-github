...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2390#issuecomment-12694",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2390#event-12075"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2390",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2390#event-12076"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2390",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2390#issuecomment-12695",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
