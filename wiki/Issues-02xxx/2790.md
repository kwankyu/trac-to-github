...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2790#event-29295"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2790#event-29296"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2790#event-29297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2790",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2790#event-29298"
}
```
