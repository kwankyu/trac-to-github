...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2797#event-29373"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2797#event-29374"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2797#event-29375"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2797",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2797#event-29376"
}
```
