...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2068#event-20713"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2068#event-20714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2068",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2068#event-20715"
}
```
