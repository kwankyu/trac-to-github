...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30466"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2891",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2891#event-30467"
}
```
