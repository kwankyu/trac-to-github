...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2133#event-21504"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2133#event-21505"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2133",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2133#event-21506"
}
```
