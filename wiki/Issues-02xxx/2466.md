...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2466",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2466#event-25541"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2466#event-25542"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2466",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2466#event-25543"
}
```
