...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2384",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2384#event-24553"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2384#event-24554"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2384#event-24555"
}
```
