...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2978#event-31493"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2978#event-31494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2978#event-31495"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2978",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2978#event-31496"
}
```
