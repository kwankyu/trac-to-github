...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2004#event-20058"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2004#event-20059"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2004",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2004#event-20060"
}
```
