...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2551#event-26558"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2551#event-26559"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2551",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2551#event-26560"
}
```
