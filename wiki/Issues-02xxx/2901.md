...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2901#event-30607"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2901#event-30608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2901#event-30609"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2901",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2901#event-30610"
}
```
