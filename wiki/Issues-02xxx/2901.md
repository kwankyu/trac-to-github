...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2901/sage-2901.patch",
    "created_at": "2008-04-13T04:00:56Z",
    "issue": "https://github.com/sagemath/sage/issues/2901",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2901/sage-2901.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "**Attachment:** [sage-2901.patch](https://github.com/sagemath/sage/files/ticket2901/sage-2901.patch)",
    "created_at": "2008-04-13T04:00:56Z",
    "issue": "https://github.com/sagemath/sage/issues/2901",
    "type": "issue_comment",
...
**Attachment:** [sage-2901.patch](https://github.com/sagemath/sage/files/ticket2901/sage-2901.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2901#event-15279"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2901#event-15280"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2901#event-15281"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2901#event-15282"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2901",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2901#event-15283"
}
```
