...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2977#event-31478"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2977",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2977#event-31479"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2977#event-31480"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2977#event-31481"
}
```
