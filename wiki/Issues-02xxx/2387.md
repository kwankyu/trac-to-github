...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2387#event-24589"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2387#event-24590"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2387",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2387#event-24591"
}
```
