...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2522#event-26215"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2522#event-26216"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2522",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2522#event-26217"
}
```
