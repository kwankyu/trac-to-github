...
```json
{
    ...
    "title_was": "A copy method for SingularElement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2300#event-23427"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2300#event-23428"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2300",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2300#event-23429"
}
```
