...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2453#event-12494"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2453#event-12495"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2453#event-12496"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2453#event-12497"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2453#event-12498"
}
```
...
```json
{
    ...
    "milestone": "sage-2.10.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2453#event-12499"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2453#event-12500"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2453",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2453#event-12501"
}
```
