...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2333#event-11665"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2333#event-11666"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2333#event-11667"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2333#event-11668"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2333#event-11669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2333",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2333#event-11670"
}
```
