...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2726#event-28659"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2726#event-28660"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2726#event-28661"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2726",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2726#event-28662"
}
```
