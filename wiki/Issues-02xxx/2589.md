...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-27017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-27018"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2589",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2589#event-27019"
}
```
