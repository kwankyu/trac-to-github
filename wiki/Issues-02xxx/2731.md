...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2731#event-28700"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2731#event-28701"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2731#event-28702"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2731",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2731#event-28703"
}
```
