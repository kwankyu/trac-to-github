...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2621#event-27435"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2621#event-27436"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2621#event-27437"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2621",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2621#event-27438"
}
```
