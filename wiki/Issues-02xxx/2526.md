...
```json
{
    ...
    "subject": "https://github.com/sagetrac-mabshoff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2526#event-26260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2526#event-26261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2526",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2526#event-26262"
}
```
