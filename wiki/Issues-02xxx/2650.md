...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2650#event-13826"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2650#event-13827"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2650#issuecomment-14458",
    "user": "https://github.com/rhinton"
}
```
