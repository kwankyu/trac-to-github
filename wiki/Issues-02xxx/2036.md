...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2036#event-20369"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2036#event-20370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2036",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2036#event-20371"
}
```
