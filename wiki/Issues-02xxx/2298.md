...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [nf-from-algebraic.patch](https://github.com/sagemath/sage/files/ticket2298/nf-from-algebraic.patch)",
    "created_at": "2008-02-25T16:18:17Z",
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-11382"
}
```
...
```json
{
    "body": "**Attachment:** [nf-from-algebraic-v2.patch](https://github.com/sagemath/sage/files/ticket2298/nf-from-algebraic-v2.patch)",
    "created_at": "2008-02-28T03:51:51Z",
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
...
**Attachment:** [nf-from-algebraic-v2.patch](https://github.com/sagemath/sage/files/ticket2298/nf-from-algebraic-v2.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-11383"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-11384"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-11385"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-11386"
}
```
...
```json
{
    "body": "**Attachment:** [nf-from-algebraic-response.patch](https://github.com/sagemath/sage/files/ticket2298/nf-from-algebraic-response.patch)",
    "created_at": "2008-03-02T19:18:48Z",
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_comment",
...
**Attachment:** [nf-from-algebraic-response.patch](https://github.com/sagemath/sage/files/ticket2298/nf-from-algebraic-response.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-11387"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-11388"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-11389"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2298",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2298#event-11390"
}
```
