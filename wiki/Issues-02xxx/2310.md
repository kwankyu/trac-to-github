...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2310#event-23544"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2310#event-23545"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2310",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2310#event-23546"
}
```
