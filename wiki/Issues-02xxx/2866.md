...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2866#event-30127"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2866#event-30128"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2866#event-30129"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2866",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2866#event-30130"
}
```
