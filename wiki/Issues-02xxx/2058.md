...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2058#event-20611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2058#event-20612"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2058",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2058#event-20613"
}
```
