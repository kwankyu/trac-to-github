...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2833#event-29765"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2833#event-29766"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2833#event-29767"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2833",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2833#event-29768"
}
```
