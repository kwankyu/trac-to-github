...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2908#event-30681"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2908#event-30682"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2908",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2908#event-30683"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2908#event-30684"
}
```
