...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2980#event-31509"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2980#event-31510"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2980#event-31511"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2980",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2980#event-31512"
}
```
