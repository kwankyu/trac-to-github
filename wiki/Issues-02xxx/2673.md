...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2673",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28045"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28047"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2673#event-28048"
}
```
