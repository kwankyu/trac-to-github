...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2721#event-28611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2721#event-28612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2721#event-28613"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2721",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2721#event-28614"
}
```
