...
```json
{
    ...
    "milestone_title": "sage-3.2.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2393#event-24648"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2393#event-24649"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2393",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2393#event-24650"
}
```
