...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2913/sage-2913.patch",
    "created_at": "2008-04-14T03:29:44Z",
    "issue": "https://github.com/sagemath/sage/issues/2913",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2913/sage-2913.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "**Attachment:** [sage-2913.patch](https://github.com/sagemath/sage/files/ticket2913/sage-2913.patch)",
    "created_at": "2008-04-14T03:29:44Z",
    "issue": "https://github.com/sagemath/sage/issues/2913",
    "type": "issue_comment",
...
**Attachment:** [sage-2913.patch](https://github.com/sagemath/sage/files/ticket2913/sage-2913.patch)
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2913",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2913#issuecomment-15995",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2913#event-15353"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2913#event-15354"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2913",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2913#event-15355"
}
```
