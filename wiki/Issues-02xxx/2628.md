...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2628#event-27512"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2628#event-27513"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2628#event-27514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2628",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2628#event-27515"
}
```
