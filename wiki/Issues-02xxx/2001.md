...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2001#event-20032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2001#event-20033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2001",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2001#event-20034"
}
```
