...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2718",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2718#event-28587"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2718#event-28588"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2718#event-28589"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2718",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2718#event-28590"
}
```
