...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2075#event-10015"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2075#event-10016"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2075#event-10017"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2075#event-10018"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2075#event-10019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2075",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2075#event-10020"
}
```
