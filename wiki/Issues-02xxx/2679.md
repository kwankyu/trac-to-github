...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2679",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2679#issuecomment-14632",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2679",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2679#event-13984"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2679#event-13985"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2679#event-13986"
}
```
