...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2017#event-9666"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2017",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/2017#issuecomment-10111",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "milestone": "sage-2.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2017#event-9667"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2017#event-9668"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2017#event-9669"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2017#event-9670"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2017",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2017#event-9671"
}
```
