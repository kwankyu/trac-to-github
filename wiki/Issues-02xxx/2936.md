...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2936#event-30994"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2936#event-30995"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2936",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2936#event-30996"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2936#event-30997"
}
```
