...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2504/2504-units_cache.patch",
    "created_at": "2008-04-13T02:27:55Z",
    "issue": "https://github.com/sagemath/sage/issues/2504",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2504/2504-units_cache.patch",
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [2504-units_cache.patch](https://github.com/sagemath/sage/files/ticket2504/2504-units_cache.patch)\n\nThe attached patch fixes this and adds doctests illustrating the correct behavior.",
    "created_at": "2008-04-13T02:27:55Z",
    "issue": "https://github.com/sagemath/sage/issues/2504",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2504#event-12807"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket2504/2504-units_cache.2.patch",
    "created_at": "2008-04-15T20:18:32Z",
    "issue": "https://github.com/sagemath/sage/issues/2504",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket2504/2504-units_cache.2.patch",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:3'></a>\n**Attachment:** [2504-units_cache.2.patch](https://github.com/sagemath/sage/files/ticket2504/2504-units_cache.2.patch)\n\nYou are completely right.  I've replaced the patch and reorganized the code so it looks a bit cleaner.",
    "created_at": "2008-04-15T20:18:32Z",
    "issue": "https://github.com/sagemath/sage/issues/2504",
    "type": "issue_comment",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2504#event-12808"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2504#event-12809"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2504#event-12810"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2504",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2504#event-12811"
}
```
