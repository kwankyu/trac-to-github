...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2995#event-31648"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2995#event-31649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2995#event-31650"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2995",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2995#event-31651"
}
```
