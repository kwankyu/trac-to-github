...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2672#event-28036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2672#event-28037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2672#event-28038"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2672",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2672#event-28039"
}
```
