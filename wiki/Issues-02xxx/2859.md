...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2859#event-30052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2859#event-30053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2859#event-30054"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2859",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2859#event-30055"
}
```
