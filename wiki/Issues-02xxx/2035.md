...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-20358"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-20359"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2035",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2035#event-20360"
}
```
