...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2779#event-29169"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2779#event-29170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2779#event-29171"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2779",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2779#event-29172"
}
```
