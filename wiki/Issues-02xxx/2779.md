...
```json
{
    ...
    "milestone": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2779#event-14507"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2779#event-14508"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2779#event-14509"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2779#event-14510"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2779#event-14511"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2779",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2779#event-14512"
}
```
