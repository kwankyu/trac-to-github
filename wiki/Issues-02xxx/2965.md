...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2965#event-31360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2965",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2965#event-31361"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2965#event-31362"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2965#event-31363"
}
```
