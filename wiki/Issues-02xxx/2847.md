...
```json
{
    ...
    "title_was": "more speedups to cyclotomic polynomials",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2847#event-29912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2847#event-29913"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2847",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2847#event-29914"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2847#event-29915"
}
```
