...
```json
{
    ...
    "title_was": "Wrap Cremona's newforms class",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2394#event-24663"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2394#event-24664"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2394",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2394#event-24665"
}
```
