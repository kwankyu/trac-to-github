...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24601"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24602"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2388",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2388#event-24603"
}
```
