...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2020#event-20184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2020#event-20185"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2020",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2020#event-20186"
}
```
