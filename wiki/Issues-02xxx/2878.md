...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2878#event-30303"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2878#event-30304"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2878#event-30305"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2878",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2878#event-30306"
}
```
