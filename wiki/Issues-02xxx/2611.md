...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2611#event-27295"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2611#event-27296"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2611",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2611#event-27297"
}
```
