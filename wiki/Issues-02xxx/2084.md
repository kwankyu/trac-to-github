...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10058"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10059"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10060"
}
```
...
```json
{
    ...
    "label": "component: number theory",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10061"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10062"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10063"
}
```
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10064"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10065"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10066"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10067"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2084",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2084#event-10068"
}
```
