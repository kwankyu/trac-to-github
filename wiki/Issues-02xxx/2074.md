...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2074#event-20792"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2074#event-20793"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2074",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2074#event-20794"
}
```
