...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2129",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2129#event-21472"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2129#event-21473"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2129#event-21474"
}
```
