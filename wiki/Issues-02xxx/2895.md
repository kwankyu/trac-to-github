...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-30513"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-30514"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-30515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2895",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2895#event-30516"
}
```
