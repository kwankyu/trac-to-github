...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2680#event-28109"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2680#event-28110"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2680#event-28111"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2680",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2680#event-28112"
}
```
