...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2396#event-24684"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2396",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2396#event-24685"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2396#event-24686"
}
```
