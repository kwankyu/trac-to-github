...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2241",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2241#event-22803"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.1.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2241#event-22804"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2241#event-22805"
}
```
