...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2375#event-24451"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2375#event-24452"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2375",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2375#event-24453"
}
```
