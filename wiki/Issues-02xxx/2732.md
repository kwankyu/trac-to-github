...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2732#event-28708"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2732#event-28709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2732",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2732#event-28710"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2732#event-28711"
}
```
