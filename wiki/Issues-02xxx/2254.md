...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2254#event-11155"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2254#event-11156"
}
```
...
```json
{
    ...
    "label": "component: linear algebra",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2254#event-11157"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2254#event-11158"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2254",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2254#event-11159"
}
```
