...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2461#event-25487"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2461#event-25488"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2461",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2461#event-25489"
}
```
