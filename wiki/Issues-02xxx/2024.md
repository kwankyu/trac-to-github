...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2024",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-20240"
}
```
...
```json
{
    ...
    "title_was": "univariate gcd over Z_N (N composite)",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-20241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2024",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2024#event-20242"
}
```
