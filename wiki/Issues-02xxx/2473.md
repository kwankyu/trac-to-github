...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2473#event-25619"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2473#event-25620"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2473",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2473#event-25621"
}
```
