...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2982#event-31525"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2982#event-31526"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2982#event-31527"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2982",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2982#event-31528"
}
```
