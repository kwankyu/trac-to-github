...
```json
{
    ...
    "milestone_title": "sage-3.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2809#event-29504"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2809#event-29505"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2809#event-29506"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2809",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2809#event-29507"
}
```
