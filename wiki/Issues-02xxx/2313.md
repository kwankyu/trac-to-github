...
```json
{
    ...
    "milestone_title": "sage-3.2.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2313#event-23577"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2313#event-23578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2313",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2313#event-23579"
}
```
