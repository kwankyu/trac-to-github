...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2224#event-22626"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2224#event-22627"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2224",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2224#event-22628"
}
```
