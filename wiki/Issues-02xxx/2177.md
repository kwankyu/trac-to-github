...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2177#event-22005"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2177#event-22006"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2177",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2177#event-22007"
}
```
