...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2370#event-24400"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2370",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2370#event-24401"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2370#event-24402"
}
```
