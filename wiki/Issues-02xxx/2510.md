...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2510#event-26055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2510#event-26056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2510",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2510#event-26057"
}
```
