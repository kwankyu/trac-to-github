...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2295#event-23359"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2295#event-23360"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2295",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2295#event-23361"
}
```
