...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-24201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-24202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2356",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2356#event-24203"
}
```
