...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2937#event-31000"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2937#event-31001"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2937#event-31002"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2937",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2937#event-31003"
}
```
