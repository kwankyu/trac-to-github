...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2226#event-22648"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2226#event-22649"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2226",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2226#event-22650"
}
```
