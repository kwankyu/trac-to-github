...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2534#event-26347"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2534#event-26348"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/2534",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/2534#event-26349"
}
```
