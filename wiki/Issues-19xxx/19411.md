...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19411#event-272895"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19411#event-272896"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19411#event-272897"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19411#event-272898"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19411#event-272899"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19411",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19411#issuecomment-275830",
    "user": "https://github.com/dkrenn"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19411#event-272900"
}
```
