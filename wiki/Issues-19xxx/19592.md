...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19592#event-275137"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19592#event-275138"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19592#event-275139"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19592#event-275140"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19592#issuecomment-279223",
    "user": "https://github.com/yuan-zhou"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19592#event-275141"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19592",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19592#issuecomment-279224",
...
```json
{
    ...
    "milestone_title": "sage-6.10",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19592#event-275142"
}
```
