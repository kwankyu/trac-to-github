...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-280156"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-280157"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-280158"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-280159"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19998#issuecomment-286442",
...
```json
{
    ...
    "milestone_title": "sage-7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-280160"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-280161"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-280162"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19998",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19998#issuecomment-286443",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone_title": "sage-7.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19998#event-280163"
}
```
