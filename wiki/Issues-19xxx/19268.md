...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19268#issuecomment-275825",
    "user": "https://github.com/monien"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/19268",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/19268#issuecomment-275826",
    "user": "https://github.com/monien"
}
```
...
```json
{
    ...
    "milestone": "sage-6.9",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/19268#event-174989"
}
```
