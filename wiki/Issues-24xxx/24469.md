...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24469#issuecomment-373069",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24469#issuecomment-373070",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24469#issuecomment-373071",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24469#event-219066"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24469#event-219067"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24469#issuecomment-373072",
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24469#event-219068"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24469",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24469#issuecomment-373073",
    "user": "https://github.com/slel"
}
```
