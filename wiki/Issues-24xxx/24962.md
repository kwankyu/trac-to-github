...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24962#issuecomment-382697",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24962",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24962#issuecomment-382698",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24962#event-223309"
}
```
