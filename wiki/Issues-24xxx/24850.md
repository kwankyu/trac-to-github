...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24850#event-222377"
}
```
...
```json
{
    ...
    "label": "trivial",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24850#event-222378"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24850#issuecomment-380471",
...
```json
{
    ...
    "label": "good first issue",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24850#event-222379"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24850#issuecomment-380472",
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24850#event-222380"
}
```
