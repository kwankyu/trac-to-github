...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24187#issuecomment-368449",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24187",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24187#event-216801"
}
```
...
```json
{
    ...
    "label": "worksforme",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24187#event-216802"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24187#issuecomment-368450",
    "user": "https://github.com/koffie"
}
```
