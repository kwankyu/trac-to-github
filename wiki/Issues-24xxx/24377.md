...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24377#issuecomment-371819",
    "user": "https://github.com/enriqueartal"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24377",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24377#event-218393"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24377#event-218394"
}
```
