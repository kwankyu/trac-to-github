...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24078#issuecomment-366386",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24078#event-215920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24078#issuecomment-366387",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24078#issuecomment-366388",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24078",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24078#issuecomment-366389",
    "user": "https://github.com/rwst"
}
```
