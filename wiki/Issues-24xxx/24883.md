...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341500"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341501"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341503"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24883#issuecomment-378384",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24883#issuecomment-378385",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24883#issuecomment-378386",
    "user": "https://github.com/sagetrac-ipasquinelli"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24883#issuecomment-378387",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24883#issuecomment-378388",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24883",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24883#issuecomment-378389",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341504"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341505"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341506"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341507"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341508"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341509"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341512"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341513"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341514"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341515"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341518"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341519"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341520"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341521"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24883",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24883#event-341522"
}
```
