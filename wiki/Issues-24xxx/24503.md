...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24503#event-219320"
}
```
...
```json
{
    ...
    "milestone": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24503#event-219321"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24503#issuecomment-373567",
    "user": "https://github.com/videlec"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24503#issuecomment-373568",
...
```json
{
    ...
    "milestone": "sage-8.6",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24503#event-219322"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24503#event-219323"
}
```
...
```json
{
    ...
    "milestone": "sage-8.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24503#event-219324"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24503#event-219325"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24503#issuecomment-373569",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "milestone": "sage-8.8",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24503#event-219326"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24503",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24503#issuecomment-373570",
    "user": "https://github.com/embray"
}
```
