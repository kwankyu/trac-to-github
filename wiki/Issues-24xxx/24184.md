...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24184#issuecomment-368416",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24184",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24184#event-216783"
}
```
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24184#event-216784"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24184",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24184#issuecomment-368417",
    "user": "https://github.com/jdemeyer"
}
```
