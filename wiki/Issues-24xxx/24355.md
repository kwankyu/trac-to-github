...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-334946"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-334947"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-334948"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-334949"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24355#issuecomment-368608",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24355#issuecomment-368609",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-334950"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-334951"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24355#issuecomment-368610",
    "user": "https://github.com/mezzarobba"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-334952"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-334953"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-334954"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24355#event-334955"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24355",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24355#issuecomment-368611",
    "user": "https://github.com/mezzarobba"
}
```
