...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24822#event-340799"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24822#event-340800"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24822#event-340801"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24822#event-340802"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24822#event-340803"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24822#issuecomment-377353",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24822#issuecomment-377354",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24822#issuecomment-377355",
    "user": "https://github.com/darijgr"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24822",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24822#issuecomment-377356",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24822#event-340804"
}
```
