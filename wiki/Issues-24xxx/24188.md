...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332850"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332852"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332853"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24188#issuecomment-365846",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332854"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332857"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332858"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24188",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24188#event-332861"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24188",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24188#issuecomment-365847",
    "user": "https://github.com/koffie"
}
```
