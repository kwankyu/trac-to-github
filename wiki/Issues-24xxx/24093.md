...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24093#issuecomment-366872",
    "user": "https://trac.sagemath.org/admin/accounts/users/clienkaemper"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24093",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24093#issuecomment-366873",
...
```json
{
    ...
    "milestone": "sage-8.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24093#event-216114"
}
```
