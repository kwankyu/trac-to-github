...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24534#event-337074"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24534#event-337075"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24534#event-337076"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24534#event-337077"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24534#event-337078"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24534#issuecomment-371497",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24534",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24534#event-337079"
}
```
...
```json
{
    ...
    "milestone_title": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24534#event-337080"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24534",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24534#issuecomment-371498",
    "user": "https://github.com/embray"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24534#event-337081"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24534#event-337082"
}
```
