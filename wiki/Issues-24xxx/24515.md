...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/24515#issuecomment-373750",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/24515",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24515#event-219436"
}
```
...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24515#event-219437"
}
```
...
```json
{
    ...
    "milestone": "sage-8.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/24515#event-219438"
}
```
