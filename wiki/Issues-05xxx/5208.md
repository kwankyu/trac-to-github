...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5208#event-60377"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5208#event-60378"
}
```
...
```json
{
    ...
    "title_was": "Differing behavior for matrix left_kernel vs. right_kernel",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5208#event-60379"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5208#event-60380"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5208#event-60381"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5208",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5208#event-60382"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5208",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5208#issuecomment-31902",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
