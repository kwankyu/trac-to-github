...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5113#event-59090"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5113#event-59091"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5113#event-59092"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5113#event-59093"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5113",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5113#issuecomment-31188",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5113#event-59094"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5113",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5113#event-59095"
}
```
