...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5104#event-58936"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5104#event-58937"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5104#event-58938"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5104#event-58939"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5104",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5104#issuecomment-31100",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5104#event-58940"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5104",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5104#event-58941"
}
```
