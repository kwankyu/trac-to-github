...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5760#event-67877"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5760#event-67878"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5760#event-67879"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5760#event-67880"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5760#event-67881"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5760",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5760#issuecomment-36516",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5760#event-67882"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5760",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5760#event-67883"
}
```
