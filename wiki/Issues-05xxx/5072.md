...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5072#event-58461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5072#event-58462"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5072#event-58463"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5072#event-58464"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5072",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5072#issuecomment-30786",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5072#event-58465"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5072",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5072#event-58466"
}
```
