...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5367#event-62553"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5367#event-62554"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5367#event-62555"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5367#event-62556"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5367",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5367#issuecomment-33105",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5367#event-62557"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5367",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5367#event-62558"
}
```
