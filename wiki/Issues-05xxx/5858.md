...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5858#event-69425"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5858#event-69426"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5858#event-69427"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5858#event-69428"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5858#event-69429"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5858#event-69430"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5858",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5858#event-69431"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5858",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5858#issuecomment-37720",
    "user": "https://github.com/sagetrac-mvngu"
}
```
