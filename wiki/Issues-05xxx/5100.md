...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5100#issuecomment-32253",
...
```json
{
    ...
    "label": "minor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31470"
}
```
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31471"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31472"
}
```
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31473"
}
```
...
```json
{
    ...
    "label": "blocker",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31474"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31475"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31476"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31477"
}
```
...
```json
{
    ...
    "asset_name": "trac_5100-empty-trash.patch",
    "asset_url": "tarball://root/attachments/ticket5100/trac_5100-empty-trash.patch",
    "created_at": "2009-12-05T12:04:38Z",
    "issue": "https://github.com/sagemath/sage/issues/5100",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5100/trac_5100-empty-trash.patch",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    "body": "**Attachment:** [trac_5100-empty-trash.patch](https://github.com/sagemath/sage/files/ticket5100/trac_5100-empty-trash.patch)\n\nAn attempt at fixing the bug.",
    "created_at": "2009-12-05T12:04:38Z",
    "issue": "https://github.com/sagemath/sage/issues/5100",
    "type": "issue_comment",
...
**Attachment:** [trac_5100-empty-trash.patch](https://github.com/sagemath/sage/files/ticket5100/trac_5100-empty-trash.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31478"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31479"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31480"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31481"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5100",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5100#event-31482"
}
```
