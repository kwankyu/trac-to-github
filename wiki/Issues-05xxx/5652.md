...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5652#event-66523"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5652#event-66524"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5652",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5652#issuecomment-35712",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5652#event-66525"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5652#event-66526"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5652#event-66527"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5652#event-66528"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5652",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5652#event-66529"
}
```
