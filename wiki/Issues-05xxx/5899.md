...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5899#event-69920"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5899#event-69921"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5899#event-69922"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5899#event-69923"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5899#event-69924"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5899#event-69925"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5899",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5899#event-69926"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5899",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5899#issuecomment-38065",
    "user": "https://github.com/mwhansen"
}
```
