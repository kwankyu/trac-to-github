...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5539#event-64979"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5539#event-64980"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5539#event-64981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5539#event-64982"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5539",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5539#issuecomment-34713",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5539#event-64983"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5539",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5539#event-64984"
}
```
