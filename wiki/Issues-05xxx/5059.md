...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5059#event-58271"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5059#event-58272"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5059#event-58273"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5059#event-58274"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5059",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5059#issuecomment-30735",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5059#event-58275"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5059",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5059#event-58276"
}
```
