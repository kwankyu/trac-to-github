...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5678#event-66853"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5678#event-66854"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5678#event-66855"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5678#event-66856"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5678",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5678#event-66857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5678",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5678#issuecomment-35970",
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5678#event-66858"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5678#event-66859"
}
```
