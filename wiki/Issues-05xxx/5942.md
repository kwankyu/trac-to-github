...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5942#event-70432"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5942#event-70433"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5942#event-70434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5942#event-70435"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5942",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5942#issuecomment-38408",
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5942#event-70436"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5942",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5942#event-70437"
}
```
