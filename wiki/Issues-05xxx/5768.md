...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5768#event-68033"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5768#event-68034"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5768#event-68035"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5768#event-68036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5768#event-68037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5768#event-68038"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5768",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5768#event-68039"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5768",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5768#issuecomment-36612",
    "user": "https://github.com/jdemeyer"
}
```
