...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5431#event-63445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5431#event-63446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5431#event-63447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5431#event-63448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5431#event-63449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5431",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5431#event-63450"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5431",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5431#issuecomment-33701",
    "user": "https://github.com/ncalexan"
}
```
