...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5167#event-59840"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5167#event-59841"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5167#event-59842"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5167#event-59843"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5167#event-59844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5167",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5167#issuecomment-31650",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5167",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5167#event-59845"
}
```
