...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5371#event-62611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5371#event-62612"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5371#event-62613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5371#event-62614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5371#event-62615"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5371",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5371#event-62616"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5371",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5371#issuecomment-33136",
    "user": "https://github.com/ncalexan"
}
```
