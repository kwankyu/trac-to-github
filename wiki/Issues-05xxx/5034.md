...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5034#event-57951"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5034#event-57952"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5034#event-57953"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5034#event-57954"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5034",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5034#issuecomment-30564",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5034#event-57955"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5034",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5034#event-57956"
}
```
