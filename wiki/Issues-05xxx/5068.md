...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5068#event-58407"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5068#event-58408"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5068#event-58409"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5068#event-58410"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5068",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5068#issuecomment-30775",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5068#event-58411"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5068",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5068#event-58412"
}
```
