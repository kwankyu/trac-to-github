...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5035#event-57961"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5035#event-57962"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5035#event-57963"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5035#event-57964"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5035",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5035#issuecomment-30569",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5035#event-57965"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5035",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5035#event-57966"
}
```
