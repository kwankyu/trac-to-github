...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5565#event-65341"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5565#event-65342"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5565#event-65343"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5565#event-65344"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5565",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5565#event-65345"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5565#event-65346"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5565",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5565#issuecomment-34926",
    "user": "https://github.com/zimmermann6"
}
```
