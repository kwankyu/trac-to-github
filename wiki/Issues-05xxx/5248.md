...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5248#event-60945"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5248#event-60946"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5248#event-60947"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5248",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5248#issuecomment-32160",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5248",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5248#event-60948"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5248#event-60949"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5248#event-60950"
}
```
