...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5771#event-68067"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5771#event-68068"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5771#event-68069"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5771#event-68070"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5771#event-68071"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5771",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5771#issuecomment-36629",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5771#event-68072"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5771",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5771#event-68073"
}
```
