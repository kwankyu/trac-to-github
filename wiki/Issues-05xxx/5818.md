...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5818#event-68806"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5818#event-68807"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5818#event-68808"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5818#event-68809"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5818#event-68810"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5818",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5818#issuecomment-37182",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5818#event-68811"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5818",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5818#event-68812"
}
```
