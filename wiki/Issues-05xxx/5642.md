...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5642#event-66402"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5642#event-66403"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5642#event-66404"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5642#event-66405"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5642#event-66406"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5642#event-66407"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5642",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5642#event-66408"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5642",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5642#issuecomment-35644",
    "user": "https://github.com/loefflerd"
}
```
