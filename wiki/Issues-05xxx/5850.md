...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5850#event-69298"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5850#event-69299"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5850#event-69300"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5850#event-69301"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5850#event-69302"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5850#event-69303"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5850",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5850#event-69304"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5850",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5850#issuecomment-37593",
    "user": "https://github.com/mezzarobba"
}
```
