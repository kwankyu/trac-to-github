...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5497#event-64400"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5497#event-64401"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5497#event-64402"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5497#event-64403"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5497",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5497#event-64404"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5497",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5497#issuecomment-34332",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5497#event-64405"
}
```
