...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5003#event-57604"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5003#event-57605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5003#event-57606"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5003#event-57607"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5003",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5003#issuecomment-30443",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5003#event-57608"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5003",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5003#event-57609"
}
```
