...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5504#event-64489"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5504#event-64490"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5504#event-64491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5504",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5504#event-64492"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5504",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5504#issuecomment-34381",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5504#event-64493"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5504#event-64494"
}
```
