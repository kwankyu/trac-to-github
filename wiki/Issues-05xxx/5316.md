...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5316#event-61919"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5316#event-61920"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5316#event-61921"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5316#event-61922"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5316",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5316#issuecomment-32781",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5316#event-61923"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5316",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5316#event-61924"
}
```
