...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5385#event-62788"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5385#event-62789"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5385",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5385#issuecomment-33212",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5385#event-62790"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5385#event-62791"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5385#event-62792"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5385",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5385#event-62793"
}
```
