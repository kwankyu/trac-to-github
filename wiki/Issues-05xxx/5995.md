...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5995#event-71285"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5995#event-71286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5995#event-71287"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5995#event-71288"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5995#event-71289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5995#event-71290"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5995",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5995#event-71291"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5995",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5995#issuecomment-39123",
    "user": "https://github.com/mwhansen"
}
```
