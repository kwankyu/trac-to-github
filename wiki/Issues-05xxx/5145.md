...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5145#event-59563"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5145#event-59564"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5145#event-59565"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5145#event-59566"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5145#event-59567"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5145",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5145#event-59568"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5145",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5145#issuecomment-31418",
    "user": "https://github.com/sagetrac-mvngu"
}
```
