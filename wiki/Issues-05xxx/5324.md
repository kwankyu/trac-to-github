...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5324#event-62024"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5324#event-62025"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5324#event-62026"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5324#event-62027"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5324",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5324#issuecomment-32816",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5324#event-62028"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5324",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5324#event-62029"
}
```
