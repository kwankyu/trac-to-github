...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5250#event-60978"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5250#event-60979"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5250#event-60980"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5250#event-60981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5250#event-60982"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5250",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5250#event-60983"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5250",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5250#issuecomment-32218",
    "user": "https://github.com/loefflerd"
}
```
