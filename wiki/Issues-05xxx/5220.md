...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-60542"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-60543"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5220#issuecomment-31983",
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-60544"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-60545"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-60546"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5220",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-60547"
}
```
