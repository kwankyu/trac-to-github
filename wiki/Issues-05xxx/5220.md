...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5220#issuecomment-33203",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5220",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5220#issuecomment-33204",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-32453"
}
```
...
```json
{
    "body": "**Attachment:** [trac_5220-referee.patch](https://github.com/sagemath/sage/files/ticket5220/trac_5220-referee.patch)",
    "created_at": "2009-03-05T05:18:39Z",
    "issue": "https://github.com/sagemath/sage/issues/5220",
    "type": "issue_comment",
...
**Attachment:** [trac_5220-referee.patch](https://github.com/sagemath/sage/files/ticket5220/trac_5220-referee.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-32454"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-32455"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-32456"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-32457"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-32458"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5220",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5220#event-32459"
}
```
