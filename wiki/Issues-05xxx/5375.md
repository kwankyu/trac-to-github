...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5375#event-62651"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5375#event-62652"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5375#event-62653"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5375#event-62654"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5375",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5375#issuecomment-33149",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5375#event-62655"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5375",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5375#event-62656"
}
```
