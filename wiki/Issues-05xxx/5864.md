...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5864#event-69495"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5864#event-69496"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5864#event-69497"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5864#event-69498"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5864",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5864#issuecomment-37756",
    "user": "https://github.com/peterjeremy"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5864#event-69499"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5864",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5864#event-69500"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5864#event-69501"
}
```
