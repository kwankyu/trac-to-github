...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5180#event-60034"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5180#event-60035"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5180#event-60036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5180#event-60037"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5180#event-60038"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5180",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5180#event-60039"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5180",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5180#issuecomment-31777",
    "user": "https://github.com/loefflerd"
}
```
