...
```json
{
    ...
    "subject": "https://github.com/nbruin",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5295#event-61618"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5295#event-61619"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5295#event-61620"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5295#event-61621"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5295",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5295#issuecomment-32596",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5295#event-61622"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5295",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5295#event-61623"
}
```
