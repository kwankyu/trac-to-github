...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5444",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5444#event-63613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5444#event-63614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5444#event-63615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5444#event-63616"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5444#event-63617"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5444",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5444#event-63618"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5444",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5444#issuecomment-33763",
    "user": "https://github.com/ncalexan"
}
```
