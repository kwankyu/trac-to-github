...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5037#event-57979"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5037#event-57980"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5037",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5037#issuecomment-30571",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5037#event-57981"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5037#event-57982"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5037",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5037#event-57983"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5037#event-57984"
}
```
