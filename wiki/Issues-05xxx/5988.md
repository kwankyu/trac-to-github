...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5988",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5988#issuecomment-39015",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5988#event-71170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5988#event-71171"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5988#event-71172"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5988#event-71173"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5988#event-71174"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5988#event-71175"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5988",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5988#event-71176"
}
```
