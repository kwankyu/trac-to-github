...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-63713"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-63714"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-63715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-63716"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5451#issuecomment-33873",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-63717"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5451",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5451#event-63718"
}
```
