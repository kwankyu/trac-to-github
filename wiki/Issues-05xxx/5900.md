...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5900#event-69929"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5900#event-69930"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5900#event-69931"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5900#event-69932"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5900#event-69933"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5900#event-69934"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5900",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5900#event-69935"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5900",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5900#issuecomment-38072",
    "user": "https://github.com/sagetrac-mvngu"
}
```
