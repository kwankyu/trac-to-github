...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5091",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5091#issuecomment-30936",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5091#event-58720"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5091#event-58721"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5091#event-58722"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5091#event-58723"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5091#event-58724"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5091",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5091#event-58725"
}
```
