...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5931#event-70322"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5931#event-70323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5931#event-70324"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5931#event-70325"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5931",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5931#event-70326"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5931#event-70327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5931",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5931#event-70328"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5931",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5931#issuecomment-38351",
    "user": "https://github.com/mwhansen"
}
```
