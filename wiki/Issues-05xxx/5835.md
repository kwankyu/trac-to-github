...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5835#event-69018"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5835",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5835#event-69019"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5835#event-69020"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5835",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5835#issuecomment-37286",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5835#event-69021"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5835#event-69022"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5835#event-69023"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5835#event-69024"
}
```
