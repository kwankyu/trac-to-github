...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5560#event-65281"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5560#event-65282"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5560#event-65283"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5560#event-65284"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5560",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5560#issuecomment-34878",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5560#event-65285"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5560",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5560#event-65286"
}
```
