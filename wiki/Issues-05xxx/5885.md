...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5885#event-69767"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5885#event-69768"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5885#event-69769"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5885#event-69770"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5885#event-69771"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5885",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5885#issuecomment-37956",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5885#event-69772"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5885",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5885#event-69773"
}
```
