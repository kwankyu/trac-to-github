...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5660#event-66630"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5660#event-66631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5660#event-66632"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5660#event-66633"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5660#event-66634"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5660#event-66635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5660",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5660#event-66636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5660",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5660#issuecomment-35827",
    "user": "https://github.com/JohnCremona"
}
```
