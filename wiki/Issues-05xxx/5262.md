...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5262#event-61153"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5262#event-61154"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5262#event-61155"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5262#event-61156"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5262#event-61157"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5262",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5262#event-61158"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5262",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5262#issuecomment-32309",
    "user": "https://github.com/loefflerd"
}
```
