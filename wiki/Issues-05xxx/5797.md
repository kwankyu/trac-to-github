...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5797#event-68488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5797#event-68489"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5797#event-68490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5797",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5797#issuecomment-36961",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5797#event-68491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5797",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5797#event-68492"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5797#event-68493"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5797#event-68494"
}
```
