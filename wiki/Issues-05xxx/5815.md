...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5815#event-68744"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5815#event-68745"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5815#event-68746"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5815#event-68747"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5815#event-68748"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5815",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5815#issuecomment-37144",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5815#event-68749"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5815",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5815#event-68750"
}
```
