...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5148#event-59600"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5148#event-59601"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5148#event-59602"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5148#event-59603"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5148#event-59604"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5148",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5148#event-59605"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5148",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5148#issuecomment-31445",
    "user": "https://github.com/haraldschilly"
}
```
