...
```json
{
    ...
    "label": "bug",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33265"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33266"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5313/Singular_error.patch",
    "created_at": "2010-07-14T20:53:05Z",
    "issue": "https://github.com/sagemath/sage/issues/5313",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5313/Singular_error.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [Singular_error.patch](https://github.com/sagemath/sage/files/ticket5313/Singular_error.patch)\n\nNOTE to future self:\n\nTo work on singular:\n\n1. sage -f -m singular-x.y.z.spkg\n2. cd spkg/build/singular-x.y.z\n3. Make changes\n4. Type `make install-libsingular`",
    "created_at": "2010-07-14T20:53:05Z",
    "issue": "https://github.com/sagemath/sage/issues/5313",
    "type": "issue_comment",
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5313/trac_5313-sigon_sigoff.patch",
    "created_at": "2010-07-14T21:36:57Z",
    "issue": "https://github.com/sagemath/sage/issues/5313",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5313/trac_5313-sigon_sigoff.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "**Attachment:** [trac_5313-sigon_sigoff.patch](https://github.com/sagemath/sage/files/ticket5313/trac_5313-sigon_sigoff.patch)\n\nthis is a patch to the singular spkg.  It patches a patch file.",
    "created_at": "2010-07-14T21:36:57Z",
    "issue": "https://github.com/sagemath/sage/issues/5313",
    "type": "issue_comment",
...
**Attachment:** [trac_5313-sigon_sigoff.patch](https://github.com/sagemath/sage/files/ticket5313/trac_5313-sigon_sigoff.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33267"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5313/singular-spkg_add_abort.patch",
    "created_at": "2010-07-14T21:37:22Z",
    "issue": "https://github.com/sagemath/sage/issues/5313",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5313/singular-spkg_add_abort.patch",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    "body": "<a id='comment:6'></a>\n**Attachment:** [singular-spkg_add_abort.patch](https://github.com/sagemath/sage/files/ticket5313/singular-spkg_add_abort.patch)",
    "created_at": "2010-07-14T21:37:22Z",
    "issue": "https://github.com/sagemath/sage/issues/5313",
    "type": "issue_comment",
...
```json
{
    "body": "<a id='comment:7'></a>\nThis patch https://github.com/sagemath/sage/files/ticket5313/Singular_error.patch is already included in #8059.",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33268"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33269"
}
```
...
```json
{
    ...
    "milestone": "sage-5.11",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33270"
}
```
...
```json
{
    ...
    "milestone": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33271"
}
```
...
```json
{
    ...
    "milestone": "sage-6.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33272"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33273"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33274"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33275"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33276"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33277"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5313#event-33278"
}
```
