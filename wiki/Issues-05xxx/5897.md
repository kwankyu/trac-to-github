...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5897#event-69900"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5897#event-69901"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5897#event-69902"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5897#event-69903"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5897#event-69904"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5897",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5897#issuecomment-38053",
    "user": "https://github.com/qed777"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5897#event-69905"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5897",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5897#event-69906"
}
```
