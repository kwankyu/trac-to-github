...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5756#event-67822"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5756#event-67823"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5756#event-67824"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5756#event-67825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5756#event-67826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5756#event-67827"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5756",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5756#event-67828"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5756",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5756#issuecomment-36487",
    "user": "https://github.com/robertwb"
}
```
