...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5084#event-58638"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5084#event-58639"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5084#event-58640"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5084#event-58641"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5084",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5084#issuecomment-30900",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5084#event-58642"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5084",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5084#event-58643"
}
```
