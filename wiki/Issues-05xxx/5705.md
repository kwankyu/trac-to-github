...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5705#event-67158"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5705#event-67159"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5705#event-67160"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5705#event-67161"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5705#event-67162"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5705#event-67163"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5705",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5705#event-67164"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5705",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5705#issuecomment-36115",
    "user": "https://github.com/malb"
}
```
