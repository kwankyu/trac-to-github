...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5646#event-66443"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5646#event-66444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5646#event-66445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5646#event-66446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5646#event-66447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5646#event-66448"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5646",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5646#event-66449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5646",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5646#issuecomment-35668",
    "user": "https://github.com/jdemeyer"
}
```
