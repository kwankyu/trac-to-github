...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5187#event-60119"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5187#event-60120"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5187#event-60121"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5187",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5187#event-60122"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5187#event-60123"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5187#event-60124"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5187#issuecomment-31811",
    "user": "https://github.com/williamstein"
}
```
