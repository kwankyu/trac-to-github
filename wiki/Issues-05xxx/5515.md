...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5515#event-64663"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5515#event-64664"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5515#event-64665"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5515#event-64666"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5515#event-64667"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5515",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5515#issuecomment-34497",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5515",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5515#event-64668"
}
```
