...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5379#event-62705"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5379#event-62706"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5379",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5379#issuecomment-33167",
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5379#event-62707"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5379#event-62708"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5379#event-62709"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5379",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5379#event-62710"
}
```
