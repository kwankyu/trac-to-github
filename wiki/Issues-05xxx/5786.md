...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5786#event-68276"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5786",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5786#event-68277"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5786#event-68278"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5786#event-68279"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5786#event-68280"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5786",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5786#issuecomment-36759",
    "user": "https://github.com/TimDumol"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5786#event-68281"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5786#event-68282"
}
```
