...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5743#event-67654"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5743#event-67655"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5743#event-67656"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5743#event-67657"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5743#event-67658"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5743",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5743#issuecomment-36413",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5743#event-67659"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5743",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5743#event-67660"
}
```
