...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5855#event-69386"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5855#event-69387"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5855#event-69388"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5855#event-69389"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5855",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5855#event-69390"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5855",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5855#issuecomment-37694",
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5855#event-69391"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5855#event-69392"
}
```
