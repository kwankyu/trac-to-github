...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5810#event-68669"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5810#event-68670"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5810#event-68671"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5810#event-68672"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5810#event-68673"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5810",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5810#issuecomment-37093",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5810",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5810#event-68674"
}
```
