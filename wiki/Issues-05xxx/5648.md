...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5648#event-66462"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5648#event-66463"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5648#event-66464"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5648#event-66465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5648#event-66466"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5648#event-66467"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5648",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5648#event-66468"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5648",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5648#issuecomment-35676",
    "user": "https://github.com/loefflerd"
}
```
