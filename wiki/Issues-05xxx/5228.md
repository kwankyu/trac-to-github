...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5228#event-60650"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5228#event-60651"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5228",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5228#issuecomment-32039",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5228#event-60652"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5228",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5228#event-60653"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5228#event-60654"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5228#event-60655"
}
```
