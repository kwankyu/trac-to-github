...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5215#event-60460"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5215#event-60461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5215#event-60462"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5215#event-60463"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5215",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5215#issuecomment-31942",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5215#event-60464"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5215",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5215#event-60465"
}
```
