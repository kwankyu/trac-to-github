...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5535#event-64915"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5535#event-64916"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5535#event-64917"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5535#event-64918"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5535",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5535#event-64919"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5535#event-64920"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5535",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5535#issuecomment-34666",
    "user": "https://github.com/rhinton"
}
```
