...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5510#event-64576"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5510#event-64577"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5510#event-64578"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5510#event-64579"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5510#event-64580"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5510",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5510#event-64581"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5510",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5510#issuecomment-34420",
    "user": "https://github.com/ncalexan"
}
```
