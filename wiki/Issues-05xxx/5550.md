...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5550#event-65137"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5550#event-65138"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5550",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5550#issuecomment-34782",
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5550#event-65139"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5550",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5550#event-65140"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5550#event-65141"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5550#event-65142"
}
```
