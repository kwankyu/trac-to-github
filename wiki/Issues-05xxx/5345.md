...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5345#event-62306"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5345#event-62307"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5345#event-62308"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5345#event-62309"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5345#event-62310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5345",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5345#event-62311"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5345",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5345#issuecomment-32977",
    "user": "https://github.com/sagetrac-mvngu"
}
```
