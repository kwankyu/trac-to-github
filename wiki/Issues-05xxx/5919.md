...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5919#event-70143"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5919#event-70144"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5919#event-70145"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5919#event-70146"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5919#event-70147"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5919",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5919#issuecomment-38223",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5919#event-70148"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5919",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5919#event-70149"
}
```
