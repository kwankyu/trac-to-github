...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5675#event-66825"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5675#event-66826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5675#event-66827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5675#event-66828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5675#event-66829"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5675#event-66830"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5675",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5675#event-66831"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5675",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5675#issuecomment-35960",
    "user": "https://github.com/qed777"
}
```
