...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5908#event-70015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5908#event-70016"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5908#event-70017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5908#event-70018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5908#event-70019"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5908",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5908#event-70020"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5908#event-70021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5908",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5908#issuecomment-38138",
    "user": "https://github.com/rkirov"
}
```
