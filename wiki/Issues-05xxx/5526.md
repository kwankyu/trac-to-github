...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5526#event-64801"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5526#event-64802"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5526#event-64803"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5526#event-64804"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5526",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5526#issuecomment-34617",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5526#event-64805"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5526",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5526#event-64806"
}
```
