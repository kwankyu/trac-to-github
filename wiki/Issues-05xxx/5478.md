...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5478#event-64097"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5478#event-64098"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5478#event-64099"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5478#event-64100"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5478",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5478#event-64101"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5478",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5478#issuecomment-34144",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5478#event-64102"
}
```
