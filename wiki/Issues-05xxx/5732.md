...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5732#event-67498"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5732#event-67499"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5732#event-67500"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5732#event-67501"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5732#event-67502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5732#event-67503"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5732",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5732#event-67504"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5732",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5732#issuecomment-36315",
    "user": "https://github.com/mwhansen"
}
```
