...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5723#event-67379"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5723#event-67380"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5723#event-67381"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5723#event-67382"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5723",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5723#issuecomment-36247",
    "user": "https://github.com/ncalexan"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5723#event-67383"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5723#event-67384"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5723",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5723#event-67385"
}
```
