...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5781#event-68214"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5781#event-68215"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5781#event-68216"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5781#event-68217"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5781#event-68218"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5781",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5781#issuecomment-36732",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5781#event-68219"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5781",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5781#event-68220"
}
```
