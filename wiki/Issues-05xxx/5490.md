...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64289"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64291"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64292"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64293"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5490#issuecomment-34269",
...
```json
{
    ...
    "title_was": "Easter!",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64294"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64295"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5490#issuecomment-34270",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5490#issuecomment-34271",
    "user": "https://github.com/sagetrac-psinis"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5490#issuecomment-34273",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64296"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5490#issuecomment-34274",
    "user": "https://github.com/sagetrac-psinis"
}
```
...
```json
{
    "body": "<div id=\"comment:7\" align=\"right\">comment:7</div>\n\nReplying to [@sagetrac-psinis](#comment%3A6):\n> What's the next step...?\n\nEr...whatever you like, I suppose!",
    "created_at": "2009-03-17T12:16:25Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5490#issuecomment-34275",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5490#issuecomment-34276",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5490#issuecomment-34277",
    "user": "https://github.com/cswiercz"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5490#issuecomment-34278",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64298"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64299"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5490",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5490#issuecomment-34279",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64300"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5490#event-64301"
}
```
