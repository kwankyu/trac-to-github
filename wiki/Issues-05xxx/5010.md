...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5010",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5010#issuecomment-31635",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5010#event-30772"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5010#event-30773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5010",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5010#event-30774"
}
```
