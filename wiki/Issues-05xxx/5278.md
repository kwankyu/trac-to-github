...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-61354"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5278",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5278#issuecomment-32391",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-61355"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5278",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-61356"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-61357"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-61358"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5278",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5278#event-61359"
}
```
