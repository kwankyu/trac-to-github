...
```json
{
    ...
    "title_was": "Doctest failure in devel/sage/doc/en/bordeaux_2008/method_of_graphs.rst",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-63408"
}
```
...
```json
{
    ...
    "title_was": "[not ready for review] Doctest failure in devel/sage/doc/en/bordeaux_2008/method_of_graphs.rst",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-63409"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-63410"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-63411"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-63412"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5428",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5428#event-63413"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5428",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5428#issuecomment-33682",
    "user": "https://github.com/sagetrac-GeorgSWeber"
}
```
