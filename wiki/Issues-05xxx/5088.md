...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5088#event-58671"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5088#event-58672"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5088#event-58673"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5088#event-58674"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5088#event-58675"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5088",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5088#event-58676"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5088",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5088#issuecomment-30920",
    "user": "https://github.com/slel"
}
```
