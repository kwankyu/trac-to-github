...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5209#event-60387"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5209#event-60388"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5209#event-60389"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5209#event-60390"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5209",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5209#issuecomment-31907",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5209#event-60391"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5209",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5209#event-60392"
}
```
