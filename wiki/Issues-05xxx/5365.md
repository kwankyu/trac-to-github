...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5365#event-33634"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5365",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5365#event-33635"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5365#event-33636"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5365#issuecomment-34358",
    "user": "https://trac.sagemath.org/admin/accounts/users/ekirkman"
}
```
