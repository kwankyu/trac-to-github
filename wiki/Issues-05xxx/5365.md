...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5365#event-62530"
}
```
...
```json
{
    ...
    "subject": "https://github.com/sagetrac-ekirkman",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5365#event-62531"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5365#event-62532"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5365#event-62533"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5365",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5365#event-62534"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5365#event-62535"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5365",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5365#issuecomment-33091",
    "user": "https://github.com/sagetrac-ekirkman"
}
```
