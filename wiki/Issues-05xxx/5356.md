...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5356#event-62428"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5356#event-62429"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5356#event-62430"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5356#event-62431"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5356",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5356#issuecomment-33041",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5356#event-62432"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5356",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5356#event-62433"
}
```
