...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5216#event-60470"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5216#event-60471"
}
```
...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5216#event-60472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5216#event-60473"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5216",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5216#issuecomment-31946",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5216#event-60474"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5216",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5216#event-60475"
}
```
