...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5733#event-67510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5733#event-67511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5733#event-67512"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5733#event-67513"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5733#event-67514"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5733",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5733#issuecomment-36319",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5733#event-67515"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5733",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5733#event-67516"
}
```
