...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-65472"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-65473"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-65474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-65475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-65476"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5573",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5573#issuecomment-35045",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-65477"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5573",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5573#event-65478"
}
```
