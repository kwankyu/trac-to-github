...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5154#event-59668"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5154#event-59669"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5154#event-59670"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5154#event-59671"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5154",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5154#issuecomment-31501",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5154#event-59672"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5154",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5154#event-59673"
}
```
