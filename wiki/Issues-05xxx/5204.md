...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5204#event-60329"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5204#event-60330"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5204#event-60331"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5204#event-60332"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5204",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5204#issuecomment-31881",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5204#event-60333"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5204",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5204#event-60334"
}
```
