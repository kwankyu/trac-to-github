...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5687#event-66963"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5687#event-66964"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5687#event-66965"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5687#event-66966"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5687#event-66967"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5687",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5687#issuecomment-36026",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5687#event-66968"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5687",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5687#event-66969"
}
```
