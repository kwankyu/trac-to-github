...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5058#event-58258"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5058#event-58259"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5058#event-58260"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5058#event-58261"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5058",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5058#issuecomment-30729",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5058#event-58262"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5058",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5058#event-58263"
}
```
