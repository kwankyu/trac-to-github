...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5599#event-65828"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5599#event-65829"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5599#event-65830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5599#event-65831"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5599#event-65832"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5599#event-65833"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5599",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5599#event-65834"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5599",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5599#issuecomment-35257",
    "user": "https://github.com/mwhansen"
}
```
