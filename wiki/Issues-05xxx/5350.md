...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5350#event-62359"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5350#event-62360"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5350#event-62361"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5350",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5350#event-62362"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5350#event-62363"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5350#event-62364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5350",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5350#issuecomment-33007",
    "user": "https://github.com/rlmill"
}
```
