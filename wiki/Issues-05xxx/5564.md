...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5564",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5564#event-65333"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5564",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5564#event-65334"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.1.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5564#event-65335"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5564#event-65336"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5564#event-65337"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5564",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5564#event-65338"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5564",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5564#issuecomment-34920",
    "user": "https://github.com/sagetrac-mvngu"
}
```
