...
```json
{
    ...
    "subject": "https://github.com/tornaria",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5517#event-64683"
}
```
...
```json
{
    ...
    "subject": "https://github.com/tornaria",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5517#event-64684"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5517#event-64685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5517#event-64686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5517#event-64687"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5517",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5517#event-64688"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5517",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5517#issuecomment-34511",
