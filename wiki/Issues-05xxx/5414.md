...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5414#event-63184"
}
```
...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5414#event-63185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5414#event-63186"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5414#event-63187"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5414#event-63188"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5414",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5414#event-63189"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5414",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5414#issuecomment-33555",
    "user": "https://github.com/mwhansen"
}
```
