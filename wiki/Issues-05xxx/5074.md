...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5074#event-58491"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5074",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5074#issuecomment-30808",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-5.12",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5074#event-58492"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5074#event-58493"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5074#event-58494"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5074#event-58495"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5074",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5074#event-58496"
}
```
