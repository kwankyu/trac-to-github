...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-57888"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-57889"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-57890"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-57891"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5028",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5028#issuecomment-30538",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-57892"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5028",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-57893"
}
```
