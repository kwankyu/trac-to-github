...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5028",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5028#issuecomment-31716",
    "user": "https://github.com/seblabbe"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-30887"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-30888"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-30889"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-30890"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5028",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5028#event-30891"
}
```
