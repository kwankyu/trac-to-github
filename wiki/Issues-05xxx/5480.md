...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5480#event-64132"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5480#event-64133"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5480#event-64134"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5480#event-64135"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5480",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5480#issuecomment-34158",
    "user": "https://github.com/mwhansen"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5480#event-64136"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5480",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5480#event-64137"
}
```
