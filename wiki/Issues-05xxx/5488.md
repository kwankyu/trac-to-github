...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5488#event-64264"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5488#event-64265"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5488#event-64266"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5488#event-64267"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5488",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5488#issuecomment-34246",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5488#event-64268"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5488",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5488#event-64269"
}
```
