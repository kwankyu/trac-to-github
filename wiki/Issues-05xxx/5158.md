...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5158#event-59736"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5158#event-59737"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5158#event-59738"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5158#event-59739"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5158",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5158#issuecomment-31582",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5158#event-59740"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5158",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5158#event-59741"
}
```
