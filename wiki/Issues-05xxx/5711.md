...
```json
{
    ...
    "asset_name": "enhanced-typesetting-of-symbolic-functions.patch",
    "asset_url": "tarball://root/attachments/ticket5711/enhanced-typesetting-of-symbolic-functions.patch",
    "created_at": "2009-04-08T11:55:50Z",
    "issue": "https://github.com/sagemath/sage/issues/5711",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5711/enhanced-typesetting-of-symbolic-functions.patch",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    "body": "**Attachment:** [enhanced-typesetting-of-symbolic-functions.patch](https://github.com/sagemath/sage/files/ticket5711/enhanced-typesetting-of-symbolic-functions.patch)",
    "created_at": "2009-04-08T11:55:50Z",
    "issue": "https://github.com/sagemath/sage/issues/5711",
    "type": "issue_comment",
...
**Attachment:** [enhanced-typesetting-of-symbolic-functions.patch](https://github.com/sagemath/sage/files/ticket5711/enhanced-typesetting-of-symbolic-functions.patch)
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36431"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36432"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36433"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36434"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36435"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36436"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36437"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "enhanced-symbolic-typesetting-rebased_to_4.0.1.patch",
    "asset_url": "tarball://root/attachments/ticket5711/enhanced-symbolic-typesetting-rebased_to_4.0.1.patch",
    "created_at": "2009-06-13T00:14:49Z",
    "issue": "https://github.com/sagemath/sage/issues/5711",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5711/enhanced-symbolic-typesetting-rebased_to_4.0.1.patch",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    "body": "**Attachment:** [enhanced-symbolic-typesetting-rebased_to_4.0.1.patch](https://github.com/sagemath/sage/files/ticket5711/enhanced-symbolic-typesetting-rebased_to_4.0.1.patch)",
    "created_at": "2009-06-13T00:14:49Z",
    "issue": "https://github.com/sagemath/sage/issues/5711",
    "type": "issue_comment",
...
**Attachment:** [enhanced-symbolic-typesetting-rebased_to_4.0.1.patch](https://github.com/sagemath/sage/files/ticket5711/enhanced-symbolic-typesetting-rebased_to_4.0.1.patch)
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36438"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36439"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36440"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36441"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36442"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36443"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_5711-enhanced-symbolic-typesetting-rebased_to_4.0.2.patch",
    "asset_url": "tarball://root/attachments/ticket5711/trac_5711-enhanced-symbolic-typesetting-rebased_to_4.0.2.patch",
    "created_at": "2009-06-23T11:33:05Z",
    "issue": "https://github.com/sagemath/sage/issues/5711",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5711/trac_5711-enhanced-symbolic-typesetting-rebased_to_4.0.2.patch",
    "user": "https://github.com/golam-m-hossain"
}
```
...
```json
{
    "body": "**Attachment:** [trac_5711-enhanced-symbolic-typesetting-rebased_to_4.0.2.patch](https://github.com/sagemath/sage/files/ticket5711/trac_5711-enhanced-symbolic-typesetting-rebased_to_4.0.2.patch)",
    "created_at": "2009-06-23T11:33:05Z",
    "issue": "https://github.com/sagemath/sage/issues/5711",
    "type": "issue_comment",
...
**Attachment:** [trac_5711-enhanced-symbolic-typesetting-rebased_to_4.0.2.patch](https://github.com/sagemath/sage/files/ticket5711/trac_5711-enhanced-symbolic-typesetting-rebased_to_4.0.2.patch)
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36444"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36445"
}
```
...
{
    "asset_content_type": "application/octet-stream",
    "asset_name": "trac_5711-doctest_fixes.patch",
    "asset_url": "tarball://root/attachments/ticket5711/trac_5711-doctest_fixes.patch",
    "created_at": "2009-06-23T13:28:06Z",
    "issue": "https://github.com/sagemath/sage/issues/5711",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5711/trac_5711-doctest_fixes.patch",
    "user": "https://github.com/burcin"
}
```
...
```json
{
    "body": "**Attachment:** [trac_5711-doctest_fixes.patch](https://github.com/sagemath/sage/files/ticket5711/trac_5711-doctest_fixes.patch)\n\ndoctest fixes",
    "created_at": "2009-06-23T13:28:06Z",
    "issue": "https://github.com/sagemath/sage/issues/5711",
    "type": "issue_comment",
...
**Attachment:** [trac_5711-doctest_fixes.patch](https://github.com/sagemath/sage/files/ticket5711/trac_5711-doctest_fixes.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36446"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36447"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36448"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5711",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5711#event-36449"
}
```
