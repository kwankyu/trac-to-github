...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5325#event-62032"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5325#event-62033"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5325#event-62034"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5325#event-62035"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5325",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5325#issuecomment-32818",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5325#event-62036"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5325#event-62037"
}
```
