...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5437#event-63509"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5437#event-63510"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5437#event-63511"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5437#event-63512"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5437",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5437#issuecomment-33726",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5437#event-63513"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5437",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5437#event-63514"
}
```
