...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5997#event-71316"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5997#event-71317"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5997#event-71318"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5997#event-71319"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5997",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5997#event-71320"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5997#event-71321"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5997#event-71322"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5997",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5997#issuecomment-39157",
    "user": "https://github.com/loefflerd"
}
```
