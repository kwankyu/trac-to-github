...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5373#event-62631"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5373#event-62632"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5373#event-62633"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5373#event-62634"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5373",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5373#issuecomment-33143",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5373#event-62635"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5373",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5373#event-62636"
}
```
