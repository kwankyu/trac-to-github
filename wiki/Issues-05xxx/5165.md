...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5165#event-59824"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5165#event-59825"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5165#event-59826"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5165#event-59827"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5165#event-59828"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5165",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5165#event-59829"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5165",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5165#issuecomment-31645",
    "user": "https://github.com/jhpalmieri"
}
```
