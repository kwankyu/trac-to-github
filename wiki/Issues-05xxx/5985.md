...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5985#event-71123"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5985#event-71124"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5985#event-71125"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5985#event-71126"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5985#event-71127"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5985#event-71128"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5985",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5985#event-71129"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5985",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5985#issuecomment-38991",
    "user": "https://github.com/mwhansen"
}
```
