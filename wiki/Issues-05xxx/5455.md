...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5455#event-63770"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5455#event-63771"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5455#event-63772"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5455#event-63773"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5455",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5455#issuecomment-33935",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5455#event-63774"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5455",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5455#event-63775"
}
```
