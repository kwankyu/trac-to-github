...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-66011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-66012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-66013"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-66014"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-66015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-66016"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5612",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5612#event-66017"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5612",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5612#issuecomment-35446",
    "user": "https://github.com/jdemeyer"
}
```
