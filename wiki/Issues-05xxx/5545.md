...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5545",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5545#issuecomment-34749",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5545#event-65066"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5545#event-65067"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5545#event-65068"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5545",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5545#event-65069"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5545#event-65070"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5545#event-65071"
}
```
