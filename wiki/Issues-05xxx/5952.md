...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5952#event-70593"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5952#event-70594"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5952#event-70595"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5952#event-70596"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5952",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5952#event-70597"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5952",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5952#issuecomment-38514",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5952#event-70598"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5952#event-70599"
}
```
