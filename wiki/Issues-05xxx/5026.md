...
```json
{
    ...
    "subject": "https://github.com/craigcitro",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5026#event-57868"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5026#event-57869"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5026#event-57870"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5026#event-57871"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5026",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5026#issuecomment-30531",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5026#event-57872"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5026",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5026#event-57873"
}
```
