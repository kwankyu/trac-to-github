...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5649#event-66474"
}
```
...
```json
{
    ...
    "subject": "https://github.com/kcrisman",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5649#event-66475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5649#event-66476"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5649#event-66477"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5649#event-66478"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5649#event-66479"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5649",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5649#event-66480"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5649",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5649#issuecomment-35687",
    "user": "https://github.com/kcrisman"
}
```
