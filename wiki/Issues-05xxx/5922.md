...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5922#event-70200"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5922#event-70201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5922#event-70202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5922",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5922#event-70203"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5922",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5922#issuecomment-38263",
    "user": "https://github.com/sagetrac-mvngu"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5922#event-70204"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5922#event-70205"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5922#event-70206"
}
```
