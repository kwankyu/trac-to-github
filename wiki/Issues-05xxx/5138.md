...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5138#event-59445"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5138#event-59446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5138#event-59447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5138#event-59448"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5138",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5138#issuecomment-31367",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5138#event-59449"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5138",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5138#event-59450"
}
```
