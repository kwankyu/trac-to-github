...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5650#event-66485"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5650#event-66486"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5650#event-66487"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5650#event-66488"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5650#event-66489"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5650",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5650#issuecomment-35691",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5650#event-66490"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5650",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5650#event-66491"
}
```
