...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5272#event-61284"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5272#event-61285"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5272#event-61286"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5272#event-61287"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5272",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5272#issuecomment-32360",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5272#event-61288"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5272",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5272#event-61289"
}
```
