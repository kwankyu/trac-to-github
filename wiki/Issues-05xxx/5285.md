...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5285#event-61473"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5285#event-61474"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5285#event-61475"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5285#event-61476"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5285",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5285#issuecomment-32499",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5285#event-61477"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5285",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5285#event-61478"
}
```
