...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5724#event-67392"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5724#event-67393"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5724#event-67394"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5724#event-67395"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5724",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5724#event-67396"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5724#event-67397"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5724",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5724#event-67398"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5724",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5724#issuecomment-36258",
    "user": "https://github.com/williamstein"
}
```
