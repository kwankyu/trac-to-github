...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5575#event-65514"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5575#event-65515"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5575#event-65516"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5575#event-65517"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5575#event-65518"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5575",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5575#issuecomment-35086",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5575#event-65519"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5575",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5575#event-65520"
}
```
