...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64228"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64229"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64231"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5486",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5486#issuecomment-34214",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64232"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5486",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5486#event-64233"
}
```
