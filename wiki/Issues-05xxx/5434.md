...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5434#event-63480"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5434#event-63481"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5434#event-63482"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5434#event-63483"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5434",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5434#issuecomment-33714",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5434#event-63484"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5434",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5434#event-63485"
}
```
