...
```json
{
    ...
    "milestone": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5390#event-33802"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5390#event-33803"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5390#event-33804"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5390#event-33805"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5390#event-33806"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5390",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5390#event-33807"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5390",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5390#issuecomment-34514",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "milestone": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5390#event-33808"
}
```
