...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-59052"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-59053"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5111",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5111#issuecomment-31168",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-59054"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-59055"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-59056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5111",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5111#event-59057"
}
```
