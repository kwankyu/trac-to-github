...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5050#event-58169"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5050#event-58170"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5050#event-58171"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5050#event-58172"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5050",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5050#issuecomment-30697",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5050#event-58173"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5050",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5050#event-58174"
}
```
