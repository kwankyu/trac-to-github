...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5280#event-61399"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5280#event-61400"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5280#event-61401"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5280#event-61402"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5280",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5280#event-61403"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5280",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5280#issuecomment-32415",
    "user": "https://github.com/rlmill"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5280#event-61404"
}
```
