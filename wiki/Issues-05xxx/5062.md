...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5062#event-58320"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5062#event-58321"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5062",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5062#issuecomment-30753",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5062#event-58322"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5062#event-58323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5062#event-58324"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5062",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5062#event-58325"
}
```
