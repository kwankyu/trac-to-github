...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5808#event-68646"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5808#event-68647"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5808#event-68648"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5808#event-68649"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5808#event-68650"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5808",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5808#issuecomment-37083",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5808#event-68651"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5808",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5808#event-68652"
}
```
