...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5283#event-61443"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5283#event-61444"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5283#event-61445"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5283",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5283#issuecomment-32484",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5283#event-61446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5283#event-61447"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5283",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5283#event-61448"
}
```
