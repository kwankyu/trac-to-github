...
```json
{
    ...
    "title_was": "faster sr",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5586#event-65650"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5586#event-65651"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5586#event-65652"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5586",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5586#issuecomment-35147",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5586#event-65653"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5586",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5586#event-65654"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5586#event-65655"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5586#event-65656"
}
```
