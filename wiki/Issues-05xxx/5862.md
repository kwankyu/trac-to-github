...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5862#event-69468"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5862#event-69469"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5862#event-69470"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5862",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5862#event-69471"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5862",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5862#issuecomment-37747",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5862#event-69472"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5862#event-69473"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5862",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5862#event-69474"
}
```
