...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5241#event-60848"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5241#event-60849"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5241#event-60850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5241#event-60851"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5241#event-60852"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5241",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5241#event-60853"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5241",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5241#issuecomment-32117",
    "user": "https://github.com/mwhansen"
}
```
