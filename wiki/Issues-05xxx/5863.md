...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5863#event-69479"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5863#event-69480"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5863#event-69481"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5863",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5863#issuecomment-37750",
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5863#event-69482"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5863#event-69483"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5863#event-69484"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5863",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5863#event-69485"
}
```
