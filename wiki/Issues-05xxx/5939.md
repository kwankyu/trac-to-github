...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5939#event-70401"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5939#event-70402"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5939#event-70403"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5939#event-70404"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5939#event-70405"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5939",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5939#issuecomment-38393",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5939#event-70406"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5939",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5939#event-70407"
}
```
