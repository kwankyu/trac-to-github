...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5363#event-62513"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5363#event-62514"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5363#event-62515"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5363#event-62516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5363",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5363#issuecomment-33088",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5363#event-62517"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5363",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5363#event-62518"
}
```
