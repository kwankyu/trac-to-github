...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5255#event-61046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5255#event-61047"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5255#event-61048"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5255#event-61049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5255",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5255#issuecomment-32255",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5255#event-61050"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5255",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5255#event-61051"
}
```
