...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5683#event-66911"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5683#event-66912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5683#event-66913"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5683#event-66914"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5683#event-66915"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5683",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5683#issuecomment-35993",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5683#event-66916"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5683",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5683#event-66917"
}
```
