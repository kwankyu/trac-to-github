...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5044#event-31003"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5044",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5044#issuecomment-31818",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label": "critical",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5044#event-31004"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5044#event-31005"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5044#event-31006"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5044#event-31007"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5044",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5044#event-31008"
}
```
