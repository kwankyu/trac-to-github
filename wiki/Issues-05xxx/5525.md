...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5525#event-64791"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5525#event-64792"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5525",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5525#issuecomment-34614",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5525#event-64793"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5525#event-64794"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5525#event-64795"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5525",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5525#event-64796"
}
```
