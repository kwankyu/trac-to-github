...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5157#event-59725"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5157#event-59726"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5157#event-59727"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5157#event-59728"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5157",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5157#issuecomment-31579",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5157#event-59729"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5157",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5157#event-59730"
}
```
