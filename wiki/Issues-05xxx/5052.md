...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5052#event-58187"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5052#event-58188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5052#event-58189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5052#event-58190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5052",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5052#issuecomment-30704",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5052#event-58191"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5052",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5052#event-58192"
}
```
