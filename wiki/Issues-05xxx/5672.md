...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5672#event-66787"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5672#event-66788"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5672#event-66789"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5672#event-66790"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5672#event-66791"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5672",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5672#issuecomment-35931",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5672#event-66792"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5672",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5672#event-66793"
}
```
