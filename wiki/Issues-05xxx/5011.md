...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5011#issuecomment-31638",
    "user": "https://github.com/craigcitro"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5011#event-30775"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5011#event-30776"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5011",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5011#event-30777"
}
```
