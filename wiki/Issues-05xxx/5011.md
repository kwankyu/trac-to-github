...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5011#event-57683"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5011#event-57684"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5011#event-57685"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5011#event-57686"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5011",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5011#issuecomment-30462",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5011#event-57687"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5011",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5011#event-57688"
}
```
