...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5225#event-60613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5225#event-60614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5225#event-60615"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5225#event-60616"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5225",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5225#issuecomment-32010",
    "user": "https://github.com/mkoeppe"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5225#event-60617"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5225",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5225#event-60618"
}
```
