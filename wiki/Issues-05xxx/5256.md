...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5256#event-61057"
}
```
...
```json
{
    ...
    "subject": "https://github.com/hivert",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5256#event-61058"
}
```
...
```json
{
    ...
    "subject": "https://github.com/hivert",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5256#event-61059"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5256#event-61060"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5256",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5256#issuecomment-32265",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5256#event-61061"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5256",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5256#event-61062"
}
```
