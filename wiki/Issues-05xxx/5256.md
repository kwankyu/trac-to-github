...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5256#issuecomment-33495",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5256#event-32768"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5256#event-32769"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5256",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5256#event-32770"
}
```
