...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-69884"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-69885"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-69886"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-69887"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-69888"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-69889"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5895",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-69890"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5895",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5895#issuecomment-38044",
    "user": "https://github.com/mwhansen"
}
```
