...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5895/trac_5895_limit_snapshots.2.patch",
    "created_at": "2009-04-26T01:48:42Z",
    "issue": "https://github.com/sagemath/sage/issues/5895",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5895/trac_5895_limit_snapshots.2.patch",
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38044"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38045"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38046"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38047"
}
```
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38048"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5895/trac_5895_limit_snapshots_2.patch",
    "created_at": "2009-04-27T13:32:02Z",
    "issue": "https://github.com/sagemath/sage/issues/5895",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5895/trac_5895_limit_snapshots_2.patch",
    "user": "https://github.com/rbeezer"
}
```
...
```json
{
    "body": "**Attachment:** [trac_5895_limit_snapshots_2.patch](https://github.com/sagemath/sage/files/ticket5895/trac_5895_limit_snapshots_2.patch)",
    "created_at": "2009-04-27T13:32:02Z",
    "issue": "https://github.com/sagemath/sage/issues/5895",
    "type": "issue_comment",
...
**Attachment:** [trac_5895_limit_snapshots_2.patch](https://github.com/sagemath/sage/files/ticket5895/trac_5895_limit_snapshots_2.patch)
...
```json
{
    ...
    "label": "needs work",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38049"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38050"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38051"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38052"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38053"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5895",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5895#event-38054"
}
```
