...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5160#issuecomment-32834",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5160#issuecomment-32835",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-32029"
}
```
...
```json
{
    ...
    "label": "enhancement",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-32030"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-32031"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-32032"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-32033"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5160",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-32034"
}
```
