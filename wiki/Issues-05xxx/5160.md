...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-59774"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-59775"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-59776"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-59777"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5160",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5160#issuecomment-31625",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-59778"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5160",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5160#event-59779"
}
```
