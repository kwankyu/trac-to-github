...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5212#event-60425"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5212#event-60426"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5212#event-60427"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5212#event-60428"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5212",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5212#issuecomment-31924",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5212#event-60429"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5212",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5212#event-60430"
}
```
