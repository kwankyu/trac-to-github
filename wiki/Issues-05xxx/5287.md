...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5287#event-61499"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5287#event-61500"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5287#event-61501"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5287#event-61502"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5287#event-61503"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5287",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5287#event-61504"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5287",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5287#issuecomment-32511",
    "user": "https://github.com/malb"
}
```
