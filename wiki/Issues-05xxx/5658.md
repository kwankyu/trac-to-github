...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5658#event-66605"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5658#event-66606"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5658#event-66607"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5658#event-66608"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5658#event-66609"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5658",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5658#issuecomment-35811",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5658#event-66610"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5658",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5658#event-66611"
}
```
