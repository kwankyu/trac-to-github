...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66433"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66434"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66435"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66436"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66437"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5645",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5645#event-66438"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5645",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5645#issuecomment-35660",
    "user": "https://github.com/sagetrac-mvngu"
}
```
