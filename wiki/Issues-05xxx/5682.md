...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5682#event-66902"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5682",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5682#issuecomment-35987",
    "user": "https://github.com/kedlaya"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5682#event-66903"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5682#event-66904"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5682#event-66905"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5682#event-66906"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5682#event-66907"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5682",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5682#event-66908"
}
```
