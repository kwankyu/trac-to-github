...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5747#event-67716"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5747#event-67717"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5747#event-67718"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5747",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5747#issuecomment-36428",
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5747#event-67719"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5747#event-67720"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5747#event-67721"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5747",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5747#event-67722"
}
```
