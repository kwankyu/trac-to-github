...
```json
{
    ...
    "milestone_title": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5328#event-62078"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5328#event-62079"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5328#event-62080"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5328#event-62081"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5328#event-62082"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5328",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5328#event-62083"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5328",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5328#issuecomment-32830",
    "user": "https://github.com/jdemeyer"
}
```
