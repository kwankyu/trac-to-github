...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5961#event-70728"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5961",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5961#issuecomment-38640",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5961#event-70729"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5961#event-70730"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5961#event-70731"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5961",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5961#event-70732"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5961#event-70733"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5961#event-70734"
}
```
