...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5290#event-61535"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5290#event-61536"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5290#event-61537"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5290",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5290#event-61538"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5290",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5290#issuecomment-32527",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5290#event-61539"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5290",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5290#event-61540"
}
```
