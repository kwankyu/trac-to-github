...
```json
{
    ...
    "title_was": "tinymce issues",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5025#event-57856"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5025#event-57857"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5025",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5025#event-57858"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5025#event-57859"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5025#event-57860"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5025",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5025#event-57861"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5025",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5025#issuecomment-30528",
    "user": "https://github.com/kcrisman"
}
```
