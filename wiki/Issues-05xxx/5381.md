...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5381#event-62732"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5381#event-62733"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5381#event-62734"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5381#event-62735"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5381",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5381#issuecomment-33190",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5381#event-62736"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5381",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5381#event-62737"
}
```
