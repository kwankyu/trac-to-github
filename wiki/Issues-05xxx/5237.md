...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5237",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5237#issuecomment-32082",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5237#event-60788"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5237#event-60789"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5237#event-60790"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5237#event-60791"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5237#event-60792"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5237",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5237#event-60793"
}
```
