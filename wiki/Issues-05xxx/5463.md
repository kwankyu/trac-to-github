...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5463#event-63922"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5463#event-63923"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5463#event-63924"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5463",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5463#event-63925"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5463",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5463#issuecomment-34071",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5463#event-63926"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5463#event-63927"
}
```
