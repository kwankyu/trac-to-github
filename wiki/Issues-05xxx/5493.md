...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5493#event-34721"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5493#event-34722"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5493#event-34723"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5493#event-34724"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5493",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5493#issuecomment-35602",
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5493#event-34725"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5493",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5493#event-34726"
}
```
