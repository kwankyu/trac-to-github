...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5432#event-63459"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5432#event-63460"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5432#event-63461"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5432#event-63462"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5432",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5432#issuecomment-33706",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5432#event-63463"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5432",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5432#event-63464"
}
```
