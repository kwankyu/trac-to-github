...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5182#event-60053"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5182#event-60054"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5182#event-60055"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5182#event-60056"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5182",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5182#issuecomment-31782",
    "user": "https://github.com/jbandlow"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5182",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5182#event-60057"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5182#event-60058"
}
```
