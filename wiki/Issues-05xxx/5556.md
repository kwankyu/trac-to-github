...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5556#event-65231"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5556#event-65232"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5556#event-65233"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5556#event-65234"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5556#event-65235"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5556",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5556#event-65236"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5556",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5556#issuecomment-34847",
    "user": "https://github.com/mwhansen"
}
```
