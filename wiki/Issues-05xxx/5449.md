...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-63686"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-63687"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-63688"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5449",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5449#issuecomment-33857",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5449",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-63689"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-63690"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5449#event-63691"
}
```
