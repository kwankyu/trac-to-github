...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5744#event-67665"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5744#event-67666"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5744#event-67667"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5744#event-67668"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5744#event-67669"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5744",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5744#issuecomment-36418",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5744#event-67670"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5744",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5744#event-67671"
}
```
