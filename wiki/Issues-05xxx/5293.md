...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5293#event-61578"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5293",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5293#event-61579"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5293#event-61580"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5293#event-61581"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5293",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5293#issuecomment-32553",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5293#event-61582"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5293",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5293#event-61583"
}
```
