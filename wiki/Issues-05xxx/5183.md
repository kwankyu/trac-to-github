...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5183#event-60062"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5183#event-60063"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5183#event-60064"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5183#event-60065"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5183#event-60066"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5183",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5183#issuecomment-31783",
    "user": "https://github.com/jhpalmieri"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5183",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5183#event-60067"
}
```
