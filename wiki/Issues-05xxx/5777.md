...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5777#event-68151"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5777#event-68152"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5777#event-68153"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5777#event-68154"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5777#event-68155"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5777",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5777#issuecomment-36662",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5777#event-68156"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5777",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5777#event-68157"
}
```
