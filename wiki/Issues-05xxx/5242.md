...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-60859"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-60860"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-60861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-60862"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5242",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5242#issuecomment-32126",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-60863"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5242",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-60864"
}
```
