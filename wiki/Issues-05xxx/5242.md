...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5242#issuecomment-33351",
    "user": "https://github.com/hivert"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-32653"
}
```
...
```json
{
    ...
    "asset_name": "generic_power_fix_semigroup-5242-submitted.patch",
    "asset_url": "tarball://root/attachments/ticket5242/generic_power_fix_semigroup-5242-submitted.patch",
    "created_at": "2009-02-12T13:50:42Z",
    "issue": "https://github.com/sagemath/sage/issues/5242",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5242/generic_power_fix_semigroup-5242-submitted.patch",
...
```json
{
    "body": "<a id='comment:1'></a>\n**Attachment:** [generic_power_fix_semigroup-5242-submitted.patch](https://github.com/sagemath/sage/files/ticket5242/generic_power_fix_semigroup-5242-submitted.patch)",
    "created_at": "2009-02-12T13:50:42Z",
    "issue": "https://github.com/sagemath/sage/issues/5242",
    "type": "issue_comment",
...
```json
{
    ...
    "milestone": "sage-3.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-32654"
}
```
...
```json
{
    ...
    "label": "component: combinatorics",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-32655"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-32656"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-32657"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5242",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5242#event-32658"
}
```
