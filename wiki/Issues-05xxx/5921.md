...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5921#event-70188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5921#event-70189"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5921#event-70190"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5921#event-70191"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5921#event-70192"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5921",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5921#issuecomment-38257",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5921#event-70193"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5921",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5921#event-70194"
}
```
