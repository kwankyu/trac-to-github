...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5849#event-69288"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5849#event-69289"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5849#event-69290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5849#event-69291"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5849#event-69292"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5849",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5849#issuecomment-37579",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5849#event-69293"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5849",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5849#event-69294"
}
```
