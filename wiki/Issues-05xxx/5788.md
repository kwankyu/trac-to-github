...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5788#event-68305"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5788#event-68306"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5788#event-68307"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5788#event-68308"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5788#event-68309"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5788",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5788#issuecomment-36776",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5788#event-68310"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5788",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5788#event-68311"
}
```
