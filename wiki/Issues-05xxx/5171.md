...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5171#event-59886"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5171#event-59887"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5171#event-59888"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5171#event-59889"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5171#event-59890"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5171",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5171#event-59891"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5171",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5171#issuecomment-31675",
    "user": "https://github.com/rlmill"
}
```
