...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5501#event-64446"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5501#event-64447"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5501#event-64448"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5501#event-64449"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5501#event-64450"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5501",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5501#event-64451"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5501",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5501#issuecomment-34365",
    "user": "https://github.com/sagetrac-mvngu"
}
```
