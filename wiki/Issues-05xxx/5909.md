...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70022"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70023"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70024"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70025"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5909",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70026"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5909",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5909#issuecomment-38139",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70027"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5909#event-70028"
}
```
