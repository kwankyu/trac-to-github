...
```json
{
    ...
    "milestone_title": "sage-3.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5121#event-59194"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5121#event-59195"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5121",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5121#issuecomment-31249",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5121#event-59196"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5121",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5121#event-59197"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5121#event-59198"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5121",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5121#event-59199"
}
```
