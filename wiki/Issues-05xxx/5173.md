...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5173#event-59906"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5173#event-59907"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5173#event-59908"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5173#event-59909"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5173",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5173#issuecomment-31682",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5173#event-59910"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5173",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5173#event-59911"
}
```
