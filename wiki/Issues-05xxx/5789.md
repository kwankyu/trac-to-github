...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5789#event-68322"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5789#event-68323"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5789#event-68324"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5789",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5789#event-68325"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5789#event-68326"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5789#event-68327"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5789",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5789#issuecomment-36800",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5789#event-68328"
}
```
