...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5540#event-64988"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5540#event-64989"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5540#event-64990"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5540#event-64991"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5540",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5540#issuecomment-34717",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5540#event-64992"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5540",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5540#event-64993"
}
```
