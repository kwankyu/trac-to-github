...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5311#event-61861"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5311#event-61862"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5311#event-61863"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5311#event-61864"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5311",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5311#issuecomment-32753",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5311#event-61865"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5311",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5311#event-61866"
}
```
