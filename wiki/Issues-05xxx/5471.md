...
```json
{
    ...
    "label": "duplicate",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5471#event-34516"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5471",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5471#event-34517"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5471#issuecomment-35400",
    "user": "https://trac.sagemath.org/admin/accounts/users/GeorgSWeber"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5471#event-34518"
}
```
