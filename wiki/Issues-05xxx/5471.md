...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5471#event-64001"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5471#event-64002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5471#event-64003"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5471#event-64004"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5471",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5471#event-64005"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5471",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5471#issuecomment-34106",
    "user": "https://github.com/sagetrac-GeorgSWeber"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5471#event-64006"
}
```
