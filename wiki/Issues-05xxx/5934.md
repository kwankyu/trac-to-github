...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5934#event-70350"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5934#event-70351"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5934#event-70352"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5934#event-70353"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5934#event-70354"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5934#event-70355"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5934",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5934#event-70356"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5934",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5934#issuecomment-38367",
    "user": "https://github.com/sagetrac-mvngu"
}
```
