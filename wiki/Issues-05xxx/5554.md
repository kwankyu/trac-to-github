...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5554#event-65201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5554#event-65202"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5554",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5554#issuecomment-34809",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5554#event-65203"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5554#event-65204"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5554#event-65205"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5554",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5554#event-65206"
}
```
