...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5555#event-65218"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5555#event-65219"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5555#event-65220"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5555#event-65221"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5555#event-65222"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5555",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5555#event-65223"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5555",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5555#issuecomment-34836",
    "user": "https://github.com/dandrake"
}
```
