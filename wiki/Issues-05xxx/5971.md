...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5971#event-70897"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5971#event-70898"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5971#event-70899"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5971#event-70900"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5971#event-70901"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5971#event-70902"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5971",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5971#event-70903"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5971",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5971#issuecomment-38778",
    "user": "https://github.com/sagetrac-mvngu"
}
```
