...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5972#event-70906"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5972#event-70907"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5972#event-70908"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5972#event-70909"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5972#event-70910"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5972#event-70911"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5972",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5972#event-70912"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5972",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5972#issuecomment-38783",
    "user": "https://github.com/williamstein"
}
```
