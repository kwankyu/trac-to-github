...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5133#event-59383"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5133#event-59384"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5133#event-59385"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5133",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5133#event-59386"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5133",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5133#event-59387"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5133",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5133#event-59388"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5133",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5133#issuecomment-31342",
    "user": "https://github.com/sagetrac-mvngu"
}
```
