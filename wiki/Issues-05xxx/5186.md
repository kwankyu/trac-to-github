...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60108"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60109"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60110"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60111"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60112"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5186",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5186#event-60113"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5186",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5186#issuecomment-31807",
    "user": "https://github.com/wjp"
}
```
