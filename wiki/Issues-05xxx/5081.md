...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5081#event-58598"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5081#event-58599"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5081#event-58600"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5081#event-58601"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5081#event-58602"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5081",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5081#event-58603"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5081",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5081#issuecomment-30888",
    "user": "https://github.com/sagetrac-mvngu"
}
```
