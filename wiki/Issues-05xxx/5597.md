...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-65788"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-65789"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-65790"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-65791"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-65792"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-65793"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5597",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5597#event-65794"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5597",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5597#issuecomment-35221",
    "user": "https://github.com/mwhansen"
}
```
