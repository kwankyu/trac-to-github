...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5483#event-64182"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5483#event-64183"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5483#event-64184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5483#event-64185"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5483#event-64186"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5483",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5483#event-64187"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5483",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5483#issuecomment-34189",
    "user": "https://github.com/mwhansen"
}
```
