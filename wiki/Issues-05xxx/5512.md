...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5512#event-64611"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5512#event-64612"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5512#event-64613"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5512#event-64614"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5512#event-64615"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5512",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5512#event-64616"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5512",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5512#issuecomment-34446",
    "user": "https://github.com/jdemeyer"
}
```
