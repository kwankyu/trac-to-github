...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5474#event-64041"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5474#event-64042"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5474#event-64043"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5474#event-64044"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5474#event-64045"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5474",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5474#event-64046"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5474",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5474#issuecomment-34116",
    "user": "https://github.com/jhpalmieri"
}
```
