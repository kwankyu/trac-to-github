...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5898#event-69910"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5898#event-69911"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5898#event-69912"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5898#event-69913"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5898#event-69914"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5898",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5898#issuecomment-38059",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5898#event-69915"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5898",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5898#event-69916"
}
```
