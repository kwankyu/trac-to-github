...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5233#event-60721"
}
```
...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5233#event-60722"
}
```
...
```json
{
    ...
    "subject": "https://github.com/mwhansen",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5233#event-60723"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5233#event-60724"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5233",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5233#issuecomment-32062",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5233#event-60725"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5233",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5233#event-60726"
}
```
