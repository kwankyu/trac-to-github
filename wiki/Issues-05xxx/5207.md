...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5207#event-60361"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5207#event-60362"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5207#event-60363"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5207#event-60364"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5207",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5207#issuecomment-31893",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5207#event-60365"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5207",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5207#event-60366"
}
```
