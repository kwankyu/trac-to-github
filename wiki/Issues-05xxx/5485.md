...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5485#issuecomment-35502",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5485#issuecomment-35503",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5485#issuecomment-35504",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5485#issuecomment-35505",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5485#issuecomment-35506",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5485",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5485#issuecomment-35507",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5485#event-34652"
}
```
...
```json
{
    ...
    "asset_name": "dimension_zero_ideal.patch",
    "asset_url": "tarball://root/attachments/ticket5485/dimension_zero_ideal.patch",
    "created_at": "2009-03-30T22:40:18Z",
    "issue": "https://github.com/sagemath/sage/issues/5485",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5485/dimension_zero_ideal.patch",
    "user": "https://github.com/johnperry-math"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5485#event-34653"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5485#event-34654"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5485#event-34655"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5485",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5485#event-34656"
}
```
