...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5021#event-30843"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5021",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5021#issuecomment-31675",
    "user": "https://github.com/jasongrout"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5021#event-30844"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5021",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5021#event-30845"
}
```
