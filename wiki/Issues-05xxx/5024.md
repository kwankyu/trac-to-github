...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5024#issuecomment-31685",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5024#event-30857"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5024#event-30858"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5024",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5024#event-30859"
}
```
