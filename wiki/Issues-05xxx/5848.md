...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5848#event-69272"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5848#event-69273"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5848#event-69274"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5848#event-69275"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5848#event-69276"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5848",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5848#issuecomment-37574",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5848#event-69277"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5848",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5848#event-69278"
}
```
