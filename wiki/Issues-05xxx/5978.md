...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5978#event-71016"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5978#event-71017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5978#event-71018"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5978#event-71019"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5978#event-71020"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5978#event-71021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5978",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5978#event-71022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5978",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5978#issuecomment-38904",
    "user": "https://github.com/jdemeyer"
}
```
