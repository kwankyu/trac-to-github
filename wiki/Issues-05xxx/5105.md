...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5105#event-58958"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5105#event-58959"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5105#event-58960"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5105#event-58961"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5105#event-58962"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5105",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5105#event-58963"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5105",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5105#issuecomment-31110",
    "user": "https://github.com/loefflerd"
}
```
