...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5991#event-71212"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5991#event-71213"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5991#event-71214"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5991#event-71215"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5991#event-71216"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5991#event-71217"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5991",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5991#event-71218"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5991",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5991#issuecomment-39052",
    "user": "https://github.com/mwhansen"
}
```
