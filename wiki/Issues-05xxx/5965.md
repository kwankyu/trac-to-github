...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5965#event-70808"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5965#event-70809"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5965#event-70810"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5965#event-70811"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5965#event-70812"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5965#event-70813"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5965",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5965#event-70814"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5965",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5965#issuecomment-38689",
    "user": "https://github.com/slel"
}
```
