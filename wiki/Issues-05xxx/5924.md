...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5924#event-70226"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5924#event-70227"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5924#event-70228"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5924#event-70229"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5924#event-70230"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5924#event-70231"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5924#event-70232"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5924",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5924#issuecomment-38281",
    "user": "https://github.com/loefflerd"
}
```
