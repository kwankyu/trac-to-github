...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5792#event-68365"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5792#event-68366"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5792#event-68367"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5792#event-68368"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5792#event-68369"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5792#event-68370"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5792",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5792#event-68371"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5792",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5792#issuecomment-36834",
    "user": "https://github.com/loefflerd"
}
```
