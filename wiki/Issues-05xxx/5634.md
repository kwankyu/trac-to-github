...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5634#event-66288"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5634#event-66289"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5634",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5634#issuecomment-35589",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5634#event-66290"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5634#event-66291"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.7",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5634#event-66292"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5634#event-66293"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5634",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5634#event-66294"
}
```
