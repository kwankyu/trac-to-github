...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5905#event-69985"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5905#event-69986"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5905#event-69987"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5905#event-69988"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5905#event-69989"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5905",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5905#issuecomment-38119",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5905#event-69990"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5905",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5905#event-69991"
}
```
