...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5221#event-60555"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5221#event-60556"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5221#event-60557"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5221#event-60558"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5221#event-60559"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5221",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5221#event-60560"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5221",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5221#issuecomment-31994",
    "user": "https://github.com/sagetrac-mvngu"
}
```
