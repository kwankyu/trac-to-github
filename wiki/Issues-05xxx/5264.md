...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5264#event-61174"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5264#event-61175"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5264#event-61176"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5264#event-61177"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5264",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5264#issuecomment-32324",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5264#event-61178"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5264",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5264#event-61179"
}
```
