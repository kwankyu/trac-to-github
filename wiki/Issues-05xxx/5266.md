...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5266#event-61200"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5266#event-61201"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5266#event-61202"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5266#event-61203"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5266",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5266#issuecomment-32333",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5266#event-61204"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5266",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5266#event-61205"
}
```
