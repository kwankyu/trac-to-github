...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5106#event-58977"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5106#event-58978"
}
```
...
```json
{
    ...
    "title_was": "[needs rebase] preparse bug with time and generator assignment naming",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5106#event-58979"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5106#event-58980"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5106",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5106#issuecomment-31126",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5106#event-58981"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5106",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5106#event-58982"
}
```
