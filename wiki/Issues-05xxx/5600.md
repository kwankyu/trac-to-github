...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-65843"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-65844"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-65845"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-65846"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-65847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-65848"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5600",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5600#event-65849"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5600",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5600#issuecomment-35275",
    "user": "https://github.com/sagetrac-mvngu"
}
```
