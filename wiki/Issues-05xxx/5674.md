...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5674#event-66814"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5674#event-66815"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5674#event-66816"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5674#event-66817"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5674#event-66818"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5674#event-66819"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5674",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5674#event-66820"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5674",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5674#issuecomment-35949",
    "user": "https://github.com/JohnCremona"
}
```
