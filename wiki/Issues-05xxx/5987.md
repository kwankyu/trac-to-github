...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5987#event-71155"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5987#event-71156"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5987#event-71157"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5987#event-71158"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5987#event-71159"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5987",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5987#issuecomment-39010",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5987#event-71160"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5987",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5987#event-71161"
}
```
