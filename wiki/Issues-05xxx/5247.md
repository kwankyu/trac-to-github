...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5247#event-60933"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5247#event-60934"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5247",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5247#issuecomment-32157",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5247#event-60935"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5247#event-60936"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5247#event-60937"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5247",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5247#event-60938"
}
```
