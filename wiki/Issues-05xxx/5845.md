...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5845#event-69184"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5845#event-69185"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5845#event-69186"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5845#event-69187"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5845#event-69188"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5845#event-69189"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5845",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5845#event-69190"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5845",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5845#issuecomment-37404",
    "user": "https://github.com/ncalexan"
}
```
