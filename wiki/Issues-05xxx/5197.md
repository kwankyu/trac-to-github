...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60231"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60232"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60233"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5197",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60234"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5197",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5197#issuecomment-31841",
    "user": "https://github.com/williamstein"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60235"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5197#event-60236"
}
```
