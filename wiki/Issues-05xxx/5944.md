...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5944#event-70465"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5944#event-70466"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5944#event-70467"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5944#event-70468"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5944",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5944#event-70469"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5944",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5944#issuecomment-38438",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5944#event-70470"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5944#event-70471"
}
```
