...
```json
{
    ...
    "subject": "https://github.com/loefflerd",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5968#event-70845"
}
```
...
```json
{
    ...
    "milestone_title": "sage-4.0.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5968#event-70846"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5968#event-70847"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5968#event-70848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5968#event-70849"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5968#event-70850"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5968",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5968#event-70851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5968",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5968#issuecomment-38725",
    "user": "https://github.com/loefflerd"
}
```
