...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5955#event-70625"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5955#event-70626"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5955#event-70627"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5955#event-70628"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5955#event-70629"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5955",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5955#issuecomment-38533",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5955#event-70630"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5955",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5955#event-70631"
}
```
