...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5925#event-70235"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5925#event-70236"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5925#event-70237"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5925#event-70238"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5925",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5925#event-70239"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5925#event-70240"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5925",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5925#event-70241"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5925",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5925#issuecomment-38294",
    "user": "https://github.com/nthiery"
}
```
