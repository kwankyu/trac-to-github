...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5561#event-65295"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5561#event-65296"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5561",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5561#issuecomment-34887",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5561#event-65297"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5561",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5561#event-65298"
}
```
...
```json
{
    ...
    "milestone_title": "sage-3.4.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5561#event-65299"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5561#event-65300"
}
```
