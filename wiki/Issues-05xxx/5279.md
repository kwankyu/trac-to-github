...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5279#event-61379"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5279#event-61380"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5279#event-61381"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5279#event-61382"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5279",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5279#issuecomment-32397",
    "user": "https://github.com/dcoudert"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5279#event-61383"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5279",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5279#event-61384"
}
```
