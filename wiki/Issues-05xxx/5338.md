...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5338#event-62208"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5338#event-62209"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5338#event-62210"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5338#event-62211"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5338#event-62212"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5338",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5338#event-62213"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5338",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5338#issuecomment-32923",
    "user": "https://github.com/mwhansen"
}
```
