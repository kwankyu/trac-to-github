...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5217#issuecomment-33176",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5217",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5217#issuecomment-33177",
    "user": "https://trac.sagemath.org/admin/accounts/users/mabshoff"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5217#event-32409"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5217#event-32410"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5217#event-32411"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5217#event-32412"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5217",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5217#event-32413"
}
```
