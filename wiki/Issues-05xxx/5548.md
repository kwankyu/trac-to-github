...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5548#event-65113"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5548#event-65114"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5548#event-65115"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5548#event-65116"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5548#event-65117"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5548",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5548#event-65118"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5548",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5548#issuecomment-34776",
    "user": "https://github.com/jdemeyer"
}
```
