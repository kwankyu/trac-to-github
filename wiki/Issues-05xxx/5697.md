...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5697#event-67073"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5697#event-67074"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5697#event-67075"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5697#event-67076"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5697#event-67077"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5697",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5697#issuecomment-36072",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5697#event-67078"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5697",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5697#event-67079"
}
```
