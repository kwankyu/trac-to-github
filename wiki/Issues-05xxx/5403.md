...
```json
{
    ...
    "subject": "https://github.com/tornaria",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5403#event-63044"
}
```
...
```json
{
    ...
    "subject": "https://github.com/tornaria",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5403#event-63045"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5403#event-63046"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5403#event-63047"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5403#event-63048"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5403",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5403#event-63049"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5403",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5403#issuecomment-33443",
    "user": "https://github.com/sagetrac-mabshoff"
}
```
