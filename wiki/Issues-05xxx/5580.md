...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5580#event-65559"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5580#event-65560"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5580#event-65561"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5580#event-65562"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5580",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5580#event-65563"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5580",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5580#issuecomment-35110",
    "user": "https://github.com/qed777"
}
```
