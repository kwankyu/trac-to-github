...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5656/gb_lift.patch",
    "created_at": "2009-05-12T01:55:46Z",
    "issue": "https://github.com/sagemath/sage/issues/5656",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5656/gb_lift.patch",
    "user": "https://github.com/malb"
}
```
...
```json
{
    "body": "**Attachment:** [gb_lift.patch](https://github.com/sagemath/sage/files/ticket5656/gb_lift.patch)",
    "created_at": "2009-05-12T01:55:46Z",
    "issue": "https://github.com/sagemath/sage/issues/5656",
    "type": "issue_comment",
...
**Attachment:** [gb_lift.patch](https://github.com/sagemath/sage/files/ticket5656/gb_lift.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-36089"
}
```
...
```json
{
    ...
    "asset_url": "tarball://root/attachments/ticket5656/trac_5656-gb_lift-revised.patch",
    "created_at": "2009-06-04T13:50:50Z",
    "issue": "https://github.com/sagemath/sage/issues/5656",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5656/trac_5656-gb_lift-revised.patch",
...
```json
{
    "body": "**Attachment:** [trac_5656-gb_lift-revised.patch](https://github.com/sagemath/sage/files/ticket5656/trac_5656-gb_lift-revised.patch)\n\nrevision of Martin's patch",
    "created_at": "2009-06-04T13:50:50Z",
    "issue": "https://github.com/sagemath/sage/issues/5656",
    "type": "issue_comment",
...
**Attachment:** [trac_5656-gb_lift-revised.patch](https://github.com/sagemath/sage/files/ticket5656/trac_5656-gb_lift-revised.patch)
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-36090"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-36091"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-36092"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5656",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-36093"
}
```
