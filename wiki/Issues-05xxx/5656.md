...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-66588"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-66589"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-66590"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-66591"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-66592"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-66593"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5656",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5656#event-66594"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5656",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5656#issuecomment-35804",
    "user": "https://github.com/mwhansen"
}
```
