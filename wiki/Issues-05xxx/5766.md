...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5766#event-67999"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5766#event-68000"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5766#event-68001"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5766#event-68002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5766#event-68003"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5766#event-68004"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5766",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5766#event-68005"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5766",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5766#issuecomment-36588",
    "user": "https://github.com/mwhansen"
}
```
