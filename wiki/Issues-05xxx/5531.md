...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5531#event-64847"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5531#event-64848"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5531#event-64849"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5531#event-64850"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5531#event-64851"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5531",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5531#event-64852"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5531",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5531#issuecomment-34635",
    "user": "https://github.com/loefflerd"
}
```
