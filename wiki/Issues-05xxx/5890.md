...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-38017"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-38018"
}
```
...
```json
{
    ...
    "asset_name": "trac_5890.patch",
    "asset_url": "tarball://root/attachments/ticket5890/trac_5890.patch",
    "created_at": "2009-04-25T05:26:32Z",
    "issue": "https://github.com/sagemath/sage/issues/5890",
    "type": "attachment",
    "url": "https://github.com/sagemath/sage/files/ticket5890/trac_5890.patch",
    "user": "https://github.com/aghitza"
}
```
...
```json
{
    "body": "<a id='comment:4'></a>\n**Attachment:** [trac_5890.patch](https://github.com/sagemath/sage/files/ticket5890/trac_5890.patch)",
    "created_at": "2009-04-25T05:26:32Z",
    "issue": "https://github.com/sagemath/sage/issues/5890",
    "type": "issue_comment",
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-38019"
}
```
...
```json
{
    ...
    "milestone": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-38020"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-38021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5890",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-38022"
}
```
