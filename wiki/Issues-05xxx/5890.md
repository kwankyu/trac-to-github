...
```json
{
    ...
    "subject": "https://github.com/aghitza",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-69829"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-69830"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-69831"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-69832"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5890",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5890#issuecomment-37992",
...
```json
{
    ...
    "milestone_title": "sage-4.0",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-69833"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-69834"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5890",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5890#event-69835"
}
```
