...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5936#event-70371"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5936#event-70372"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5936#event-70373"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5936#event-70374"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5936#event-70375"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5936#event-70376"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5936",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5936#event-70377"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5936",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5936#issuecomment-38374",
    "user": "https://github.com/mwhansen"
}
```
