...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5176#event-59937"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5176#event-59938"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5176#event-59939"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5176#event-59940"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5176#event-59941"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5176",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/5176#event-59942"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/5176",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/5176#issuecomment-31700",
    "user": "https://github.com/jasongrout"
}
```
