...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16060#issuecomment-206975",
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16060#event-143913"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16060",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16060#issuecomment-206976",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16060#event-143914"
}
```
...
```json
{
    ...
    "label": "needs review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16060#event-143915"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16060#event-143916"
}
```
...
```json
{
    ...
    "label": "positive review",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16060#event-143917"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16060",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16060#event-143918"
}
```
