...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233000"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233001"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233002"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233003"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233004"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233005"
}
```
...
```json
{
    ...
    "title_was": "polar_plot crash with expressions containing floor",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233006"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233007"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233008"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233009"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233010"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233011"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233012"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233013"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16459#issuecomment-212846",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233014"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16459#issuecomment-212847",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16459#issuecomment-212848",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233016"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16459#issuecomment-212849",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233017"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233018"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16459#issuecomment-212850",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16459#issuecomment-212851",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233019"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233020"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16459#issuecomment-212852",
    "user": "https://github.com/kcrisman"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16459",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16459#issuecomment-212853",
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16459",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16459#event-233022"
}
```
