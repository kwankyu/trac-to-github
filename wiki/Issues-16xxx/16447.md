...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16447#event-232787"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16447#event-232788"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16447#event-232789"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16447#event-232790"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16447#issuecomment-212389",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16447#issuecomment-212390",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16447#issuecomment-212391",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16447",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16447#issuecomment-212392",
    "user": "https://github.com/rwst"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16447#event-232791"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16447#event-232792"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16447#event-232793"
}
```
