...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238705"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238706"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238707"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238708"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238709"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238710"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238711"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238712"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238713"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238714"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16843",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16843#issuecomment-221410",
    "user": "https://github.com/sagetrac-mkamalakshya"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16843",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16843#issuecomment-221411",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16843",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16843#issuecomment-221412",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238715"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238716"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16843",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16843#issuecomment-221413",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16843",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16843#issuecomment-221414",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16843",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16843#issuecomment-221415",
    "user": "https://github.com/pjbruin"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16843",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16843#issuecomment-221416",
    "user": "https://github.com/tscrim"
}
```
...
```json
{
    "body": "<div id=\"comment:14\" align=\"right\">comment:14</div>\n\nReplying to [@pjbruin](#comment%3A9):\n> We should make sure that `QQ` is in `VectorSpaces(QQ)`.\n\nSee https://github.com/sagemath/trac_to_gh/wiki/CategoriesRoadMap for a brief discussion on that topic. IIRC that was discussed too on #10963. It's not quite trivial, and it's not totally clear that we actually want it (e.g. add to QQ all the methods of a vector space, like basis, ...). Work on this is welcome if anyone volunteers ...",
    "created_at": "2014-08-20T04:52:56Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/16843",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16843#issuecomment-221417",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16843#event-238717"
}
```
