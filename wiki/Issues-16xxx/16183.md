...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16183#event-145215"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16183",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16183#issuecomment-209221",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16183",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16183#issuecomment-209222",
    "user": "https://github.com/nthiery"
}
```
...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16183#event-145216"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16183#event-145217"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16183#event-145218"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16183#event-145219"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16183#event-145220"
}
```
