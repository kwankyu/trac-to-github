...
```json
{
    ...
    "milestone": "sage-6.2",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16006#event-143409"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16006#event-143410"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16006#event-143411"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16006#event-143412"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16006#event-143413"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16006",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16006#issuecomment-205854",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16006",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16006#event-143414"
}
```
