...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229014"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229015"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229016"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229017"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229018"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229019"
}
```
...
```json
{
    "body": "<div id=\"comment:12\" align=\"right\">comment:12</div>\n\n... going with the latter.\n\nIf you're ok with my changes, just set the ticket to positive review.  (The implementation is perhaps suboptimal, but the output is fancy! ;-) )\n\n---\nNew commits:\n<table><tr><td><a href=\"https://github.com/sagemath/sagetrac-mirror/commit/49b8b4ced71fd942193f22281255aeefdb7b0eb3\"><code>49b8b4c</code></a></td><td><code>Ticket #16187 reviewer patch: Beautify output of sage --{optional,experimental}</code></td></tr></table>\n",
    "created_at": "2014-04-19T21:39:32Z",
    "formatter": "markdown",
    "issue": "https://github.com/sagemath/sage/issues/16187",
    "type": "issue_comment",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16187#issuecomment-206762",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16187#issuecomment-206763",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229020"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229021"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16187#issuecomment-206764",
    "user": "https://github.com/vbraun"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16187#issuecomment-206765",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229022"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16187#issuecomment-206766",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16187#issuecomment-206767",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16187#issuecomment-206768",
    "user": "https://github.com/nexttime"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229023"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16187",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16187#event-229024"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16187",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16187#issuecomment-206769",
    "user": "https://github.com/vbraun"
}
```
