...
```json
{
    ...
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-222141",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-151387"
}
```
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-151388"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-222142",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-222143",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-222144",
    "user": "https://trac.sagemath.org/admin/accounts/users/ajagekar.akshay"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-222145",
...
```json
{
    ...
    "milestone": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-151389"
}
```
