...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-237543"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-237544"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-237545"
}
```
...
```json
{
    ...
    "label_text_color": "ffffff",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-237546"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-219637",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "milestone_title": "sage-6.3",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-237547"
}
```
...
```json
{
    ...
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-237548"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-219638",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-219639",
    "user": "https://github.com/jdemeyer"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-219640",
    "user": "https://github.com/sagetrac-ajagekar-akshay"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/16769",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/16769#issuecomment-219641",
...
```json
{
    ...
    "milestone_title": "sage-6.4",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/16769#event-237549"
}
```
