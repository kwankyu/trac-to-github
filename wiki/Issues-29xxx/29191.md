...
```json
{
    ...
    "milestone": "sage-9.1",
    "type": "issue_event",
    "url": "https://github.com/sagemath/sage/issues/29191#event-261919"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29191#issuecomment-460516",
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29191#issuecomment-460517",
    "user": "https://github.com/kliem"
}
```
...
```json
{
    ...
    "issue": "https://github.com/sagemath/sage/issues/29191",
    "type": "issue_comment",
    "url": "https://github.com/sagemath/sage/issues/29191#issuecomment-460518",
    "user": "https://github.com/kliem"
}
```
